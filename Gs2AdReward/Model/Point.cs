...
namespace Gs2.Gs2AdReward.Model
{
	...
	[Preserve]
#endif
	public partial class Point : IComparable
	{
        ...
        public static Point FromJson(JsonData data)
        {
            ...
            return new Point()
                ...
                .WithValue(!data.Keys.Contains("point") || data["point"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableLong(data["point"].ToString()))
