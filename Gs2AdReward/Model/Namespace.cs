...
namespace Gs2.Gs2AdReward.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2AdReward.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        public Namespace WithTransactionSettingV2(Gs2.Gs2AdReward.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        public Namespace WithAcquirePointScript(Gs2.Gs2AdReward.Model.ScriptSetting acquirePointScript) {
            this.AcquirePointScript = acquirePointScript;
            return this;
        }
        public Namespace WithConsumePointScript(Gs2.Gs2AdReward.Model.ScriptSetting consumePointScript) {
        ...
        public void WriteJson(JsonWriter writer)
        {
            ...
            if (AcquirePointScript != null) {
                writer.WritePropertyName("acquirePointScript");
                AcquirePointScript.WriteJson(writer);
            }
            if (ConsumePointScript != null) {
                writer.WritePropertyName("consumePointScript");
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(Admob, other.Admob);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(UnityAd, other.UnityAd);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.CompareArray(AppLovinMaxes, other.AppLovinMaxes);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(AcquirePointScript, other.AcquirePointScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ConsumePointScript, other.ConsumePointScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ChangePointNotification, other.ChangePointNotification);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public object Clone() {
            return new Namespace {
                ...
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2AdReward.Model.TransactionSettingV2,
