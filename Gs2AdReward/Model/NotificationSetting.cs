...
namespace Gs2.Gs2AdReward.Model
{
	...
	public partial class NotificationSetting : IComparable
	{
        ...
        public Gs2.Gs2AdReward.Model.MobileNotificationMessage[] MobileNotificationMessages { set; get; }
        ...
        public NotificationSetting WithMobileNotificationMessages(Gs2.Gs2AdReward.Model.MobileNotificationMessage[] mobileNotificationMessages) {
        ...
        public static NotificationSetting FromJson(JsonData data)
        {
            ...
            return new NotificationSetting()
                ...
                .WithMobileNotificationMessages(!data.Keys.Contains("mobileNotificationMessages") || data["mobileNotificationMessages"] == null || !data["mobileNotificationMessages"].IsArray ? null : data["mobileNotificationMessages"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2AdReward.Model.MobileNotificationMessage.FromJson(v);
                }).ToArray())
        ...
        public void Validate() {
            {
                if (GatewayNamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("notificationSetting", "adReward.notificationSetting.gatewayNamespaceId.error.tooLong"),
                    });
                }
            }
            {
            }
            {
                if (Sound.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("notificationSetting", "adReward.notificationSetting.sound.error.tooLong"),
                    });
                }
            }
            {
                if (MobileNotificationMessages.Length > 100) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("notificationSetting", "adReward.notificationSetting.mobileNotificationMessages.error.tooMany"),
                    });
                }
            }
            {
                switch (Enable) {
                    ...
                    default:
                        throw new Gs2.Core.Exception.BadRequestException(new [] {
                            new RequestError("notificationSetting", "adReward.notificationSetting.enable.error.invalid"),
                        });
                }
            }
        }
        ...
        public object Clone() {
            return new NotificationSetting {
                ...
                EnableTransferMobileNotification = EnableTransferMobileNotification,
                Sound = Sound,
                MobileNotificationMessages = MobileNotificationMessages?.Clone() as Gs2.Gs2AdReward.Model.MobileNotificationMessage[],
                Enable = Enable,
            };
        }
    }
