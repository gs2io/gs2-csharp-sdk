...
namespace Gs2.Gs2AdReward.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2AdReward.Model.Namespace>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2AdReward.Model.Namespace>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2AdReward.Model.Namespace>
    #endif
    {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2AdReward.Model.Namespace> GetAsyncEnumerator(
