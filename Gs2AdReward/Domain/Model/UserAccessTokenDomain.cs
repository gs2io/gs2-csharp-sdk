...
namespace Gs2.Gs2AdReward.Domain.Model
{
    ...
    public partial class UserAccessTokenDomain {
        ...
        public UserAccessTokenDomain(
            ...
            this._parentKey = Gs2.Gs2AdReward.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                this.NamespaceName,
                "User"
            );
        }

        public Gs2.Gs2AdReward.Domain.Model.PointAccessTokenDomain Point(
        ) {
            return new Gs2.Gs2AdReward.Domain.Model.PointAccessTokenDomain(
                this._gs2,
                this.NamespaceName,
                this._accessToken
            );
