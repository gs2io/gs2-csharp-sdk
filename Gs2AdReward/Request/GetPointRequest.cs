...
#endif
	[System.Serializable]
	public class GetPointRequest : Gs2Request<GetPointRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPointRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPointRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPointRequest)x;
            return this;
        }
    }
}