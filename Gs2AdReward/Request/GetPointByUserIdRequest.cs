...
namespace Gs2.Gs2AdReward.Request
{
	...
	public class GetPointByUserIdRequest : Gs2Request<GetPointByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPointByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPointByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPointByUserIdRequest)x;
            return this;
        }
    }
}