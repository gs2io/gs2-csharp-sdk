...
namespace Gs2.Gs2Showcase.Model.Cache
{
    public static class Gs2Showcase
    {
        ...
        public static string PutUserData(
            ...
            switch (kind) {
                case "randomDisplayItem":
                    return Gs2.Gs2Showcase.Model.RandomDisplayItem.FromJson(JsonMapper.ToObject(payload))
        ...
        public static bool SetListCached(
            ...
            switch (kind) {
                case "randomDisplayItem":
                    cache.SetListCached<Gs2.Gs2Showcase.Model.RandomDisplayItem>(parentKey);
                    return true;
            }
            return false;
        }
