...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<BuyResult> InvokeFuture(
            this BuyRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<BuyResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<BuyResult> self)
            {
            ...
            return new Gs2InlineFuture<BuyResult>(Impl);
        }
#endif
