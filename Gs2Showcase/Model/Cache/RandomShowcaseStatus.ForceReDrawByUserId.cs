...
namespace Gs2.Gs2Showcase.Model.Cache
{
    public static partial class RandomShowcaseStatusExt
    {
        public static void PutCache(
            this ForceReDrawByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<ForceReDrawByUserIdResult> InvokeFuture(
            this ForceReDrawByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<ForceReDrawByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<ForceReDrawByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<ForceReDrawByUserIdResult>(Impl);
        }
#endif
