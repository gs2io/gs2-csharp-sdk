...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class GetCurrentShowcaseMasterRequest : Gs2Request<GetCurrentShowcaseMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentShowcaseMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentShowcaseMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentShowcaseMasterRequest)x;
            return this;
        }
    }
}