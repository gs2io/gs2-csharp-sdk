...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class UpdateCurrentShowcaseMasterFromGitHubRequest : Gs2Request<UpdateCurrentShowcaseMasterFromGitHubRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentShowcaseMasterFromGitHubRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new UpdateCurrentShowcaseMasterFromGitHubRequest()
                ...
                .WithCheckoutSetting(!data.Keys.Contains("checkoutSetting") || data["checkoutSetting"] == null ? null : Gs2.Gs2Showcase.Model.GitHubCheckoutSetting.FromJson(data["checkoutSetting"]));
        }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentShowcaseMasterFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentShowcaseMasterFromGitHubRequest)x;
            return this;
        }
    }
}