...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class GetShowcaseByUserIdRequest : Gs2Request<GetShowcaseByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetShowcaseByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetShowcaseByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetShowcaseByUserIdRequest)x;
            return this;
        }
    }
}