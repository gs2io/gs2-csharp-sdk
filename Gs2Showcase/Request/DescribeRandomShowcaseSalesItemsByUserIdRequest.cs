...
#endif
	[System.Serializable]
	public class DescribeRandomShowcaseSalesItemsByUserIdRequest : Gs2Request<DescribeRandomShowcaseSalesItemsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRandomShowcaseSalesItemsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRandomShowcaseSalesItemsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRandomShowcaseSalesItemsByUserIdRequest)x;
            return this;
        }
    }
}