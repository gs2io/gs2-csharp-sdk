...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class DescribeSalesItemGroupMastersRequest : Gs2Request<DescribeSalesItemGroupMastersRequest>
	{
        ...
        public DescribeSalesItemGroupMastersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSalesItemGroupMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSalesItemGroupMastersRequest)x;
            return this;
        }
    }
}