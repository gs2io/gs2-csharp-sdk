...
#endif
	[System.Serializable]
	public class IncrementPurchaseCountByStampTaskRequest : Gs2Request<IncrementPurchaseCountByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static IncrementPurchaseCountByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply IncrementPurchaseCountByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (IncrementPurchaseCountByStampTaskRequest)x;
            return this;
        }
    }
}