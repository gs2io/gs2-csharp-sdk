...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class DecrementPurchaseCountByStampSheetRequest : Gs2Request<DecrementPurchaseCountByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static DecrementPurchaseCountByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DecrementPurchaseCountByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DecrementPurchaseCountByStampSheetRequest)x;
            return this;
        }
    }
}