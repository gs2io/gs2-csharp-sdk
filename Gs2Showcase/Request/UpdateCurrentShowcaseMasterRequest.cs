...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class UpdateCurrentShowcaseMasterRequest : Gs2Request<UpdateCurrentShowcaseMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentShowcaseMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentShowcaseMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentShowcaseMasterRequest)x;
            return this;
        }
    }
}