...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class GetShowcaseMasterRequest : Gs2Request<GetShowcaseMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetShowcaseMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetShowcaseMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetShowcaseMasterRequest)x;
            return this;
        }
    }
}