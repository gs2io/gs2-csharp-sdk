...
namespace Gs2.Gs2Showcase.Request
{
	...
	public class DescribeShowcasesByUserIdRequest : Gs2Request<DescribeShowcasesByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeShowcasesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeShowcasesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeShowcasesByUserIdRequest)x;
            return this;
        }
    }
}