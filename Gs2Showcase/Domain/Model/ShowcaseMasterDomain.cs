...
namespace Gs2.Gs2Showcase.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Showcase.Model.ShowcaseMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Showcase.Model.ShowcaseMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "showcaseMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Showcase.Domain.Model.ShowcaseMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Showcase.Model.ShowcaseMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class ShowcaseMasterDomain {
        ...
        public IFuture<Gs2.Gs2Showcase.Model.ShowcaseMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Showcase.Model.ShowcaseMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Showcase.Model.ShowcaseMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Showcase.Model.ShowcaseMaster>(
                        _parentKey,
                        Gs2.Gs2Showcase.Domain.Model.ShowcaseMasterDomain.CreateCacheKey(
                            this.ShowcaseName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Showcase.Model.ShowcaseMaster>(
                _parentKey,
                Gs2.Gs2Showcase.Domain.Model.ShowcaseMasterDomain.CreateCacheKey(
                    this.ShowcaseName.ToString()
                )
