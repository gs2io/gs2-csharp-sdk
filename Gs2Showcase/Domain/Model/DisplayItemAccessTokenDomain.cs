...
namespace Gs2.Gs2Showcase.Domain.Model
{
    ...
    public partial class DisplayItemAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Showcase.Domain.Model.DisplayItemAccessTokenDomain> BuyAsync(
            #else
        public IFuture<Gs2.Gs2Showcase.Domain.Model.DisplayItemAccessTokenDomain> Buy(
            #endif
        #else
        public async Task<Gs2.Gs2Showcase.Domain.Model.DisplayItemAccessTokenDomain> BuyAsync(
        #endif
            BuyRequest request
        ) {

        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2Showcase.Domain.Model.DisplayItemAccessTokenDomain> self)
            {
        #endif
            request
            ...
            return new Gs2InlineFuture<Gs2.Gs2Showcase.Domain.Model.DisplayItemAccessTokenDomain>(Impl);
        #endif
        }
