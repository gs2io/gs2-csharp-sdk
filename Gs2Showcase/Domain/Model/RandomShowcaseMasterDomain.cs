...
namespace Gs2.Gs2Showcase.Domain.Model
{
    ...
    public partial class RandomShowcaseMasterDomain {
        ...
        #if GS2_ENABLE_UNITASK
        private async UniTask<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> GetAsync(
        #else
    ...
    public partial class RandomShowcaseMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> Model() => ModelAsync();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Showcase.Model.RandomShowcaseMaster> callback)
        #endif
        {
