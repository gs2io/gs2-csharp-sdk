    ...
    public class Gs2Showcase {
        ...
        public async Task<Gs2.Gs2Showcase.Domain.Model.NamespaceDomain> CreateNamespaceAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Showcase.Domain.Model.NamespaceDomain> self)
          {
            ...
            Gs2.Gs2Showcase.Domain.Model.NamespaceDomain domain = new Gs2.Gs2Showcase.Domain.Model.NamespaceDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Showcase.Model.Namespace> Namespaces(
            #else
