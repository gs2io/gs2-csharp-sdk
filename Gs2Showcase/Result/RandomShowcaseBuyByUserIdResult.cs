...
#endif
	[System.Serializable]
	public class RandomShowcaseBuyByUserIdResult : IResult
	{
        ...
        public RandomShowcaseBuyByUserIdResult WithItem(Gs2.Gs2Showcase.Model.RandomDisplayItem item) {
            this.Item = item;
            return this;
        }
        ...
        public RandomShowcaseBuyByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public RandomShowcaseBuyByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public RandomShowcaseBuyByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public RandomShowcaseBuyByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RandomShowcaseBuyByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
