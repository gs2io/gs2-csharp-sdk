...
namespace Gs2.Gs2Showcase.Result
{
	...
	public class BuyByUserIdResult : IResult
	{
        ...
        public BuyByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public BuyByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public BuyByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public BuyByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static BuyByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
