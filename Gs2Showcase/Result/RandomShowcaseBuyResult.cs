...
#endif
	[System.Serializable]
	public class RandomShowcaseBuyResult : IResult
	{
        ...
        public RandomShowcaseBuyResult WithItem(Gs2.Gs2Showcase.Model.RandomDisplayItem item) {
            this.Item = item;
            return this;
        }
        ...
        public RandomShowcaseBuyResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public RandomShowcaseBuyResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public RandomShowcaseBuyResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public RandomShowcaseBuyResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RandomShowcaseBuyResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
