...
#endif
	[System.Serializable]
	public class BuyResult : IResult
	{
        ...
        public BuyResult WithItem(Gs2.Gs2Showcase.Model.SalesItem item) {
            this.Item = item;
            return this;
        }
        ...
        public BuyResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public BuyResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public BuyResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public BuyResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static BuyResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new BuyResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2Showcase.Model.SalesItem.FromJson(data["item"]))
