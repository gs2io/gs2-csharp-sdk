...
#endif
	[System.Serializable]
	public class PreUpdateCurrentShowcaseMasterResult : IResult
	{
        ...
        public PreUpdateCurrentShowcaseMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentShowcaseMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
