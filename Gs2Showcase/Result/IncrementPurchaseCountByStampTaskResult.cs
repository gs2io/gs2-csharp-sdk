...
namespace Gs2.Gs2Showcase.Result
{
	...
	public class IncrementPurchaseCountByStampTaskResult : IResult
	{
        ...
        public IncrementPurchaseCountByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IncrementPurchaseCountByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
