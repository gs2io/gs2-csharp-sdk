...
namespace Gs2.Gs2Showcase
{
	public class Gs2ShowcaseWebSocketClient : AbstractGs2Client
	{
        ...
        public class PreUpdateCurrentShowcaseMasterTask : Gs2WebSocketSessionTask<Request.PreUpdateCurrentShowcaseMasterRequest, Result.PreUpdateCurrentShowcaseMasterResult>
        {
	        public PreUpdateCurrentShowcaseMasterTask(IGs2Session session, Request.PreUpdateCurrentShowcaseMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.PreUpdateCurrentShowcaseMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
		...
		{
			var task = new PreUpdateCurrentShowcaseMasterTask(
			    Gs2WebSocketSession,
			    request
            );
            yield return task;
            callback.Invoke(new AsyncResult<Result.PreUpdateCurrentShowcaseMasterResult>(task.Result, task.Error));
        }
    ...
    #if GS2_ENABLE_UNITASK
		public async UniTask<Result.PreUpdateCurrentShowcaseMasterResult> PreUpdateCurrentShowcaseMasterAsync(
            Request.PreUpdateCurrentShowcaseMasterRequest request
        )
		{
		    var task = new PreUpdateCurrentShowcaseMasterTask(
    ...
    #endif
#else
		public async Task<Result.PreUpdateCurrentShowcaseMasterResult> PreUpdateCurrentShowcaseMasterAsync(
            Request.PreUpdateCurrentShowcaseMasterRequest request
        )
		{
		    var task = new PreUpdateCurrentShowcaseMasterTask(
