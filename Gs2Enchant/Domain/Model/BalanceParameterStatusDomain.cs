...
namespace Gs2.Gs2Enchant.Domain.Model
{
    ...
    public partial class BalanceParameterStatusDomain {
        ...
        ) => ReDrawAsync(request).ToGs2Future();
        #endif
    ...
    public partial class BalanceParameterStatusDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Model.BalanceParameterStatus> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Enchant.Model.BalanceParameterStatus> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Enchant.Model.BalanceParameterStatus> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Enchant.Model.BalanceParameterStatus> Model() => ModelAsync();
        #endif
