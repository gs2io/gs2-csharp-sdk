...
namespace Gs2.Gs2Enchant.Domain.Model
{
    ...
    public partial class RarityParameterStatusAccessTokenDomain {
        ...
        public RarityParameterStatusAccessTokenDomain(
            CacheDatabase cache,
        ...
        private async UniTask<Gs2.Gs2Enchant.Model.RarityParameterStatus> GetAsync(
            #else
        private IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Enchant.Model.RarityParameterStatus> GetAsync(
            ...
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.GetRarityParameterStatusFuture(
                request
            );
            yield return future;
            ...
            #else
            var result = await this._client.GetRarityParameterStatusAsync(
                request
            );
            #endif
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain> VerifyAsync(
            #else
        public IFuture<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain> Verify(
            #endif
        #else
        public async Task<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain> VerifyAsync(
        #endif
            ...
            request
                ...
                .WithPropertyId(this.PropertyId);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.VerifyRarityParameterStatusFuture(
                request
            );
            yield return future;
            if (future.Error != null)
            ...
            var result = future.Result;
            #else
            var result = await this._client.VerifyRarityParameterStatusAsync(
                request
            );
            #endif
            var requestModel = request;
            ...
            Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain domain = this;
            ...
            return new Gs2InlineFuture<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain>(Impl);
        #endif
        }
        ...
        public async Task<Gs2.Gs2Enchant.Model.RarityParameterStatus> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Enchant.Model.RarityParameterStatus>(
                       _parentKey,
            ...
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Enchant.Model.RarityParameterStatus>(
                _parentKey,
                Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusDomain.CreateCacheKey(
                    this.ParameterName?.ToString(),
                    this.PropertyId?.ToString()
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            _cache.Put<Gs2.Gs2Enchant.Model.RarityParameterStatus>(
                                _parentKey,
                                key,
                                null,
                                UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Enchant.Model.RarityParameterStatus>(
                    _parentKey,
                    Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusDomain.CreateCacheKey(
                        this.ParameterName?.ToString(),
                        this.PropertyId?.ToString()
