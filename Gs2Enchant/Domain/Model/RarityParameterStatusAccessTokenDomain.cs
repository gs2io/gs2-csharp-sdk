    ...
    public partial class RarityParameterStatusAccessTokenDomain {
        ...
        private async Task<Gs2.Gs2Enchant.Model.RarityParameterStatus> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                () => this._client.GetRarityParameterStatusAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain> VerifyAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                this.AccessToken?.TimeOffset,
                () => this._client.VerifyRarityParameterStatusAsync(request)
            );
            var domain = this;
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Enchant.Model.RarityParameterStatus> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Enchant.Model.RarityParameterStatus> Model() => ModelAsync();
        #endif
