...
namespace Gs2.Gs2Enchant.Domain.Model
{
    ...
    public partial class RarityParameterStatusAccessTokenDomain {
        ...
        private IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> self)
            {
                ...
                request
                    ...
                    .WithParameterName(this.ParameterName)
                    .WithPropertyId(this.PropertyId);
                GetRarityParameterStatusResult result = null;
                try {
                    result = await this._client.GetRarityParameterStatusAsync(
                        request
                    );
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain> VerifyFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusAccessTokenDomain> self)
            {
                ...
                request
                    ...
                    .WithParameterName(this.ParameterName)
                    .WithPropertyId(this.PropertyId);
                VerifyRarityParameterStatusResult result = null;
                    result = await this._client.VerifyRarityParameterStatusAsync(
                        request
                    );
                #endif
        ...
        public IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Model.RarityParameterStatus> self)
            {
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Enchant.Model.RarityParameterStatus>(
                        _parentKey,
                        Gs2.Gs2Enchant.Domain.Model.RarityParameterStatusDomain.CreateCacheKey(
                            this.ParameterName?.ToString(),
                            this.PropertyId?.ToString()
