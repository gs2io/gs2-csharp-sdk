...
namespace Gs2.Gs2Enchant.Domain.Model
{
    ...
    public partial class RarityParameterModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Enchant.Model.RarityParameterModelMaster>(
                ...
                return await (null as Gs2.Gs2Enchant.Model.RarityParameterModelMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.ParameterName,
                    null,
        ...
        public UniTask<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> Model() => ModelAsync();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> callback)
        #endif
        {
