            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Model.RarityParameterModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "rarityParameterModelMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Domain.Model.RarityParameterModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Enchant.Model.RarityParameterModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
