...
namespace Gs2.Gs2Enchant.Domain.Model
{
    ...
    public partial class CurrentParameterMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> ExportMasterFuture(
        ...
        #if UNITY_2017_1_OR_NEWER
        private IFuture<Gs2.Gs2Enchant.Model.CurrentParameterMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Model.CurrentParameterMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.GetCurrentParameterMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        private async Task<Gs2.Gs2Enchant.Model.CurrentParameterMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCurrentParameterMasterAsync(request)
            );
            return result?.Item;
        }
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> PreUpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.PreUpdateCurrentParameterMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> PreUpdateAsync(
            #else
        public async Task<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> PreUpdateAsync(
            #endif
            PreUpdateCurrentParameterMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentParameterMasterAsync(request)
            );
            var domain = this;
            this.UploadToken = domain.UploadToken = result?.UploadToken;
            this.UploadUrl = domain.UploadUrl = result?.UploadUrl;
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.UpdateCurrentParameterMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public async Task<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentParameterMasterAsync(request)
            );
            var domain = this;
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.UpdateCurrentParameterMasterFromGitHubFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public async Task<Gs2.Gs2Enchant.Domain.Model.CurrentParameterMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentParameterMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentParameterMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enchant.Model.CurrentParameterMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Enchant.Model.CurrentParameterMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2Enchant.Model.CurrentParameterMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetFuture(
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Enchant.Model.CurrentParameterMaster> ModelAsync()
            #else
        ...
        {
            (null as Gs2.Gs2Enchant.Model.CurrentParameterMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2Enchant.Model.CurrentParameterMaster>(
                (null as Gs2.Gs2Enchant.Model.CurrentParameterMaster).CacheParentKey(
                    this.NamespaceName,
                    null
                ),
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Enchant.Model.CurrentParameterMaster> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Enchant.Model.CurrentParameterMaster> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Enchant.Model.CurrentParameterMaster> callback)
            #endif
        {
