    ...
    public class DescribeBalanceParameterModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Enchant.Model.BalanceParameterModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Enchant.Model.BalanceParameterModelMaster>
            (
                ...
                var request = new Gs2.Gs2Enchant.Request.DescribeBalanceParameterModelMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Enchant.Model.BalanceParameterModelMaster>(
                        (null as Gs2.Gs2Enchant.Model.BalanceParameterModelMaster).CacheParentKey(
                            NamespaceName,
                            null
                        )
        ...
        )
        {
            ...
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Enchant.Model.BalanceParameterModelMaster>(async (writer, token) =>
            {
                ...
                using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Enchant.Model.BalanceParameterModelMaster>(
                       ...
                       "ListBalanceParameterModelMaster"
                   ).LockAsync()) {
                while(this._hasNext()) {
