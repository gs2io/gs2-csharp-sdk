...
{
    public static class ReDrawBalanceParameterStatusByUserIdSpeculativeExecutor {

        public static string Action() {
            return "Gs2Enchant:ReDrawBalanceParameterStatusByUserId";
        }
        public static Gs2.Gs2Enchant.Model.BalanceParameterStatus Transform(
            Gs2.Core.Domain.Gs2 domain,
            AccessToken accessToken,
            ReDrawBalanceParameterStatusByUserIdRequest request,
            Gs2.Gs2Enchant.Model.BalanceParameterStatus item
        ) {
#if UNITY_2017_1_OR_NEWER
