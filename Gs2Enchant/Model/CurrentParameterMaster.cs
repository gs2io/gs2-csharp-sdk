...
namespace Gs2.Gs2Enchant.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentParameterMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentParameterMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        {
            var other = obj as CurrentParameterMaster;
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentParameterMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentParameterMaster", "enchant.currentParameterMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentParameterMaster", "enchant.currentParameterMaster.settings.error.tooLong"),
                    });
                }
            }
        }
