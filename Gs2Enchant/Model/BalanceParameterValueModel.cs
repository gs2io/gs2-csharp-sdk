...
namespace Gs2.Gs2Enchant.Model
{
	...
	public partial class BalanceParameterValueModel : IComparable
	{
    	...
    	[Preserve]
#endif
        public static BalanceParameterValueModel FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        {
            var other = obj as BalanceParameterValueModel;
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type BalanceParameterValueModel.", nameof(obj));
            }
            var diff = 0;
