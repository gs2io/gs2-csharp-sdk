...
namespace Gs2.Gs2Enchant.Model.Cache
{
    public static partial class BalanceParameterStatusExt
    {
        public static void PutCache(
            this DeleteBalanceParameterStatusByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DeleteBalanceParameterStatusByUserIdResult> InvokeFuture(
            this DeleteBalanceParameterStatusByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DeleteBalanceParameterStatusByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DeleteBalanceParameterStatusByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<DeleteBalanceParameterStatusByUserIdResult>(Impl);
        }
#endif
