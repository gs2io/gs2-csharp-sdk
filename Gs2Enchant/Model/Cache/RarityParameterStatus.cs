...
namespace Gs2.Gs2Enchant.Model.Cache
{
    public static partial class RarityParameterStatusExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<RarityParameterStatus> FetchFuture(
            this RarityParameterStatus self,
            CacheDatabase cache,
            string namespaceName,
            string userId,
            ...
            return new Gs2InlineFuture<RarityParameterStatus>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<RarityParameterStatus> FetchAsync(
#else
        public static async Task<RarityParameterStatus> FetchAsync(
#endif
            this RarityParameterStatus self,
            CacheDatabase cache,
            string namespaceName,
        ...
        public static Tuple<RarityParameterStatus, bool> GetCache(
            this RarityParameterStatus self,
            CacheDatabase cache,
            string namespaceName,
            string userId,
