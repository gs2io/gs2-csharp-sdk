	...
	public partial class RarityParameterStatus : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type RarityParameterStatus.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(RarityParameterStatusId, other.RarityParameterStatusId);
            if (diff != 0)
            {
                return diff;
            }
