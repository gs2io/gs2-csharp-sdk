...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class GetRarityParameterModelMasterRequest : Gs2Request<GetRarityParameterModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetRarityParameterModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetRarityParameterModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetRarityParameterModelMasterRequest)x;
            return this;
        }
    }
}