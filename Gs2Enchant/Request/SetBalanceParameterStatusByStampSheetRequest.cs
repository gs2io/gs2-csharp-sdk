...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class SetBalanceParameterStatusByStampSheetRequest : Gs2Request<SetBalanceParameterStatusByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static SetBalanceParameterStatusByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply SetBalanceParameterStatusByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (SetBalanceParameterStatusByStampSheetRequest)x;
            return this;
        }
    }
}