...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class GetBalanceParameterModelMasterRequest : Gs2Request<GetBalanceParameterModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBalanceParameterModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetBalanceParameterModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetBalanceParameterModelMasterRequest)x;
            return this;
        }
    }
}