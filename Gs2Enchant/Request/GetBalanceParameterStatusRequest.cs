...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class GetBalanceParameterStatusRequest : Gs2Request<GetBalanceParameterStatusRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBalanceParameterStatusRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetBalanceParameterStatusRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetBalanceParameterStatusRequest)x;
            return this;
        }
    }
}