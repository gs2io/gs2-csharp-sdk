...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class DescribeBalanceParameterModelsRequest : Gs2Request<DescribeBalanceParameterModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeBalanceParameterModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeBalanceParameterModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeBalanceParameterModelsRequest)x;
            return this;
        }
    }
}