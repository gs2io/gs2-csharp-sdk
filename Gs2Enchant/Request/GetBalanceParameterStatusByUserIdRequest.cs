...
#endif
	[System.Serializable]
	public class GetBalanceParameterStatusByUserIdRequest : Gs2Request<GetBalanceParameterStatusByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBalanceParameterStatusByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetBalanceParameterStatusByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetBalanceParameterStatusByUserIdRequest)x;
            return this;
        }
    }
}