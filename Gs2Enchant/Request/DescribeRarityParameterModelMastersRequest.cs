...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class DescribeRarityParameterModelMastersRequest : Gs2Request<DescribeRarityParameterModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRarityParameterModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRarityParameterModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRarityParameterModelMastersRequest)x;
            return this;
        }
    }
}