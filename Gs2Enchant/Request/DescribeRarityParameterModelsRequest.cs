...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class DescribeRarityParameterModelsRequest : Gs2Request<DescribeRarityParameterModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRarityParameterModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRarityParameterModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRarityParameterModelsRequest)x;
            return this;
        }
    }
}