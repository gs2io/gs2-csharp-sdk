...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class GetRarityParameterStatusByUserIdRequest : Gs2Request<GetRarityParameterStatusByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetRarityParameterStatusByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetRarityParameterStatusByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetRarityParameterStatusByUserIdRequest)x;
            return this;
        }
    }
}