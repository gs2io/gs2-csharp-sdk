...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class AddRarityParameterStatusByStampSheetRequest : Gs2Request<AddRarityParameterStatusByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AddRarityParameterStatusByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AddRarityParameterStatusByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AddRarityParameterStatusByStampSheetRequest)x;
            return this;
        }
    }
}