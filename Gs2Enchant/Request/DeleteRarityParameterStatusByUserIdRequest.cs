...
namespace Gs2.Gs2Enchant.Request
{
	...
	public class DeleteRarityParameterStatusByUserIdRequest : Gs2Request<DeleteRarityParameterStatusByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteRarityParameterStatusByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteRarityParameterStatusByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteRarityParameterStatusByUserIdRequest)x;
            return this;
        }
    }
}