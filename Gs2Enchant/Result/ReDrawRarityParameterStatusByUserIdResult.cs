...
namespace Gs2.Gs2Enchant.Result
{
	...
	public class ReDrawRarityParameterStatusByUserIdResult : IResult
	{
        ...
        public ReDrawRarityParameterStatusByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReDrawRarityParameterStatusByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
