...
namespace Gs2.Gs2Enchant.Result
{
	...
	public class UpdateCurrentParameterMasterFromGitHubResult : IResult
	{
        ...
        public UpdateCurrentParameterMasterFromGitHubResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UpdateCurrentParameterMasterFromGitHubResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
