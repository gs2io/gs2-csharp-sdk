...
#endif
	[System.Serializable]
	public class AddRarityParameterStatusByUserIdResult : IResult
	{
        ...
        public AddRarityParameterStatusByUserIdResult WithItem(Gs2.Gs2Enchant.Model.RarityParameterStatus item) {
            this.Item = item;
            return this;
        }

        public AddRarityParameterStatusByUserIdResult WithOld(Gs2.Gs2Enchant.Model.RarityParameterStatus old) {
            this.Old = old;
            return this;
        }

        public AddRarityParameterStatusByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AddRarityParameterStatusByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
