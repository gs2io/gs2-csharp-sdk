...
#endif
	[System.Serializable]
	public class SetBalanceParameterStatusByStampSheetResult : IResult
	{
        ...
        public SetBalanceParameterStatusByStampSheetResult WithItem(Gs2.Gs2Enchant.Model.BalanceParameterStatus item) {
            this.Item = item;
            return this;
        }

        public SetBalanceParameterStatusByStampSheetResult WithOld(Gs2.Gs2Enchant.Model.BalanceParameterStatus old) {
            this.Old = old;
            return this;
        }

        public SetBalanceParameterStatusByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetBalanceParameterStatusByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
