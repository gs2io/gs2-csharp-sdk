...
#endif
	[System.Serializable]
	public class SetRarityParameterStatusByUserIdResult : IResult
	{
        ...
        public SetRarityParameterStatusByUserIdResult WithItem(Gs2.Gs2Enchant.Model.RarityParameterStatus item) {
            this.Item = item;
            return this;
        }

        public SetRarityParameterStatusByUserIdResult WithOld(Gs2.Gs2Enchant.Model.RarityParameterStatus old) {
            this.Old = old;
            return this;
        }

        public SetRarityParameterStatusByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRarityParameterStatusByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
