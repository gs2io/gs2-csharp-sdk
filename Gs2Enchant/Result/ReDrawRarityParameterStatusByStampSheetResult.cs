...
#endif
	[System.Serializable]
	public class ReDrawRarityParameterStatusByStampSheetResult : IResult
	{
        ...
        public ReDrawRarityParameterStatusByStampSheetResult WithItem(Gs2.Gs2Enchant.Model.RarityParameterStatus item) {
            this.Item = item;
            return this;
        }

        public ReDrawRarityParameterStatusByStampSheetResult WithOld(Gs2.Gs2Enchant.Model.RarityParameterStatus old) {
            this.Old = old;
            return this;
        }

        public ReDrawRarityParameterStatusByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReDrawRarityParameterStatusByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
