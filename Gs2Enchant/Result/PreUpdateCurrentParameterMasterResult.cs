...
#endif
	[System.Serializable]
	public class PreUpdateCurrentParameterMasterResult : IResult
	{
        ...
        public PreUpdateCurrentParameterMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentParameterMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
