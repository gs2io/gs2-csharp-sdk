...
namespace Gs2.Gs2Enchant.Result
{
	...
	public class ReDrawBalanceParameterStatusByStampSheetResult : IResult
	{
        ...
        public ReDrawBalanceParameterStatusByStampSheetResult WithOld(Gs2.Gs2Enchant.Model.BalanceParameterStatus old) {
            this.Old = old;
            return this;
        }

        public ReDrawBalanceParameterStatusByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReDrawBalanceParameterStatusByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
