...
namespace Gs2.Gs2Datastore.Domain.Model
{
    ...
    public partial class DataObjectDomain {
        ...
        #else
        public async Task<ulong> SubscribeDataObjectHistoriesWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Datastore.Model.DataObjectHistory[]> callback
        )
        {
    ...
    public partial class DataObjectDomain {
        ...
        ) => PrepareReUploadAsync(request).ToGs2Future();
        #endif
        ...
        ) => DoneUploadAsync(request).ToGs2Future();
        #endif
        ...
        ) => PrepareDownloadByUserIdAndDataObjectNameAsync(request).ToGs2Future();
        #endif
        ...
        ) => PrepareDownloadByUserIdAndDataObjectNameAndGenerationAsync(request).ToGs2Future();
        #endif
    ...
    public partial class DataObjectDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Datastore.Model.DataObject> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Datastore.Model.DataObject> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Datastore.Model.DataObject> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Datastore.Model.DataObject> Model() => ModelAsync();
        #endif
