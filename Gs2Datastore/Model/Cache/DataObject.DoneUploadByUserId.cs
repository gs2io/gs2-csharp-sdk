...
namespace Gs2.Gs2Datastore.Model.Cache
{
    public static partial class DataObjectExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DoneUploadByUserIdResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DoneUploadByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<DoneUploadByUserIdResult>(Impl);
        }
#endif
