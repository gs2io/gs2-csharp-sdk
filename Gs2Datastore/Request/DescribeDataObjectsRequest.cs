...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class DescribeDataObjectsRequest : Gs2Request<DescribeDataObjectsRequest>
	{
        ...
        public DescribeDataObjectsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeDataObjectsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDataObjectsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDataObjectsRequest)x;
            return this;
        }
    }
}