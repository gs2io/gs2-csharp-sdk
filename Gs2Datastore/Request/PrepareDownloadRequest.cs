...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class PrepareDownloadRequest : Gs2Request<PrepareDownloadRequest>
	{
    	...
    	[Preserve]
#endif
        public static PrepareDownloadRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareDownloadRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareDownloadRequest)x;
            return this;
        }
    }
}