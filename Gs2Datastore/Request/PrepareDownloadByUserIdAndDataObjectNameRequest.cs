...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class PrepareDownloadByUserIdAndDataObjectNameRequest : Gs2Request<PrepareDownloadByUserIdAndDataObjectNameRequest>
	{
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareDownloadByUserIdAndDataObjectNameRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareDownloadByUserIdAndDataObjectNameRequest)x;
            return this;
        }
    }
}