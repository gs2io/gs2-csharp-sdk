...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class DescribeDataObjectHistoriesRequest : Gs2Request<DescribeDataObjectHistoriesRequest>
	{
        ...
        public DescribeDataObjectHistoriesRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeDataObjectHistoriesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDataObjectHistoriesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDataObjectHistoriesRequest)x;
            return this;
        }
    }
}