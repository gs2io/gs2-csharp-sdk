...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class DeleteDataObjectRequest : Gs2Request<DeleteDataObjectRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteDataObjectRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteDataObjectRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteDataObjectRequest)x;
            return this;
        }
    }
}