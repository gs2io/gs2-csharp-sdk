...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class PrepareDownloadOwnDataRequest : Gs2Request<PrepareDownloadOwnDataRequest>
	{
    	...
    	[Preserve]
#endif
        public static PrepareDownloadOwnDataRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareDownloadOwnDataRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareDownloadOwnDataRequest)x;
            return this;
        }
    }
}