...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class PrepareReUploadByUserIdRequest : Gs2Request<PrepareReUploadByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static PrepareReUploadByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareReUploadByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareReUploadByUserIdRequest)x;
            return this;
        }
    }
}