...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class PrepareDownloadByGenerationRequest : Gs2Request<PrepareDownloadByGenerationRequest>
	{
    	...
    	[Preserve]
#endif
        public static PrepareDownloadByGenerationRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareDownloadByGenerationRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareDownloadByGenerationRequest)x;
            return this;
        }
    }
}