...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class PrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest : Gs2Request<PrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest>
	{
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareDownloadByUserIdAndDataObjectNameAndGenerationRequest)x;
            return this;
        }
    }
}