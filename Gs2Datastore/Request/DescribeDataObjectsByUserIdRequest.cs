...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class DescribeDataObjectsByUserIdRequest : Gs2Request<DescribeDataObjectsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeDataObjectsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDataObjectsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDataObjectsByUserIdRequest)x;
            return this;
        }
    }
}