...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class DescribeDataObjectHistoriesByUserIdRequest : Gs2Request<DescribeDataObjectHistoriesByUserIdRequest>
	{
        ...
        public DescribeDataObjectHistoriesByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeDataObjectHistoriesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDataObjectHistoriesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDataObjectHistoriesByUserIdRequest)x;
            return this;
        }
    }
}