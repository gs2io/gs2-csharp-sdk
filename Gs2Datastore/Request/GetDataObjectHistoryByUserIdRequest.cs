...
namespace Gs2.Gs2Datastore.Request
{
	...
	public class GetDataObjectHistoryByUserIdRequest : Gs2Request<GetDataObjectHistoryByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetDataObjectHistoryByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetDataObjectHistoryByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetDataObjectHistoryByUserIdRequest)x;
            return this;
        }
    }
}