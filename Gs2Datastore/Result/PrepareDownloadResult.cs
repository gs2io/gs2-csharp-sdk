...
#endif
	[System.Serializable]
	public class PrepareDownloadResult : IResult
	{
        ...
        public PrepareDownloadResult WithItem(Gs2.Gs2Datastore.Model.DataObject item) {
            this.Item = item;
            return this;
        }
        ...
        public PrepareDownloadResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PrepareDownloadResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
