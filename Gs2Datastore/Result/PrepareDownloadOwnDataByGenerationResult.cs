...
namespace Gs2.Gs2Datastore.Result
{
	...
	public class PrepareDownloadOwnDataByGenerationResult : IResult
	{
        ...
        public PrepareDownloadOwnDataByGenerationResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PrepareDownloadOwnDataByGenerationResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
