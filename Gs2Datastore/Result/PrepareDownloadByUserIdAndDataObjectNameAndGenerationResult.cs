...
#endif
	[System.Serializable]
	public class PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult : IResult
	{
        ...
        public PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult WithItem(Gs2.Gs2Datastore.Model.DataObject item) {
            this.Item = item;
            return this;
        }
        ...
        public PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PrepareDownloadByUserIdAndDataObjectNameAndGenerationResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
