...
#endif
	[System.Serializable]
	public class PrepareReUploadByUserIdResult : IResult
	{
        public Gs2.Gs2Datastore.Model.DataObject Item { set; get; }
        public string UploadUrl { set; get; }
        public ResultMetadata Metadata { set; get; }

        public PrepareReUploadByUserIdResult WithItem(Gs2.Gs2Datastore.Model.DataObject item) {
            this.Item = item;
            return this;
        }
        ...
        public PrepareReUploadByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PrepareReUploadByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
