...
#endif
	[System.Serializable]
	public class PrepareDownloadByUserIdResult : IResult
	{
        ...
        public PrepareDownloadByUserIdResult WithItem(Gs2.Gs2Datastore.Model.DataObject item) {
            this.Item = item;
            return this;
        }

        public PrepareDownloadByUserIdResult WithFileUrl(string fileUrl) {
            this.FileUrl = fileUrl;
            return this;
        }

        public PrepareDownloadByUserIdResult WithContentLength(long? contentLength) {
            this.ContentLength = contentLength;
            return this;
        }

        public PrepareDownloadByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PrepareDownloadByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
