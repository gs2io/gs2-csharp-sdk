...
#endif
	[System.Serializable]
	public class PrepareDownloadByGenerationAndUserIdResult : IResult
	{
        ...
        public PrepareDownloadByGenerationAndUserIdResult WithItem(Gs2.Gs2Datastore.Model.DataObject item) {
            this.Item = item;
            return this;
        }
        ...
        public PrepareDownloadByGenerationAndUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PrepareDownloadByGenerationAndUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
