...
namespace Gs2.Gs2Datastore
{
	public class Gs2DatastoreWebSocketClient : AbstractGs2Client
	{
        ...
        private class GetDataObjectHistoryTask : Gs2WebSocketSessionTask<Request.GetDataObjectHistoryRequest, Result.GetDataObjectHistoryResult>
        {
...
#else
		public async Task<Result.GetDataObjectHistoryResult> GetDataObjectHistory(
            Request.GetDataObjectHistoryRequest request
        )
		{
		    var task = new GetDataObjectHistoryTask(
        ...
        private class GetDataObjectHistoryByUserIdTask : Gs2WebSocketSessionTask<Request.GetDataObjectHistoryByUserIdRequest, Result.GetDataObjectHistoryByUserIdResult>
        {
...
#else
		public async Task<Result.GetDataObjectHistoryByUserIdResult> GetDataObjectHistoryByUserId(
            Request.GetDataObjectHistoryByUserIdRequest request
        )
		{
		    var task = new GetDataObjectHistoryByUserIdTask(
