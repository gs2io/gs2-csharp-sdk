...
{
    public static class SetMoldCapacityByUserIdSpeculativeExecutor {
...
/* diff +++ start */
            ...
            var prepared = SetMoldCapacityByUserIdRequest.FromJson(request.ToJson());
            ...
            if (!IsUsable(
                ...
                ) || prepared.Capacity.Value > modelCache.Item1.MaxCapacity.Value) {
                return null;
            }
...
/* diff +++ start */
            return new MoldCapacityMutationSpeculativeCommit(
                ...
                current => {
                    ...
                    changed.Capacity = prepared.Capacity;
                    return changed;
                }
            ).Invoke;
        }
...
/* diff +++ start */
        private static bool IsUsable(
            ...
            return foundMold && foundModel && mold != null && model != null &&
                   ...
                   mold.UserId == userId && model.MoldModelId == expectedModelId &&
