...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribePropertyFormsIterator : Gs2Iterator<Gs2.Gs2Formation.Model.PropertyForm> {
    #else
    public class DescribePropertyFormsIterator : IAsyncEnumerable<Gs2.Gs2Formation.Model.PropertyForm> {
    #endif
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Formation.Model.PropertyForm> GetAsyncEnumerator(
