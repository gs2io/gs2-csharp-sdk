...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    public class DescribePropertyFormsIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Formation.Model.PropertyForm>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Formation.Model.PropertyForm>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Formation.Model.PropertyForm>
    #endif
    {
        ...
        public DescribePropertyFormsIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Formation.Request.DescribePropertyFormsRequest()
                ...
                var future = this._client.DescribePropertyFormsFuture(
                #else
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Formation.Model.PropertyForm>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Formation.Model.PropertyForm>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Formation.Model.PropertyForm> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Formation.Model.PropertyForm> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Formation.Model.PropertyForm>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
