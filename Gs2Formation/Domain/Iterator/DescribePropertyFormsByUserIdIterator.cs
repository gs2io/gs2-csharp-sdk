...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    public class DescribePropertyFormsByUserIdIterator :
    #if UNITY_2017_1_OR_NEWER
    ...
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Formation.Request.DescribePropertyFormsByUserIdRequest()
                ...
                var future = this._client.DescribePropertyFormsByUserIdFuture(
                #else
