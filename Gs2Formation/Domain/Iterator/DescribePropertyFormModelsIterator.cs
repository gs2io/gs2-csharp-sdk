...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    public class DescribePropertyFormModelsIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Formation.Model.PropertyFormModel>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Formation.Model.PropertyFormModel>
    #else
        IAsyncEnumerable<Gs2.Gs2Formation.Model.PropertyFormModel>
    #endif
    {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Formation.Model.PropertyFormModel>
            (
                ...
                var request = new Gs2.Gs2Formation.Request.DescribePropertyFormModelsRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Formation.Model.PropertyFormModel>(
                        (null as Gs2.Gs2Formation.Model.PropertyFormModel).CacheParentKey(
                            NamespaceName,
                            null
                        )
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Formation.Model.PropertyFormModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Formation.Model.PropertyFormModel>(async (writer, token) =>
        #else
