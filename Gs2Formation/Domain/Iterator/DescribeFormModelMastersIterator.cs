    ...
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Formation.Request.DescribeFormModelMastersRequest()
        ...
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Formation.Model.FormModelMaster>(async (writer, token) =>
        #else
