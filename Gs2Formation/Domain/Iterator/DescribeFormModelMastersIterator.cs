...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    public class DescribeFormModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Formation.Model.FormModelMaster> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Formation.Model.FormModelMaster>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Formation.Model.FormModelMaster>
                (
                        parentKey
                )
                    .ToArray();
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Formation.Model.FormModelMaster>(
                            listParentKey
                    );
                }
            }
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Formation.Model.FormModelMaster ret = this._result[0];
