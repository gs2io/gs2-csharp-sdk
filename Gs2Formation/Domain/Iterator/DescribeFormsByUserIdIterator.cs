...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Formation.Model.Form>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Formation.Model.Form>
    #else
        IAsyncEnumerable<Gs2.Gs2Formation.Model.Form>
    #endif
    {
        ...
        public DescribeFormsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Formation.Request.DescribeFormsByUserIdRequest()
                    ...
                    .WithLimit(fetchSize);
                var r = await this._client.DescribeFormsByUserIdAsync(
                    request
                );
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Formation.Model.Form>(
                        (null as Gs2.Gs2Formation.Model.Form).CacheParentKey(
                            NamespaceName,
                            UserId,
                            MoldModelName,
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Formation.Model.Form>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Formation.Model.Form>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Formation.Model.Form> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Formation.Model.Form>(async (writer, token) =>
        #else
