...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    public class DescribeMoldModelsIterator : IAsyncEnumerable<Gs2.Gs2Formation.Model.MoldModel> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Formation.Model.MoldModel>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Formation.Model.MoldModel>
                (
                        parentKey
                )
                    .ToArray();
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Formation.Model.MoldModel>(
                            listParentKey
                    );
                }
            }
        ...
        )
        {
            ...
            while(this._hasNext()) {
                ...
                Gs2.Gs2Formation.Model.MoldModel ret = this._result[0];
