...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Formation.Model.MoldModel>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Formation.Model.MoldModel>
    #else
        IAsyncEnumerable<Gs2.Gs2Formation.Model.MoldModel>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Formation.Request.DescribeMoldModelsRequest()
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Formation.Model.MoldModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Formation.Model.MoldModel>(async (writer, token) =>
        #else
