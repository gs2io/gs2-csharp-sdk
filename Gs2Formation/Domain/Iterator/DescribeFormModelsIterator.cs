...
namespace Gs2.Gs2Formation.Domain.Iterator
{
    ...
    public class DescribeFormModelsIterator : IAsyncEnumerable<Gs2.Gs2Formation.Model.FormModel> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Formation.Model.FormModel>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Formation.Model.FormModel>
                (
                        parentKey
                )
                    .ToArray();
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Formation.Model.FormModel>(
                            listParentKey
                    );
                }
            }
