...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class FormModelMasterDomain {
        ...
        public string FormModelName { get; } = null!;
    ...
    public partial class FormModelMasterDomain {
        ...
        private async Task<Gs2.Gs2Formation.Model.FormModelMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetFormModelMasterAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.FormModelMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateFormModelMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.FormModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    null,
                    null,
                    () => this._client.DeleteFormModelMasterAsync(request)
                );
            }
    ...
    public partial class FormModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Formation.Model.FormModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Formation.Model.FormModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Formation.Model.FormModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Formation.Model.FormModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Formation.Model.FormModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.FormModelName,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Formation.Model.FormModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Formation.Model.FormModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Formation.Model.FormModelMaster> callback)
        #endif
        {
