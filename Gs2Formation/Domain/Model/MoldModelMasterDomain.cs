...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class MoldModelMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Formation.Model.MoldModelMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Formation.Model.MoldModelMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Formation.Model.MoldModelMaster> GetAsync(
            ...
            #else
            var result = await this._client.GetMoldModelMasterAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.MoldModelMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateMoldModelMasterAsync(
                request
            );
            #endif
            var requestModel = request;
            ...
            Gs2.Gs2Formation.Domain.Model.MoldModelMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.MoldModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                if (e.errors[0].component == "moldModelMaster")
                {
                    ...
                    _cache.Delete<Gs2.Gs2Formation.Model.MoldModelMaster>(parentKey, key);
                }
                else
                {
                    throw e;
        ...
        public async Task<Gs2.Gs2Formation.Model.MoldModelMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Formation.Model.MoldModelMaster value = _cache.Get<Gs2.Gs2Formation.Model.MoldModelMaster>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            if (e.errors[0].component == "moldModelMaster")
                            {
                                _cache.Delete<Gs2.Gs2Formation.Model.MoldModelMaster>(
                                    _parentKey,
                                    Gs2.Gs2Formation.Domain.Model.MoldModelMasterDomain.CreateCacheKey(
                                        this.MoldName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Formation.Model.MoldModelMaster>(
                    _parentKey,
                    Gs2.Gs2Formation.Domain.Model.MoldModelMasterDomain.CreateCacheKey(
                        this.MoldName?.ToString()
                    )
