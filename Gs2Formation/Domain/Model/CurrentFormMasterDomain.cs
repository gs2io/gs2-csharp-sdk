...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class CurrentFormMasterDomain {
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.CurrentFormMasterDomain> ExportMasterAsync(
            ...
            Gs2.Gs2Formation.Domain.Model.CurrentFormMasterDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Formation.Model.CurrentFormMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Formation.Model.CurrentFormMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Formation.Model.CurrentFormMaster> GetAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.GetCurrentFormMasterAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.CurrentFormMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCurrentFormMasterAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2Formation.Domain.Model.CurrentFormMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCurrentFormMasterFromGitHubAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2Formation.Model.CurrentFormMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Formation.Model.CurrentFormMaster>(
                       _parentKey,
