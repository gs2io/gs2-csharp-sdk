...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class PropertyFormModelDomain {
        ...
        private async UniTask<Gs2.Gs2Formation.Model.PropertyFormModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Formation.Model.PropertyFormModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Formation.Model.PropertyFormModel> GetAsync(
            ...
            #else
            var result = await this._client.GetPropertyFormModelAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Formation.Model.PropertyFormModel> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Formation.Model.PropertyFormModel>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Formation.Model.PropertyFormModel>(
                    _parentKey,
                    Gs2.Gs2Formation.Domain.Model.PropertyFormModelDomain.CreateCacheKey(
                        this.PropertyFormModelName?.ToString()
                    )
