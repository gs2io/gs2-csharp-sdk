...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class PropertyFormModelDomain {
        ...
        #if GS2_ENABLE_UNITASK
        private async UniTask<Gs2.Gs2Formation.Model.PropertyFormModel> GetAsync(
        #else
        private async Task<Gs2.Gs2Formation.Model.PropertyFormModel> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetPropertyFormModelAsync(request)
            );
            return result?.Item;
        }
    ...
    public partial class PropertyFormModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Formation.Model.PropertyFormModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Formation.Model.PropertyFormModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Formation.Model.PropertyFormModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Formation.Model.PropertyFormModel> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Formation.Model.PropertyFormModel).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.PropertyFormModelName,
                null
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2Formation.Model.PropertyFormModel>(
                (null as Gs2.Gs2Formation.Model.PropertyFormModel).CacheParentKey(
                    this.NamespaceName,
                    null
                ),
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Formation.Model.PropertyFormModel> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Formation.Model.PropertyFormModel> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Formation.Model.PropertyFormModel> callback)
        #endif
        {
