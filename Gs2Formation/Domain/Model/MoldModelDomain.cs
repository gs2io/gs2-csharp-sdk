...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class MoldModelDomain {
        ...
        private async UniTask<Gs2.Gs2Formation.Model.MoldModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Formation.Model.MoldModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Formation.Model.MoldModel> GetAsync(
            ...
            #else
            var result = await this._client.GetMoldModelAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Formation.Model.MoldModel> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Formation.Model.MoldModel>(
                       _parentKey,
