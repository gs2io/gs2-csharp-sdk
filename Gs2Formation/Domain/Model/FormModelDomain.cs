...
namespace Gs2.Gs2Formation.Domain.Model
{
    ...
    public partial class FormModelDomain {
        ...
        private async UniTask<Gs2.Gs2Formation.Model.FormModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Formation.Model.FormModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Formation.Model.FormModel> GetAsync(
            ...
            #else
            var result = await this._client.GetFormModelAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Formation.Model.FormModel> Model() {
            ...
            {
        #endif
            Gs2.Gs2Formation.Model.FormModel value = _cache.Get<Gs2.Gs2Formation.Model.FormModel>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2Formation.Model.FormModel>(
                                    _parentKey,
                                    Gs2.Gs2Formation.Domain.Model.FormModelDomain.CreateCacheKey(
                                        this.FormModelName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Formation.Model.FormModel>(
                    _parentKey,
                    Gs2.Gs2Formation.Domain.Model.FormModelDomain.CreateCacheKey(
                        this.FormModelName?.ToString()
                    )
