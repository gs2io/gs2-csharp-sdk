...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribePropertyFormModelMastersRequest : Gs2Request<DescribePropertyFormModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribePropertyFormModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribePropertyFormModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribePropertyFormModelMastersRequest)x;
            return this;
        }
    }
}