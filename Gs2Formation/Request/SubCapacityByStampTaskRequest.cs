...
namespace Gs2.Gs2Formation.Request
{
	...
	public class SubCapacityByStampTaskRequest : Gs2Request<SubCapacityByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static SubCapacityByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply SubCapacityByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (SubCapacityByStampTaskRequest)x;
            return this;
        }
    }
}