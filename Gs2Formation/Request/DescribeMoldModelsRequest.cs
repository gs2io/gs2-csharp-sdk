...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeMoldModelsRequest : Gs2Request<DescribeMoldModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeMoldModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMoldModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMoldModelsRequest)x;
            return this;
        }
    }
}