...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeFormsByUserIdRequest : Gs2Request<DescribeFormsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeFormsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeFormsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeFormsByUserIdRequest)x;
            return this;
        }
    }
}