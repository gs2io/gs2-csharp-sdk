...
namespace Gs2.Gs2Formation.Request
{
	...
	public class UpdateCurrentFormMasterRequest : Gs2Request<UpdateCurrentFormMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentFormMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentFormMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentFormMasterRequest)x;
            return this;
        }
    }
}