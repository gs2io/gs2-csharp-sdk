...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribePropertyFormModelsRequest : Gs2Request<DescribePropertyFormModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribePropertyFormModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribePropertyFormModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribePropertyFormModelsRequest)x;
            return this;
        }
    }
}