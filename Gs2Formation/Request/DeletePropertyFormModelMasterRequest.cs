...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DeletePropertyFormModelMasterRequest : Gs2Request<DeletePropertyFormModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeletePropertyFormModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeletePropertyFormModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeletePropertyFormModelMasterRequest)x;
            return this;
        }
    }
}