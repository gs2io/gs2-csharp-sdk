...
namespace Gs2.Gs2Formation.Request
{
	...
	public class GetPropertyFormModelRequest : Gs2Request<GetPropertyFormModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPropertyFormModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPropertyFormModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPropertyFormModelRequest)x;
            return this;
        }
    }
}