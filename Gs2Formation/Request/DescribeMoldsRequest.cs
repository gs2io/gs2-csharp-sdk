...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeMoldsRequest : Gs2Request<DescribeMoldsRequest>
	{
        ...
        public DescribeMoldsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeMoldsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMoldsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMoldsRequest)x;
            return this;
        }
    }
}