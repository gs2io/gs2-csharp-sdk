...
namespace Gs2.Gs2Formation.Request
{
	...
	public class GetFormModelMasterRequest : Gs2Request<GetFormModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetFormModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetFormModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetFormModelMasterRequest)x;
            return this;
        }
    }
}