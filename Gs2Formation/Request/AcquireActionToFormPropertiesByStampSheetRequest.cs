...
namespace Gs2.Gs2Formation.Request
{
	...
	public class AcquireActionToFormPropertiesByStampSheetRequest : Gs2Request<AcquireActionToFormPropertiesByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AcquireActionToFormPropertiesByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AcquireActionToFormPropertiesByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AcquireActionToFormPropertiesByStampSheetRequest)x;
            return this;
        }
    }
}