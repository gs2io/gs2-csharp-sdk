...
#endif
	[System.Serializable]
	public class SubMoldCapacityRequest : Gs2Request<SubMoldCapacityRequest>
	{
        ...
        public SubMoldCapacityRequest WithCapacity(int? capacity) {
    	...
    	[Preserve]
#endif
        public static SubMoldCapacityRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
