...
namespace Gs2.Gs2Formation.Request
{
	...
	public class GetMoldModelRequest : Gs2Request<GetMoldModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetMoldModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetMoldModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetMoldModelRequest)x;
            return this;
        }
    }
}