...
namespace Gs2.Gs2Formation.Request
{
	...
	public class AddCapacityByStampSheetRequest : Gs2Request<AddCapacityByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AddCapacityByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AddCapacityByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AddCapacityByStampSheetRequest)x;
            return this;
        }
    }
}