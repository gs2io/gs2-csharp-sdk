...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeMoldsByUserIdRequest : Gs2Request<DescribeMoldsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeMoldsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMoldsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMoldsByUserIdRequest)x;
            return this;
        }
    }
}