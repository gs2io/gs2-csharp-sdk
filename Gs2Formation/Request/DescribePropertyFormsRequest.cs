...
#endif
	[System.Serializable]
	public class DescribePropertyFormsRequest : Gs2Request<DescribePropertyFormsRequest>
	{
        ...
        public DescribePropertyFormsRequest WithPropertyFormModelName(string propertyFormModelName) {
        ...
        public DescribePropertyFormsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribePropertyFormsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribePropertyFormsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribePropertyFormsRequest)x;
            return this;
        }
    }
}