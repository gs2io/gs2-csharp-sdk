...
#endif
	[System.Serializable]
	public class GetFormModelRequest : Gs2Request<GetFormModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetFormModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetFormModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetFormModelRequest)x;
            return this;
        }
    }
}