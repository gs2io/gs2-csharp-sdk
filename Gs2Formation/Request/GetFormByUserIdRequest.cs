...
namespace Gs2.Gs2Formation.Request
{
	...
	public class GetFormByUserIdRequest : Gs2Request<GetFormByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetFormByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetFormByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetFormByUserIdRequest)x;
            return this;
        }
    }
}