...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeFormsRequest : Gs2Request<DescribeFormsRequest>
	{
        ...
        public DescribeFormsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeFormsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeFormsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeFormsRequest)x;
            return this;
        }
    }
}