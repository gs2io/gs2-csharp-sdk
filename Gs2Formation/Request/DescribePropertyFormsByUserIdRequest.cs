...
#endif
	[System.Serializable]
	public class DescribePropertyFormsByUserIdRequest : Gs2Request<DescribePropertyFormsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribePropertyFormsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribePropertyFormsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribePropertyFormsByUserIdRequest)x;
            return this;
        }
    }
}