...
namespace Gs2.Gs2Formation.Request
{
	...
	public class GetCurrentFormMasterRequest : Gs2Request<GetCurrentFormMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentFormMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentFormMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentFormMasterRequest)x;
            return this;
        }
    }
}