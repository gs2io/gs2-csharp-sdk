...
namespace Gs2.Gs2Formation.Request
{
	...
	public class DescribeMoldModelMastersRequest : Gs2Request<DescribeMoldModelMastersRequest>
	{
        ...
        public DescribeMoldModelMastersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeMoldModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMoldModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMoldModelMastersRequest)x;
            return this;
        }
    }
}