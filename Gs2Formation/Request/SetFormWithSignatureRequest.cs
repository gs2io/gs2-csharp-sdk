	...
	public class SetFormWithSignatureRequest : Gs2Request<SetFormWithSignatureRequest>
	{
        ...
        public static SetFormWithSignatureRequest FromJson(JsonData data)
        {
            ...
            return new SetFormWithSignatureRequest()
                ...
                .WithSlots(!data.Keys.Contains("slots") || data["slots"] == null || !data["slots"].IsArray ? new Gs2.Gs2Formation.Model.SlotWithSignature[]{} : data["slots"].Cast<JsonData>().Select(v => {
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply SetFormWithSignatureRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (SetFormWithSignatureRequest)x;
            return this;
        }
    }
}