...
namespace Gs2.Gs2Formation.Model.Cache
{
    public static partial class FormExt
    {
        public static void PutCache(
            this GetFormByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<GetFormByUserIdResult> InvokeFuture(
            this GetFormByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<GetFormByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<GetFormByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<GetFormByUserIdResult>(Impl);
        }
#endif
