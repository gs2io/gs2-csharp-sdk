...
namespace Gs2.Gs2Formation.Model.Cache
{
    public static partial class FormExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DeleteFormByUserIdResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DeleteFormByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<DeleteFormByUserIdResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<DeleteFormByUserIdResult> InvokeAsync(
#else
        public static async Task<DeleteFormByUserIdResult> InvokeAsync(
#endif
            this DeleteFormByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<DeleteFormByUserIdResult>> invokeImpl
#else
            Func<Task<DeleteFormByUserIdResult>> invokeImpl
#endif
        )
        {
