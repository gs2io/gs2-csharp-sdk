...
namespace Gs2.Gs2Formation.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        private static System.Text.RegularExpressions.Regex _regionRegex = new System.Text.RegularExpressions.Regex(
                @"grn:gs2:(?<region>.+):(?<ownerId>.+):formation:(?<namespaceName>.+)",
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(UpdateMoldScript, other.UpdateMoldScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(UpdateFormScript, other.UpdateFormScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(UpdatePropertyFormScript, other.UpdatePropertyFormScript);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "formation.namespace.namespaceId.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "formation.namespace.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "formation.namespace.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "formation.namespace.revision.error.invalid"),
                    });
                }
