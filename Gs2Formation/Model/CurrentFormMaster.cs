...
namespace Gs2.Gs2Formation.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentFormMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentFormMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentFormMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentFormMaster", "formation.currentFormMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentFormMaster", "formation.currentFormMaster.settings.error.tooLong"),
                    });
                }
            }
        }
