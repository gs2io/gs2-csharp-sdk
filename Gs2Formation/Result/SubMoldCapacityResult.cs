...
#endif
	[System.Serializable]
	public class SubMoldCapacityResult : IResult
	{
        public Gs2.Gs2Formation.Model.Mold Item { set; get; }
        public Gs2.Gs2Formation.Model.MoldModel MoldModel { set; get; }
        public ResultMetadata Metadata { set; get; }

        public SubMoldCapacityResult WithItem(Gs2.Gs2Formation.Model.Mold item) {
            this.Item = item;
            return this;
        }

        public SubMoldCapacityResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public SubMoldCapacityResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SubMoldCapacityResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
