...
namespace Gs2.Gs2Formation.Result
{
	...
	public class SetFormResult : IResult
	{
        ...
        public SetFormResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public SetFormResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public SetFormResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
    	...
    	[Preserve]
#endif
        public static SetFormResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
