...
#endif
	[System.Serializable]
	public class DeletePropertyFormResult : IResult
	{
        ...
        public DeletePropertyFormResult WithItem(Gs2.Gs2Formation.Model.PropertyForm item) {
            this.Item = item;
            return this;
        }

        public DeletePropertyFormResult WithPropertyFormModel(Gs2.Gs2Formation.Model.PropertyFormModel propertyFormModel) {
            this.PropertyFormModel = propertyFormModel;
            return this;
        }

        public DeletePropertyFormResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeletePropertyFormResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
