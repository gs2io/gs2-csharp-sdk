...
namespace Gs2.Gs2Formation.Result
{
	...
	public class AcquireActionToFormPropertiesByStampSheetResult : IResult
	{
        ...
        public AcquireActionToFormPropertiesByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public AcquireActionToFormPropertiesByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public AcquireActionToFormPropertiesByStampSheetResult WithMetadata(ResultMetadata metadata) {
