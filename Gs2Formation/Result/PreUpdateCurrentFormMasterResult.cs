...
#endif
	[System.Serializable]
	public class PreUpdateCurrentFormMasterResult : IResult
	{
        ...
        public PreUpdateCurrentFormMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentFormMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
