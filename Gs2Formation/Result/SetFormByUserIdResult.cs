...
#endif
	[System.Serializable]
	public class SetFormByUserIdResult : IResult
	{
        ...
        public SetFormByUserIdResult WithItem(Gs2.Gs2Formation.Model.Form item) {
            this.Item = item;
            return this;
        }

        public SetFormByUserIdResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public SetFormByUserIdResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public SetFormByUserIdResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
            this.FormModel = formModel;
            return this;
        }

        public SetFormByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetFormByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
