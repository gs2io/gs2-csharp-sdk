...
namespace Gs2.Gs2Formation.Result
{
	...
	{
        public Gs2.Gs2Formation.Model.FormModelMaster[] Items { set; get; } = null!;
        ...
        public static DescribeFormModelMastersResult FromJson(JsonData data)
        {
            ...
            return new DescribeFormModelMastersResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Formation.Model.FormModelMaster[]{} : data["items"].Cast<JsonData>().Select(v => {
