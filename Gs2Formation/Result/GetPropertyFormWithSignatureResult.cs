...
namespace Gs2.Gs2Formation.Result
{
	...
	public class GetPropertyFormWithSignatureResult : IResult
	{
        ...
        public GetPropertyFormWithSignatureResult WithPropertyFormModel(Gs2.Gs2Formation.Model.PropertyFormModel propertyFormModel) {
    	...
    	[Preserve]
#endif
        public static GetPropertyFormWithSignatureResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
