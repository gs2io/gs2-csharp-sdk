...
#endif
	[System.Serializable]
	public class GetFormResult : IResult
	{
        ...
        public GetFormResult WithItem(Gs2.Gs2Formation.Model.Form item) {
            this.Item = item;
            return this;
        }

        public GetFormResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public GetFormResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public GetFormResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
            this.FormModel = formModel;
            return this;
        }

        public GetFormResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetFormResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
