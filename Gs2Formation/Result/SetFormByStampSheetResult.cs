...
#endif
	[System.Serializable]
	public class SetFormByStampSheetResult : IResult
	{
        ...
        public SetFormByStampSheetResult WithItem(Gs2.Gs2Formation.Model.Form item) {
            this.Item = item;
            return this;
        }

        public SetFormByStampSheetResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public SetFormByStampSheetResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public SetFormByStampSheetResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
            this.FormModel = formModel;
            return this;
        }

        public SetFormByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetFormByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
