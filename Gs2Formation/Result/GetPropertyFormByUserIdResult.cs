...
#endif
	[System.Serializable]
	public class GetPropertyFormByUserIdResult : IResult
	{
        ...
        public GetPropertyFormByUserIdResult WithItem(Gs2.Gs2Formation.Model.PropertyForm item) {
            this.Item = item;
            return this;
        }

        public GetPropertyFormByUserIdResult WithPropertyFormModel(Gs2.Gs2Formation.Model.PropertyFormModel propertyFormModel) {
            this.PropertyFormModel = propertyFormModel;
            return this;
        }

        public GetPropertyFormByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetPropertyFormByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
