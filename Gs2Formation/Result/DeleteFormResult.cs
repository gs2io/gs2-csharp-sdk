...
#endif
	[System.Serializable]
	public class DeleteFormResult : IResult
	{
        ...
        public DeleteFormResult WithItem(Gs2.Gs2Formation.Model.Form item) {
            this.Item = item;
            return this;
        }

        public DeleteFormResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public DeleteFormResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public DeleteFormResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
            this.FormModel = formModel;
            return this;
        }

        public DeleteFormResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteFormResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
