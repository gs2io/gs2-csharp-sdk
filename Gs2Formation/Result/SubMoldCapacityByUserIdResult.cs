...
#endif
	[System.Serializable]
	public class SubMoldCapacityByUserIdResult : IResult
	{
        public Gs2.Gs2Formation.Model.Mold Item { set; get; }
        public Gs2.Gs2Formation.Model.MoldModel MoldModel { set; get; }
        public ResultMetadata Metadata { set; get; }

        public SubMoldCapacityByUserIdResult WithItem(Gs2.Gs2Formation.Model.Mold item) {
            this.Item = item;
            return this;
        }

        public SubMoldCapacityByUserIdResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public SubMoldCapacityByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SubMoldCapacityByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
