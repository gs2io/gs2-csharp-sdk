...
#endif
	[System.Serializable]
	public class SetFormWithSignatureResult : IResult
	{
        ...
        public SetFormWithSignatureResult WithItem(Gs2.Gs2Formation.Model.Form item) {
            this.Item = item;
            return this;
        }

        public SetFormWithSignatureResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public SetFormWithSignatureResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public SetFormWithSignatureResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
            this.FormModel = formModel;
            return this;
        }

        public SetFormWithSignatureResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetFormWithSignatureResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
