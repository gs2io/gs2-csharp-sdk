...
namespace Gs2.Gs2Formation.Result
{
	...
	public class AcquireActionToPropertyFormPropertiesByStampSheetResult : IResult
	{
        ...
        public AcquireActionToPropertyFormPropertiesByStampSheetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public AcquireActionToPropertyFormPropertiesByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public AcquireActionToPropertyFormPropertiesByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public AcquireActionToPropertyFormPropertiesByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AcquireActionToPropertyFormPropertiesByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
