...
#endif
	[System.Serializable]
	public class SetPropertyFormByUserIdResult : IResult
	{
        ...
        public SetPropertyFormByUserIdResult WithItem(Gs2.Gs2Formation.Model.PropertyForm item) {
            this.Item = item;
            return this;
        }

        public SetPropertyFormByUserIdResult WithPropertyFormModel(Gs2.Gs2Formation.Model.PropertyFormModel propertyFormModel) {
            this.PropertyFormModel = propertyFormModel;
            return this;
        }

        public SetPropertyFormByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetPropertyFormByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
