...
#endif
	[System.Serializable]
	public class GetFormByUserIdResult : IResult
	{
        ...
        public GetFormByUserIdResult WithItem(Gs2.Gs2Formation.Model.Form item) {
            this.Item = item;
            return this;
        }

        public GetFormByUserIdResult WithMold(Gs2.Gs2Formation.Model.Mold mold) {
            this.Mold = mold;
            return this;
        }

        public GetFormByUserIdResult WithMoldModel(Gs2.Gs2Formation.Model.MoldModel moldModel) {
            this.MoldModel = moldModel;
            return this;
        }

        public GetFormByUserIdResult WithFormModel(Gs2.Gs2Formation.Model.FormModel formModel) {
            this.FormModel = formModel;
            return this;
        }

        public GetFormByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetFormByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
