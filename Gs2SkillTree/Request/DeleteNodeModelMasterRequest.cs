...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class DeleteNodeModelMasterRequest : Gs2Request<DeleteNodeModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteNodeModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteNodeModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteNodeModelMasterRequest)x;
            return this;
        }
    }
}