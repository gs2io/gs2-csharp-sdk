...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class GetNodeModelMasterRequest : Gs2Request<GetNodeModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetNodeModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetNodeModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetNodeModelMasterRequest)x;
            return this;
        }
    }
}