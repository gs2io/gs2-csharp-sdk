...
#endif
	[System.Serializable]
	public class GetStatusModelRequest : Gs2Request<GetStatusModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetStatusModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetStatusModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetStatusModelRequest)x;
            return this;
        }
    }
}