...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class MarkRestrainByStampTaskRequest : Gs2Request<MarkRestrainByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static MarkRestrainByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply MarkRestrainByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (MarkRestrainByStampTaskRequest)x;
            return this;
        }
    }
}