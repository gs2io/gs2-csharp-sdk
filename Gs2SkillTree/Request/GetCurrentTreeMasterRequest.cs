...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class GetCurrentTreeMasterRequest : Gs2Request<GetCurrentTreeMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentTreeMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentTreeMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentTreeMasterRequest)x;
            return this;
        }
    }
}