...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class DescribeNodeModelsRequest : Gs2Request<DescribeNodeModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeNodeModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeNodeModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeNodeModelsRequest)x;
            return this;
        }
    }
}