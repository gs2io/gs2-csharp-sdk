...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class UpdateCurrentTreeMasterRequest : Gs2Request<UpdateCurrentTreeMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentTreeMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentTreeMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentTreeMasterRequest)x;
            return this;
        }
    }
}