...
namespace Gs2.Gs2SkillTree.Request
{
	...
	public class MarkReleaseByStampSheetRequest : Gs2Request<MarkReleaseByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static MarkReleaseByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply MarkReleaseByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (MarkReleaseByStampSheetRequest)x;
            return this;
        }
    }
}