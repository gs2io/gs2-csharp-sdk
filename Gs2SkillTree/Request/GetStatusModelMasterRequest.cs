...
#endif
	[System.Serializable]
	public class GetStatusModelMasterRequest : Gs2Request<GetStatusModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetStatusModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetStatusModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetStatusModelMasterRequest)x;
            return this;
        }
    }
}