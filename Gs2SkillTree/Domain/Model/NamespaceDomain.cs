...
namespace Gs2.Gs2SkillTree.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> CreateNodeModelMaster(
            ...
            return CreateNodeModelMasterFuture(request);
        }
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2SkillTree.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Model.Namespace> self)
            {
                var parentKey = string.Join(
        ...
        public IFuture<Gs2.Gs2SkillTree.Model.Namespace> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2SkillTree.Model.Namespace> Model()
        {
            return await ModelAsync();
        }
        #endif
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2SkillTree.Model.Namespace>(
                _parentKey,
                Gs2.Gs2SkillTree.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName.ToString()
                )
