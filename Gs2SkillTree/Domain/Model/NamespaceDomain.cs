...
namespace Gs2.Gs2SkillTree.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public async Task<Gs2.Gs2SkillTree.Domain.Model.NamespaceDomain> GetStatusAsync(
            ...
            Gs2.Gs2SkillTree.Domain.Model.NamespaceDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2SkillTree.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2SkillTree.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> CreateNodeModelMasterAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.CreateNodeModelMasterAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2SkillTree.Model.Namespace> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2SkillTree.Model.Namespace>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2SkillTree.Model.Namespace>(
                    parentKey,
                    Gs2.Gs2SkillTree.Domain.Model.NamespaceDomain.CreateCacheKey(
                        this.NamespaceName?.ToString()
                    )
