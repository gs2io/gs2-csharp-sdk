...
namespace Gs2.Gs2SkillTree.Domain.Model
{
    ...
    public partial class NodeModelMasterDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Model.NodeModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "nodeModelMaster")
                        {
        ...
        private async Task<Gs2.Gs2SkillTree.Model.NodeModelMaster> GetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithNodeModelName(this.NodeModelName);
            GetNodeModelMasterResult result = null;
            try {
                result = await this._client.GetNodeModelMasterAsync(
                    request
                );
        ...
        public async Task<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> UpdateAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithNodeModelName(this.NodeModelName);
            UpdateNodeModelMasterResult result = null;
                result = await this._client.UpdateNodeModelMasterAsync(
                    request
                );
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2SkillTree.Model.NodeModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class NodeModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2SkillTree.Model.NodeModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Model.NodeModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                        _parentKey,
                        Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain.CreateCacheKey(
                            this.NodeModelName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                _parentKey,
                Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain.CreateCacheKey(
                    this.NodeModelName.ToString()
                )
