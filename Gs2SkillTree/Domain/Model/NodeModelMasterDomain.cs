...
namespace Gs2.Gs2SkillTree.Domain.Model
{
    ...
    public partial class NodeModelMasterDomain {
        ...
        private async UniTask<Gs2.Gs2SkillTree.Model.NodeModelMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2SkillTree.Model.NodeModelMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2SkillTree.Model.NodeModelMaster> GetAsync(
            ...
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.GetNodeModelMasterFuture(
                request
            );
            yield return future;
            ...
            #else
            var result = await this._client.GetNodeModelMasterAsync(
                request
            );
            #endif
        ...
        public async UniTask<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> UpdateAsync(
            #else
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> Update(
            #endif
        #else
        public async Task<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> UpdateAsync(
            ...
            request
                ...
                .WithNodeModelName(this.NodeModelName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.UpdateNodeModelMasterFuture(
                request
            );
            yield return future;
            if (future.Error != null)
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateNodeModelMasterAsync(
                request
            );
            #endif
            var requestModel = request;
            ...
            Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain domain = this;
        ...
        public async UniTask<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> DeleteAsync(
            #else
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> Delete(
            #endif
        #else
        public async Task<Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain> DeleteAsync(
            ...
            request
                ...
                .WithNodeModelName(this.NodeModelName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.DeleteNodeModelMasterFuture(
                request
            );
            yield return future;
            if (future.Error != null)
            {
                if (future.Error is Gs2.Core.Exception.NotFoundException) {
                    ...
                    _cache.Put<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                        _parentKey,
                        key,
                        null,
                        UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
            ...
            var result = future.Result;
            #else
            DeleteNodeModelMasterResult result = null;
            try {
                result = await this._client.DeleteNodeModelMasterAsync(
                    request
                );
            } catch(Gs2.Core.Exception.NotFoundException e) {
                if (e.errors[0].component == "nodeModelMaster")
                {
                    var key = Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain.CreateCacheKey(
                        request.NodeModelName.ToString()
                    );
            ...
            if (resultModel != null) {
                ...
                if (resultModel.Item != null) {
                    ...
                    cache.Delete<Gs2.Gs2SkillTree.Model.NodeModelMaster>(parentKey, key);
                }
            }
            Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2SkillTree.Model.NodeModelMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                       _parentKey,
                       Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain.CreateCacheKey(
                            this.NodeModelName?.ToString()
                        )).LockAsync())
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                _parentKey,
                Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain.CreateCacheKey(
                    this.NodeModelName?.ToString()
                )
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                    _parentKey,
                    Gs2.Gs2SkillTree.Domain.Model.NodeModelMasterDomain.CreateCacheKey(
                        this.NodeModelName?.ToString()
                    )
