        ...
        private IFuture<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.GetCurrentTreeMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> PreUpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.PreUpdateCurrentTreeMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.UpdateCurrentTreeMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.UpdateCurrentTreeMasterFromGitHubFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
    ...
    public partial class CurrentTreeMasterDomain {
        ...
        public IFuture<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2SkillTree.Model.CurrentTreeMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetFuture(
