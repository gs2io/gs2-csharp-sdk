...
namespace Gs2.Gs2SkillTree.Domain.Model
{
    ...
    public partial class CurrentTreeMasterDomain {
        ...
        private async Task<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCurrentTreeMasterAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> PreUpdateFuture(
            PreUpdateCurrentTreeMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentTreeMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentTreeMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentTreeMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2SkillTree.Domain.Model.CurrentTreeMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentTreeMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentTreeMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2SkillTree.Model.CurrentTreeMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2SkillTree.Model.CurrentTreeMaster>(
                (null as Gs2.Gs2SkillTree.Model.CurrentTreeMaster).CacheParentKey(
                    this.NamespaceName,
                    null
                ),
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2SkillTree.Model.CurrentTreeMaster> callback)
        #endif
        {
