    ...
    public class DescribeNodeModelMastersIterator : IAsyncEnumerable<Gs2.Gs2SkillTree.Model.NodeModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2SkillTree.Model.NodeModelMaster>
            (
                ...
                var request = new Gs2.Gs2SkillTree.Request.DescribeNodeModelMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2SkillTree.Model.NodeModelMaster>(
                        (null as Gs2.Gs2SkillTree.Model.NodeModelMaster).CacheParentKey(
                            NamespaceName,
                            null
                        )
