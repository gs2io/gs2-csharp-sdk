...
namespace Gs2.Gs2SkillTree.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeStatusesIterator : Gs2Iterator<Gs2.Gs2SkillTree.Model.Status> {
    #else
    public class DescribeStatusesIterator : IAsyncEnumerable<Gs2.Gs2SkillTree.Model.Status> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2SkillTree.Model.Status[] _result;
        ...
        public DescribeStatusesIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2SkillTree.Model.Status[]{};
        }
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2SkillTree.Request.DescribeStatusesRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2SkillTree.Model.Status>(
                        (null as Gs2.Gs2SkillTree.Model.Status).CacheParentKey(
                            NamespaceName,
                            AccessToken?.UserId,
                            this.AccessToken?.TimeOffset
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2SkillTree.Model.Status>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2SkillTree.Model.Status>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2SkillTree.Model.Status> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2SkillTree.Model.Status>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
