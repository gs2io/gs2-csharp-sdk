...
#endif
	[System.Serializable]
	public class PreUpdateCurrentTreeMasterResult : IResult
	{
        ...
        public PreUpdateCurrentTreeMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentTreeMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
