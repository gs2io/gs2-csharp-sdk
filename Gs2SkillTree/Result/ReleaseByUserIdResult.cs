...
namespace Gs2.Gs2SkillTree.Result
{
	...
	public class ReleaseByUserIdResult : IResult
	{
        ...
        public ReleaseByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReleaseByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReleaseByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReleaseByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReleaseByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
