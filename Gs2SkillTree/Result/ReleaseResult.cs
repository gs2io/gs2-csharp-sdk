...
#endif
	[System.Serializable]
	public class ReleaseResult : IResult
	{
        ...
        public ReleaseResult WithItem(Gs2.Gs2SkillTree.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public ReleaseResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReleaseResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReleaseResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReleaseResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReleaseResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
