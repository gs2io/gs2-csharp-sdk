...
namespace Gs2.Gs2SkillTree.Result
{
	...
	public class DescribeStatusesByUserIdResult : IResult
	{
        ...
        public DescribeStatusesByUserIdResult WithItems(Gs2.Gs2SkillTree.Model.Status[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeStatusesByUserIdResult FromJson(JsonData data)
        {
            ...
            return new DescribeStatusesByUserIdResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2SkillTree.Model.Status[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2SkillTree.Model.Status.FromJson(v);
                }).ToArray())
