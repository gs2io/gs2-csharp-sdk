...
#endif
	[System.Serializable]
	public class RestrainByUserIdResult : IResult
	{
        ...
        public RestrainByUserIdResult WithItem(Gs2.Gs2SkillTree.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public RestrainByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public RestrainByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public RestrainByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public RestrainByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RestrainByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new RestrainByUserIdResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2SkillTree.Model.Status.FromJson(data["item"]))
