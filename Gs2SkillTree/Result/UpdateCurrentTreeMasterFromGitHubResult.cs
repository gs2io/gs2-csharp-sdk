...
namespace Gs2.Gs2SkillTree.Result
{
	...
	public class UpdateCurrentTreeMasterFromGitHubResult : IResult
	{
        ...
        public UpdateCurrentTreeMasterFromGitHubResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UpdateCurrentTreeMasterFromGitHubResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
