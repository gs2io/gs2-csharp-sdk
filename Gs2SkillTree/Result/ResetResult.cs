...
#endif
	[System.Serializable]
	public class ResetResult : IResult
	{
        ...
        public ResetResult WithItem(Gs2.Gs2SkillTree.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public ResetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ResetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ResetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ResetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ResetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
