...
#endif
	[System.Serializable]
	public class RestrainResult : IResult
	{
        ...
        public RestrainResult WithItem(Gs2.Gs2SkillTree.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public RestrainResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public RestrainResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public RestrainResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public RestrainResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RestrainResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
