...
namespace Gs2.Gs2SkillTree.Model.Cache
{
    public static partial class NodeModelMasterExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DeleteNodeModelMasterResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DeleteNodeModelMasterResult> self)
            {
            ...
            return new Gs2InlineFuture<DeleteNodeModelMasterResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<DeleteNodeModelMasterResult> InvokeAsync(
#else
        public static async Task<DeleteNodeModelMasterResult> InvokeAsync(
#endif
            this DeleteNodeModelMasterRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<DeleteNodeModelMasterResult>> invokeImpl
#else
            Func<Task<DeleteNodeModelMasterResult>> invokeImpl
#endif
        )
        {
