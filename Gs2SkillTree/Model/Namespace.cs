...
namespace Gs2.Gs2SkillTree.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2SkillTree.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        public Namespace WithTransactionSettingV2(Gs2.Gs2SkillTree.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        public void WriteJson(JsonWriter writer)
        {
            ...
            if (ReleaseScript != null) {
                writer.WritePropertyName("releaseScript");
                ReleaseScript.WriteJson(writer);
            }
            if (RestrainScript != null) {
                writer.WritePropertyName("restrainScript");
                RestrainScript.WriteJson(writer);
            }
            if (LogSetting != null) {
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(ReleaseScript, other.ReleaseScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(RestrainScript, other.RestrainScript);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "skillTree.namespace.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "skillTree.namespace.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "skillTree.namespace.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "skillTree.namespace.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "skillTree.namespace.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "skillTree.namespace.revision.error.invalid"),
                    });
                }
        ...
        public object Clone() {
            return new Namespace {
                ...
                Name = Name,
                Description = Description,
                TransactionSetting = TransactionSetting?.Clone() as Gs2.Gs2SkillTree.Model.TransactionSetting,
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2SkillTree.Model.TransactionSettingV2,
                ReleaseScript = ReleaseScript?.Clone() as Gs2.Gs2SkillTree.Model.ScriptSetting,
                RestrainScript = RestrainScript?.Clone() as Gs2.Gs2SkillTree.Model.ScriptSetting,
                LogSetting = LogSetting?.Clone() as Gs2.Gs2SkillTree.Model.LogSetting,
                CreatedAt = CreatedAt,
                UpdatedAt = UpdatedAt,
                Revision = Revision,
            };
