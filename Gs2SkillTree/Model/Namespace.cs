...
namespace Gs2.Gs2SkillTree.Model
{
	...
	public class Namespace : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReleaseScript == null && ReleaseScript == other.ReleaseScript)
            {
                // null and null
            }
            else
            {
                diff += ReleaseScript.CompareTo(other.ReleaseScript);
            }
            if (RestrainScript == null && RestrainScript == other.RestrainScript)
            {
                // null and null
            }
            else
            {
                diff += RestrainScript.CompareTo(other.RestrainScript);
            }
