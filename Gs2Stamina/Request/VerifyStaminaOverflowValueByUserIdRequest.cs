...
#endif
	[System.Serializable]
	public class VerifyStaminaOverflowValueByUserIdRequest : Gs2Request<VerifyStaminaOverflowValueByUserIdRequest>
	{
        ...
        public VerifyStaminaOverflowValueByUserIdRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaOverflowValueByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaOverflowValueByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
