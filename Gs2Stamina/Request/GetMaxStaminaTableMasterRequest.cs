...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class GetMaxStaminaTableMasterRequest : Gs2Request<GetMaxStaminaTableMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetMaxStaminaTableMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetMaxStaminaTableMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetMaxStaminaTableMasterRequest)x;
            return this;
        }
    }
}