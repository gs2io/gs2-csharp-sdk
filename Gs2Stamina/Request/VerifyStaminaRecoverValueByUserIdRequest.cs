...
#endif
	[System.Serializable]
	public class VerifyStaminaRecoverValueByUserIdRequest : Gs2Request<VerifyStaminaRecoverValueByUserIdRequest>
	{
        ...
        public VerifyStaminaRecoverValueByUserIdRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaRecoverValueByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaRecoverValueByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
