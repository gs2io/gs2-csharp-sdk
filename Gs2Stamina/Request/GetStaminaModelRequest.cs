...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class GetStaminaModelRequest : Gs2Request<GetStaminaModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetStaminaModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetStaminaModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetStaminaModelRequest)x;
            return this;
        }
    }
}