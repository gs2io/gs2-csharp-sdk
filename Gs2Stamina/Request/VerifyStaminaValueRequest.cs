...
#endif
	[System.Serializable]
	public class VerifyStaminaValueRequest : Gs2Request<VerifyStaminaValueRequest>
	{
        ...
        public VerifyStaminaValueRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaValueRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaValueRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
