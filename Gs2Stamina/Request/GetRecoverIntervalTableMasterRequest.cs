...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class GetRecoverIntervalTableMasterRequest : Gs2Request<GetRecoverIntervalTableMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetRecoverIntervalTableMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetRecoverIntervalTableMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetRecoverIntervalTableMasterRequest)x;
            return this;
        }
    }
}