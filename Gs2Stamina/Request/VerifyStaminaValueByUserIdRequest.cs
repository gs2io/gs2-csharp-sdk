...
#endif
	[System.Serializable]
	public class VerifyStaminaValueByUserIdRequest : Gs2Request<VerifyStaminaValueByUserIdRequest>
	{
        ...
        public VerifyStaminaValueByUserIdRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaValueByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaValueByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
