...
#endif
	[System.Serializable]
	public class VerifyStaminaMaxValueByUserIdRequest : Gs2Request<VerifyStaminaMaxValueByUserIdRequest>
	{
        ...
        public VerifyStaminaMaxValueByUserIdRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaMaxValueByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaMaxValueByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
