...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class GetStaminaModelMasterRequest : Gs2Request<GetStaminaModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetStaminaModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetStaminaModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetStaminaModelMasterRequest)x;
            return this;
        }
    }
}