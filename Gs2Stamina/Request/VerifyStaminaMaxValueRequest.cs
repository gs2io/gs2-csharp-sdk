...
#endif
	[System.Serializable]
	public class VerifyStaminaMaxValueRequest : Gs2Request<VerifyStaminaMaxValueRequest>
	{
        ...
        public VerifyStaminaMaxValueRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaMaxValueRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaMaxValueRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
