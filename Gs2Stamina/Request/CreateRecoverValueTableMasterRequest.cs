...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class CreateRecoverValueTableMasterRequest : Gs2Request<CreateRecoverValueTableMasterRequest>
	{
        ...
        public CreateRecoverValueTableMasterRequest WithValues(int[] values) {
            this.Values = values;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static CreateRecoverValueTableMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply CreateRecoverValueTableMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (CreateRecoverValueTableMasterRequest)x;
            return this;
        }
    }
}