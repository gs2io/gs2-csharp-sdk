...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class RecoverStaminaByStampSheetRequest : Gs2Request<RecoverStaminaByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static RecoverStaminaByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RecoverStaminaByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RecoverStaminaByStampSheetRequest)x;
            return this;
        }
    }
}