...
#endif
	[System.Serializable]
	public class VerifyStaminaRecoverIntervalMinutesRequest : Gs2Request<VerifyStaminaRecoverIntervalMinutesRequest>
	{
        ...
        public VerifyStaminaRecoverIntervalMinutesRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaRecoverIntervalMinutesRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaRecoverIntervalMinutesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
