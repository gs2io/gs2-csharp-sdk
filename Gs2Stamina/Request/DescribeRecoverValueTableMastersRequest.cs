...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class DescribeRecoverValueTableMastersRequest : Gs2Request<DescribeRecoverValueTableMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRecoverValueTableMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRecoverValueTableMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRecoverValueTableMastersRequest)x;
            return this;
        }
    }
}