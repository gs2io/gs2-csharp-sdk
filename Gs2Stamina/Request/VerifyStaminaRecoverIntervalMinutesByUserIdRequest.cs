...
#endif
	[System.Serializable]
	public class VerifyStaminaRecoverIntervalMinutesByUserIdRequest : Gs2Request<VerifyStaminaRecoverIntervalMinutesByUserIdRequest>
	{
        ...
        public VerifyStaminaRecoverIntervalMinutesByUserIdRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaRecoverIntervalMinutesByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaRecoverIntervalMinutesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
