...
#endif
	[System.Serializable]
	public class VerifyStaminaOverflowValueRequest : Gs2Request<VerifyStaminaOverflowValueRequest>
	{
        ...
        public VerifyStaminaOverflowValueRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyStaminaOverflowValueRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaOverflowValueRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
