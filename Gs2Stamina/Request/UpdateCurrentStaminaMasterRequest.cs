...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class UpdateCurrentStaminaMasterRequest : Gs2Request<UpdateCurrentStaminaMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentStaminaMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentStaminaMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentStaminaMasterRequest)x;
            return this;
        }
    }
}