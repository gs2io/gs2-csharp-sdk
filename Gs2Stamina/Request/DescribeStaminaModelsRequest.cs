...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class DescribeStaminaModelsRequest : Gs2Request<DescribeStaminaModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeStaminaModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeStaminaModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeStaminaModelsRequest)x;
            return this;
        }
    }
}