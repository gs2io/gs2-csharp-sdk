...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class GetCurrentStaminaMasterRequest : Gs2Request<GetCurrentStaminaMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentStaminaMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentStaminaMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentStaminaMasterRequest)x;
            return this;
        }
    }
}