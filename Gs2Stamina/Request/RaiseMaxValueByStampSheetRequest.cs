...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class RaiseMaxValueByStampSheetRequest : Gs2Request<RaiseMaxValueByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static RaiseMaxValueByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RaiseMaxValueByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RaiseMaxValueByStampSheetRequest)x;
            return this;
        }
    }
}