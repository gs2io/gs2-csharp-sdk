...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class SetMaxValueByStampSheetRequest : Gs2Request<SetMaxValueByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static SetMaxValueByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply SetMaxValueByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (SetMaxValueByStampSheetRequest)x;
            return this;
        }
    }
}