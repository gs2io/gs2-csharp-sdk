...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class DescribeStaminasByUserIdRequest : Gs2Request<DescribeStaminasByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeStaminasByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeStaminasByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeStaminasByUserIdRequest)x;
            return this;
        }
    }
}