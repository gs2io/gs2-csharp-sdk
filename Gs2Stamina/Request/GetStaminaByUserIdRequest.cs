...
namespace Gs2.Gs2Stamina.Request
{
	...
	public class GetStaminaByUserIdRequest : Gs2Request<GetStaminaByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetStaminaByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetStaminaByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetStaminaByUserIdRequest)x;
            return this;
        }
    }
}