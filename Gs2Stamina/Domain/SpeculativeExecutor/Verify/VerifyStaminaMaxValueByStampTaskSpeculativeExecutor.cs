...
{
    public static class VerifyStaminaMaxValueByUserIdSpeculativeExecutor {
/* diff +++ start */
            ...
            IPreparedSpeculativeVerification
        {
            ...
            private readonly VerifyStaminaMaxValueByUserIdRequest _request;
...
/* diff +++ start */
        ...
        public static async Task<Func<object>> ExecuteInverseAsync(
            ...
            var inverse = request == null ? null :
                VerifyStaminaMaxValueByUserIdRequest.FromJson(request.ToJson());
...
/* diff +++ start */
            ...
            var prepared = VerifyStaminaMaxValueByUserIdRequest.FromJson(
                request.ToJson()
            );
