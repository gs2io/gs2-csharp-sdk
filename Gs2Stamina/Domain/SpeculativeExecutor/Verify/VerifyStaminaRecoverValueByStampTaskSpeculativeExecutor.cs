...
{
    public static class VerifyStaminaRecoverValueByUserIdSpeculativeExecutor {
/* diff +++ start */
            ...
            IPreparedSpeculativeVerification
        {
            ...
            private readonly VerifyStaminaRecoverValueByUserIdRequest _request;
...
/* diff +++ start */
        ...
        public static async Task<Func<object>> ExecuteInverseAsync(
            ...
            var inverse = request == null ? null :
                VerifyStaminaRecoverValueByUserIdRequest.FromJson(request.ToJson());
...
/* diff +++ start */
            ...
            var prepared = VerifyStaminaRecoverValueByUserIdRequest.FromJson(
                request.ToJson()
            );
