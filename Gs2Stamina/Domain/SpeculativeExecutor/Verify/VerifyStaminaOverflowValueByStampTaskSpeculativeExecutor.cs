...
{
    public static class VerifyStaminaOverflowValueByUserIdSpeculativeExecutor {
/* diff +++ start */
            ...
            IPreparedSpeculativeVerification
        {
            ...
            private readonly VerifyStaminaOverflowValueByUserIdRequest _request;
...
/* diff +++ start */
        ...
        public static async Task<Func<object>> ExecuteInverseAsync(
            ...
            var inverse = request == null ? null :
                VerifyStaminaOverflowValueByUserIdRequest.FromJson(request.ToJson());
...
/* diff +++ start */
            ...
            var prepared = VerifyStaminaOverflowValueByUserIdRequest.FromJson(
                request.ToJson()
            );
