...
namespace Gs2.Gs2Stamina.Domain.Iterator
{
    ...
    public class DescribeStaminaModelsIterator : IAsyncEnumerable<Gs2.Gs2Stamina.Model.StaminaModel> {
        ...
        private bool _last;
        private Gs2.Gs2Stamina.Model.StaminaModel[] _result;
        ...
        public DescribeStaminaModelsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Stamina.Model.StaminaModel[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Stamina.Model.StaminaModel>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Stamina.Model.StaminaModel>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeStaminaModelsFuture(
                #else
                var r = await this._client.DescribeStaminaModelsAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Stamina.Model.StaminaModel>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Stamina.Model.StaminaModel>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Stamina.Model.StaminaModel ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Stamina.Model.StaminaModel>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Stamina.Model.StaminaModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Stamina.Model.StaminaModel>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
