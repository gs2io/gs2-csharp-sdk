...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class RecoverValueTableDomain {
        ...
        public IFuture<Gs2.Gs2Stamina.Model.RecoverValueTable> ModelFuture()
        {
            ...
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Stamina.Model.RecoverValueTable>(
                    _parentKey,
            ...
            #endif
        {
            ...
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Stamina.Model.RecoverValueTable>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableDomain.CreateCacheKey(
                )).LockAsync())
            {
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Stamina.Model.RecoverValueTable>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableDomain.CreateCacheKey(
                )
            );
        ...
        public ulong Subscribe(Action<Gs2.Gs2Stamina.Model.RecoverValueTable> callback)
        {
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2Stamina.Model.RecoverValueTable>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableDomain.CreateCacheKey(
                ),
                callbackId
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Stamina.Model.RecoverValueTable> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Stamina.Model.RecoverValueTable> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Stamina.Model.RecoverValueTable> callback)
            #endif
        {
