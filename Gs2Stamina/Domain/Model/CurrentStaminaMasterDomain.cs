...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class CurrentStaminaMasterDomain {
        ...
        public async Task<Gs2.Gs2Stamina.Model.CurrentStaminaMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Stamina.Model.CurrentStaminaMaster>(
                       _parentKey,
                       Gs2.Gs2Stamina.Domain.Model.CurrentStaminaMasterDomain.CreateCacheKey(
                        )).LockAsync())
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Stamina.Model.CurrentStaminaMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.CurrentStaminaMasterDomain.CreateCacheKey(
                )
            );
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            _cache.Put<Gs2.Gs2Stamina.Model.CurrentStaminaMaster>(
                                _parentKey,
                                key,
                                null,
                                UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Stamina.Model.CurrentStaminaMaster>(
                    _parentKey,
                    Gs2.Gs2Stamina.Domain.Model.CurrentStaminaMasterDomain.CreateCacheKey(
                    )
                );
