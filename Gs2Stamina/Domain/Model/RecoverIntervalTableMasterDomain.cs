...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class RecoverIntervalTableMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster> GetAsync(
            ...
            request
                ...
                .WithRecoverIntervalTableName(this._recoverIntervalTableName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            ...
            #else
            var result = await this._client.GetRecoverIntervalTableMasterAsync(
                request
            );
            #endif
            ...
            if (result.Item != null) {
                _cache.Put(
                    ...
                    Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain.CreateCacheKey(
                        request.RecoverIntervalTableName != null ? request.RecoverIntervalTableName.ToString() : null
                    ),
                    result.Item,
        ...
        public async Task<Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateRecoverIntervalTableMasterAsync(
                request
            );
            #endif
            ...
            Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain.CreateCacheKey(
                    request.RecoverIntervalTableName != null ? request.RecoverIntervalTableName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster value = _cache.Get<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Stamina.Model.RecoverIntervalTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverIntervalTableMasterDomain.CreateCacheKey(
                    this.RecoverIntervalTableName?.ToString()
                )
