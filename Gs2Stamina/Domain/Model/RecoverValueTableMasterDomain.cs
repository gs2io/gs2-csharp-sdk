...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class RecoverValueTableMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> GetAsync(
            ...
            request
                ...
                .WithRecoverValueTableName(this._recoverValueTableName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            ...
            #else
            var result = await this._client.GetRecoverValueTableMasterAsync(
                request
            );
            #endif
            ...
            if (result.Item != null) {
                _cache.Put(
                    ...
                    Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain.CreateCacheKey(
                        request.RecoverValueTableName != null ? request.RecoverValueTableName.ToString() : null
                    ),
                    result.Item,
        ...
        public async Task<Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateRecoverValueTableMasterAsync(
                request
            );
            #endif
            ...
            Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain.CreateCacheKey(
                    request.RecoverValueTableName != null ? request.RecoverValueTableName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Stamina.Model.RecoverValueTableMaster value = _cache.Get<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain.CreateCacheKey(
                    this.RecoverValueTableName?.ToString()
                )
