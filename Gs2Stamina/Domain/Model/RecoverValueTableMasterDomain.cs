...
namespace Gs2.Gs2Stamina.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "recoverValueTableMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class RecoverValueTableMasterDomain {
        ...
        public IFuture<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Stamina.Model.RecoverValueTableMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                        _parentKey,
                        Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain.CreateCacheKey(
                            this.RecoverValueTableName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Stamina.Model.RecoverValueTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.RecoverValueTableMasterDomain.CreateCacheKey(
                    this.RecoverValueTableName.ToString()
                )
