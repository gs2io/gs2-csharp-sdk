...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class MaxStaminaTableMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> Model() => ModelAsync();
        #endif
