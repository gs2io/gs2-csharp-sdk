...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class MaxStaminaTableMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> GetAsync(
            ...
            request
                ...
                .WithMaxStaminaTableName(this._maxStaminaTableName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            ...
            #else
            var result = await this._client.GetMaxStaminaTableMasterAsync(
                request
            );
            #endif
            ...
            if (result.Item != null) {
                _cache.Put(
                    ...
                    Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain.CreateCacheKey(
                        request.MaxStaminaTableName != null ? request.MaxStaminaTableName.ToString() : null
                    ),
                    result.Item,
        ...
        public async Task<Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateMaxStaminaTableMasterAsync(
                request
            );
            #endif
            ...
            Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain.CreateCacheKey(
                    request.MaxStaminaTableName != null ? request.MaxStaminaTableName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Stamina.Model.MaxStaminaTableMaster value = _cache.Get<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Stamina.Model.MaxStaminaTableMaster>(
                _parentKey,
                Gs2.Gs2Stamina.Domain.Model.MaxStaminaTableMasterDomain.CreateCacheKey(
                    this.MaxStaminaTableName?.ToString()
                )
