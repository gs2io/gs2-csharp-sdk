...
namespace Gs2.Gs2Stamina.Domain.Model
{
    ...
    public partial class StaminaModelDomain {
        ...
        private async Task<Gs2.Gs2Stamina.Model.StaminaModel> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetStaminaModelAsync(request)
            );
            return result?.Item;
        }
    ...
    public partial class StaminaModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Stamina.Model.StaminaModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Stamina.Model.StaminaModel>(
                        ...
                        (null as Gs2.Gs2Stamina.Model.StaminaModel).CacheKey(
                            this.StaminaName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Stamina.Model.StaminaModel).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.StaminaName,
                    null
                ...
                return await (null as Gs2.Gs2Stamina.Model.StaminaModel).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.StaminaName,
                    null,
        ...
        public UniTask<Gs2.Gs2Stamina.Model.StaminaModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Stamina.Model.StaminaModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Stamina.Model.StaminaModel> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Stamina.Model.StaminaModel).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.StaminaName,
                null
