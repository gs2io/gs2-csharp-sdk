...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class VerifyStaminaMaxValueByStampTaskResult : IResult
	{
        ...
        public VerifyStaminaMaxValueByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaMaxValueByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
