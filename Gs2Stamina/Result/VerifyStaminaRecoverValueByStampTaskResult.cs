...
#endif
	[System.Serializable]
	public class VerifyStaminaRecoverValueByStampTaskResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyStaminaRecoverValueByStampTaskResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyStaminaRecoverValueByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaRecoverValueByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
