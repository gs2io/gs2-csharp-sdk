...
#endif
	[System.Serializable]
	public class PreUpdateCurrentStaminaMasterResult : IResult
	{
        ...
        public PreUpdateCurrentStaminaMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentStaminaMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
