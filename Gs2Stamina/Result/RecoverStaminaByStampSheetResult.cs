...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class RecoverStaminaByStampSheetResult : IResult
	{
        ...
        public RecoverStaminaByStampSheetResult WithOverflowValue(int? overflowValue) {
            this.OverflowValue = overflowValue;
            return this;
        }

        public RecoverStaminaByStampSheetResult WithMetadata(ResultMetadata metadata) {
