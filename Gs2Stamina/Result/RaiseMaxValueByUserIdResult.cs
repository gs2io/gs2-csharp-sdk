...
#endif
	[System.Serializable]
	public class RaiseMaxValueByUserIdResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public Gs2.Gs2Stamina.Model.StaminaModel StaminaModel { set; get; }
        public ResultMetadata Metadata { set; get; }

        public RaiseMaxValueByUserIdResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public RaiseMaxValueByUserIdResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public RaiseMaxValueByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RaiseMaxValueByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
