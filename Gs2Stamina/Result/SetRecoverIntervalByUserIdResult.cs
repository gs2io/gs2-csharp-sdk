...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class SetRecoverIntervalByUserIdResult : IResult
	{
        ...
        public SetRecoverIntervalByUserIdResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public SetRecoverIntervalByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRecoverIntervalByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
