...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class RecoverStaminaByUserIdResult : IResult
	{
        ...
        public RecoverStaminaByUserIdResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
    	...
    	[Preserve]
#endif
        public static RecoverStaminaByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
