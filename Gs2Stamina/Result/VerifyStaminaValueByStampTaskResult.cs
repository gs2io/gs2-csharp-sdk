...
#endif
	[System.Serializable]
	public class VerifyStaminaValueByStampTaskResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyStaminaValueByStampTaskResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyStaminaValueByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaValueByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
