...
#endif
	[System.Serializable]
	public class SetMaxValueByUserIdResult : IResult
	{
        ...
        public SetMaxValueByUserIdResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public SetMaxValueByUserIdResult WithOld(Gs2.Gs2Stamina.Model.Stamina old) {
            this.Old = old;
            return this;
        }

        public SetMaxValueByUserIdResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public SetMaxValueByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetMaxValueByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
