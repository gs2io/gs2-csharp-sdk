...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class UpdateCurrentStaminaMasterFromGitHubResult : IResult
	{
        ...
        public UpdateCurrentStaminaMasterFromGitHubResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UpdateCurrentStaminaMasterFromGitHubResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
