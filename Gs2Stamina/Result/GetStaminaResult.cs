...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class GetStaminaResult : IResult
	{
        ...
        public GetStaminaResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public GetStaminaResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetStaminaResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
