...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class UpdateRecoverValueTableMasterResult : IResult
	{
        ...
        public UpdateRecoverValueTableMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UpdateRecoverValueTableMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
