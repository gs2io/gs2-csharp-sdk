...
#endif
	[System.Serializable]
	public class VerifyStaminaOverflowValueByStampTaskResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyStaminaOverflowValueByStampTaskResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyStaminaOverflowValueByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyStaminaOverflowValueByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
