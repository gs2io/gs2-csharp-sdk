...
#endif
	[System.Serializable]
	public class SetRecoverIntervalByStatusResult : IResult
	{
        ...
        public SetRecoverIntervalByStatusResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public SetRecoverIntervalByStatusResult WithOld(Gs2.Gs2Stamina.Model.Stamina old) {
            this.Old = old;
            return this;
        }

        public SetRecoverIntervalByStatusResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public SetRecoverIntervalByStatusResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRecoverIntervalByStatusResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
