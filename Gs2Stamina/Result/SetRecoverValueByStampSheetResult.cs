...
#endif
	[System.Serializable]
	public class SetRecoverValueByStampSheetResult : IResult
	{
        ...
        public SetRecoverValueByStampSheetResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public SetRecoverValueByStampSheetResult WithOld(Gs2.Gs2Stamina.Model.Stamina old) {
            this.Old = old;
            return this;
        }

        public SetRecoverValueByStampSheetResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public SetRecoverValueByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRecoverValueByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
