...
#endif
	[System.Serializable]
	public class DecreaseMaxValueResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public Gs2.Gs2Stamina.Model.StaminaModel StaminaModel { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DecreaseMaxValueResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public DecreaseMaxValueResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public DecreaseMaxValueResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DecreaseMaxValueResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
