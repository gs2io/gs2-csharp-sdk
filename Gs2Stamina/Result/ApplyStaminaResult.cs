...
#endif
	[System.Serializable]
	public class ApplyStaminaResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public Gs2.Gs2Stamina.Model.StaminaModel StaminaModel { set; get; }
        public ResultMetadata Metadata { set; get; }

        public ApplyStaminaResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public ApplyStaminaResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public ApplyStaminaResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ApplyStaminaResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
