...
#endif
	[System.Serializable]
	public class SetRecoverValueByStatusResult : IResult
	{
        ...
        public SetRecoverValueByStatusResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public SetRecoverValueByStatusResult WithOld(Gs2.Gs2Stamina.Model.Stamina old) {
            this.Old = old;
            return this;
        }

        public SetRecoverValueByStatusResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public SetRecoverValueByStatusResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRecoverValueByStatusResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
