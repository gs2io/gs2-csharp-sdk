...
#endif
	[System.Serializable]
	public class SetRecoverIntervalByStampSheetResult : IResult
	{
        ...
        public SetRecoverIntervalByStampSheetResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public SetRecoverIntervalByStampSheetResult WithOld(Gs2.Gs2Stamina.Model.Stamina old) {
            this.Old = old;
            return this;
        }

        public SetRecoverIntervalByStampSheetResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public SetRecoverIntervalByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRecoverIntervalByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
