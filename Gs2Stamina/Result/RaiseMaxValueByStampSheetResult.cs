...
#endif
	[System.Serializable]
	public class RaiseMaxValueByStampSheetResult : IResult
	{
        public Gs2.Gs2Stamina.Model.Stamina Item { set; get; }
        public Gs2.Gs2Stamina.Model.StaminaModel StaminaModel { set; get; }
        public ResultMetadata Metadata { set; get; }

        public RaiseMaxValueByStampSheetResult WithItem(Gs2.Gs2Stamina.Model.Stamina item) {
            this.Item = item;
            return this;
        }

        public RaiseMaxValueByStampSheetResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
            this.StaminaModel = staminaModel;
            return this;
        }

        public RaiseMaxValueByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RaiseMaxValueByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
