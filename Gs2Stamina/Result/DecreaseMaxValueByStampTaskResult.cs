...
namespace Gs2.Gs2Stamina.Result
{
	...
	public class DecreaseMaxValueByStampTaskResult : IResult
	{
        ...
        public DecreaseMaxValueByStampTaskResult WithStaminaModel(Gs2.Gs2Stamina.Model.StaminaModel staminaModel) {
        ...
        public DecreaseMaxValueByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DecreaseMaxValueByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
