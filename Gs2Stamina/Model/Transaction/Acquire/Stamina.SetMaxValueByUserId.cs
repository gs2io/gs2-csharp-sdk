...
namespace Gs2.Gs2Stamina.Model.Transaction
{
    public static partial class StaminaExt
    {
        ...
        public static Stamina SpeculativeExecution(
            ...
            clone.MaxValue = request.MaxValue;
            return clone;
        }
        ...
        public static SetMaxValueByUserIdRequest Rate(
            ...
            request.MaxValue = (int?) (request.MaxValue * rate);
            return request;
        }
    }

    public static partial class SetMaxValueByUserIdRequestExt
    {
        public static SetMaxValueByUserIdRequest Rate(
            this SetMaxValueByUserIdRequest request,
            BigInteger rate
        ) {
            request.MaxValue = (int?) ((request.MaxValue ?? 0) * rate);
            return request;
        }
    }
}