...
namespace Gs2.Gs2Stamina.Model.Transaction
{
    public static partial class StaminaExt
    {
        public static bool IsExecutable(
            ...
            switch (request.VerifyType) {
                case "less":
                    return self.OverflowValue < request.Value;
                case "lessEqual":
                    return self.OverflowValue <= request.Value;
                case "greater":
                    return self.OverflowValue > request.Value;
        ...
        public static VerifyStaminaOverflowValueByUserIdRequest Rate(
    ...
    public static partial class VerifyStaminaOverflowValueByUserIdRequestExt
    {
        public static VerifyStaminaOverflowValueByUserIdRequest Rate(
            this VerifyStaminaOverflowValueByUserIdRequest request,
            BigInteger rate
