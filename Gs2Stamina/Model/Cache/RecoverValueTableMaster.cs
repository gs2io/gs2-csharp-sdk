...
namespace Gs2.Gs2Stamina.Model.Cache
{
    public static partial class RecoverValueTableMasterExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<RecoverValueTableMaster> FetchFuture(
            this RecoverValueTableMaster self,
            CacheDatabase cache,
            string namespaceName,
            string recoverValueTableName,
            ...
            return new Gs2InlineFuture<RecoverValueTableMaster>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<RecoverValueTableMaster> FetchAsync(
#else
        public static async Task<RecoverValueTableMaster> FetchAsync(
#endif
            this RecoverValueTableMaster self,
            CacheDatabase cache,
            string namespaceName,
...
#else
            Func<Task<RecoverValueTableMaster>> fetchImpl
#endif
        ) {
            try {
        ...
        public static Tuple<RecoverValueTableMaster, bool> GetCache(
            this RecoverValueTableMaster self,
            CacheDatabase cache,
            string namespaceName,
            string recoverValueTableName,
