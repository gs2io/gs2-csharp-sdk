...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<ApplyStaminaResult> InvokeFuture(
            this ApplyStaminaRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<ApplyStaminaResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<ApplyStaminaResult> self)
            {
            ...
            return new Gs2InlineFuture<ApplyStaminaResult>(Impl);
        }
#endif
