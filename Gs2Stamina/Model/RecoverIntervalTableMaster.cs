...
namespace Gs2.Gs2Stamina.Model
{
	...
	[Preserve]
#endif
	public partial class RecoverIntervalTableMaster : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type RecoverIntervalTableMaster.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(RecoverIntervalTableId, other.RecoverIntervalTableId);
            if (diff != 0)
            {
                return diff;
            }
