	...
	public partial class RecoverValueTableMaster : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type RecoverValueTableMaster.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(RecoverValueTableId, other.RecoverValueTableId);
            if (diff != 0)
            {
                return diff;
            }
