...
namespace Gs2.Gs2LoginReward.Domain.Model
{
    ...
    public partial class BonusDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> ReceiveAsync(
            #else
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> Receive(
            #endif
        #else
        public async Task<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> ReceiveAsync(
        #endif
            ReceiveByUserIdRequest request
        ) {

        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> self)
            {
        #endif
            request
            ...
            return new Gs2InlineFuture<Gs2.Gs2LoginReward.Domain.Model.BonusDomain>(Impl);
        #endif
        }

        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> MissedReceiveAsync(
            #else
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> MissedReceive(
            #endif
        #else
        public async Task<Gs2.Gs2LoginReward.Domain.Model.BonusDomain> MissedReceiveAsync(
        #endif
            ...
            request
                ...
                .WithUserId(this.UserId);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.MissedReceiveByUserIdFuture(
                request
            );
            yield return future;
            if (future.Error != null)
            ...
            var result = future.Result;
            #else
            var result = await this._client.MissedReceiveByUserIdAsync(
                request
            );
            #endif
            var requestModel = request;
