...
namespace Gs2.Gs2LoginReward.Domain.Model
{
    ...
    public partial class BonusAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> ReceiveAsync(
            #else
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> Receive(
            #endif
        #else
        public async Task<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> ReceiveAsync(
        #endif
            ReceiveRequest request
        ) {

        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> self)
            {
        #endif
            request
            ...
            return new Gs2InlineFuture<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain>(Impl);
        #endif
        }

        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> MissedReceiveAsync(
            #else
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> MissedReceive(
            #endif
        #else
        public async Task<Gs2.Gs2LoginReward.Domain.Model.BonusAccessTokenDomain> MissedReceiveAsync(
        #endif
