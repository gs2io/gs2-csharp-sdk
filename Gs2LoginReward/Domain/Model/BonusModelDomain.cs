...
namespace Gs2.Gs2LoginReward.Domain.Model
{
    ...
    public partial class BonusModelDomain {
        ...
        private async UniTask<Gs2.Gs2LoginReward.Model.BonusModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2LoginReward.Model.BonusModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2LoginReward.Model.BonusModel> GetAsync(
            ...
            #else
            var result = await this._client.GetBonusModelAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2LoginReward.Model.BonusModel> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2LoginReward.Model.BonusModel>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2LoginReward.Model.BonusModel>(
                    _parentKey,
                    Gs2.Gs2LoginReward.Domain.Model.BonusModelDomain.CreateCacheKey(
                        this.BonusModelName?.ToString()
                    )
