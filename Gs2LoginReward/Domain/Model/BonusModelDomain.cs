...
namespace Gs2.Gs2LoginReward.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Model.BonusModel> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        _cache.Put<Gs2.Gs2LoginReward.Model.BonusModel>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors[0].Component != "bonusModel")
                        {
                ...
                try {
                    ...
                    if (e.Errors[0].Component != "bonusModel")
                    {
                        throw;
                    }
                }
    ...
    public partial class BonusModelDomain {
        ...
        public IFuture<Gs2.Gs2LoginReward.Model.BonusModel> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Model.BonusModel> self)
            {
                var (value, find) = _cache.Get<Gs2.Gs2LoginReward.Model.BonusModel>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2LoginReward.Model.BonusModel>(
                        _parentKey,
                        Gs2.Gs2LoginReward.Domain.Model.BonusModelDomain.CreateCacheKey(
                            this.BonusModelName?.ToString()
                        )
        ...
        {
            this._cache.Unsubscribe<Gs2.Gs2LoginReward.Model.BonusModel>(
                _parentKey,
                Gs2.Gs2LoginReward.Domain.Model.BonusModelDomain.CreateCacheKey(
                    this.BonusModelName.ToString()
                ),
