...
namespace Gs2.Gs2LoginReward.Domain.Model
{
    ...
    public partial class CurrentBonusMasterDomain {
        ...
        private async Task<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCurrentBonusMasterAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> PreUpdateFuture(
            PreUpdateCurrentBonusMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentBonusMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentBonusMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentBonusMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentBonusMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentBonusMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2LoginReward.Model.CurrentBonusMaster>(
                        (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).CacheParentKey(
                            this.NamespaceName,
                            null
                        ),
                        (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null
                );
                ...
                return await (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetAsync(
        ...
        public UniTask<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2LoginReward.Model.CurrentBonusMaster>(
                (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).CacheParentKey(
                    this.NamespaceName,
                    null
                ),
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> callback)
        #endif
        {
