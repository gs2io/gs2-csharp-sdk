        ...
        private IFuture<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.GetCurrentBonusMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> PreUpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.PreUpdateCurrentBonusMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateCurrentBonusMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Domain.Model.CurrentBonusMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateCurrentBonusMasterFromGitHubFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
    ...
    public partial class CurrentBonusMasterDomain {
        ...
        public IFuture<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2LoginReward.Model.CurrentBonusMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2LoginReward.Model.CurrentBonusMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    () => this.GetFuture(
