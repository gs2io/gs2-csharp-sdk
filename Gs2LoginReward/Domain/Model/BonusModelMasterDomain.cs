...
namespace Gs2.Gs2LoginReward.Domain.Model
{
    ...
    public partial class BonusModelMasterDomain {
        ...
        private async Task<Gs2.Gs2LoginReward.Model.BonusModelMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetBonusModelMasterAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2LoginReward.Domain.Model.BonusModelMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateBonusModelMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2LoginReward.Domain.Model.BonusModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    null,
                    null,
                    () => this._client.DeleteBonusModelMasterAsync(request)
                );
            }
    ...
    public partial class BonusModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2LoginReward.Model.BonusModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2LoginReward.Model.BonusModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2LoginReward.Model.BonusModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2LoginReward.Model.BonusModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2LoginReward.Model.BonusModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.BonusModelName,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2LoginReward.Model.BonusModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2LoginReward.Model.BonusModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2LoginReward.Model.BonusModelMaster> callback)
        #endif
        {
