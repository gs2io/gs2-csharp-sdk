...
namespace Gs2.Gs2LoginReward.Domain.Iterator
{
    ...
    public class DescribeBonusModelMastersIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2LoginReward.Model.BonusModelMaster>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2LoginReward.Model.BonusModelMaster>
    #else
        IAsyncEnumerable<Gs2.Gs2LoginReward.Model.BonusModelMaster>
    #endif
    {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2LoginReward.Model.BonusModelMaster>
            (
                ...
                var request = new Gs2.Gs2LoginReward.Request.DescribeBonusModelMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2LoginReward.Model.BonusModelMaster>(
                        (null as Gs2.Gs2LoginReward.Model.BonusModelMaster).CacheParentKey(
                            NamespaceName,
                            null
                        )
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2LoginReward.Model.BonusModelMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2LoginReward.Model.BonusModelMaster>(async (writer, token) =>
        #else
