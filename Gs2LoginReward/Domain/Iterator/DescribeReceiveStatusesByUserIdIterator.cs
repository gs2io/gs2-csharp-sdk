...
namespace Gs2.Gs2LoginReward.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeReceiveStatusesByUserIdIterator : Gs2Iterator<Gs2.Gs2LoginReward.Model.ReceiveStatus> {
    #else
    public class DescribeReceiveStatusesByUserIdIterator : IAsyncEnumerable<Gs2.Gs2LoginReward.Model.ReceiveStatus> {
    #endif
        ...
        public DescribeReceiveStatusesByUserIdIterator(
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2LoginReward.Model.ReceiveStatus>
            (
                ...
                var request = new Gs2.Gs2LoginReward.Request.DescribeReceiveStatusesByUserIdRequest()
                ...
                var future = this._client.DescribeReceiveStatusesByUserIdFuture(
                #else
                var r = await this._client.DescribeReceiveStatusesByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2LoginReward.Model.ReceiveStatus>(
                        (null as Gs2.Gs2LoginReward.Model.ReceiveStatus).CacheParentKey(
                            NamespaceName,
                            UserId
                        )
