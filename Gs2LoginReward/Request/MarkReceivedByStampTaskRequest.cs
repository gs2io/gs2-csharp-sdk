...
namespace Gs2.Gs2LoginReward.Request
{
	...
	public class MarkReceivedByStampTaskRequest : Gs2Request<MarkReceivedByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static MarkReceivedByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply MarkReceivedByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (MarkReceivedByStampTaskRequest)x;
            return this;
        }
    }
}