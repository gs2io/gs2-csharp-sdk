...
#endif
	[System.Serializable]
	public class GetReceiveStatusByUserIdRequest : Gs2Request<GetReceiveStatusByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetReceiveStatusByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetReceiveStatusByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetReceiveStatusByUserIdRequest)x;
            return this;
        }
    }
}