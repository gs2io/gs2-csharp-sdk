...
namespace Gs2.Gs2LoginReward.Request
{
	...
	public class DeleteReceiveStatusByStampSheetRequest : Gs2Request<DeleteReceiveStatusByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteReceiveStatusByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteReceiveStatusByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteReceiveStatusByStampSheetRequest)x;
            return this;
        }
    }
}