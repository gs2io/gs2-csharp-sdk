...
namespace Gs2.Gs2LoginReward.Request
{
	...
	public class GetReceiveStatusRequest : Gs2Request<GetReceiveStatusRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetReceiveStatusRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetReceiveStatusRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetReceiveStatusRequest)x;
            return this;
        }
    }
}