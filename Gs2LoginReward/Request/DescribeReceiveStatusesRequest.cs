...
namespace Gs2.Gs2LoginReward.Request
{
	...
	public class DescribeReceiveStatusesRequest : Gs2Request<DescribeReceiveStatusesRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeReceiveStatusesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeReceiveStatusesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeReceiveStatusesRequest)x;
            return this;
        }
    }
}