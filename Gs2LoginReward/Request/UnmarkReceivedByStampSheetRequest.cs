...
namespace Gs2.Gs2LoginReward.Request
{
	...
	public class UnmarkReceivedByStampSheetRequest : Gs2Request<UnmarkReceivedByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static UnmarkReceivedByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UnmarkReceivedByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UnmarkReceivedByStampSheetRequest)x;
            return this;
        }
    }
}