...
#endif
	[System.Serializable]
	public class GetBonusModelRequest : Gs2Request<GetBonusModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBonusModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetBonusModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetBonusModelRequest)x;
            return this;
        }
    }
}