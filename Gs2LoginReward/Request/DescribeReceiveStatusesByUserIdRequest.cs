...
#endif
	[System.Serializable]
	public class DescribeReceiveStatusesByUserIdRequest : Gs2Request<DescribeReceiveStatusesByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeReceiveStatusesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeReceiveStatusesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeReceiveStatusesByUserIdRequest)x;
            return this;
        }
    }
}