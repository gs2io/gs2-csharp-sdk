...
#endif
	[System.Serializable]
	public class MissedReceiveRequest : Gs2Request<MissedReceiveRequest>
	{
        ...
        public MissedReceiveRequest WithStepNumber(int? stepNumber) {
            this.StepNumber = stepNumber;
            return this;
        }
        public MissedReceiveRequest WithConfig(Gs2.Gs2LoginReward.Model.Config[] config) {
            this.Config = config;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static MissedReceiveRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply MissedReceiveRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (MissedReceiveRequest)x;
            return this;
        }
    }
}