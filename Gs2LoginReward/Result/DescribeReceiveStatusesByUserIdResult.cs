...
#endif
	[System.Serializable]
	public class DescribeReceiveStatusesByUserIdResult : IResult
	{
        public Gs2.Gs2LoginReward.Model.ReceiveStatus[] Items { set; get; }
        public string NextPageToken { set; get; }

        public DescribeReceiveStatusesByUserIdResult WithItems(Gs2.Gs2LoginReward.Model.ReceiveStatus[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeReceiveStatusesByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeReceiveStatusesByUserIdResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2LoginReward.Model.ReceiveStatus[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2LoginReward.Model.ReceiveStatus.FromJson(v);
                }).ToArray())
