...
#endif
	[System.Serializable]
	public class GetReceiveStatusByUserIdResult : IResult
	{
        ...
        public GetReceiveStatusByUserIdResult WithItem(Gs2.Gs2LoginReward.Model.ReceiveStatus item) {
            this.Item = item;
            return this;
        }

        public GetReceiveStatusByUserIdResult WithBonusModel(Gs2.Gs2LoginReward.Model.BonusModel bonusModel) {
            this.BonusModel = bonusModel;
            return this;
        }

        public GetReceiveStatusByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetReceiveStatusByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
