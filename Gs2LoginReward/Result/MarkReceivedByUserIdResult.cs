...
#endif
	[System.Serializable]
	public class MarkReceivedByUserIdResult : IResult
	{
        ...
        public MarkReceivedByUserIdResult WithItem(Gs2.Gs2LoginReward.Model.ReceiveStatus item) {
            this.Item = item;
            return this;
        }

        public MarkReceivedByUserIdResult WithBonusModel(Gs2.Gs2LoginReward.Model.BonusModel bonusModel) {
            this.BonusModel = bonusModel;
            return this;
        }

        public MarkReceivedByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static MarkReceivedByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
