...
#endif
	[System.Serializable]
	public class UnmarkReceivedByStampSheetResult : IResult
	{
        ...
        public UnmarkReceivedByStampSheetResult WithItem(Gs2.Gs2LoginReward.Model.ReceiveStatus item) {
            this.Item = item;
            return this;
        }

        public UnmarkReceivedByStampSheetResult WithBonusModel(Gs2.Gs2LoginReward.Model.BonusModel bonusModel) {
            this.BonusModel = bonusModel;
            return this;
        }

        public UnmarkReceivedByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UnmarkReceivedByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
