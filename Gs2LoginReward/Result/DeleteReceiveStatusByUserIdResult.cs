...
#endif
	[System.Serializable]
	public class DeleteReceiveStatusByUserIdResult : IResult
	{
        ...
        public DeleteReceiveStatusByUserIdResult WithItem(Gs2.Gs2LoginReward.Model.ReceiveStatus item) {
            this.Item = item;
            return this;
        }

        public DeleteReceiveStatusByUserIdResult WithBonusModel(Gs2.Gs2LoginReward.Model.BonusModel bonusModel) {
            this.BonusModel = bonusModel;
            return this;
        }

        public DeleteReceiveStatusByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteReceiveStatusByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
