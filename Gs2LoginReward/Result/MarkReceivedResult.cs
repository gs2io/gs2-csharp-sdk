...
namespace Gs2.Gs2LoginReward.Result
{
	...
	public class MarkReceivedResult : IResult
	{
        ...
        public MarkReceivedResult WithBonusModel(Gs2.Gs2LoginReward.Model.BonusModel bonusModel) {
            this.BonusModel = bonusModel;
            return this;
        }

        public MarkReceivedResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static MarkReceivedResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
