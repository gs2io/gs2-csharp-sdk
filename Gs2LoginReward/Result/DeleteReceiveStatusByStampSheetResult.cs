...
#endif
	[System.Serializable]
	public class DeleteReceiveStatusByStampSheetResult : IResult
	{
        ...
        public DeleteReceiveStatusByStampSheetResult WithItem(Gs2.Gs2LoginReward.Model.ReceiveStatus item) {
            this.Item = item;
            return this;
        }

        public DeleteReceiveStatusByStampSheetResult WithBonusModel(Gs2.Gs2LoginReward.Model.BonusModel bonusModel) {
            this.BonusModel = bonusModel;
            return this;
        }

        public DeleteReceiveStatusByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteReceiveStatusByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
