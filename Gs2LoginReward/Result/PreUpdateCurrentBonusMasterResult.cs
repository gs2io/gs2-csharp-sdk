...
#endif
	[System.Serializable]
	public class PreUpdateCurrentBonusMasterResult : IResult
	{
        ...
        public PreUpdateCurrentBonusMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentBonusMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
