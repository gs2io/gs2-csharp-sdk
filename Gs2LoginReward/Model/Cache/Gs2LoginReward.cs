...
namespace Gs2.Gs2LoginReward.Model.Cache
{
    public static class Gs2LoginReward
    {
        public static string PutUserData(
            ...
            switch (kind) {
                case "receiveStatus":
                    return Gs2.Gs2LoginReward.Model.ReceiveStatus.FromJson(JsonMapper.ToObject(payload))
        ...
        public static bool SetListCached(
            ...
            switch (kind) {
                case "receiveStatus":
                    cache.SetListCached<Gs2.Gs2LoginReward.Model.ReceiveStatus>(parentKey);
                    return true;
            }
            return false;
        }
