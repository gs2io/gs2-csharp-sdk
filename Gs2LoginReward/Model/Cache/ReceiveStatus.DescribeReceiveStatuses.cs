...
namespace Gs2.Gs2LoginReward.Model.Cache
{
    public static partial class ReceiveStatusExt
    {
        public static void PutCache(
            this DescribeReceiveStatusesResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeReceiveStatusesResult> InvokeFuture(
            this DescribeReceiveStatusesRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DescribeReceiveStatusesResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DescribeReceiveStatusesResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeReceiveStatusesResult>(Impl);
        }
#endif
