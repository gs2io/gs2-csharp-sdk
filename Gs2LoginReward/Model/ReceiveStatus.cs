	...
	public partial class ReceiveStatus : IComparable
	{
        ...
        public static ReceiveStatus FromJson(JsonData data)
        {
            ...
            return new ReceiveStatus()
                ...
                .WithLastReceivedAt(!data.Keys.Contains("lastReceivedAt") || data["lastReceivedAt"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableLong(data["lastReceivedAt"].ToString()))
