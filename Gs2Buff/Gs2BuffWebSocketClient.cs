...
{
	public class Gs2BuffWebSocketClient : AbstractGs2Client
	{
		...
		public Gs2BuffWebSocketClient(Gs2WebSocketSession Gs2WebSocketSession) : base(Gs2WebSocketSession)
		{
        ...
        public class GetBuffEntryModelTask : Gs2WebSocketSessionTask<Request.GetBuffEntryModelRequest, Result.GetBuffEntryModelResult>
        {
	        public GetBuffEntryModelTask(IGs2Session session, Request.GetBuffEntryModelRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.GetBuffEntryModelRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
                ...
                if (request.BuffEntryName != null)
                {
                    jsonWriter.WritePropertyName("buffEntryName");
                    jsonWriter.Write(request.BuffEntryName.ToString());
                }
                if (request.ContextStack != null)
                {
                    jsonWriter.WritePropertyName("contextStack");
        ...
        public class CreateBuffEntryModelMasterTask : Gs2WebSocketSessionTask<Request.CreateBuffEntryModelMasterRequest, Result.CreateBuffEntryModelMasterResult>
        {
	        public CreateBuffEntryModelMasterTask(IGs2Session session, Request.CreateBuffEntryModelMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.CreateBuffEntryModelMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
                ...
                if (request.TargetType != null)
                {
                    ...
                    jsonWriter.Write(request.TargetType.ToString());
                }
                ...
                if (request.ApplyPeriodScheduleEventId != null)
                {
                    ...
                    jsonWriter.Write(request.ApplyPeriodScheduleEventId.ToString());
                }
                if (request.ContextStack != null)
                {
                    jsonWriter.WritePropertyName("contextStack");
        ...
        public class GetBuffEntryModelMasterTask : Gs2WebSocketSessionTask<Request.GetBuffEntryModelMasterRequest, Result.GetBuffEntryModelMasterResult>
        {
	        public GetBuffEntryModelMasterTask(IGs2Session session, Request.GetBuffEntryModelMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.GetBuffEntryModelMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
        ...
        public class UpdateBuffEntryModelMasterTask : Gs2WebSocketSessionTask<Request.UpdateBuffEntryModelMasterRequest, Result.UpdateBuffEntryModelMasterResult>
        {
	        public UpdateBuffEntryModelMasterTask(IGs2Session session, Request.UpdateBuffEntryModelMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.UpdateBuffEntryModelMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
        ...
        public class DeleteBuffEntryModelMasterTask : Gs2WebSocketSessionTask<Request.DeleteBuffEntryModelMasterRequest, Result.DeleteBuffEntryModelMasterResult>
        {
	        public DeleteBuffEntryModelMasterTask(IGs2Session session, Request.DeleteBuffEntryModelMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.DeleteBuffEntryModelMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
        ...
        public class PreUpdateCurrentBuffMasterTask : Gs2WebSocketSessionTask<Request.PreUpdateCurrentBuffMasterRequest, Result.PreUpdateCurrentBuffMasterResult>
        {
	        public PreUpdateCurrentBuffMasterTask(IGs2Session session, Request.PreUpdateCurrentBuffMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.PreUpdateCurrentBuffMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
