...
#endif
	[System.Serializable]
	public class DescribeBuffEntryModelsResult : IResult
	{
        public Gs2.Gs2Buff.Model.BuffEntryModel[] Items { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeBuffEntryModelsResult WithItems(Gs2.Gs2Buff.Model.BuffEntryModel[] items) {
            this.Items = items;
            return this;
        }

        public DescribeBuffEntryModelsResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeBuffEntryModelsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
