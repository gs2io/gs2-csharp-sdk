...
#endif
	[System.Serializable]
	public class PreUpdateCurrentBuffMasterResult : IResult
	{
        ...
        public PreUpdateCurrentBuffMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentBuffMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
