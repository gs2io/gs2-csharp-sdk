...
#endif
	[System.Serializable]
	public class ApplyBuffByUserIdResult : IResult
	{
        public Gs2.Gs2Buff.Model.BuffEntryModel[] Items { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public ApplyBuffByUserIdResult WithItems(Gs2.Gs2Buff.Model.BuffEntryModel[] items) {
            this.Items = items;
            return this;
        }
        ...
        public ApplyBuffByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ApplyBuffByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
