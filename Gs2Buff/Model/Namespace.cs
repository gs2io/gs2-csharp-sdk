...
namespace Gs2.Gs2Buff.Model
{
	...
	public class Namespace : IComparable
	{
        ...
        public Namespace WithLogSetting(Gs2.Gs2Buff.Model.LogSetting logSetting) {
        ...
        private static System.Text.RegularExpressions.Regex _regionRegex = new System.Text.RegularExpressions.Regex(
                @"grn:gs2:(?<region>.+):(?<ownerId>.+):buff:(?<namespaceName>.+)",
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ApplyBuffScript == null && ApplyBuffScript == other.ApplyBuffScript)
            {
                // null and null
            }
            else
            {
                diff += ApplyBuffScript.CompareTo(other.ApplyBuffScript);
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "buff.namespace.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "buff.namespace.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "buff.namespace.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "buff.namespace.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "buff.namespace.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "buff.namespace.revision.error.invalid"),
                    });
                }
