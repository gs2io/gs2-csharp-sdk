...
namespace Gs2.Gs2Buff.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        private IFuture<Gs2.Gs2Buff.Model.Namespace> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Buff.Model.Namespace> self)
            {
                request = request
                    .WithContextStack(string.IsNullOrEmpty(request.ContextStack) ? this._gs2.DefaultContextStack : request.ContextStack)
                    .WithNamespaceName(this.NamespaceName);
            ...
            return new Gs2InlineFuture<Gs2.Gs2Buff.Model.Namespace>(Impl);
        }
        #endif
        ...
        public IFuture<Gs2.Gs2Buff.Domain.Model.BuffEntryModelMasterDomain> CreateBuffEntryModelMasterFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Buff.Domain.Model.BuffEntryModelMasterDomain> self)
            {
                request = request
                    .WithContextStack(string.IsNullOrEmpty(request.ContextStack) ? this._gs2.DefaultContextStack : request.ContextStack)
                    .WithNamespaceName(this.NamespaceName);
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.CreateBuffEntryModelMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
            ...
            return new Gs2InlineFuture<Gs2.Gs2Buff.Domain.Model.BuffEntryModelMasterDomain>(Impl);
        }
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Buff.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Buff.Model.Namespace> self)
            {
                ...
                var future = (null as Gs2.Gs2Buff.Model.Namespace).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    () => this.GetFuture(
        ...
        public async UniTask<Gs2.Gs2Buff.Model.Namespace> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Buff.Model.Namespace> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Buff.Model.Namespace> Model()
        {
            return await ModelAsync();
        }
        #endif
