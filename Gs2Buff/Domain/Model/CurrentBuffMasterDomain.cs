...
namespace Gs2.Gs2Buff.Domain.Model
{
    ...
    public partial class CurrentBuffMasterDomain {
        ...
        public CurrentBuffMasterDomain(
    ...
    public partial class CurrentBuffMasterDomain {
        ...
        private async Task<Gs2.Gs2Buff.Model.CurrentBuffMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                _gs2.Cache,
                null,
                () => this._client.GetCurrentBuffMasterAsync(request)
            );
            return result?.Item;
        }
        #endif
        ...
        public async Task<Gs2.Gs2Buff.Domain.Model.CurrentBuffMasterDomain> PreUpdateAsync(
            ...
            var result = await request.InvokeAsync(
                _gs2.Cache,
                null,
                () => this._client.PreUpdateCurrentBuffMasterAsync(request)
            );
            var domain = this;
            this.UploadToken = domain.UploadToken = result?.UploadToken;
            this.UploadUrl = domain.UploadUrl = result?.UploadUrl;
        ...
        public async Task<Gs2.Gs2Buff.Domain.Model.CurrentBuffMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                _gs2.Cache,
                null,
                () => this._client.UpdateCurrentBuffMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Buff.Domain.Model.CurrentBuffMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                _gs2.Cache,
                null,
                () => this._client.UpdateCurrentBuffMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentBuffMasterDomain {
            ...
            #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Buff.Model.CurrentBuffMaster>(
                        ...
                        (null as Gs2.Gs2Buff.Model.CurrentBuffMaster).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Buff.Model.CurrentBuffMaster).GetCache(
                    this._gs2.Cache,
                ...
                return await (null as Gs2.Gs2Buff.Model.CurrentBuffMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    () => this.GetAsync(
                        new GetCurrentBuffMasterRequest()
        ...
        {
            (null as Gs2.Gs2Buff.Model.CurrentBuffMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName
            );
        }

        public ulong Subscribe(Action<Gs2.Gs2Buff.Model.CurrentBuffMaster> callback)
        {
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2Buff.Model.CurrentBuffMaster>(
                (null as Gs2.Gs2Buff.Model.CurrentBuffMaster).CacheParentKey(
                    this.NamespaceName
                ),
                (null as Gs2.Gs2Buff.Model.CurrentBuffMaster).CacheKey(
