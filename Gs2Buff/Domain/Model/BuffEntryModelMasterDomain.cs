...
namespace Gs2.Gs2Buff.Domain.Model
{
    ...
    public partial class BuffEntryModelMasterDomain {
        ...
        private IFuture<Gs2.Gs2Buff.Model.BuffEntryModelMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Buff.Model.BuffEntryModelMaster> self)
            {
                request = request
            ...
            return new Gs2InlineFuture<Gs2.Gs2Buff.Model.BuffEntryModelMaster>(Impl);
        }
        #endif
    ...
    public partial class BuffEntryModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Buff.Model.BuffEntryModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Buff.Model.BuffEntryModelMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2Buff.Model.BuffEntryModelMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.BuffEntryName,
                    () => this.GetFuture(
        ...
        public async UniTask<Gs2.Gs2Buff.Model.BuffEntryModelMaster> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Buff.Model.BuffEntryModelMaster> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Buff.Model.BuffEntryModelMaster> Model()
        {
            return await ModelAsync();
        }
        #endif
