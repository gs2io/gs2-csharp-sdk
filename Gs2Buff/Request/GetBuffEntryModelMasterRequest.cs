...
#endif
	[System.Serializable]
	public class GetBuffEntryModelMasterRequest : Gs2Request<GetBuffEntryModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBuffEntryModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
