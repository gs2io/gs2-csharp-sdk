...
#endif
	[System.Serializable]
	public class DescribeBuffEntryModelMastersRequest : Gs2Request<DescribeBuffEntryModelMastersRequest>
	{
        ...
        public DescribeBuffEntryModelMastersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeBuffEntryModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
