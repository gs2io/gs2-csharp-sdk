...
namespace Gs2.Gs2Project.Model
{
	...
	[Preserve]
#endif
	public partial class CleanProgress : IComparable
	{
        ...
        public static CleanProgress FromJson(JsonData data)
        {
            ...
            return new CleanProgress()
                ...
                .WithCleaned(!data.Keys.Contains("cleaned") || data["cleaned"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableInt(data["cleaned"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CleanProgress.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(CleanProgressId, other.CleanProgressId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(Cleaned, other.Cleaned);
            if (diff != 0)
            {
                return diff;
            }
