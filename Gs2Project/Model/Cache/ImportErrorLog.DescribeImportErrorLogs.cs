...
namespace Gs2.Gs2Project.Model.Cache
{
    public static partial class ImportErrorLogExt
    {
        public static void PutCache(
            this DescribeImportErrorLogsResult self,
            CacheDatabase cache,
            string userId,
            DescribeImportErrorLogsRequest request
        ) {
            foreach (var item in self.Items ?? Array.Empty<ImportErrorLog>())
            {
                item.PutCache(
                    cache,
                    default,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeImportErrorLogsResult> InvokeFuture(
            this DescribeImportErrorLogsRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DescribeImportErrorLogsResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DescribeImportErrorLogsResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeImportErrorLogsResult>(Impl);
        }
#endif
