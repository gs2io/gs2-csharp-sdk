...
namespace Gs2.Gs2Project.Model.Cache
{
    public static partial class ImportErrorLogExt
    {
        ...
        public static string PutUserData(
            ...
            self.PutCache(
                cache,
                ImportErrorLog.GetAccountNameFromGrn(self.DumpProgressId),
                ImportErrorLog.GetProjectNameFromGrn(self.DumpProgressId),
                ImportErrorLog.GetTransactionIdFromGrn(self.DumpProgressId),
                self.Name,
                timeOffset
            );
