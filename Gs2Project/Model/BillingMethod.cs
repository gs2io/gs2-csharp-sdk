	...
	public partial class BillingMethod : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type BillingMethod.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(BillingMethodId, other.BillingMethodId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(MethodType, other.MethodType);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(CardSignatureName, other.CardSignatureName);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(CardBrand, other.CardBrand);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(CardLast4, other.CardLast4);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(PartnerId, other.PartnerId);
            if (diff != 0)
            {
                return diff;
            }
