	...
	public partial class ImportProgress : IComparable
	{
        ...
        public static ImportProgress FromJson(JsonData data)
        {
            ...
            return new ImportProgress()
                ...
                .WithImported(!data.Keys.Contains("imported") || data["imported"] == null ? null : (int?)(data["imported"].ToString().Contains(".") ? (int)double.Parse(data["imported"].ToString()) : int.Parse(data["imported"].ToString())))
        ...
        public void WriteJson(JsonWriter writer)
        {
            ...
            if (Imported != null) {
                ...
                writer.Write((Imported.ToString().Contains(".") ? (int)double.Parse(Imported.ToString()) : int.Parse(Imported.ToString())));
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type ImportProgress.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(ImportProgressId, other.ImportProgressId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(Imported, other.Imported);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (ImportProgressId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.importProgressId.error.tooLong"),
                    });
                }
            }
            {
                if (TransactionId.Length > 36) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.transactionId.error.tooLong"),
                    });
                }
            }
            {
                if (UserId.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.userId.error.tooLong"),
                    });
                }
            }
            {
                if (Imported < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.imported.error.invalid"),
                    });
                }
                if (Imported > 1000) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
            ...
            }
            {
                if (MicroserviceCount < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.microserviceCount.error.invalid"),
                    });
                }
            ...
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("importProgress", "project.importProgress.revision.error.invalid"),
                    });
                }
