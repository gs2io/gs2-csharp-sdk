...
namespace Gs2.Gs2Project.Result
{
	...
	public class DeleteProjectResult : IResult
	{
        ...
        public DeleteProjectResult WithItem(Gs2.Gs2Project.Model.Project item) {
            this.Item = item;
            return this;
        }

        public DeleteProjectResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteProjectResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
