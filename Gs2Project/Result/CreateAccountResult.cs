...
namespace Gs2.Gs2Project.Result
{
	...
	public class CreateAccountResult : IResult
	{
        ...
        public CreateAccountResult WithItem(Gs2.Gs2Project.Model.Account item) {
            this.Item = item;
            return this;
        }

        public CreateAccountResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CreateAccountResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
