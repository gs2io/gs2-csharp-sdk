...
namespace Gs2.Gs2Project.Request
{
	...
	public class GetBillingMethodRequest : Gs2Request<GetBillingMethodRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBillingMethodRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetBillingMethodRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetBillingMethodRequest)x;
            return this;
        }
    }
}