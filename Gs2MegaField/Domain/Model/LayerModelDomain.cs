...
namespace Gs2.Gs2MegaField.Domain.Model
{
    ...
    public partial class LayerModelDomain {
        ...
        public async Task<Gs2.Gs2MegaField.Model.LayerModel> Model() {
            ...
            {
        #endif
            Gs2.Gs2MegaField.Model.LayerModel value = _cache.Get<Gs2.Gs2MegaField.Model.LayerModel>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2MegaField.Model.LayerModel>(
                                    _parentKey,
                                    Gs2.Gs2MegaField.Domain.Model.LayerModelDomain.CreateCacheKey(
                                        this.LayerModelName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2MegaField.Model.LayerModel>(
                    _parentKey,
                    Gs2.Gs2MegaField.Domain.Model.LayerModelDomain.CreateCacheKey(
                        this.LayerModelName?.ToString()
                    )
