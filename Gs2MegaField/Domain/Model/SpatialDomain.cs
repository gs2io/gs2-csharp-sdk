...
namespace Gs2.Gs2MegaField.Domain.Model
{
    ...
    public partial class SpatialDomain {
        ...
        public UniTask<Gs2.Gs2MegaField.Model.Spatial> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2MegaField.Model.Spatial> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2MegaField.Model.Spatial> Model() => ModelAsync();
        #endif
