...
namespace Gs2.Gs2MegaField.Domain.Model
{
    ...
    public partial class AreaModelMasterDomain {
        ...
        public async Task<Gs2.Gs2MegaField.Domain.Model.LayerModelMasterDomain> CreateLayerModelMasterAsync(
            ...
            #endif
            Gs2.Gs2MegaField.Domain.Model.LayerModelMasterDomain domain = new Gs2.Gs2MegaField.Domain.Model.LayerModelMasterDomain(
                this._cache,
        ...
        public async Task<Gs2.Gs2MegaField.Model.AreaModelMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2MegaField.Model.AreaModelMaster value = _cache.Get<Gs2.Gs2MegaField.Model.AreaModelMaster>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2MegaField.Model.AreaModelMaster>(
                                    _parentKey,
                                    Gs2.Gs2MegaField.Domain.Model.AreaModelMasterDomain.CreateCacheKey(
                                        this.AreaModelName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2MegaField.Model.AreaModelMaster>(
                    _parentKey,
                    Gs2.Gs2MegaField.Domain.Model.AreaModelMasterDomain.CreateCacheKey(
                        this.AreaModelName?.ToString()
                    )
