...
namespace Gs2.Gs2MegaField.Domain.Model
{
    ...
    public partial class AreaModelMasterDomain {
        ...
        #endif
                            callback.Invoke(await LayerModelMastersAsync(
                            ).ToArrayAsync());
                        }
        ...
        #else
        public async Task<ulong> SubscribeLayerModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2MegaField.Model.LayerModelMaster[]> callback
        )
        {
        ...
        public void InvalidateLayerModelMasters(
        )
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2MegaField.Model.LayerModelMaster>(
                (null as Gs2.Gs2MegaField.Model.LayerModelMaster).CacheParentKey(
                    this.NamespaceName,
                    this.AreaModelName,
                    null
    ...
    public partial class AreaModelMasterDomain {
        ...
        ) => CreateLayerModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class AreaModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2MegaField.Model.AreaModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2MegaField.Model.AreaModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2MegaField.Model.AreaModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2MegaField.Model.AreaModelMaster> Model() => ModelAsync();
        #endif
