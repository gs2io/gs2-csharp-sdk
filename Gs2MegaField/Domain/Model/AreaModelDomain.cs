...
namespace Gs2.Gs2MegaField.Domain.Model
{
    ...
    public partial class AreaModelDomain {
        ...
        #endif
                            callback.Invoke(await LayerModelsAsync(
                            ).ToArrayAsync());
                        }
        ...
        #else
        public async Task<ulong> SubscribeLayerModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2MegaField.Model.LayerModel[]> callback
        )
        {
        ...
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2MegaField.Model.LayerModel>(
                (null as Gs2.Gs2MegaField.Model.LayerModel).CacheParentKey(
                    this.NamespaceName,
                    this.AreaModelName,
                    null
    ...
    public partial class AreaModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2MegaField.Model.AreaModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2MegaField.Model.AreaModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2MegaField.Model.AreaModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2MegaField.Model.AreaModel> Model() => ModelAsync();
        #endif
