        ...
        private IFuture<Gs2.Gs2MegaField.Model.CurrentFieldMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2MegaField.Model.CurrentFieldMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.GetCurrentFieldMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> PreUpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.PreUpdateCurrentFieldMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.UpdateCurrentFieldMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    ...
                    null,
                    null,
                    () => this._client.UpdateCurrentFieldMasterFromGitHubFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
    ...
    public partial class CurrentFieldMasterDomain {
        ...
        public IFuture<Gs2.Gs2MegaField.Model.CurrentFieldMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2MegaField.Model.CurrentFieldMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2MegaField.Model.CurrentFieldMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetFuture(
