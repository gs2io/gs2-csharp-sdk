...
namespace Gs2.Gs2MegaField.Domain.Model
{
    ...
    public partial class CurrentFieldMasterDomain {
        ...
        private async Task<Gs2.Gs2MegaField.Model.CurrentFieldMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCurrentFieldMasterAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> PreUpdateFuture(
            PreUpdateCurrentFieldMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentFieldMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentFieldMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentFieldMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2MegaField.Domain.Model.CurrentFieldMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentFieldMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentFieldMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2MegaField.Model.CurrentFieldMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2MegaField.Model.CurrentFieldMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2MegaField.Model.CurrentFieldMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2MegaField.Model.CurrentFieldMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2MegaField.Model.CurrentFieldMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2MegaField.Model.CurrentFieldMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2MegaField.Model.CurrentFieldMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2MegaField.Model.CurrentFieldMaster> callback)
        #endif
        {
