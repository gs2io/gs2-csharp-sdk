...
namespace Gs2.Gs2MegaField.Domain
{
    ...
    public class Gs2MegaField {
        ...
        public IFuture<Gs2.Gs2MegaField.Domain.Model.NamespaceDomain> CreateNamespace(
            CreateNamespaceRequest request
        ) {
        ...
        {
            return this._gs2.Cache.ListSubscribe<Gs2.Gs2MegaField.Model.Namespace>(
                "megaField:Namespace",
                callback
            );
        }
        ...
        {
            this._gs2.Cache.ListUnsubscribe<Gs2.Gs2MegaField.Model.Namespace>(
                "megaField:Namespace",
                callbackId
            );
        }

        public Gs2.Gs2MegaField.Domain.Model.NamespaceDomain Namespace(
            string namespaceName
        ) {
            return new Gs2.Gs2MegaField.Domain.Model.NamespaceDomain(
                this._gs2,
                namespaceName
            );
        }
