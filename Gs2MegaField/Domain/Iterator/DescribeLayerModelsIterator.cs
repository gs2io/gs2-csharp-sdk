...
namespace Gs2.Gs2MegaField.Domain.Iterator
{
    ...
    public class DescribeLayerModelsIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2MegaField.Model.LayerModel>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2MegaField.Model.LayerModel>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2MegaField.Model.LayerModel>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2MegaField.Request.DescribeLayerModelsRequest()
                    .WithContextStack(this._gs2.DefaultContextStack)
                    .WithNamespaceName(this.NamespaceName)
                    .WithAreaModelName(this.AreaModelName);
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                var future = this._client.DescribeLayerModelsFuture(
                #else
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2MegaField.Model.LayerModel>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2MegaField.Model.LayerModel>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2MegaField.Model.LayerModel> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2MegaField.Model.LayerModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2MegaField.Model.LayerModel>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
