...
namespace Gs2.Gs2MegaField.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeLayerModelsIterator : Gs2Iterator<Gs2.Gs2MegaField.Model.LayerModel> {
    #else
    public class DescribeLayerModelsIterator : IAsyncEnumerable<Gs2.Gs2MegaField.Model.LayerModel> {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2MegaField.Model.LayerModel> GetAsyncEnumerator(
