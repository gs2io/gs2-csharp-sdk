...
namespace Gs2.Gs2MegaField.Domain.Iterator
{
    ...
    public class DescribeLayerModelMastersIterator : IAsyncEnumerable<Gs2.Gs2MegaField.Model.LayerModelMaster> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2MegaField.Model.LayerModelMaster>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2MegaField.Model.LayerModelMaster>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeLayerModelMastersFuture(
                #else
                var r = await this._client.DescribeLayerModelMastersAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2MegaField.Model.LayerModelMaster>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2MegaField.Model.LayerModelMaster>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2MegaField.Model.LayerModelMaster ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2MegaField.Model.LayerModelMaster>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2MegaField.Model.LayerModelMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2MegaField.Model.LayerModelMaster>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
