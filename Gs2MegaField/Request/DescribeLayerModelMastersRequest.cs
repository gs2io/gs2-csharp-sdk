...
namespace Gs2.Gs2MegaField.Request
{
	...
	public class DescribeLayerModelMastersRequest : Gs2Request<DescribeLayerModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeLayerModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeLayerModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeLayerModelMastersRequest)x;
            return this;
        }
    }
}