...
namespace Gs2.Gs2MegaField.Request
{
	...
	public class DeleteLayerModelMasterRequest : Gs2Request<DeleteLayerModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteLayerModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteLayerModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteLayerModelMasterRequest)x;
            return this;
        }
    }
}