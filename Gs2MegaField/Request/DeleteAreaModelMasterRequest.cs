...
namespace Gs2.Gs2MegaField.Request
{
	...
	public class DeleteAreaModelMasterRequest : Gs2Request<DeleteAreaModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteAreaModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteAreaModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteAreaModelMasterRequest)x;
            return this;
        }
    }
}