...
#endif
	[System.Serializable]
	public class GetLayerModelMasterRequest : Gs2Request<GetLayerModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetLayerModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetLayerModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetLayerModelMasterRequest)x;
            return this;
        }
    }
}