...
namespace Gs2.Gs2MegaField.Request
{
	...
	public class GetCurrentFieldMasterRequest : Gs2Request<GetCurrentFieldMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentFieldMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentFieldMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentFieldMasterRequest)x;
            return this;
        }
    }
}