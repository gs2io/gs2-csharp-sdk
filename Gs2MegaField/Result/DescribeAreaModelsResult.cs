...
namespace Gs2.Gs2MegaField.Result
{
	...
	public class DescribeAreaModelsResult : IResult
	{
    	...
    	[Preserve]
#endif
        public static DescribeAreaModelsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeAreaModelsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null ? new Gs2.Gs2MegaField.Model.AreaModel[]{} : data["items"].Cast<JsonData>().Select(v => {
