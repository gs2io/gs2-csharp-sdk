...
#endif
	[System.Serializable]
	public class NearUserIdsFromSystemResult : IResult
	{
        public string[] Items { set; get; }
        public ResultMetadata Metadata { set; get; }

        public NearUserIdsFromSystemResult WithItems(string[] items) {
            this.Items = items;
            return this;
        }

        public NearUserIdsFromSystemResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static NearUserIdsFromSystemResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
