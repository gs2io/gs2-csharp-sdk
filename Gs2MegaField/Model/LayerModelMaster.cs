...
namespace Gs2.Gs2MegaField.Model
{
	...
	[Preserve]
#endif
	public partial class LayerModelMaster : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type LayerModelMaster.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(LayerModelMasterId, other.LayerModelMasterId);
            if (diff != 0)
            {
                return diff;
            }
