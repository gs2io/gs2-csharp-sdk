...
namespace Gs2.Gs2MegaField.Model.Cache
{
    public static partial class AreaModelMasterExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeAreaModelMastersResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DescribeAreaModelMastersResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeAreaModelMastersResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<DescribeAreaModelMastersResult> InvokeAsync(
#else
        public static async Task<DescribeAreaModelMastersResult> InvokeAsync(
#endif
            this DescribeAreaModelMastersRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<DescribeAreaModelMastersResult>> invokeImpl
#else
            Func<Task<DescribeAreaModelMastersResult>> invokeImpl
#endif
        )
        {
