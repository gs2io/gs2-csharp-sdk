...
namespace Gs2.Gs2Enhance.Model.Cache
{
    public static partial class ProgressExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<GetProgressByUserIdResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<GetProgressByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<GetProgressByUserIdResult>(Impl);
        }
#endif
