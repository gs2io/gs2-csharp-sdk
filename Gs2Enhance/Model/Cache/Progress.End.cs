...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<EndResult> InvokeFuture(
            this EndRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<EndResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<EndResult> self)
            {
            ...
            return new Gs2InlineFuture<EndResult>(Impl);
        }
#endif
