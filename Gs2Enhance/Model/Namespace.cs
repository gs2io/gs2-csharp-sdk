...
namespace Gs2.Gs2Enhance.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2Enhance.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        public Namespace WithTransactionSettingV2(Gs2.Gs2Enhance.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        public static Namespace FromJson(JsonData data)
        {
            ...
            return new Namespace()
                ...
                .WithTransactionSettingV2(!data.Keys.Contains("transactionSettingV2") || data["transactionSettingV2"] == null ? null : Gs2.Gs2Enhance.Model.TransactionSettingV2.FromJson(data["transactionSettingV2"]))
                ...
                .WithEnableDirectEnhance(!data.Keys.Contains("enableDirectEnhance") || data["enableDirectEnhance"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableBool(data["enableDirectEnhance"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(EnhanceScript, other.EnhanceScript);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(EnableDirectEnhance, other.EnableDirectEnhance);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public object Clone() {
            return new Namespace {
                ...
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2Enhance.Model.TransactionSettingV2,
