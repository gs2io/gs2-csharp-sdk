...
namespace Gs2.Gs2Enhance.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentRateMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentRateMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentRateMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentRateMaster", "enhance.currentRateMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentRateMaster", "enhance.currentRateMaster.settings.error.tooLong"),
                    });
                }
            }
        }
