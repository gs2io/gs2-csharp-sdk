...
namespace Gs2.Gs2Enhance.Model.Transaction
{
    public static partial class EnhanceExt
    {
        ...
        public static RateModel SpeculativeExecution(
            ...
            UnityEngine.Debug.LogWarning("Speculative execution not supported on this action: Gs2Enhance:DirectEnhanceByUserId");
#else
        ...
        public static DirectEnhanceByUserIdRequest Rate(
            ...
            throw new NotSupportedException($"not supported rate action Gs2Enhance:DirectEnhanceByUserId");
        }
    }

    public static partial class DirectEnhanceByUserIdRequestExt
    {
        public static DirectEnhanceByUserIdRequest Rate(
            this DirectEnhanceByUserIdRequest request,
            BigInteger rate
