...
namespace Gs2.Gs2Enhance.Request
{
	...
	public class DirectEnhanceByStampSheetRequest : Gs2Request<DirectEnhanceByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static DirectEnhanceByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DirectEnhanceByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DirectEnhanceByStampSheetRequest)x;
            return this;
        }
    }
}