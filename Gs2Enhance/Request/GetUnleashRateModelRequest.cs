...
namespace Gs2.Gs2Enhance.Request
{
	...
	public class GetUnleashRateModelRequest : Gs2Request<GetUnleashRateModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetUnleashRateModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetUnleashRateModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetUnleashRateModelRequest)x;
            return this;
        }
    }
}