...
namespace Gs2.Gs2Enhance.Request
{
	...
	public class DescribeRateModelsRequest : Gs2Request<DescribeRateModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRateModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRateModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRateModelsRequest)x;
            return this;
        }
    }
}