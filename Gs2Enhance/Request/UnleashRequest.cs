...
#endif
	[System.Serializable]
	public class UnleashRequest : Gs2Request<UnleashRequest>
	{
    	...
    	[Preserve]
#endif
        public static UnleashRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new UnleashRequest()
                ...
                .WithMaterials(!data.Keys.Contains("materials") || data["materials"] == null || !data["materials"].IsArray ? new string[]{} : data["materials"].Cast<JsonData>().Select(v => {
                    return v.ToString();
                }).ToArray())
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UnleashRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UnleashRequest)x;
            return this;
        }
    }
}