...
namespace Gs2.Gs2Enhance.Request
{
	...
	public class DeleteRateModelMasterRequest : Gs2Request<DeleteRateModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteRateModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteRateModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteRateModelMasterRequest)x;
            return this;
        }
    }
}