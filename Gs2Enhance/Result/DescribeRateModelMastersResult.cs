	...
	public class DescribeRateModelMastersResult : IResult
	{
        ...
        public static DescribeRateModelMastersResult FromJson(JsonData data)
        {
            ...
            return new DescribeRateModelMastersResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Enhance.Model.RateModelMaster[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Enhance.Model.RateModelMaster.FromJson(v);
                }).ToArray())
