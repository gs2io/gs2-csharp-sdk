...
namespace Gs2.Gs2Enhance.Result
{
	...
	{
        public Gs2.Gs2Enhance.Model.UnleashRateModel[] Items { set; get; }
        ...
        public static DescribeUnleashRateModelsResult FromJson(JsonData data)
        {
            ...
            return new DescribeUnleashRateModelsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Enhance.Model.UnleashRateModel[]{} : data["items"].Cast<JsonData>().Select(v => {
