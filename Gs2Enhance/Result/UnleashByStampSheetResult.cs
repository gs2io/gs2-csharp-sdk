...
#endif
	[System.Serializable]
	public class UnleashByStampSheetResult : IResult
	{
        public Gs2.Gs2Enhance.Model.UnleashRateModel Item { set; get; }
        ...
        public UnleashByStampSheetResult WithItem(Gs2.Gs2Enhance.Model.UnleashRateModel item) {
            this.Item = item;
            return this;
        }
        ...
        public UnleashByStampSheetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public UnleashByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public UnleashByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public UnleashByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UnleashByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
