...
namespace Gs2.Gs2Enhance.Result
{
	...
	public class DeleteProgressByStampTaskResult : IResult
	{
        ...
        public DeleteProgressByStampTaskResult WithItem(Gs2.Gs2Enhance.Model.Progress item) {
            this.Item = item;
            return this;
        }
        ...
        public DeleteProgressByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteProgressByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
