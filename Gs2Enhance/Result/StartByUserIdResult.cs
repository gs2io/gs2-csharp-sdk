...
namespace Gs2.Gs2Enhance.Result
{
	...
	public class StartByUserIdResult : IResult
	{
        ...
        public StartByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public StartByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public StartByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public StartByUserIdResult WithMetadata(ResultMetadata metadata) {
