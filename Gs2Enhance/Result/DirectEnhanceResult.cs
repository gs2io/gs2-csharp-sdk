...
namespace Gs2.Gs2Enhance.Result
{
	...
	public class DirectEnhanceResult : IResult
	{
        ...
        public DirectEnhanceResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public DirectEnhanceResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
        ...
        public DirectEnhanceResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DirectEnhanceResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
