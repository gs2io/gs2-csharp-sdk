...
#endif
	[System.Serializable]
	public class UnleashResult : IResult
	{
        ...
        public UnleashResult WithItem(Gs2.Gs2Enhance.Model.UnleashRateModel item) {
            this.Item = item;
            return this;
        }
        ...
        public UnleashResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public UnleashResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public UnleashResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public UnleashResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UnleashResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
