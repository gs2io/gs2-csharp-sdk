...
namespace Gs2.Gs2Enhance.Domain.Iterator
{
    ...
    public class DescribeNamespacesIterator : IAsyncEnumerable<Gs2.Gs2Enhance.Model.Namespace> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Enhance.Model.Namespace>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Enhance.Model.Namespace>
                (
                        parentKey
                )
                    .ToArray();
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Enhance.Model.Namespace>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<Gs2.Gs2Enhance.Model.Namespace> callback
        )
        {
