...
namespace Gs2.Gs2Enhance.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Enhance.Model.Namespace>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Enhance.Model.Namespace>
    #else
        IAsyncEnumerable<Gs2.Gs2Enhance.Model.Namespace>
    #endif
    {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Enhance.Model.Namespace>
            (
                ...
                var request = new Gs2.Gs2Enhance.Request.DescribeNamespacesRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Enhance.Model.Namespace>(
                        (null as Gs2.Gs2Enhance.Model.Namespace).CacheParentKey(
                            null
                        )
                    );
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Enhance.Model.Namespace> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Enhance.Model.Namespace>(async (writer, token) =>
        #else
