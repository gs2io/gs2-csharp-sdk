...
namespace Gs2.Gs2Enhance.Domain.Model
{
    ...
    public partial class UnleashRateModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enhance.Model.UnleashRateModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Enhance.Model.UnleashRateModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Enhance.Model.UnleashRateModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Enhance.Model.UnleashRateModel> Model() => ModelAsync();
        #endif
