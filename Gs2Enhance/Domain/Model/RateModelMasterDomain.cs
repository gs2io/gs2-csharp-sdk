...
namespace Gs2.Gs2Enhance.Domain.Model
{
    ...
    public partial class RateModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Enhance.Model.RateModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Enhance.Model.RateModelMaster>(
                        (null as Gs2.Gs2Enhance.Model.RateModelMaster).CacheParentKey(
                            this.NamespaceName,
                            null
                        ),
                        (null as Gs2.Gs2Enhance.Model.RateModelMaster).CacheKey(
                            this.RateName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Enhance.Model.RateModelMaster).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.RateName,
                    null
                ...
                return await (null as Gs2.Gs2Enhance.Model.RateModelMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.RateName,
                    null,
        ...
        public UniTask<Gs2.Gs2Enhance.Model.RateModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Enhance.Model.RateModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Enhance.Model.RateModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Enhance.Model.RateModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.RateName,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Enhance.Model.RateModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Enhance.Model.RateModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Enhance.Model.RateModelMaster> callback)
        #endif
        {
