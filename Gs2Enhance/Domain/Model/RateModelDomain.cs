...
namespace Gs2.Gs2Enhance.Domain.Model
{
    ...
    public partial class RateModelDomain {
        ...
        private async UniTask<Gs2.Gs2Enhance.Model.RateModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Enhance.Model.RateModel> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2Enhance.Model.RateModel> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Enhance.Model.RateModel>(
                       _parentKey,
            ...
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Enhance.Model.RateModel>(
                _parentKey,
                Gs2.Gs2Enhance.Domain.Model.RateModelDomain.CreateCacheKey(
                    this.RateName?.ToString()
                )
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            _cache.Put<Gs2.Gs2Enhance.Model.RateModel>(
                                _parentKey,
                                key,
                                null,
                                UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Enhance.Model.RateModel>(
                    _parentKey,
                    Gs2.Gs2Enhance.Domain.Model.RateModelDomain.CreateCacheKey(
                        this.RateName?.ToString()
                    )
