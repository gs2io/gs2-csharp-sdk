...
namespace Gs2.Gs2Enhance.Domain.Model
{
    ...
    public partial class EnhanceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Enhance.Domain.Model.EnhanceDomain> DirectAsync(
            #else
        public IFuture<Gs2.Gs2Enhance.Domain.Model.EnhanceDomain> Direct(
            #endif
        #else
        public async Task<Gs2.Gs2Enhance.Domain.Model.EnhanceDomain> DirectAsync(
        #endif
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Enhance.Domain.Model.EnhanceDomain> self)
          {
            ...
            return new Gs2InlineFuture<Gs2.Gs2Enhance.Domain.Model.EnhanceDomain>(Impl);
        #endif
        }
