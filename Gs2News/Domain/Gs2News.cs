    ...
    public class Gs2News {
        ...
        public async Task<Gs2.Gs2News.Domain.Model.NamespaceDomain> CreateNamespaceAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2News.Domain.Model.NamespaceDomain> self)
          {
            ...
            Gs2.Gs2News.Domain.Model.NamespaceDomain domain = new Gs2.Gs2News.Domain.Model.NamespaceDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2News.Model.Namespace> Namespaces(
            #else
