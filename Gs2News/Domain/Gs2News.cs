...
namespace Gs2.Gs2News.Domain
{
    ...
    public class Gs2News {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2News.Model.Namespace> NamespacesAsync(
            #else
        ...
        {
            return this._gs2.Cache.ListSubscribe<Gs2.Gs2News.Model.Namespace>(
        ...
        {
            this._gs2.Cache.ListUnsubscribe<Gs2.Gs2News.Model.Namespace>(
                (null as Gs2.Gs2News.Model.Namespace).CacheParentKey(
                    null
                ),
                callbackId
        ...
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2News.Model.Namespace>(
                (null as Gs2.Gs2News.Model.Namespace).CacheParentKey(
                    null
                )
            );
        ...
        public Gs2.Gs2News.Domain.Model.NamespaceDomain Namespace(
            string namespaceName
        ) {
            return new Gs2.Gs2News.Domain.Model.NamespaceDomain(
                this._gs2,
                namespaceName
            );
        }
