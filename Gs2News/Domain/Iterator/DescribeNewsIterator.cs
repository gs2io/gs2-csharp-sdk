...
namespace Gs2.Gs2News.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeNewsIterator : Gs2Iterator<Gs2.Gs2News.Model.News> {
    #else
    public class DescribeNewsIterator : IAsyncEnumerable<Gs2.Gs2News.Model.News> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2News.Model.News[] _result;

        int? fetchSize;

        public DescribeNewsIterator(
            CacheDatabase cache,
            ...
            this._last = false;
            this._result = new Gs2.Gs2News.Model.News[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2News.Model.News>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2News.Model.News>
                (
                        parentKey
                )
                    .ToArray();
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2News.Model.News>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2News.Model.News>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2News.Model.News ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2News.Model.News>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2News.Model.News> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2News.Model.News>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
