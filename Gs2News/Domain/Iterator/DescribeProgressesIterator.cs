...
namespace Gs2.Gs2News.Domain.Iterator
{
    ...
    public class DescribeProgressesIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2News.Model.Progress>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2News.Model.Progress>
    #else
        IAsyncEnumerable<Gs2.Gs2News.Model.Progress>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2News.Request.DescribeProgressesRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2News.Model.Progress>(
                        (null as Gs2.Gs2News.Model.Progress).CacheParentKey(
                            NamespaceName,
                            null
                        )
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2News.Model.Progress> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2News.Model.Progress>(async (writer, token) =>
        #else
