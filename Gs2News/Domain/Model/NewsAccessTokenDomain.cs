...
namespace Gs2.Gs2News.Domain.Model
{
    ...
    public partial class NewsAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2News.Domain.Model.SetCookieRequestEntryAccessTokenDomain[]> WantGrantFuture(
            WantGrantRequest request
        ) => WantGrantAsync(request).ToGs2Future();
        #endif
        ...
        public async Task<Gs2.Gs2News.Domain.Model.SetCookieRequestEntryAccessTokenDomain[]> WantGrantAsync(
            ...
            var domain = result?.Items?.Select(v => new Gs2.Gs2News.Domain.Model.SetCookieRequestEntryAccessTokenDomain(
                ...
                v?.Key,
                v?.Value
            )).ToArray() ?? Array.Empty<Gs2.Gs2News.Domain.Model.SetCookieRequestEntryAccessTokenDomain>();
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2News.Model.News> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2News.Model.News> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2News.Model.News> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2News.Model.News> Model() => ModelAsync();
        #endif
