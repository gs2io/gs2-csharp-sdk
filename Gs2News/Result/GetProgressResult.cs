...
namespace Gs2.Gs2News.Result
{
	...
	public class GetProgressResult : IResult
	{
        ...
        public GetProgressResult WithMetadata(ResultMetadata metadata) {
        ...
        public static GetProgressResult FromJson(JsonData data)
        {
            ...
            return new GetProgressResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2News.Model.Progress.FromJson(data["item"]))
