...
namespace Gs2.Gs2News.Result
{
	...
	{
        public Gs2.Gs2News.Model.Output[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeOutputsResult WithItems(Gs2.Gs2News.Model.Output[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeOutputsResult FromJson(JsonData data)
        {
            ...
            return new DescribeOutputsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2News.Model.Output[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2News.Model.Output.FromJson(v);
                }).ToArray())
