...
namespace Gs2.Gs2News
{
	public class Gs2NewsWebSocketClient : AbstractGs2Client
	{
        ...
        private class UpdateCurrentNewsMasterTask : Gs2WebSocketSessionTask<Request.UpdateCurrentNewsMasterRequest, Result.UpdateCurrentNewsMasterResult>
        {
...
#else
		public async Task<Result.UpdateCurrentNewsMasterResult> UpdateCurrentNewsMaster(
            Request.UpdateCurrentNewsMasterRequest request
        )
		{
		    var task = new UpdateCurrentNewsMasterTask(
