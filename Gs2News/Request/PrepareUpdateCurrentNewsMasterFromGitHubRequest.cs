...
namespace Gs2.Gs2News.Request
{
	...
	public class PrepareUpdateCurrentNewsMasterFromGitHubRequest : Gs2Request<PrepareUpdateCurrentNewsMasterFromGitHubRequest>
	{
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareUpdateCurrentNewsMasterFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareUpdateCurrentNewsMasterFromGitHubRequest)x;
            return this;
        }
    }
}