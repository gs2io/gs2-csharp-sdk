...
namespace Gs2.Gs2News.Request
{
	...
	public class DescribeNewsByUserIdRequest : Gs2Request<DescribeNewsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeNewsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeNewsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeNewsByUserIdRequest)x;
            return this;
        }
    }
}