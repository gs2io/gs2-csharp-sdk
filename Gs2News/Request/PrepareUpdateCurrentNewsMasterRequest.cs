...
namespace Gs2.Gs2News.Request
{
	...
	public class PrepareUpdateCurrentNewsMasterRequest : Gs2Request<PrepareUpdateCurrentNewsMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static PrepareUpdateCurrentNewsMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PrepareUpdateCurrentNewsMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PrepareUpdateCurrentNewsMasterRequest)x;
            return this;
        }
    }
}