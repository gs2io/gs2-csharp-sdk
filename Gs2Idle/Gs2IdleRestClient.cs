...
namespace Gs2.Gs2Idle
{
	public class Gs2IdleRestClient : AbstractGs2Client
	{
        ...
        public class CreateNamespaceTask : Gs2RestSessionTask<CreateNamespaceRequest, CreateNamespaceResult>
        {
            ...
            protected override IGs2SessionRequest CreateRequest(CreateNamespaceRequest request)
            {
                ...
                if (request.OverrideAcquireActionsScriptId != null)
                {
                    ...
                    jsonWriter.Write(request.OverrideAcquireActionsScriptId);
                }
        ...
        public class DecreaseMaximumIdleMinutesTask : Gs2RestSessionTask<DecreaseMaximumIdleMinutesRequest, DecreaseMaximumIdleMinutesResult>
        {
            public DecreaseMaximumIdleMinutesTask(IGs2Session session, RestSessionRequestFactory factory, DecreaseMaximumIdleMinutesRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(DecreaseMaximumIdleMinutesRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class DecreaseMaximumIdleMinutesByUserIdTask : Gs2RestSessionTask<DecreaseMaximumIdleMinutesByUserIdRequest, DecreaseMaximumIdleMinutesByUserIdResult>
        {
            public DecreaseMaximumIdleMinutesByUserIdTask(IGs2Session session, RestSessionRequestFactory factory, DecreaseMaximumIdleMinutesByUserIdRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(DecreaseMaximumIdleMinutesByUserIdRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class SetMaximumIdleMinutesByUserIdTask : Gs2RestSessionTask<SetMaximumIdleMinutesByUserIdRequest, SetMaximumIdleMinutesByUserIdResult>
        {
            public SetMaximumIdleMinutesByUserIdTask(IGs2Session session, RestSessionRequestFactory factory, SetMaximumIdleMinutesByUserIdRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(SetMaximumIdleMinutesByUserIdRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class DecreaseMaximumIdleMinutesByStampTaskTask : Gs2RestSessionTask<DecreaseMaximumIdleMinutesByStampTaskRequest, DecreaseMaximumIdleMinutesByStampTaskResult>
        {
            public DecreaseMaximumIdleMinutesByStampTaskTask(IGs2Session session, RestSessionRequestFactory factory, DecreaseMaximumIdleMinutesByStampTaskRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(DecreaseMaximumIdleMinutesByStampTaskRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
...
#if UNITY_2017_1_OR_NEWER
		public IEnumerator DecreaseMaximumIdleMinutesByStampTask(
                Request.DecreaseMaximumIdleMinutesByStampTaskRequest request,
                UnityAction<AsyncResult<Result.DecreaseMaximumIdleMinutesByStampTaskResult>> callback
        ) =>
            new DecreaseMaximumIdleMinutesByStampTaskTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().ToCoroutine(callback);

		public IFuture<Result.DecreaseMaximumIdleMinutesByStampTaskResult> DecreaseMaximumIdleMinutesByStampTaskFuture(
                Request.DecreaseMaximumIdleMinutesByStampTaskRequest request
        ) =>
            new DecreaseMaximumIdleMinutesByStampTaskTask(
                Gs2RestSession,
    ...
    #if GS2_ENABLE_UNITASK
		public UniTask<Result.DecreaseMaximumIdleMinutesByStampTaskResult> DecreaseMaximumIdleMinutesByStampTaskAsync(
                Request.DecreaseMaximumIdleMinutesByStampTaskRequest request
        ) =>
            new DecreaseMaximumIdleMinutesByStampTaskTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().AsUniTask<Result.DecreaseMaximumIdleMinutesByStampTaskResult>();
    #else
		public DecreaseMaximumIdleMinutesByStampTaskTask DecreaseMaximumIdleMinutesByStampTaskAsync(
                Request.DecreaseMaximumIdleMinutesByStampTaskRequest request
        )
		{
			return new DecreaseMaximumIdleMinutesByStampTaskTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
			    request
            );
    ...
    #endif
#else
		public Task<Result.DecreaseMaximumIdleMinutesByStampTaskResult> DecreaseMaximumIdleMinutesByStampTaskAsync(
                Request.DecreaseMaximumIdleMinutesByStampTaskRequest request
        ) =>
            new DecreaseMaximumIdleMinutesByStampTaskTask(
                Gs2RestSession,
        ...
        public class SetMaximumIdleMinutesByStampSheetTask : Gs2RestSessionTask<SetMaximumIdleMinutesByStampSheetRequest, SetMaximumIdleMinutesByStampSheetResult>
        {
            public SetMaximumIdleMinutesByStampSheetTask(IGs2Session session, RestSessionRequestFactory factory, SetMaximumIdleMinutesByStampSheetRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(SetMaximumIdleMinutesByStampSheetRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class ReceiveByStampSheetTask : Gs2RestSessionTask<ReceiveByStampSheetRequest, ReceiveByStampSheetResult>
        {
            public ReceiveByStampSheetTask(IGs2Session session, RestSessionRequestFactory factory, ReceiveByStampSheetRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(ReceiveByStampSheetRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
...
#if UNITY_2017_1_OR_NEWER
		public IEnumerator ReceiveByStampSheet(
                Request.ReceiveByStampSheetRequest request,
                UnityAction<AsyncResult<Result.ReceiveByStampSheetResult>> callback
        ) =>
            new ReceiveByStampSheetTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().ToCoroutine(callback);

		public IFuture<Result.ReceiveByStampSheetResult> ReceiveByStampSheetFuture(
                Request.ReceiveByStampSheetRequest request
        ) =>
            new ReceiveByStampSheetTask(
                Gs2RestSession,
    ...
    #if GS2_ENABLE_UNITASK
		public UniTask<Result.ReceiveByStampSheetResult> ReceiveByStampSheetAsync(
                Request.ReceiveByStampSheetRequest request
        ) =>
            new ReceiveByStampSheetTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().AsUniTask<Result.ReceiveByStampSheetResult>();
    #else
		public ReceiveByStampSheetTask ReceiveByStampSheetAsync(
                Request.ReceiveByStampSheetRequest request
        )
		{
			return new ReceiveByStampSheetTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
			    request
            );
    ...
    #endif
#else
		public Task<Result.ReceiveByStampSheetResult> ReceiveByStampSheetAsync(
                Request.ReceiveByStampSheetRequest request
        ) =>
            new ReceiveByStampSheetTask(
                Gs2RestSession,
		...
		public IEnumerator GetCurrentCategoryMaster(
            ...
            new GetCurrentCategoryMasterTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().ToCoroutine(callback);
    ...
    #if GS2_ENABLE_UNITASK
		public UniTask<Result.GetCurrentCategoryMasterResult> GetCurrentCategoryMasterAsync(
                Request.GetCurrentCategoryMasterRequest request
        ) =>
            new GetCurrentCategoryMasterTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().AsUniTask<Result.GetCurrentCategoryMasterResult>();
    #else
    ...
    #endif
#else
		public Task<Result.GetCurrentCategoryMasterResult> GetCurrentCategoryMasterAsync(
                Request.GetCurrentCategoryMasterRequest request
        ) =>
            new GetCurrentCategoryMasterTask(
                Gs2RestSession,
        ...
        public class PreUpdateCurrentCategoryMasterTask : Gs2RestSessionTask<PreUpdateCurrentCategoryMasterRequest, PreUpdateCurrentCategoryMasterResult>
        {
            public PreUpdateCurrentCategoryMasterTask(IGs2Session session, RestSessionRequestFactory factory, PreUpdateCurrentCategoryMasterRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(PreUpdateCurrentCategoryMasterRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "idle")
                    .Replace("{region}", Session.Region.DisplayName())
...
#if GS2_ENABLE_UNITASK
            protected override async UniTask<UpdateCurrentCategoryMasterResult> InvokeImpl()
#else
            protected override async Task<UpdateCurrentCategoryMasterResult> InvokeImpl()
#endif
            {
                if (Request.Settings != null) {
                    var preTask = new PreUpdateCurrentCategoryMasterTask(
                        Session,
                        Factory,
		...
		public IEnumerator UpdateCurrentCategoryMaster(
            ...
            new UpdateCurrentCategoryMasterTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().ToCoroutine(callback);
    ...
    #if GS2_ENABLE_UNITASK
		public UniTask<Result.UpdateCurrentCategoryMasterResult> UpdateCurrentCategoryMasterAsync(
                Request.UpdateCurrentCategoryMasterRequest request
        ) =>
            new UpdateCurrentCategoryMasterTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().AsUniTask<Result.UpdateCurrentCategoryMasterResult>();
    #else
    ...
    #endif
#else
		public Task<Result.UpdateCurrentCategoryMasterResult> UpdateCurrentCategoryMasterAsync(
                Request.UpdateCurrentCategoryMasterRequest request
        ) =>
            new UpdateCurrentCategoryMasterTask(
                Gs2RestSession,
		...
		public IEnumerator UpdateCurrentCategoryMasterFromGitHub(
            ...
            new UpdateCurrentCategoryMasterFromGitHubTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().ToCoroutine(callback);
    ...
    #if GS2_ENABLE_UNITASK
		public UniTask<Result.UpdateCurrentCategoryMasterFromGitHubResult> UpdateCurrentCategoryMasterFromGitHubAsync(
                Request.UpdateCurrentCategoryMasterFromGitHubRequest request
        ) =>
            new UpdateCurrentCategoryMasterFromGitHubTask(
                Gs2RestSession,
                new RestSessionRequestFactory(() => new UnityRestSessionRequest(_certificateHandler)),
                request
            ).Invoke().AsUniTask<Result.UpdateCurrentCategoryMasterFromGitHubResult>();
    #else
    ...
    #endif
#else
		public Task<Result.UpdateCurrentCategoryMasterFromGitHubResult> UpdateCurrentCategoryMasterFromGitHubAsync(
                Request.UpdateCurrentCategoryMasterFromGitHubRequest request
        ) =>
            new UpdateCurrentCategoryMasterFromGitHubTask(
                Gs2RestSession,
