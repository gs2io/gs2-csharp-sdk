...
namespace Gs2.Gs2Idle.Model
{
	...
	public partial class CategoryModelMaster : IComparable
	{
        ...
        public string RewardResetMode { set; get; }
        ...
        public void Validate() {
            ...
            {
                switch (RewardResetMode) {
                    case "Reset":
                    case "CarryOver":
                        break;
                    default:
                        throw new Gs2.Core.Exception.BadRequestException(new [] {
                            new RequestError("categoryModelMaster", "idle.categoryModelMaster.rewardResetMode.error.invalid"),
                        });
                }
            }
            {
