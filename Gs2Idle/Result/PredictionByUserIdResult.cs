...
namespace Gs2.Gs2Idle.Result
{
	...
	public class PredictionByUserIdResult : IResult
	{
        ...
        public PredictionByUserIdResult WithItems(Gs2.Core.Model.AcquireAction[] items) {
            this.Items = items;
            return this;
        }

        public PredictionByUserIdResult WithStatus(Gs2.Gs2Idle.Model.Status status) {
            this.Status = status;
            return this;
        }

        public PredictionByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PredictionByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
