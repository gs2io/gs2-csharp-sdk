...
#endif
	[System.Serializable]
	public class ReceiveByStampSheetResult : IResult
	{
        ...
        public ReceiveByStampSheetResult WithItems(Gs2.Core.Model.AcquireAction[] items) {
            this.Items = items;
            return this;
        }

        public ReceiveByStampSheetResult WithStatus(Gs2.Gs2Idle.Model.Status status) {
            this.Status = status;
            return this;
        }
        ...
        public ReceiveByStampSheetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReceiveByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReceiveByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReceiveByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReceiveByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
