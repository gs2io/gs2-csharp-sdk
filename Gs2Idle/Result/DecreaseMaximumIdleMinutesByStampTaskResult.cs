...
namespace Gs2.Gs2Idle.Result
{
	...
	public class DecreaseMaximumIdleMinutesByStampTaskResult : IResult
	{
        ...
        public DecreaseMaximumIdleMinutesByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DecreaseMaximumIdleMinutesByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
