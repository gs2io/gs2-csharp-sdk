...
#endif
	[System.Serializable]
	public class PreUpdateCurrentCategoryMasterResult : IResult
	{
        ...
        public PreUpdateCurrentCategoryMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentCategoryMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
