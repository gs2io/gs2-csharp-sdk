...
namespace Gs2.Gs2Idle.Domain.Model
{
    ...
    public partial class CategoryModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Idle.Model.CategoryModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Idle.Model.CategoryModel>(
                        ...
                        (null as Gs2.Gs2Idle.Model.CategoryModel).CacheKey(
                            this.CategoryName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Idle.Model.CategoryModel).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.CategoryName,
                    null
                ...
                return await (null as Gs2.Gs2Idle.Model.CategoryModel).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.CategoryName,
                    null,
        ...
        public UniTask<Gs2.Gs2Idle.Model.CategoryModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Idle.Model.CategoryModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Idle.Model.CategoryModel> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Idle.Model.CategoryModel).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.CategoryName,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Idle.Model.CategoryModel> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Idle.Model.CategoryModel> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Idle.Model.CategoryModel> callback)
        #endif
        {
