...
namespace Gs2.Gs2Idle.Domain.Model
{
    ...
    public partial class UserAccessTokenDomain {
        ...
        public ulong SubscribeStatuses(
            Action<Gs2.Gs2Idle.Model.Status[]> callback
        )
        {
        ...
        public Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain Status(
            string categoryName
        ) {
            return new Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain(
                this._gs2,
                this.NamespaceName,
                this.AccessToken,
                categoryName
