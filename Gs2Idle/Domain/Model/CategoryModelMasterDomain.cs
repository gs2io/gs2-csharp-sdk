...
namespace Gs2.Gs2Idle.Domain.Model
{
    ...
    public partial class CategoryModelMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Idle.Model.CategoryModelMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Idle.Model.CategoryModelMaster> Get(
            #endif
        #else
        ...
        public async UniTask<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> UpdateAsync(
            #else
        public IFuture<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> Update(
            #endif
        #else
        public async Task<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> UpdateAsync(
            ...
            Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain domain = this;
        ...
        public async UniTask<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> DeleteAsync(
            #else
        public IFuture<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> Delete(
            #endif
        #else
        public async Task<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> DeleteAsync(
            ...
            if (future.Error != null)
            {
                if (future.Error is Gs2.Core.Exception.NotFoundException) {
                    ...
                    _cache.Put<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                        _parentKey,
                        key,
                        null,
                        UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
            ...
            if (resultModel != null) {
                ...
                if (resultModel.Item != null) {
                    ...
                    cache.Delete<Gs2.Gs2Idle.Model.CategoryModelMaster>(parentKey, key);
                }
            }
            Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Idle.Model.CategoryModelMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                       _parentKey,
            ...
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                _parentKey,
                Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain.CreateCacheKey(
                    this.CategoryName?.ToString()
                )
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                    _parentKey,
                    Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain.CreateCacheKey(
                        this.CategoryName?.ToString()
                    )
