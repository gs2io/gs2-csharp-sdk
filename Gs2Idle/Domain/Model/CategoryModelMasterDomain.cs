...
namespace Gs2.Gs2Idle.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Idle.Model.CategoryModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                            _parentKey,
                            key,
                            null,
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Idle.Model.CategoryModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class CategoryModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2Idle.Model.CategoryModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Idle.Model.CategoryModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Idle.Model.CategoryModelMaster>(
                        _parentKey,
                        Gs2.Gs2Idle.Domain.Model.CategoryModelMasterDomain.CreateCacheKey(
                            this.CategoryName?.ToString()
                        )
