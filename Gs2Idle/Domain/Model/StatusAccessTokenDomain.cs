...
namespace Gs2.Gs2Idle.Domain.Model
{
    ...
    public partial class StatusAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain> ReceiveAsync(
            #else
        public IFuture<Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain> Receive(
            #endif
        #else
        public async Task<Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain> ReceiveAsync(
        #endif
            ReceiveRequest request
        ) {

        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain> self)
            {
        #endif
            request
                .WithNamespaceName(this.NamespaceName)
            ...
            return new Gs2InlineFuture<Gs2.Gs2Idle.Domain.Model.StatusAccessTokenDomain>(Impl);
        #endif
        }
