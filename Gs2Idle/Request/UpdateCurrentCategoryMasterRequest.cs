...
namespace Gs2.Gs2Idle.Request
{
	...
	public class UpdateCurrentCategoryMasterRequest : Gs2Request<UpdateCurrentCategoryMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentCategoryMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentCategoryMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentCategoryMasterRequest)x;
            return this;
        }
    }
}