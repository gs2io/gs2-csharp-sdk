...
namespace Gs2.Gs2Idle.Request
{
	...
	public class DecreaseMaximumIdleMinutesByStampTaskRequest : Gs2Request<DecreaseMaximumIdleMinutesByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static DecreaseMaximumIdleMinutesByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DecreaseMaximumIdleMinutesByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DecreaseMaximumIdleMinutesByStampTaskRequest)x;
            return this;
        }
    }
}