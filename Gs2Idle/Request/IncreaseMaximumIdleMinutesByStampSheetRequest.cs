...
#endif
	[System.Serializable]
	public class IncreaseMaximumIdleMinutesByStampSheetRequest : Gs2Request<IncreaseMaximumIdleMinutesByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static IncreaseMaximumIdleMinutesByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply IncreaseMaximumIdleMinutesByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (IncreaseMaximumIdleMinutesByStampSheetRequest)x;
            return this;
        }
    }
}