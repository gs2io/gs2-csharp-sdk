...
namespace Gs2.Gs2Idle.Request
{
	...
	public class GetCurrentCategoryMasterRequest : Gs2Request<GetCurrentCategoryMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentCategoryMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentCategoryMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentCategoryMasterRequest)x;
            return this;
        }
    }
}