...
namespace Gs2.Gs2Idle.Request
{
	...
	public class GetCategoryModelRequest : Gs2Request<GetCategoryModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCategoryModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCategoryModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCategoryModelRequest)x;
            return this;
        }
    }
}