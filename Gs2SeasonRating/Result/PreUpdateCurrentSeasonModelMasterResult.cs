...
#endif
	[System.Serializable]
	public class PreUpdateCurrentSeasonModelMasterResult : IResult
	{
        ...
        public PreUpdateCurrentSeasonModelMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentSeasonModelMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
