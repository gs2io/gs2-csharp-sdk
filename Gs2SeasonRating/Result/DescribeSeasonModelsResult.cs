	...
	public class DescribeSeasonModelsResult : IResult
	{
        ...
        public static DescribeSeasonModelsResult FromJson(JsonData data)
        {
            ...
            return new DescribeSeasonModelsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2SeasonRating.Model.SeasonModel[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2SeasonRating.Model.SeasonModel.FromJson(v);
                }).ToArray());
        }
