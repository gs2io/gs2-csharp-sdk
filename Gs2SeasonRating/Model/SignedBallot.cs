        ...
        public void Validate() {
            {
                if (Body.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("signedBallot", "seasonRating.signedBallot.body.error.tooLong"),
                    });
                }
            }
            {
                if (Signature.Length > 256) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("signedBallot", "seasonRating.signedBallot.signature.error.tooLong"),
                    });
                }
            }
        }
