...
#endif
	[System.Serializable]
	public class DeleteSeasonModelMasterRequest : Gs2Request<DeleteSeasonModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteSeasonModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
