...
{
	public class Gs2SeasonRatingRestClient : AbstractGs2Client
	{
#if UNITY_2017_1_OR_NEWER
		...
		public Gs2SeasonRatingRestClient(Gs2RestSession Gs2RestSession) : base(Gs2RestSession)
		{

		}

#if UNITY_2017_1_OR_NEWER
		public Gs2SeasonRatingRestClient(Gs2RestSession gs2RestSession, CertificateHandler certificateHandler) : base(gs2RestSession)
		{
        ...
        public class DescribeMatchSessionsTask : Gs2RestSessionTask<DescribeMatchSessionsRequest, DescribeMatchSessionsResult>
        {
            public DescribeMatchSessionsTask(IGs2Session session, RestSessionRequestFactory factory, DescribeMatchSessionsRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(DescribeMatchSessionsRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class CreateMatchSessionTask : Gs2RestSessionTask<CreateMatchSessionRequest, CreateMatchSessionResult>
        {
            public CreateMatchSessionTask(IGs2Session session, RestSessionRequestFactory factory, CreateMatchSessionRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(CreateMatchSessionRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
                ...
                if (request.SessionName != null)
                {
                    ...
                    jsonWriter.Write(request.SessionName);
                }
        ...
        public class GetMatchSessionTask : Gs2RestSessionTask<GetMatchSessionRequest, GetMatchSessionResult>
        {
            public GetMatchSessionTask(IGs2Session session, RestSessionRequestFactory factory, GetMatchSessionRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(GetMatchSessionRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
                ...
                url = url.Replace("{namespaceName}", !string.IsNullOrEmpty(request.NamespaceName) ? request.NamespaceName.ToString() : "null");
                url = url.Replace("{sessionName}", !string.IsNullOrEmpty(request.SessionName) ? request.SessionName.ToString() : "null");
        ...
        public class DeleteMatchSessionTask : Gs2RestSessionTask<DeleteMatchSessionRequest, DeleteMatchSessionResult>
        {
            public DeleteMatchSessionTask(IGs2Session session, RestSessionRequestFactory factory, DeleteMatchSessionRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(DeleteMatchSessionRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class GetCurrentSeasonModelMasterTask : Gs2RestSessionTask<GetCurrentSeasonModelMasterRequest, GetCurrentSeasonModelMasterResult>
        {
            public GetCurrentSeasonModelMasterTask(IGs2Session session, RestSessionRequestFactory factory, GetCurrentSeasonModelMasterRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(GetCurrentSeasonModelMasterRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class PreUpdateCurrentSeasonModelMasterTask : Gs2RestSessionTask<PreUpdateCurrentSeasonModelMasterRequest, PreUpdateCurrentSeasonModelMasterResult>
        {
            public PreUpdateCurrentSeasonModelMasterTask(IGs2Session session, RestSessionRequestFactory factory, PreUpdateCurrentSeasonModelMasterRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(PreUpdateCurrentSeasonModelMasterRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
        ...
        public class UpdateCurrentSeasonModelMasterTask : Gs2RestSessionTask<UpdateCurrentSeasonModelMasterRequest, UpdateCurrentSeasonModelMasterResult>
        {
        ...
        public class UpdateCurrentSeasonModelMasterFromGitHubTask : Gs2RestSessionTask<UpdateCurrentSeasonModelMasterFromGitHubRequest, UpdateCurrentSeasonModelMasterFromGitHubResult>
        {
            public UpdateCurrentSeasonModelMasterFromGitHubTask(IGs2Session session, RestSessionRequestFactory factory, UpdateCurrentSeasonModelMasterFromGitHubRequest request) : base(session, factory, request)
            {
            }

            protected override IGs2SessionRequest CreateRequest(UpdateCurrentSeasonModelMasterFromGitHubRequest request)
            {
                var url = Gs2RestSession.EndpointHost
                    .Replace("{service}", "season-rating")
                    .Replace("{region}", Session.Region.DisplayName())
