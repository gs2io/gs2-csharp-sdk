...
#endif
	[System.Serializable]
	public class GetCampaignModelRequest : Gs2Request<GetCampaignModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCampaignModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCampaignModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCampaignModelRequest)x;
            return this;
        }
    }
}