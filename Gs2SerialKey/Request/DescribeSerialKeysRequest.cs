...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class DescribeSerialKeysRequest : Gs2Request<DescribeSerialKeysRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeSerialKeysRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSerialKeysRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSerialKeysRequest)x;
            return this;
        }
    }
}