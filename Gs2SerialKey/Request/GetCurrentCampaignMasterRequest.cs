...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class GetCurrentCampaignMasterRequest : Gs2Request<GetCurrentCampaignMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentCampaignMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentCampaignMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentCampaignMasterRequest)x;
            return this;
        }
    }
}