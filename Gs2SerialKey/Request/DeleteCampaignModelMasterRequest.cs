...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class DeleteCampaignModelMasterRequest : Gs2Request<DeleteCampaignModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteCampaignModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteCampaignModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteCampaignModelMasterRequest)x;
            return this;
        }
    }
}