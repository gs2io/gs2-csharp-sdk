...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class DescribeCampaignModelsRequest : Gs2Request<DescribeCampaignModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeCampaignModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCampaignModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCampaignModelsRequest)x;
            return this;
        }
    }
}