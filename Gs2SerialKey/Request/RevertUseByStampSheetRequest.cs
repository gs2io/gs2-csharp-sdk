...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class RevertUseByStampSheetRequest : Gs2Request<RevertUseByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static RevertUseByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RevertUseByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RevertUseByStampSheetRequest)x;
            return this;
        }
    }
}