...
#endif
	[System.Serializable]
	public class DescribeSerialCodesRequest : Gs2Request<DescribeSerialCodesRequest>
	{
        ...
        public DescribeSerialCodesRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSerialCodesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
