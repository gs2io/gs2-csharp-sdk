...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class DescribeIssueJobsRequest : Gs2Request<DescribeIssueJobsRequest>
	{
        ...
        public DescribeIssueJobsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeIssueJobsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeIssueJobsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeIssueJobsRequest)x;
            return this;
        }
    }
}