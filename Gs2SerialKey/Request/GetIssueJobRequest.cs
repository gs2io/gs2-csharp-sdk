...
namespace Gs2.Gs2SerialKey.Request
{
	...
	public class GetIssueJobRequest : Gs2Request<GetIssueJobRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetIssueJobRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetIssueJobRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetIssueJobRequest)x;
            return this;
        }
    }
}