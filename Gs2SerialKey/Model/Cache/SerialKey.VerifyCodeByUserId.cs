...
namespace Gs2.Gs2SerialKey.Model.Cache
{
    public static partial class SerialKeyExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<VerifyCodeByUserIdResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<VerifyCodeByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<VerifyCodeByUserIdResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<VerifyCodeByUserIdResult> InvokeAsync(
#else
        public static async Task<VerifyCodeByUserIdResult> InvokeAsync(
#endif
            this VerifyCodeByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<VerifyCodeByUserIdResult>> invokeImpl
#else
            Func<Task<VerifyCodeByUserIdResult>> invokeImpl
#endif
        )
        {
