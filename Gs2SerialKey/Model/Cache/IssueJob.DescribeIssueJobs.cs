...
namespace Gs2.Gs2SerialKey.Model.Cache
{
    public static partial class IssueJobExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeIssueJobsResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DescribeIssueJobsResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeIssueJobsResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<DescribeIssueJobsResult> InvokeAsync(
#else
        public static async Task<DescribeIssueJobsResult> InvokeAsync(
#endif
            this DescribeIssueJobsRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<DescribeIssueJobsResult>> invokeImpl
#else
            Func<Task<DescribeIssueJobsResult>> invokeImpl
#endif
        )
        {
