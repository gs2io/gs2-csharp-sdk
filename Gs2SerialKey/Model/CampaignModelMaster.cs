...
namespace Gs2.Gs2SerialKey.Model
{
	...
	[Preserve]
#endif
	public partial class CampaignModelMaster : IComparable
	{
        ...
        public static CampaignModelMaster FromJson(JsonData data)
        {
            ...
            return new CampaignModelMaster()
                ...
                .WithEnableCampaignCode(!data.Keys.Contains("enableCampaignCode") || data["enableCampaignCode"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableBool(data["enableCampaignCode"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CampaignModelMaster.", nameof(obj));
            }
            var diff = 0;
