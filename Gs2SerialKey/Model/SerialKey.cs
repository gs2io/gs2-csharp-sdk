	...
	public partial class SerialKey : IComparable
	{
        ...
        public static SerialKey FromJson(JsonData data)
        {
            ...
            return new SerialKey()
                ...
                .WithUsedAt(!data.Keys.Contains("usedAt") || data["usedAt"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableLong(data["usedAt"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type SerialKey.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(SerialKeyId, other.SerialKeyId);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(CampaignModelName, other.CampaignModelName);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(Code, other.Code);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(UsedUserId, other.UsedUserId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(UsedAt, other.UsedAt);
            if (diff != 0)
            {
                return diff;
            }
