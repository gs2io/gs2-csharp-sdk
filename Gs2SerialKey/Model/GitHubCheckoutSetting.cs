        ...
        public void Validate() {
            {
                if (ApiKeyId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.apiKeyId.error.tooLong"),
                    });
                }
            }
            {
                if (RepositoryName.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.repositoryName.error.tooLong"),
                    });
                }
            }
            {
                if (SourcePath.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.sourcePath.error.tooLong"),
                    });
                }
            }
            {
                switch (ReferenceType) {
                    ...
                    default:
                        throw new Gs2.Core.Exception.BadRequestException(new [] {
                            new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.referenceType.error.invalid"),
                        });
                }
            }
            if (ReferenceType == "commit_hash") {
                if (CommitHash.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.commitHash.error.tooLong"),
                    });
                }
            }
            if (ReferenceType == "branch") {
                if (BranchName.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.branchName.error.tooLong"),
                    });
                }
            }
            if (ReferenceType == "tag") {
                if (TagName.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("gitHubCheckoutSetting", "serialKey.gitHubCheckoutSetting.tagName.error.tooLong"),
                    });
                }
            }
        }
