...
#endif
	[System.Serializable]
	public class GetSerialKeyResult : IResult
	{
        ...
        public GetSerialKeyResult WithItem(Gs2.Gs2SerialKey.Model.SerialKey item) {
            this.Item = item;
            return this;
        }

        public GetSerialKeyResult WithCampaignModel(Gs2.Gs2SerialKey.Model.CampaignModel campaignModel) {
            this.CampaignModel = campaignModel;
            return this;
        }

        public GetSerialKeyResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetSerialKeyResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
