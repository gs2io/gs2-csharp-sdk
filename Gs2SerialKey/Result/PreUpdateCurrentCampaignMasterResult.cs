...
#endif
	[System.Serializable]
	public class PreUpdateCurrentCampaignMasterResult : IResult
	{
        ...
        public PreUpdateCurrentCampaignMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentCampaignMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
