...
namespace Gs2.Gs2SerialKey.Result
{
	...
	public class UseByUserIdResult : IResult
	{
        ...
        public UseByUserIdResult WithCampaignModel(Gs2.Gs2SerialKey.Model.CampaignModel campaignModel) {
            this.CampaignModel = campaignModel;
            return this;
        }

        public UseByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UseByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
