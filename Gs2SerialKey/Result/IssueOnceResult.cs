...
#endif
	[System.Serializable]
	public class IssueOnceResult : IResult
	{
        public Gs2.Gs2SerialKey.Model.SerialKey Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public IssueOnceResult WithItem(Gs2.Gs2SerialKey.Model.SerialKey item) {
            this.Item = item;
            return this;
        }

        public IssueOnceResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IssueOnceResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
