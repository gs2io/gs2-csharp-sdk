...
namespace Gs2.Gs2SerialKey.Result
{
	...
	public class UseByStampTaskResult : IResult
	{
        ...
        public UseByStampTaskResult WithCampaignModel(Gs2.Gs2SerialKey.Model.CampaignModel campaignModel) {
        ...
        public UseByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UseByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
