...
namespace Gs2.Gs2SerialKey.Result
{
	...
	{
        public Gs2.Gs2SerialKey.Model.Namespace[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeNamespacesResult WithItems(Gs2.Gs2SerialKey.Model.Namespace[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeNamespacesResult FromJson(JsonData data)
        {
            ...
            return new DescribeNamespacesResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2SerialKey.Model.Namespace[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2SerialKey.Model.Namespace.FromJson(v);
                }).ToArray())
