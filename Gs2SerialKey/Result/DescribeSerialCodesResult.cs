...
#endif
	[System.Serializable]
	public class DescribeSerialCodesResult : IResult
	{
        public string[] Items { set; get; }
        public string NextPageToken { set; get; }

        public DescribeSerialCodesResult WithItems(string[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSerialCodesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
