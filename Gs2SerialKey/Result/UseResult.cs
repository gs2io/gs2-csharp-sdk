...
#endif
	[System.Serializable]
	public class UseResult : IResult
	{
        ...
        public UseResult WithItem(Gs2.Gs2SerialKey.Model.SerialKey item) {
            this.Item = item;
            return this;
        }

        public UseResult WithCampaignModel(Gs2.Gs2SerialKey.Model.CampaignModel campaignModel) {
            this.CampaignModel = campaignModel;
            return this;
        }

        public UseResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UseResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
