...
#endif
	[System.Serializable]
	public class RevertUseByUserIdResult : IResult
	{
        ...
        public RevertUseByUserIdResult WithItem(Gs2.Gs2SerialKey.Model.SerialKey item) {
            this.Item = item;
            return this;
        }

        public RevertUseByUserIdResult WithCampaignModel(Gs2.Gs2SerialKey.Model.CampaignModel campaignModel) {
            this.CampaignModel = campaignModel;
            return this;
        }

        public RevertUseByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RevertUseByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
