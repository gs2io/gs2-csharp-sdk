...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "serialKey:Namespace";
        }
    ...
    public partial class NamespaceDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2SerialKey.Model.Namespace>(
                            _parentKey,
                            key,
                            null,
        ...
        public IFuture<Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain> GetStatus(
            GetNamespaceStatusRequest request
        ) {
        ...
        public IFuture<Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain> Update(
            UpdateNamespaceRequest request
        ) {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (resultModel != null) {
                    
                    {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2SerialKey.Model.Namespace>(parentKey, key);
                    }
                }
                var domain = this;
        ...
        public IFuture<Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain> Delete(
            DeleteNamespaceRequest request
        ) {
        ...
        public IFuture<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> CreateCampaignModelMasterFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName);
                var future = this._client.CreateCampaignModelMasterFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
        ...
        public async Task<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> CreateCampaignModelMasterAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName);
            CreateCampaignModelMasterResult result = null;
                result = await this._client.CreateCampaignModelMasterAsync(
                    request
                );
        ...
        #if UNITY_2017_1_OR_NEWER
        [Obsolete("The name has been changed to CreateCampaignModelMasterFuture.")]
        public IFuture<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> CreateCampaignModelMaster(
            CreateCampaignModelMasterRequest request
        ) {
            return CreateCampaignModelMasterFuture(request);
        }
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        public IFuture<Gs2.Gs2SerialKey.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Model.Namespace> self)
            {
                ...
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2SerialKey.Model.Namespace>(
                    parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2SerialKey.Model.Namespace>(
                        parentKey,
                        Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain.CreateCacheKey(
                            this.NamespaceName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2SerialKey.Model.Namespace>(
                _parentKey,
                Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName.ToString()
                )
