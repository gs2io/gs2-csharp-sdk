...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public async Task<Gs2.Gs2SerialKey.Model.Namespace> Model() {
            ...
            Gs2.Gs2SerialKey.Model.Namespace value = _cache.Get<Gs2.Gs2SerialKey.Model.Namespace>(
                parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2SerialKey.Model.Namespace>(
                                    _parentKey,
                                    Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain.CreateCacheKey(
                                        this.NamespaceName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2SerialKey.Model.Namespace>(
                    parentKey,
                    Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain.CreateCacheKey(
                        this.NamespaceName?.ToString()
                    )
