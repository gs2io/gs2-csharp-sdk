...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        private async UniTask<Gs2.Gs2SerialKey.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2SerialKey.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2SerialKey.Model.Namespace> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2SerialKey.Model.Namespace>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2SerialKey.Model.Namespace>(
                    parentKey,
                    Gs2.Gs2SerialKey.Domain.Model.NamespaceDomain.CreateCacheKey(
                        this.NamespaceName?.ToString()
                    )
