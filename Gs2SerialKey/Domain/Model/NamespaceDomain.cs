...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #endif
                            callback.Invoke(await CampaignModelsAsync(
                            ).ToArrayAsync());
                        }
        ...
        #else
        public async Task<ulong> SubscribeCampaignModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2SerialKey.Model.CampaignModel[]> callback
        )
        {
        ...
        public void InvalidateCampaignModels(
        )
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2SerialKey.Model.CampaignModel>(
                (null as Gs2.Gs2SerialKey.Model.CampaignModel).CacheParentKey(
                    this.NamespaceName,
                    null
                )
                ...
                () =>
                {
                    ...
                    async Task Impl() {
                        ...
                        try {
                            ...
                            await UniTask.SwitchToMainThread();
        #endif
                            callback.Invoke(await CampaignModelMastersAsync(
                                namePrefix
                            ).ToArrayAsync());
                        }
                        catch (System.Exception) {
        ...
        #else
        public async Task<ulong> SubscribeCampaignModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2SerialKey.Model.CampaignModelMaster[]> callback,
            string namePrefix = null
        )
        ...
        public void InvalidateCampaignModelMasters(
            string namePrefix = null
        )
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2SerialKey.Model.CampaignModelMaster>(
                (null as Gs2.Gs2SerialKey.Model.CampaignModelMaster).CacheParentKey(
                    this.NamespaceName,
                    null
                )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateCampaignModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2SerialKey.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2SerialKey.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2SerialKey.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2SerialKey.Model.Namespace> Model() => ModelAsync();
        #endif
