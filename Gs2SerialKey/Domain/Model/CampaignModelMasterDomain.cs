...
namespace Gs2.Gs2SerialKey.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Model.CampaignModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2SerialKey.Model.CampaignModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "campaignModelMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2SerialKey.Model.CampaignModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class CampaignModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2SerialKey.Model.CampaignModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2SerialKey.Model.CampaignModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2SerialKey.Model.CampaignModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2SerialKey.Model.CampaignModelMaster>(
                        _parentKey,
                        Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain.CreateCacheKey(
                            this.CampaignModelName?.ToString()
                        )
