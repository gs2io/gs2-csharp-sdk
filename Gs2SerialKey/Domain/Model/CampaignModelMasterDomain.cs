...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class CampaignModelMasterDomain {
        ...
        #if GS2_ENABLE_UNITASK
        private async UniTask<Gs2.Gs2SerialKey.Model.CampaignModelMaster> GetAsync(
        #else
        private async Task<Gs2.Gs2SerialKey.Model.CampaignModelMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCampaignModelMasterAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCampaignModelMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2SerialKey.Domain.Model.CampaignModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    null,
                    null,
                    () => this._client.DeleteCampaignModelMasterAsync(request)
                );
            }
    ...
    public partial class CampaignModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2SerialKey.Model.CampaignModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2SerialKey.Model.CampaignModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2SerialKey.Model.CampaignModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2SerialKey.Model.CampaignModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2SerialKey.Model.CampaignModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.CampaignModelName,
                null
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2SerialKey.Model.CampaignModelMaster>(
                (null as Gs2.Gs2SerialKey.Model.CampaignModelMaster).CacheParentKey(
                    this.NamespaceName,
                    null
                ),
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2SerialKey.Model.CampaignModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2SerialKey.Model.CampaignModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2SerialKey.Model.CampaignModelMaster> callback)
        #endif
        {
