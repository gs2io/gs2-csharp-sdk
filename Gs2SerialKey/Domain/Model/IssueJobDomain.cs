...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class IssueJobDomain {
        ...
        private async UniTask<Gs2.Gs2SerialKey.Model.IssueJob> GetAsync(
            #else
        private IFuture<Gs2.Gs2SerialKey.Model.IssueJob> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2SerialKey.Model.IssueJob> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2SerialKey.Model.IssueJob>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2SerialKey.Model.IssueJob>(
                    _parentKey,
                    Gs2.Gs2SerialKey.Domain.Model.IssueJobDomain.CreateCacheKey(
                        this.IssueJobName?.ToString()
                    )
