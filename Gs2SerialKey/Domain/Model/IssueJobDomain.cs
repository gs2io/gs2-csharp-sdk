...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class IssueJobDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2SerialKey.Model.IssueJob> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2SerialKey.Model.IssueJob> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2SerialKey.Model.IssueJob> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2SerialKey.Model.IssueJob> Model() => ModelAsync();
        #endif
