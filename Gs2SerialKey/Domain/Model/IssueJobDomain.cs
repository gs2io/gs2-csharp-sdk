...
namespace Gs2.Gs2SerialKey.Domain.Model
{
    ...
    public partial class IssueJobDomain {
        ...
        public async Task<Gs2.Gs2SerialKey.Model.IssueJob> Model() {
            ...
            {
        #endif
            Gs2.Gs2SerialKey.Model.IssueJob value = _cache.Get<Gs2.Gs2SerialKey.Model.IssueJob>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2SerialKey.Model.IssueJob>(
                                    _parentKey,
                                    Gs2.Gs2SerialKey.Domain.Model.IssueJobDomain.CreateCacheKey(
                                        this.IssueJobName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2SerialKey.Model.IssueJob>(
                    _parentKey,
                    Gs2.Gs2SerialKey.Domain.Model.IssueJobDomain.CreateCacheKey(
                        this.IssueJobName?.ToString()
                    )
