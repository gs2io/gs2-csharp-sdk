...
namespace Gs2.Gs2SerialKey.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeSerialCodesIterator : Gs2Iterator<string> {
    #else
    public class DescribeSerialCodesIterator : IAsyncEnumerable<string> {
    #endif
        ...
        public DescribeSerialCodesIterator(
            CacheDatabase cache,
        ...
        private async Task _load() {
        #endif
            string parentKey = "serialKey:campaign:" + this._campaignModelName + ":issueJob:" + this._issueJobName;
            ...
            (
                ...
                var future = this._client.DescribeSerialCodesFuture(
                #else
                var r = await this._client.DescribeSerialCodesAsync(
                #endif
                    new Gs2.Gs2SerialKey.Request.DescribeSerialCodesRequest()
