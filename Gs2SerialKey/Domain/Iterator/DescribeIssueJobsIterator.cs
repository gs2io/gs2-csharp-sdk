...
namespace Gs2.Gs2SerialKey.Domain.Iterator
{
    ...
    public class DescribeIssueJobsIterator : IAsyncEnumerable<Gs2.Gs2SerialKey.Model.IssueJob> {
        ...
        private bool _last;
        private Gs2.Gs2SerialKey.Model.IssueJob[] _result;

        int? fetchSize;

        public DescribeIssueJobsIterator(
            CacheDatabase cache,
            ...
            this._last = false;
            this._result = new Gs2.Gs2SerialKey.Model.IssueJob[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2SerialKey.Model.IssueJob>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2SerialKey.Model.IssueJob>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeIssueJobsFuture(
                #else
                var r = await this._client.DescribeIssueJobsAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2SerialKey.Model.IssueJob>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2SerialKey.Model.IssueJob>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2SerialKey.Model.IssueJob ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2SerialKey.Model.IssueJob>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2SerialKey.Model.IssueJob> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2SerialKey.Model.IssueJob>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
