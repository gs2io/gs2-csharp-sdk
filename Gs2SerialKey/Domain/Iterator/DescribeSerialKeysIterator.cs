...
namespace Gs2.Gs2SerialKey.Domain.Iterator
{
    ...
    public class DescribeSerialKeysIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2SerialKey.Model.SerialKey>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2SerialKey.Model.SerialKey>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2SerialKey.Model.SerialKey>
    #endif
    {
        ...
        public DescribeSerialKeysIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2SerialKey.Model.SerialKey[]{};
        }
        ...
        private async Task _load() {
            ...
            (
                ...
                this._result = list
                    .Where(item => this.CampaignModelName == null || item.CampaignModelName == this.CampaignModelName)
                    .ToArray();
                this._pageToken = null;
                this._last = true;
            } else {
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2SerialKey.Model.SerialKey>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2SerialKey.Model.SerialKey>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2SerialKey.Model.SerialKey> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2SerialKey.Model.SerialKey> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2SerialKey.Model.SerialKey>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
