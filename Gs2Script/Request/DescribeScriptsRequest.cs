...
namespace Gs2.Gs2Script.Request
{
	...
	public class DescribeScriptsRequest : Gs2Request<DescribeScriptsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeScriptsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeScriptsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeScriptsRequest)x;
            return this;
        }
    }
}