...
namespace Gs2.Gs2Script.Request
{
	...
	public class DeleteScriptRequest : Gs2Request<DeleteScriptRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteScriptRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteScriptRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteScriptRequest)x;
            return this;
        }
    }
}