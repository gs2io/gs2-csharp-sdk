...
namespace Gs2.Gs2Script.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeNamespacesIterator : Gs2Iterator<Gs2.Gs2Script.Model.Namespace> {
    #else
    public class DescribeNamespacesIterator : IAsyncEnumerable<Gs2.Gs2Script.Model.Namespace> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2Script.Model.Namespace[] _result;
        ...
        public DescribeNamespacesIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Script.Model.Namespace[]{};
        }
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Script.Request.DescribeNamespacesRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Script.Model.Namespace>(
                        (null as Gs2.Gs2Script.Model.Namespace).CacheParentKey(
                            null
                        )
                    );
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Script.Model.Namespace>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Script.Model.Namespace>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Script.Model.Namespace> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Script.Model.Namespace> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Script.Model.Namespace>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
