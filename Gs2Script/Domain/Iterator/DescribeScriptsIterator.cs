...
namespace Gs2.Gs2Script.Domain.Iterator
{
    ...
    public class DescribeScriptsIterator : IAsyncEnumerable<Gs2.Gs2Script.Model.Script> {
        ...
        private bool _last;
        private Gs2.Gs2Script.Model.Script[] _result;
        ...
        public DescribeScriptsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Script.Model.Script[]{};
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._cache.TryGetList<Gs2.Gs2Script.Model.Script>
            (
                    parentKey,
                    out var list
            )) {
                ...
                var future = this._client.DescribeScriptsFuture(
                #else
                var r = await this._client.DescribeScriptsAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.SetListCached<Gs2.Gs2Script.Model.Script>(
                            parentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Script.Model.Script>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Script.Model.Script ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Script.Model.Script>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Script.Model.Script> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Script.Model.Script>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
