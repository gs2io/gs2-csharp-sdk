	...
	public partial class Script : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Script.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.Compare(DisableStringNumberToNumber, other.DisableStringNumberToNumber);
            if (diff != 0)
            {
                return diff;
            }
