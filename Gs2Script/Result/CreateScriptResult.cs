...
#endif
	[System.Serializable]
	public class CreateScriptResult : IResult
	{
        public Gs2.Gs2Script.Model.Script Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public CreateScriptResult WithItem(Gs2.Gs2Script.Model.Script item) {
            this.Item = item;
            return this;
        }

        public CreateScriptResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CreateScriptResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
