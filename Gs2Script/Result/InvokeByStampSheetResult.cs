...
#endif
	[System.Serializable]
	public class InvokeByStampSheetResult : IResult
	{
        ...
        public InvokeByStampSheetResult WithCode(int? code) {
            this.Code = code;
            return this;
        }
        ...
        public InvokeByStampSheetResult WithRandomStatus(Gs2.Gs2Script.Model.RandomStatus randomStatus) {
            this.RandomStatus = randomStatus;
            return this;
        }

        public InvokeByStampSheetResult WithExecuteTime(int? executeTime) {
            this.ExecuteTime = executeTime;
            return this;
        }

        public InvokeByStampSheetResult WithCharged(int? charged) {
            this.Charged = charged;
            return this;
        }

        public InvokeByStampSheetResult WithOutput(string[] output) {
            this.Output = output;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static InvokeByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
