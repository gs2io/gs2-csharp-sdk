...
namespace Gs2.Gs2Script.Result
{
	...
	public class InvokeScriptResult : IResult
	{
        ...
        public InvokeScriptResult WithTransaction(Gs2.Gs2Script.Model.Transaction_ transaction) {
        ...
        public InvokeScriptResult WithAtomicCommit(bool? atomicCommit) {
            this.AtomicCommit = atomicCommit;
            return this;
        }

        public InvokeScriptResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
        ...
        public InvokeScriptResult WithMetadata(ResultMetadata metadata) {
