...
namespace Gs2.Gs2Dictionary.Model.Cache
{
    public static partial class EntryExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<ResetByUserIdResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<ResetByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<ResetByUserIdResult>(Impl);
        }
#endif
