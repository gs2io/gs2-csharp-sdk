...
namespace Gs2.Gs2Dictionary.Model
{
	...
	[Preserve]
#endif
	public partial class EntryModel : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type EntryModel.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(EntryModelId, other.EntryModelId);
            if (diff != 0)
            {
                return diff;
            }
