...
namespace Gs2.Gs2Dictionary.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentEntryMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentEntryMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentEntryMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentEntryMaster", "dictionary.currentEntryMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentEntryMaster", "dictionary.currentEntryMaster.settings.error.tooLong"),
                    });
                }
            }
        }
