...
namespace Gs2.Gs2Dictionary.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "dictionary:Namespace";
        }
        ...
        {
            return this._cache.ListSubscribe<Gs2.Gs2Dictionary.Model.EntryModel>(
                Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "EntryModel"
                ),
                callback
        ...
        {
            this._cache.ListUnsubscribe<Gs2.Gs2Dictionary.Model.EntryModel>(
                Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "EntryModel"
                ),
        ...
        public ulong SubscribeEntryModelMasters(Action callback)
        {
            return this._cache.ListSubscribe<Gs2.Gs2Dictionary.Model.EntryModelMaster>(
                Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "EntryModelMaster"
                ),
        ...
        public void UnsubscribeEntryModelMasters(ulong callbackId)
        {
            this._cache.ListUnsubscribe<Gs2.Gs2Dictionary.Model.EntryModelMaster>(
                Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "EntryModelMaster"
                ),
    ...
    public partial class NamespaceDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        _cache.Put<Gs2.Gs2Dictionary.Model.Namespace>(
                            _parentKey,
                            key,
                            null,
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (resultModel != null) {
                    
                    {
                        ...
                        cache.Delete<Gs2.Gs2Dictionary.Model.Namespace>(parentKey, key);
                    }
                }
                var domain = this;
        ...
        public IFuture<Gs2.Gs2Dictionary.Domain.Model.EntryModelMasterDomain> CreateEntryModelMasterFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Dictionary.Domain.Model.EntryModelMasterDomain> self)
            {
                ...
                request
                    .WithNamespaceName(this.NamespaceName);
                CreateEntryModelMasterResult result = null;
                    result = await this._client.CreateEntryModelMasterAsync(
                        request
                    );
                #endif
        ...
        public async UniTask<Gs2.Gs2Dictionary.Domain.Model.EntryModelMasterDomain> CreateEntryModelMasterAsync(
            ...
            var future = CreateEntryModelMasterFuture(request);
            await future;
            if (future.Error != null) {
                throw future.Error;
            }
            ...
            #endif
        [Obsolete("The name has been changed to CreateEntryModelMasterFuture.")]
        public IFuture<Gs2.Gs2Dictionary.Domain.Model.EntryModelMasterDomain> CreateEntryModelMaster(
            CreateEntryModelMasterRequest request
        ) {
            return CreateEntryModelMasterFuture(request);
        }
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        public IFuture<Gs2.Gs2Dictionary.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Dictionary.Model.Namespace> self)
            {
                ...
                var (value, find) = _cache.Get<Gs2.Gs2Dictionary.Model.Namespace>(
                    parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Dictionary.Model.Namespace>(
                        parentKey,
                        Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain.CreateCacheKey(
                            this.NamespaceName?.ToString()
                        )
        ...
        {
            this._cache.Unsubscribe<Gs2.Gs2Dictionary.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Dictionary.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName.ToString()
                ),
