...
namespace Gs2.Gs2Dictionary.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeEntriesByUserIdIterator : Gs2Iterator<Gs2.Gs2Dictionary.Model.Entry> {
    #else
    public class DescribeEntriesByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Dictionary.Model.Entry> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2Dictionary.Model.Entry[] _result;
        ...
        public DescribeEntriesByUserIdIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Dictionary.Model.Entry[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Dictionary.Model.Entry>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Dictionary.Model.Entry>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeEntriesByUserIdFuture(
                #else
                var r = await this._client.DescribeEntriesByUserIdAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Dictionary.Model.Entry>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Dictionary.Model.Entry>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Dictionary.Model.Entry ret = this._result[0];
