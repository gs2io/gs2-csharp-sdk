...
namespace Gs2.Gs2Dictionary.Result
{
	...
	public class UpdateCurrentEntryMasterFromGitHubResult : IResult
	{
        ...
        public UpdateCurrentEntryMasterFromGitHubResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UpdateCurrentEntryMasterFromGitHubResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
