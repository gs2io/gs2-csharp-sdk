...
#endif
	[System.Serializable]
	public class DescribeEntriesResult : IResult
	{
        public Gs2.Gs2Dictionary.Model.Entry[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeEntriesResult WithItems(Gs2.Gs2Dictionary.Model.Entry[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeEntriesResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeEntriesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
