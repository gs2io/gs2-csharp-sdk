...
#endif
	[System.Serializable]
	public class DescribeLikesResult : IResult
	{
        public Gs2.Gs2Dictionary.Model.Like[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeLikesResult WithItems(Gs2.Gs2Dictionary.Model.Like[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeLikesResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeLikesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
