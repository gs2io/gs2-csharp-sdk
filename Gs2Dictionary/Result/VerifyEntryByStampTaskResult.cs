...
#endif
	[System.Serializable]
	public class VerifyEntryByStampTaskResult : IResult
	{
        ...
        public VerifyEntryByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyEntryByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
