...
#endif
	[System.Serializable]
	public class PreUpdateCurrentEntryMasterResult : IResult
	{
        ...
        public PreUpdateCurrentEntryMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentEntryMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
