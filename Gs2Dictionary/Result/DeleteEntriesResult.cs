...
#endif
	[System.Serializable]
	public class DeleteEntriesResult : IResult
	{
        public Gs2.Gs2Dictionary.Model.Entry[] Items { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DeleteEntriesResult WithItems(Gs2.Gs2Dictionary.Model.Entry[] items) {
            this.Items = items;
            return this;
        }

        public DeleteEntriesResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteEntriesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
