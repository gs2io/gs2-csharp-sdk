...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class DescribeEntriesRequest : Gs2Request<DescribeEntriesRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeEntriesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeEntriesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeEntriesRequest)x;
            return this;
        }
    }
}