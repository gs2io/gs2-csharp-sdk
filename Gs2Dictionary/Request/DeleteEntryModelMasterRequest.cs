...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class DeleteEntryModelMasterRequest : Gs2Request<DeleteEntryModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteEntryModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteEntryModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteEntryModelMasterRequest)x;
            return this;
        }
    }
}