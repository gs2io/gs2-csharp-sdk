...
#endif
	[System.Serializable]
	public class DeleteLikesByUserIdRequest : Gs2Request<DeleteLikesByUserIdRequest>
	{
        ...
        public DeleteLikesByUserIdRequest WithEntryModelNames(string[] entryModelNames) {
    	...
    	[Preserve]
#endif
        public static DeleteLikesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
