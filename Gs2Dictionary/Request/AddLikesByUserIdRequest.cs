...
#endif
	[System.Serializable]
	public class AddLikesByUserIdRequest : Gs2Request<AddLikesByUserIdRequest>
	{
        ...
        public AddLikesByUserIdRequest WithEntryModelNames(string[] entryModelNames) {
    	...
    	[Preserve]
#endif
        public static AddLikesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
