...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class GetCurrentEntryMasterRequest : Gs2Request<GetCurrentEntryMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentEntryMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentEntryMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentEntryMasterRequest)x;
            return this;
        }
    }
}