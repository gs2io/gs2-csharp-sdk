...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class VerifyEntryByStampTaskRequest : Gs2Request<VerifyEntryByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyEntryByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyEntryByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyEntryByStampTaskRequest)x;
            return this;
        }
    }
}