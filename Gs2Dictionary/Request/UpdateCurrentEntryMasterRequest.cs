...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class UpdateCurrentEntryMasterRequest : Gs2Request<UpdateCurrentEntryMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentEntryMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentEntryMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentEntryMasterRequest)x;
            return this;
        }
    }
}