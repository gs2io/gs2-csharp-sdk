...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class UpdateEntryModelMasterRequest : Gs2Request<UpdateEntryModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateEntryModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateEntryModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateEntryModelMasterRequest)x;
            return this;
        }
    }
}