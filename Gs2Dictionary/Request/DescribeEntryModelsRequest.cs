...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class DescribeEntryModelsRequest : Gs2Request<DescribeEntryModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeEntryModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeEntryModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeEntryModelsRequest)x;
            return this;
        }
    }
}