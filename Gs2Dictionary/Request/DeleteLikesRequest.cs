...
#endif
	[System.Serializable]
	public class DeleteLikesRequest : Gs2Request<DeleteLikesRequest>
	{
        ...
        public DeleteLikesRequest WithEntryModelNames(string[] entryModelNames) {
    	...
    	[Preserve]
#endif
        public static DeleteLikesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
