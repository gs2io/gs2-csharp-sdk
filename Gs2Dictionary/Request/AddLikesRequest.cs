...
#endif
	[System.Serializable]
	public class AddLikesRequest : Gs2Request<AddLikesRequest>
	{
        ...
        public AddLikesRequest WithEntryModelNames(string[] entryModelNames) {
    	...
    	[Preserve]
#endif
        public static AddLikesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
