...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class GetEntryWithSignatureRequest : Gs2Request<GetEntryWithSignatureRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetEntryWithSignatureRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetEntryWithSignatureRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetEntryWithSignatureRequest)x;
            return this;
        }
    }
}