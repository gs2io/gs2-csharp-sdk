...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class GetEntryModelMasterRequest : Gs2Request<GetEntryModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetEntryModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetEntryModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetEntryModelMasterRequest)x;
            return this;
        }
    }
}