...
namespace Gs2.Gs2Dictionary.Request
{
	...
	public class AddEntriesByStampSheetRequest : Gs2Request<AddEntriesByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AddEntriesByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AddEntriesByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AddEntriesByStampSheetRequest)x;
            return this;
        }
    }
}