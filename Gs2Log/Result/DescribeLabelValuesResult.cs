...
#endif
	[System.Serializable]
	public class DescribeLabelValuesResult : IResult
	{
        public Gs2.Gs2Log.Model.Label[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeLabelValuesResult WithItems(Gs2.Gs2Log.Model.Label[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeLabelValuesResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeLabelValuesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
