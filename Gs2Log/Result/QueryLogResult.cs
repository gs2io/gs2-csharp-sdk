...
#endif
	[System.Serializable]
	public class QueryLogResult : IResult
	{
        public Gs2.Gs2Log.Model.LogEntry[] Items { set; get; }
        public int? TotalEntryCount { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public QueryLogResult WithItems(Gs2.Gs2Log.Model.LogEntry[] items) {
            this.Items = items;
            return this;
        }

        public QueryLogResult WithTotalEntryCount(int? totalEntryCount) {
        ...
        public QueryLogResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static QueryLogResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public void WriteJson(JsonWriter writer)
        {
            ...
            if (TotalEntryCount != null) {
                writer.WritePropertyName("totalEntryCount");
                writer.Write((TotalEntryCount.ToString().Contains(".") ? (int)double.Parse(TotalEntryCount.ToString()) : int.Parse(TotalEntryCount.ToString())));
            }
