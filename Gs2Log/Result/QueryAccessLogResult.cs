...
#endif
	[System.Serializable]
	public class QueryAccessLogResult : IResult
	{
        public Gs2.Gs2Log.Model.AccessLog[] Items { set; get; }
        public string NextPageToken { set; get; }
        public long? TotalCount { set; get; }
        public long? ScanSize { set; get; }
        public ResultMetadata Metadata { set; get; }

        public QueryAccessLogResult WithItems(Gs2.Gs2Log.Model.AccessLog[] items) {
            this.Items = items;
            return this;
        }
        ...
        public QueryAccessLogResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static QueryAccessLogResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new QueryAccessLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? null : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Log.Model.AccessLog.FromJson(v);
                }).ToArray())
