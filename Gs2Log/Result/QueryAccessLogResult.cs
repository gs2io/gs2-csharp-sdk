...
namespace Gs2.Gs2Log.Result
{
	...
	{
        public Gs2.Gs2Log.Model.AccessLog[] Items { set; get; } = null!;
        ...
        public static QueryAccessLogResult FromJson(JsonData data)
        {
            ...
            return new QueryAccessLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Log.Model.AccessLog[]{} : data["items"].Cast<JsonData>().Select(v => {
