...
namespace Gs2.Gs2Log.Result
{
	...
	{
        public Gs2.Gs2Log.Model.AccessLogCount[] Items { set; get; } = null!;
        ...
        public static CountAccessLogResult FromJson(JsonData data)
        {
            ...
            return new CountAccessLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Log.Model.AccessLogCount[]{} : data["items"].Cast<JsonData>().Select(v => {
