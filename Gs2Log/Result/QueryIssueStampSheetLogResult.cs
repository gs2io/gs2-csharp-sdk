...
namespace Gs2.Gs2Log.Result
{
	...
	{
        public Gs2.Gs2Log.Model.IssueStampSheetLog[] Items { set; get; } = null!;
        ...
        public static QueryIssueStampSheetLogResult FromJson(JsonData data)
        {
            ...
            return new QueryIssueStampSheetLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Log.Model.IssueStampSheetLog[]{} : data["items"].Cast<JsonData>().Select(v => {
