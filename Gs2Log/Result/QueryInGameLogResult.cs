...
#endif
	[System.Serializable]
	public class QueryInGameLogResult : IResult
	{
        public Gs2.Gs2Log.Model.InGameLog[] Items { set; get; }
        public string NextPageToken { set; get; }
        public long? TotalCount { set; get; }
        public long? ScanSize { set; get; }
        public ResultMetadata Metadata { set; get; }

        public QueryInGameLogResult WithItems(Gs2.Gs2Log.Model.InGameLog[] items) {
            this.Items = items;
            return this;
        }
        ...
        public QueryInGameLogResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static QueryInGameLogResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new QueryInGameLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? null : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Log.Model.InGameLog.FromJson(v);
                }).ToArray())
