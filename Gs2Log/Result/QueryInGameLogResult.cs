...
namespace Gs2.Gs2Log.Result
{
	...
	{
        public Gs2.Gs2Log.Model.InGameLog[] Items { set; get; } = null!;
        ...
        public static QueryInGameLogResult FromJson(JsonData data)
        {
            ...
            return new QueryInGameLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Log.Model.InGameLog[]{} : data["items"].Cast<JsonData>().Select(v => {
