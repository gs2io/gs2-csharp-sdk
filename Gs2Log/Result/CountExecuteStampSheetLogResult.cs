...
namespace Gs2.Gs2Log.Result
{
	...
	{
        public Gs2.Gs2Log.Model.ExecuteStampSheetLogCount[] Items { set; get; } = null!;
        ...
        public static CountExecuteStampSheetLogResult FromJson(JsonData data)
        {
            ...
            return new CountExecuteStampSheetLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Log.Model.ExecuteStampSheetLogCount[]{} : data["items"].Cast<JsonData>().Select(v => {
