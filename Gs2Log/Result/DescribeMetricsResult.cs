...
#endif
	[System.Serializable]
	public class DescribeMetricsResult : IResult
	{
        public Gs2.Gs2Log.Model.MetricModel[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeMetricsResult WithItems(Gs2.Gs2Log.Model.MetricModel[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeMetricsResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeMetricsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeMetricsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? null : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Log.Model.MetricModel.FromJson(v);
                }).ToArray())
