...
namespace Gs2.Gs2Log.Result
{
	...
	{
        public Gs2.Gs2Log.Model.ExecuteStampSheetLog[] Items { set; get; } = null!;
        ...
        public static QueryExecuteStampSheetLogResult FromJson(JsonData data)
        {
            ...
            return new QueryExecuteStampSheetLogResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Log.Model.ExecuteStampSheetLog[]{} : data["items"].Cast<JsonData>().Select(v => {
