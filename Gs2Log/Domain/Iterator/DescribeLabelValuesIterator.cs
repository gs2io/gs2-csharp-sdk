    ...
    public class DescribeLabelValuesIterator : IAsyncEnumerable<Gs2.Gs2Log.Model.Label> {
        ...
        private async Task _load() {
            ...
            (
                ...
                this._result = list
                    .Where(item => this.LabelNamePrefix == null || item.Key.StartsWith(this.LabelNamePrefix))
                    .ToArray();
                this._pageToken = null;
                this._last = true;
            } else {
                ...
                var future = this._client.DescribeLabelValuesFuture(
                #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Log.Model.Label>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
