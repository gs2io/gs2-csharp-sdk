...
namespace Gs2.Gs2Log.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Log.Model.AccessLogCount>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Log.Model.AccessLogCount>
    #else
        IAsyncEnumerable<Gs2.Gs2Log.Model.AccessLogCount>
    #endif
    {
        ...
        private bool _last;
        private Gs2.Gs2Log.Model.AccessLogCount[] _result;
...
/* diff --- start
            var request = new Gs2.Gs2Log.Request.CountAccessLogRequest()
...
/* diff --- start
 ...
 diff --- end */
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Log.Model.AccessLogCount>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Log.Model.AccessLogCount>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Log.Model.AccessLogCount> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Log.Model.AccessLogCount>(async (writer, token) =>
        #else
        public async IAsyncEnumerator<Gs2.Gs2Log.Model.AccessLogCount> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        )
        #endif
        {
/* diff --- start
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Log.Model.AccessLogCount>(
