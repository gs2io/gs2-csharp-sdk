...
namespace Gs2.Gs2Log.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class CountAccessLogIterator : Gs2Iterator<Gs2.Gs2Log.Model.AccessLogCount> {
    #else
    public class CountAccessLogIterator : IAsyncEnumerable<Gs2.Gs2Log.Model.AccessLogCount> {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Log.Model.AccessLogCount> GetAsyncEnumerator(
