...
namespace Gs2.Gs2Log.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class CountExecuteStampTaskLogIterator : Gs2Iterator<Gs2.Gs2Log.Model.ExecuteStampTaskLogCount> {
    #else
    public class CountExecuteStampTaskLogIterator : IAsyncEnumerable<Gs2.Gs2Log.Model.ExecuteStampTaskLogCount> {
    #endif
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Log.Model.ExecuteStampTaskLogCount ret = this._result[0];
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Log.Model.ExecuteStampTaskLogCount> GetAsyncEnumerator(
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Log.Model.ExecuteStampTaskLogCount>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
