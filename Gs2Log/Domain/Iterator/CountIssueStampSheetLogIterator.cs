...
namespace Gs2.Gs2Log.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Log.Model.IssueStampSheetLogCount>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Log.Model.IssueStampSheetLogCount>
    #else
        IAsyncEnumerable<Gs2.Gs2Log.Model.IssueStampSheetLogCount>
    #endif
    {
...
/* diff --- start
            var request = new Gs2.Gs2Log.Request.CountIssueStampSheetLogRequest()
...
/* diff --- start
 ...
 diff --- end */
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Log.Model.IssueStampSheetLogCount>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Log.Model.IssueStampSheetLogCount>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Log.Model.IssueStampSheetLogCount> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Log.Model.IssueStampSheetLogCount>(async (writer, token) =>
        #else
        ...
        {
/* diff --- start
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Log.Model.IssueStampSheetLogCount>(
                    (null as Gs2.Gs2Log.Model.IssueStampSheetLogCount).CacheParentKey(
                        NamespaceName,
                        null
                   ),
                   "ListIssueStampSheetLogCount"
               ).LockAsync()) {
                while(this._hasNext()) {
