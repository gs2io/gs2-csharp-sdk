...
namespace Gs2.Gs2Log.Domain.Iterator
{
    ...
    public class QueryExecuteStampTaskLogIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Log.Model.ExecuteStampTaskLog>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Log.Model.ExecuteStampTaskLog>
    #else
        IAsyncEnumerable<Gs2.Gs2Log.Model.ExecuteStampTaskLog>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Log.Request.QueryExecuteStampTaskLogRequest()
...
/* diff +++ end */
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Log.Model.ExecuteStampTaskLog>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Log.Model.ExecuteStampTaskLog>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Log.Model.ExecuteStampTaskLog> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Log.Model.ExecuteStampTaskLog>(async (writer, token) =>
        #else
