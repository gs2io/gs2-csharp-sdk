...
namespace Gs2.Gs2Log.Domain.Iterator
{
    ...
    public class QueryIssueStampSheetLogIterator : IAsyncEnumerable<Gs2.Gs2Log.Model.IssueStampSheetLog> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Log.Model.IssueStampSheetLog>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Log.Model.IssueStampSheetLog>
                (
                        parentKey
                )
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Log.Model.IssueStampSheetLog ret = this._result[0];
