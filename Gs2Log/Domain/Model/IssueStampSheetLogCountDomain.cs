...
namespace Gs2.Gs2Log.Domain.Model
{
    ...
    public partial class IssueStampSheetLogCountDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Log.Model.IssueStampSheetLogCount> Model() {
            #else
        public IFuture<Gs2.Gs2Log.Model.IssueStampSheetLogCount> Model() {
            #endif
        #else
        public async Task<Gs2.Gs2Log.Model.IssueStampSheetLogCount> Model() {
        #endif
        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2Log.Model.IssueStampSheetLogCount> self)
            {
        #endif
            var (value, find) = this._gs2.Cache.Get<Gs2.Gs2Log.Model.IssueStampSheetLogCount>(
                _parentKey,
            ...
            return new Gs2InlineFuture<Gs2.Gs2Log.Model.IssueStampSheetLogCount>(Impl);
        #endif
        }
