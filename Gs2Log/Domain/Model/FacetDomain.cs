    ...
    public partial class FacetDomain {
            ...
            #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Log.Model.Facet>(
                        ...
                        (null as Gs2.Gs2Log.Model.Facet).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Log.Model.Facet).GetCache(
                    this._gs2.Cache,
        ...
        {
            (null as Gs2.Gs2Log.Model.Facet).DeleteCache(
                this._gs2.Cache,
                null
            );
        }

        public ulong Subscribe(Action<Gs2.Gs2Log.Model.Facet> callback)
        {
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2Log.Model.Facet>(
                (null as Gs2.Gs2Log.Model.Facet).CacheParentKey(
                    null
                ),
                (null as Gs2.Gs2Log.Model.Facet).CacheKey(
