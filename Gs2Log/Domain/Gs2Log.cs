...
namespace Gs2.Gs2Log.Domain
{
    ...
    public class Gs2Log {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Log.Domain.Model.NamespaceDomain> CreateNamespaceFuture(
            ...
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Log.Domain.Model.NamespaceDomain> CreateNamespaceAsync(
            #else
        public async Task<Gs2.Gs2Log.Domain.Model.NamespaceDomain> CreateNamespaceAsync(
            #endif
            CreateNamespaceRequest request
        ) {
        ...
        public IFuture<Gs2.Gs2Log.Domain.Model.NamespaceDomain> CreateNamespace(
            CreateNamespaceRequest request
        ) {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public Gs2Iterator<Gs2.Gs2Log.Model.Namespace> Namespaces(
        )
        {
        ...
        public IUniTaskAsyncEnumerable<Gs2.Gs2Log.Model.Namespace> NamespacesAsync(
            #else
        public Gs2Iterator<Gs2.Gs2Log.Model.Namespace> Namespaces(
            #endif
        #else
        ...
        {
            return this._gs2.Cache.ListSubscribe<Gs2.Gs2Log.Model.Namespace>(
                "log:Namespace",
                callback
            );
        }
        ...
        {
            this._gs2.Cache.ListUnsubscribe<Gs2.Gs2Log.Model.Namespace>(
                "log:Namespace",
                callbackId
            );
        }

        public Gs2.Gs2Log.Domain.Model.NamespaceDomain Namespace(
