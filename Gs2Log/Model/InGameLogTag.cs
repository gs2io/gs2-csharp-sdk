...
namespace Gs2.Gs2Log.Model
{
	...
	[Preserve]
#endif
	public partial class InGameLogTag : IComparable
	{
    	...
    	[Preserve]
#endif
        public static InGameLogTag FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type InGameLogTag.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (Key.Length > 64) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("inGameLogTag", "log.inGameLogTag.key.error.tooLong"),
                    });
                }
            }
            {
                if (Value.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("inGameLogTag", "log.inGameLogTag.value.error.tooLong"),
                    });
                }
            }
        }
