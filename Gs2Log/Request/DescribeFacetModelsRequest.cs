...
#endif
	[System.Serializable]
	public class DescribeFacetModelsRequest : Gs2Request<DescribeFacetModelsRequest>
	{
        ...
        public DescribeFacetModelsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeFacetModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
