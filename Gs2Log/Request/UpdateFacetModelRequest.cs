...
#endif
	[System.Serializable]
	public class UpdateFacetModelRequest : Gs2Request<UpdateFacetModelRequest>
	{
        ...
        public UpdateFacetModelRequest WithOrder(int? order) {
            this.Order = order;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static UpdateFacetModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
