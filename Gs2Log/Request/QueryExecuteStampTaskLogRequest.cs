...
namespace Gs2.Gs2Log.Request
{
	...
	public class QueryExecuteStampTaskLogRequest : Gs2Request<QueryExecuteStampTaskLogRequest>
	{
        ...
        public QueryExecuteStampTaskLogRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static QueryExecuteStampTaskLogRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply QueryExecuteStampTaskLogRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (QueryExecuteStampTaskLogRequest)x;
            return this;
        }
    }
}