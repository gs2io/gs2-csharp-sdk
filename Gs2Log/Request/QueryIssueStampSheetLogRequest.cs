...
namespace Gs2.Gs2Log.Request
{
	...
	public class QueryIssueStampSheetLogRequest : Gs2Request<QueryIssueStampSheetLogRequest>
	{
    	...
    	[Preserve]
#endif
        public static QueryIssueStampSheetLogRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply QueryIssueStampSheetLogRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (QueryIssueStampSheetLogRequest)x;
            return this;
        }
    }
}