...
#endif
	[System.Serializable]
	public class DescribeMetricsRequest : Gs2Request<DescribeMetricsRequest>
	{
        ...
        public DescribeMetricsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeMetricsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
