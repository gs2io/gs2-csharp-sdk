...
#endif
	[System.Serializable]
	public class DescribeDashboardsRequest : Gs2Request<DescribeDashboardsRequest>
	{
        ...
        public DescribeDashboardsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeDashboardsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
