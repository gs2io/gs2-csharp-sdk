...
#endif
	[System.Serializable]
	public class CreateStackResult : IResult
	{
        public Gs2.Gs2Deploy.Model.Stack Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public CreateStackResult WithItem(Gs2.Gs2Deploy.Model.Stack item) {
            this.Item = item;
            return this;
        }

        public CreateStackResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CreateStackResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
