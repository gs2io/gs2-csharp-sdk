...
#endif
	[System.Serializable]
	public class PreValidateResult : IResult
	{
        ...
        public PreValidateResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreValidateResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
