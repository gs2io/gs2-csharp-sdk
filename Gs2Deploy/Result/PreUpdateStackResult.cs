...
#endif
	[System.Serializable]
	public class PreUpdateStackResult : IResult
	{
        ...
        public PreUpdateStackResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateStackResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
