...
#endif
	[System.Serializable]
	public class UpdateStackResult : IResult
	{
        public Gs2.Gs2Deploy.Model.Stack Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public UpdateStackResult WithItem(Gs2.Gs2Deploy.Model.Stack item) {
            this.Item = item;
            return this;
        }

        public UpdateStackResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UpdateStackResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
