...
#endif
	[System.Serializable]
	public class DescribeResourcesResult : IResult
	{
        public Gs2.Gs2Deploy.Model.Resource[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeResourcesResult WithItems(Gs2.Gs2Deploy.Model.Resource[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeResourcesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeResourcesResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Deploy.Model.Resource[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Deploy.Model.Resource.FromJson(v);
                }).ToArray())
