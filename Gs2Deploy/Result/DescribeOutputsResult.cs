...
#endif
	[System.Serializable]
	public class DescribeOutputsResult : IResult
	{
        public Gs2.Gs2Deploy.Model.Output[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeOutputsResult WithItems(Gs2.Gs2Deploy.Model.Output[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeOutputsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeOutputsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Deploy.Model.Output[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Deploy.Model.Output.FromJson(v);
                }).ToArray())
