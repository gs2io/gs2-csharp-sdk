...
#endif
	[System.Serializable]
	public class PreChangeSetResult : IResult
	{
        ...
        public PreChangeSetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreChangeSetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
