...
#endif
	[System.Serializable]
	public class PreCreateStackResult : IResult
	{
        ...
        public PreCreateStackResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreCreateStackResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
