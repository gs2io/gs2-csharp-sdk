...
namespace Gs2.Gs2Deploy.Request
{
	...
	public class ForceDeleteStackRequest : Gs2Request<ForceDeleteStackRequest>
	{
    	...
    	[Preserve]
#endif
        public static ForceDeleteStackRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ForceDeleteStackRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ForceDeleteStackRequest)x;
            return this;
        }
    }
}