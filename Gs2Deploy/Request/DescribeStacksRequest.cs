...
namespace Gs2.Gs2Deploy.Request
{
	...
	public class DescribeStacksRequest : Gs2Request<DescribeStacksRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeStacksRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeStacksRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeStacksRequest)x;
            return this;
        }
    }
}