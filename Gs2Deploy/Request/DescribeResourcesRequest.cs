...
namespace Gs2.Gs2Deploy.Request
{
	...
	public class DescribeResourcesRequest : Gs2Request<DescribeResourcesRequest>
	{
        ...
        public DescribeResourcesRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeResourcesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeResourcesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeResourcesRequest)x;
            return this;
        }
    }
}