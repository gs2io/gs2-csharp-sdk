...
namespace Gs2.Gs2Deploy.Request
{
	...
	public class CreateStackFromGitHubRequest : Gs2Request<CreateStackFromGitHubRequest>
	{
    	...
    	[Preserve]
#endif
        public static CreateStackFromGitHubRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply CreateStackFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (CreateStackFromGitHubRequest)x;
            return this;
        }
    }
}