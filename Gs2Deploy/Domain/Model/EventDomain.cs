...
namespace Gs2.Gs2Deploy.Domain.Model
{
    ...
    public partial class EventDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Deploy.Model.Event> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Deploy.Model.Event> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Deploy.Model.Event> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Deploy.Model.Event> Model() => ModelAsync();
        #endif
