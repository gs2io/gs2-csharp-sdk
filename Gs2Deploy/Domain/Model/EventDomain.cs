...
namespace Gs2.Gs2Deploy.Domain.Model
{
    ...
    public partial class EventDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        private IFuture<Gs2.Gs2Deploy.Model.Event> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Deploy.Model.Event> self)
            {
                ...
                var future = this._client.GetEventFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        var key = Gs2.Gs2Deploy.Domain.Model.EventDomain.CreateCacheKey(
                            request.EventName.ToString()
                        );
                        this._gs2.Cache.Put<Gs2.Gs2Deploy.Model.Event>(
                            _parentKey,
                            key,
                            null,
            ...
            return new Gs2InlineFuture<Gs2.Gs2Deploy.Model.Event>(Impl);
        }
        #endif

        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        private async UniTask<Gs2.Gs2Deploy.Model.Event> GetAsync(
            #else
        private async Task<Gs2.Gs2Deploy.Model.Event> GetAsync(
            #endif
            GetEventRequest request
        ) {
            request
            ...
            try {
                result = await this._client.GetEventAsync(
                    request
                );
    ...
    public partial class EventDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Deploy.Model.Event> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Deploy.Model.Event> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Deploy.Model.Event>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Deploy.Model.Event>(
                        _parentKey,
                        Gs2.Gs2Deploy.Domain.Model.EventDomain.CreateCacheKey(
                            this.EventName?.ToString()
                        )
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Deploy.Model.Event> ModelAsync()
            #else
        ...
        public async UniTask<Gs2.Gs2Deploy.Model.Event> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Deploy.Model.Event> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Deploy.Model.Event> Model()
        {
            return await ModelAsync();
        }
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Deploy.Model.Event> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Deploy.Model.Event> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Deploy.Model.Event> callback)
            #endif
        {
