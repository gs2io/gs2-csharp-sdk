...
namespace Gs2.Gs2Deploy.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeResourcesIterator : Gs2Iterator<Gs2.Gs2Deploy.Model.Resource> {
    #else
    public class DescribeResourcesIterator : IAsyncEnumerable<Gs2.Gs2Deploy.Model.Resource> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Deploy.Model.Resource>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Deploy.Model.Resource>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeResourcesFuture(
                #else
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Deploy.Model.Resource>(
                            listParentKey
                    );
                }
            }
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Deploy.Model.Resource ret = this._result[0];
