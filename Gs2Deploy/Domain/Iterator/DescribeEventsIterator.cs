...
namespace Gs2.Gs2Deploy.Domain.Iterator
{
    ...
    public class DescribeEventsIterator : IAsyncEnumerable<Gs2.Gs2Deploy.Model.Event> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Deploy.Model.Event>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Deploy.Model.Event>
                (
                        parentKey
                )
                    .ToArray();
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Deploy.Model.Event ret = this._result[0];
