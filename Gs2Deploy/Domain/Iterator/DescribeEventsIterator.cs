...
namespace Gs2.Gs2Deploy.Domain.Iterator
{
    ...
    #endif
    {
        ...
        public DescribeEventsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Deploy.Model.Event[]{};
        }
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Deploy.Request.DescribeEventsRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Deploy.Model.Event>(
                        (null as Gs2.Gs2Deploy.Model.Event).CacheParentKey(
                            StackName,
                            null
                        )
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Deploy.Model.Event>> callback
        )
        {
        ...
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Deploy.Model.Event>(async (writer, token) =>
        #else
