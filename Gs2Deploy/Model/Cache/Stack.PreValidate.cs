...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<PreValidateResult> InvokeFuture(
            this PreValidateRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<PreValidateResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<PreValidateResult> self)
            {
            ...
            return new Gs2InlineFuture<PreValidateResult>(Impl);
        }
#endif
