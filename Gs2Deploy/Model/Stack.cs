	...
	public partial class Stack : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Stack.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(StackId, other.StackId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(Template, other.Template);
            if (diff != 0)
            {
                return diff;
            }
