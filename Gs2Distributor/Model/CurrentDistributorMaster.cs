...
namespace Gs2.Gs2Distributor.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentDistributorMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentDistributorMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentDistributorMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentDistributorMaster", "distributor.currentDistributorMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentDistributorMaster", "distributor.currentDistributorMaster.settings.error.tooLong"),
                    });
                }
            }
        }
