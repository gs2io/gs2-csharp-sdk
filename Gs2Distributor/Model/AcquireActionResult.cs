	...
	public partial class AcquireActionResult : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type AcquireActionResult.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.Compare(AcquireRequest, other.AcquireRequest);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(AcquireResult, other.AcquireResult);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (Action.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("acquireActionResult", "distributor.acquireActionResult.action.error.tooLong"),
                    });
                }
            }
            {
                if (AcquireRequest.Length > 524288) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("acquireActionResult", "distributor.acquireActionResult.acquireRequest.error.tooLong"),
                    });
                }
            }
            {
                if (StatusCode < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("acquireActionResult", "distributor.acquireActionResult.statusCode.error.invalid"),
                    });
                }
                if (StatusCode > 999) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
            ...
            }
            {
                if (AcquireResult.Length > 1048576) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("acquireActionResult", "distributor.acquireActionResult.acquireResult.error.tooLong"),
                    });
                }
            }
        }
