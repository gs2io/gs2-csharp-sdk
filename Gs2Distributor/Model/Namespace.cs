...
namespace Gs2.Gs2Distributor.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2Distributor.Model.TransactionSetting TransactionSetting { set; get; }
        public Gs2.Gs2Distributor.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        [Obsolete("This method is deprecated")]
        public Namespace WithTransactionSetting(Gs2.Gs2Distributor.Model.TransactionSetting transactionSetting) {
            this.TransactionSetting = transactionSetting;
            return this;
        }
        public Namespace WithTransactionSettingV2(Gs2.Gs2Distributor.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(AutoRunStampSheetNotification, other.AutoRunStampSheetNotification);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(AutoRunTransactionNotification, other.AutoRunTransactionNotification);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public object Clone() {
            return new Namespace {
                ...
                Name = Name,
                Description = Description,
                TransactionSetting = TransactionSetting?.Clone() as Gs2.Gs2Distributor.Model.TransactionSetting,
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2Distributor.Model.TransactionSettingV2,
                AssumeUserId = AssumeUserId,
