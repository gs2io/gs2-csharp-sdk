...
namespace Gs2.Gs2Distributor.Domain.Iterator
{
    ...
    public class DescribeUserDataIterator :
    #if UNITY_2017_1_OR_NEWER
    ...
    #endif
    {
        ...
        public DescribeUserDataIterator(
        ...
        private async Task _load() {
            ...
            var request = new Gs2.Gs2Distributor.Request.DescribeUserDataRequest()
                .WithContextStack(this._gs2.DefaultContextStack)
                .WithAccessToken(this.AccessToken != null ? this.AccessToken.Token : null)
                .WithPageToken(this._pageToken)
                .WithLimit(fetchSize);
            var r = await this._client.DescribeUserDataAsync(
                request
            );
            ...
            if (this._last) {
                foreach (var (service, kind, parentKey) in this._listCached) {
                    this._gs2.SetListCached(service, this.AccessToken?.TimeOffset, kind, parentKey);
                }
            }
        }
