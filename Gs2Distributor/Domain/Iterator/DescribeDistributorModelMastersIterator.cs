...
namespace Gs2.Gs2Distributor.Domain.Iterator
{
    ...
    public class DescribeDistributorModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModelMaster> {
        ...
        public DescribeDistributorModelMastersIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Distributor.Model.DistributorModelMaster[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Distributor.Model.DistributorModelMaster>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Distributor.Model.DistributorModelMaster>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeDistributorModelMastersFuture(
                #else
                var r = await this._client.DescribeDistributorModelMastersAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Distributor.Model.DistributorModelMaster>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Distributor.Model.DistributorModelMaster>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Distributor.Model.DistributorModelMaster ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Distributor.Model.DistributorModelMaster>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Distributor.Model.DistributorModelMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Distributor.Model.DistributorModelMaster>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
