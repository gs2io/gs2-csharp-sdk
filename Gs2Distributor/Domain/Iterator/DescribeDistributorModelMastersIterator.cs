...
namespace Gs2.Gs2Distributor.Domain.Iterator
{
    ...
    public class DescribeDistributorModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._cache.TryGetList<Gs2.Gs2Distributor.Model.DistributorModelMaster>
            (
                    parentKey,
                    out var list
            )) {
                ...
                if (this._last) {
                    this._cache.SetListCached<Gs2.Gs2Distributor.Model.DistributorModelMaster>(
                            parentKey
                    );
                }
            }
