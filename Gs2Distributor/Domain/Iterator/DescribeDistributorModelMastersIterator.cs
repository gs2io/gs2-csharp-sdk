    ...
    public class DescribeDistributorModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Distributor.Model.DistributorModelMaster>
            (
                ...
                var request = new Gs2.Gs2Distributor.Request.DescribeDistributorModelMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Distributor.Model.DistributorModelMaster>(
                        (null as Gs2.Gs2Distributor.Model.DistributorModelMaster).CacheParentKey(
                            NamespaceName,
                            null
                        )
