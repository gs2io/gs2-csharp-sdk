...
namespace Gs2.Gs2Distributor.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeDistributorModelsIterator : Gs2Iterator<Gs2.Gs2Distributor.Model.DistributorModel> {
    #else
    public class DescribeDistributorModelsIterator : IAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModel> {
    #endif
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Distributor.Model.DistributorModel>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Distributor.Model.DistributorModel>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeDistributorModelsFuture(
                #else
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Distributor.Model.DistributorModel>(
                            listParentKey
                    );
                }
            }
        ...
        )
        {
            yield return UniTask.ToCoroutine(
                async () => {
                    ...
                    Gs2.Gs2Distributor.Model.DistributorModel ret = this._result[0];
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModel> GetAsyncEnumerator(
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Distributor.Model.DistributorModel>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
