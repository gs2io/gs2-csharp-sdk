...
namespace Gs2.Gs2Distributor.Domain.Model
{
    ...
    public partial class StampSheetResultDomain {
        ...
        private async Task<Gs2.Gs2Distributor.Model.StampSheetResult> GetAsync(
            ...
            #else
            var result = await this._client.GetStampSheetResultByUserIdAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Distributor.Model.StampSheetResult> Model() {
            ...
            {
        #endif
            Gs2.Gs2Distributor.Model.StampSheetResult value = _cache.Get<Gs2.Gs2Distributor.Model.StampSheetResult>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2Distributor.Model.StampSheetResult>(
                                    _parentKey,
                                    Gs2.Gs2Distributor.Domain.Model.StampSheetResultDomain.CreateCacheKey(
                                        this.TransactionId?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Distributor.Model.StampSheetResult>(
                    _parentKey,
                    Gs2.Gs2Distributor.Domain.Model.StampSheetResultDomain.CreateCacheKey(
                        this.TransactionId?.ToString()
                    )
