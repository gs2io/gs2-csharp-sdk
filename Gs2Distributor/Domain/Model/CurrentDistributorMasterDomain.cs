...
namespace Gs2.Gs2Distributor.Domain.Model
{
    ...
    public partial class CurrentDistributorMasterDomain {
        ...
        #if GS2_ENABLE_UNITASK
        private async UniTask<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> GetAsync(
        #else
        private async Task<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCurrentDistributorMasterAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> PreUpdateFuture(
            PreUpdateCurrentDistributorMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentDistributorMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentDistributorMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentDistributorMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentDistributorMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentDistributorMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Distributor.Model.CurrentDistributorMaster>(
                        (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).CacheParentKey(
                            this.NamespaceName,
                            null
                        ),
                        (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null
                );
                ...
                return await (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetAsync(
        ...
        public UniTask<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        {
            this._gs2.Cache.Unsubscribe<Gs2.Gs2Distributor.Model.CurrentDistributorMaster>(
                (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).CacheParentKey(
                    this.NamespaceName,
                    null
                ),
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> callback)
        #endif
        {
