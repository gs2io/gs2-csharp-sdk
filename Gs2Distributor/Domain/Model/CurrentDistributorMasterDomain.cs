...
namespace Gs2.Gs2Distributor.Domain.Model
{
    ...
    public partial class CurrentDistributorMasterDomain {
        ...
        public async Task<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> ExportMasterAsync(
            ...
            #endif
            Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> GetAsync(
            ...
            #else
            var result = await this._client.GetCurrentDistributorMasterAsync(
                request
            );
            var requestModel = request;
            var resultModel = result;
        ...
        public async Task<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> UpdateAsync(
            ...
            #else
            var result = await this._client.UpdateCurrentDistributorMasterAsync(
                request
            );
            var requestModel = request;
            var resultModel = result;
        ...
        public async Task<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> UpdateFromGitHubAsync(
            ...
            #else
            var result = await this._client.UpdateCurrentDistributorMasterFromGitHubAsync(
                request
            );
            var requestModel = request;
            var resultModel = result;
        ...
        public async Task<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Distributor.Model.CurrentDistributorMaster value = _cache.Get<Gs2.Gs2Distributor.Model.CurrentDistributorMaster>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2Distributor.Model.CurrentDistributorMaster>(
                                    _parentKey,
                                    Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain.CreateCacheKey(
                                    )
                                );
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Distributor.Model.CurrentDistributorMaster>(
                _parentKey,
                Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain.CreateCacheKey(
                )
            );
