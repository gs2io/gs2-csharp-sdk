        ...
        private IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.GetCurrentDistributorMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> PreUpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.PreUpdateCurrentDistributorMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateCurrentDistributorMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Domain.Model.CurrentDistributorMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateCurrentDistributorMasterFromGitHubFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
    ...
    public partial class CurrentDistributorMasterDomain {
        ...
        public IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Model.CurrentDistributorMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2Distributor.Model.CurrentDistributorMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    () => this.GetFuture(
