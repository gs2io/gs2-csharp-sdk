...
namespace Gs2.Gs2Distributor.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "distributor:Gs2.Gs2Distributor.Model.Namespace";
        }
        ...
        public async UniTask<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> GetStatusAsync(
            #else
        public IFuture<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> GetStatus(
            #endif
        #else
        ...
        private async UniTask<Gs2.Gs2Distributor.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Distributor.Model.Namespace> Get(
            #endif
        #else
        ...
        public async UniTask<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> UpdateAsync(
            #else
        public IFuture<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> Update(
            #endif
        #else
        ...
        public async UniTask<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> DeleteAsync(
            #else
        public IFuture<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> Delete(
            #endif
        #else
        public async Task<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> DeleteAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Domain.Model.NamespaceDomain> self)
          {
            ...
            #endif
            _cache.Delete<Gs2.Gs2Distributor.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Distributor.Domain.Model.NamespaceDomain.CreateCacheKey(
                    request.NamespaceName != null ? request.NamespaceName.ToString() : null
                )
        ...
        public async UniTask<Gs2.Gs2Distributor.Domain.Model.DistributorModelMasterDomain> CreateDistributorModelMasterAsync(
            #else
        public IFuture<Gs2.Gs2Distributor.Domain.Model.DistributorModelMasterDomain> CreateDistributorModelMaster(
            #endif
        #else
        public async Task<Gs2.Gs2Distributor.Domain.Model.DistributorModelMasterDomain> CreateDistributorModelMasterAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Distributor.Domain.Model.DistributorModelMasterDomain> self)
          {
            ...
            var result = future.Result;
            #else
            var result = await this._client.CreateDistributorModelMasterAsync(
                request
            );
            #endif
            string parentKey = Gs2.Gs2Distributor.Domain.Model.NamespaceDomain.CreateCacheParentKey(
            ...
            Gs2.Gs2Distributor.Domain.Model.DistributorModelMasterDomain domain = new Gs2.Gs2Distributor.Domain.Model.DistributorModelMasterDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModel> DistributorModels(
            #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Distributor.Model.DistributorModelMaster> DistributorModelMasters(
            #else
        ...
        public async Task<Gs2.Gs2Distributor.Model.Namespace> Model() {
            ...
            {
        #endif
            Gs2.Gs2Distributor.Model.Namespace value = _cache.Get<Gs2.Gs2Distributor.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Distributor.Domain.Model.NamespaceDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Distributor.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Distributor.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName?.ToString()
                )
