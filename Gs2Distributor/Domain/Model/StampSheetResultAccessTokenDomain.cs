...
namespace Gs2.Gs2Distributor.Domain.Model
{
    ...
    public partial class StampSheetResultAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Distributor.Model.StampSheetResult> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
...
/* diff +++ start */
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Distributor.Model.StampSheetResult> ModelNoCacheFuture() => ModelNoCacheAsync().ToGs2Future();
        #endif
        #if GS2_ENABLE_UNITASK
...
/* diff --- start
        public UniTask<Gs2.Gs2Distributor.Model.StampSheetResult> Model() => ModelAsync();
 diff --- end */
/* diff +++ start */
...
/* diff --- start
        public IFuture<Gs2.Gs2Distributor.Model.StampSheetResult> Model() => ModelFuture();
 diff --- end */
/* diff +++ start */
...
/* diff +++ end */
        ...
        [Obsolete("The name has been changed to ModelAsync.")]
/* diff --- start
        public Task<Gs2.Gs2Distributor.Model.StampSheetResult> Model() => ModelAsync();
 diff --- end */
/* diff +++ start */
...
/* diff --- start
 ...
 diff --- end */
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Distributor.Model.StampSheetResult> callback) => SubscribeWithInitialCallAsync(callback).ToGs2Future(); /* diff +++ */
        #endif
