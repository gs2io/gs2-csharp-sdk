...
namespace Gs2.Gs2Distributor.Domain.Model
{
    ...
    public partial class TransactionResultAccessTokenDomain {
        ...
        public TransactionResultAccessTokenDomain(
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Distributor.Model.TransactionResult> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        {
/* diff --- start
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Distributor.Model.TransactionResult>(
...
/* diff +++ start */
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Distributor.Model.TransactionResult> ModelNoCacheFuture() => ModelNoCacheAsync().ToGs2Future();
        #endif
...
/* diff --- start
        public UniTask<Gs2.Gs2Distributor.Model.TransactionResult> Model() => ModelAsync();
 diff --- end */
/* diff +++ start */
...
/* diff --- start
        public IFuture<Gs2.Gs2Distributor.Model.TransactionResult> Model() => ModelFuture();
 diff --- end */
/* diff +++ start */
...
/* diff +++ end */
        ...
        [Obsolete("The name has been changed to ModelAsync.")]
/* diff --- start
        public Task<Gs2.Gs2Distributor.Model.TransactionResult> Model() => ModelAsync();
 diff --- end */
/* diff +++ start */
...
/* diff --- start
 ...
 diff --- end */
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Distributor.Model.TransactionResult> callback) => SubscribeWithInitialCallAsync(callback).ToGs2Future(); /* diff +++ */
        #endif
