...
#endif
	[System.Serializable]
	public class AndExpressionByStampTaskResult : IResult
	{
        ...
        public AndExpressionByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AndExpressionByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
