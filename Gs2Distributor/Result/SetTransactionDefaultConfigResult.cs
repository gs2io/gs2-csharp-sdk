...
#endif
	[System.Serializable]
	public class SetTransactionDefaultConfigResult : IResult
	{
        ...
        public SetTransactionDefaultConfigResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetTransactionDefaultConfigResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
