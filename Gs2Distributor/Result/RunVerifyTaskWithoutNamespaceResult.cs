...
#endif
	[System.Serializable]
	public class RunVerifyTaskWithoutNamespaceResult : IResult
	{
        ...
        public RunVerifyTaskWithoutNamespaceResult WithStatusCode(int? statusCode) {
        ...
        public RunVerifyTaskWithoutNamespaceResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RunVerifyTaskWithoutNamespaceResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
