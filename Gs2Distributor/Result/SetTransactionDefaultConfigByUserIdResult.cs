...
#endif
	[System.Serializable]
	public class SetTransactionDefaultConfigByUserIdResult : IResult
	{
        ...
        public SetTransactionDefaultConfigByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetTransactionDefaultConfigByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
