...
#endif
	[System.Serializable]
	public class FreezeMasterDataByUserIdResult : IResult
	{
        ...
        public FreezeMasterDataByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
