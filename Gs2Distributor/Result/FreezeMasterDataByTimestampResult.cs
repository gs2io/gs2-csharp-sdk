...
#endif
	[System.Serializable]
	public class FreezeMasterDataByTimestampResult : IResult
	{
        ...
        public FreezeMasterDataByTimestampResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataByTimestampResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
