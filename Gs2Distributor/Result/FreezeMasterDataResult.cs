...
#endif
	[System.Serializable]
	public class FreezeMasterDataResult : IResult
	{
        ...
        public FreezeMasterDataResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
