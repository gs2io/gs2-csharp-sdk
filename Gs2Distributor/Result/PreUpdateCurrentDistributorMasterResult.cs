...
#endif
	[System.Serializable]
	public class PreUpdateCurrentDistributorMasterResult : IResult
	{
        ...
        public PreUpdateCurrentDistributorMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentDistributorMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
