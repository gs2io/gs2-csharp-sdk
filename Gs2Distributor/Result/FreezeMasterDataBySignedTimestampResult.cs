...
#endif
	[System.Serializable]
	public class FreezeMasterDataBySignedTimestampResult : IResult
	{
        ...
        public FreezeMasterDataBySignedTimestampResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataBySignedTimestampResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
