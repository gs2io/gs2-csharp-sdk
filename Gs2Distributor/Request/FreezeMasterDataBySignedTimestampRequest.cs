...
#endif
	[System.Serializable]
	public class FreezeMasterDataBySignedTimestampRequest : Gs2Request<FreezeMasterDataBySignedTimestampRequest>
	{
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataBySignedTimestampRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
