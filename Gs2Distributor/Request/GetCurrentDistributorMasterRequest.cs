...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class GetCurrentDistributorMasterRequest : Gs2Request<GetCurrentDistributorMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentDistributorMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentDistributorMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentDistributorMasterRequest)x;
            return this;
        }
    }
}