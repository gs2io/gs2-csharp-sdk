...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class RunStampSheetRequest : Gs2Request<RunStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static RunStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RunStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RunStampSheetRequest)x;
            return this;
        }
    }
}