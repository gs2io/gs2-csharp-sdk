...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class RunStampTaskWithoutNamespaceRequest : Gs2Request<RunStampTaskWithoutNamespaceRequest>
	{
    	...
    	[Preserve]
#endif
        public static RunStampTaskWithoutNamespaceRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RunStampTaskWithoutNamespaceRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RunStampTaskWithoutNamespaceRequest)x;
            return this;
        }
    }
}