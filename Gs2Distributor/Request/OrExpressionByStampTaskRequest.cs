...
#endif
	[System.Serializable]
	public class OrExpressionByStampTaskRequest : Gs2Request<OrExpressionByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static OrExpressionByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
