...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class UpdateCurrentDistributorMasterFromGitHubRequest : Gs2Request<UpdateCurrentDistributorMasterFromGitHubRequest>
	{
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentDistributorMasterFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentDistributorMasterFromGitHubRequest)x;
            return this;
        }
    }
}