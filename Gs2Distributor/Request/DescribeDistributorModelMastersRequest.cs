...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class DescribeDistributorModelMastersRequest : Gs2Request<DescribeDistributorModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeDistributorModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDistributorModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDistributorModelMastersRequest)x;
            return this;
        }
    }
}