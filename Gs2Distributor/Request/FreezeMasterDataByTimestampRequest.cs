...
#endif
	[System.Serializable]
	public class FreezeMasterDataByTimestampRequest : Gs2Request<FreezeMasterDataByTimestampRequest>
	{
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataByTimestampRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
