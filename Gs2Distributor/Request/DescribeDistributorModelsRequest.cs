...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class DescribeDistributorModelsRequest : Gs2Request<DescribeDistributorModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeDistributorModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDistributorModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDistributorModelsRequest)x;
            return this;
        }
    }
}