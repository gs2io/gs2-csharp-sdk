...
#endif
	[System.Serializable]
	public class DescribeUserDataRequest : Gs2Request<DescribeUserDataRequest>
	{
         public string AccessToken { set; get; } = null!;
         public string PageToken { set; get; } = null!;
         public int? Limit { set; get; } = null!;
        public DescribeUserDataRequest WithAccessToken(string accessToken) {
            this.AccessToken = accessToken;
            return this;
        }
        public DescribeUserDataRequest WithPageToken(string pageToken) {
            this.PageToken = pageToken;
            return this;
        }
        public DescribeUserDataRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeUserDataRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
