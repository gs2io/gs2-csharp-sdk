...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class RunStampSheetWithoutNamespaceRequest : Gs2Request<RunStampSheetWithoutNamespaceRequest>
	{
    	...
    	[Preserve]
#endif
        public static RunStampSheetWithoutNamespaceRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RunStampSheetWithoutNamespaceRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RunStampSheetWithoutNamespaceRequest)x;
            return this;
        }
    }
}