...
#endif
	[System.Serializable]
	public class SetTransactionDefaultConfigRequest : Gs2Request<SetTransactionDefaultConfigRequest>
	{
    	...
    	[Preserve]
#endif
        public static SetTransactionDefaultConfigRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
