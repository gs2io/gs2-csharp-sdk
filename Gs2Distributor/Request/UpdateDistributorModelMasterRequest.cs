	...
	public class UpdateDistributorModelMasterRequest : Gs2Request<UpdateDistributorModelMasterRequest>
	{
        ...
        public static UpdateDistributorModelMasterRequest FromJson(JsonData data)
        {
            ...
            return new UpdateDistributorModelMasterRequest()
                ...
                .WithWhiteListTargetIds(!data.Keys.Contains("whiteListTargetIds") || data["whiteListTargetIds"] == null || !data["whiteListTargetIds"].IsArray ? new string[]{} : data["whiteListTargetIds"].Cast<JsonData>().Select(v => {
                    return v.ToString();
                }).ToArray());
        }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateDistributorModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateDistributorModelMasterRequest)x;
            return this;
        }
    }
}