...
namespace Gs2.Gs2Distributor.Request
{
	...
	public class RunStampSheetExpressWithoutNamespaceRequest : Gs2Request<RunStampSheetExpressWithoutNamespaceRequest>
	{
    	...
    	[Preserve]
#endif
        public static RunStampSheetExpressWithoutNamespaceRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RunStampSheetExpressWithoutNamespaceRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RunStampSheetExpressWithoutNamespaceRequest)x;
            return this;
        }
    }
}