...
#endif
	[System.Serializable]
	public class FreezeMasterDataByUserIdRequest : Gs2Request<FreezeMasterDataByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static FreezeMasterDataByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
