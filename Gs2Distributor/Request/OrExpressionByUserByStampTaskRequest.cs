...
#endif
	[System.Serializable]
	public class OrExpressionByUserByStampTaskRequest : Gs2Request<OrExpressionByUserByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static OrExpressionByUserByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
