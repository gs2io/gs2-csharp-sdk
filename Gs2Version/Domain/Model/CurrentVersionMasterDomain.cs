...
namespace Gs2.Gs2Version.Domain.Model
{
    ...
    public partial class CurrentVersionMasterDomain {
        ...
        public IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> ExportMaster(
            ExportMasterRequest request
        ) {
        ...
        private IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName);
                var future = this._client.GetCurrentVersionMasterFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                            _parentKey,
                            key,
                            null,
                            UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "currentVersionMaster")
                        {
                            self.OnError(future.Error);
                            yield break;
                        }
        ...
        private async Task<Gs2.Gs2Version.Model.CurrentVersionMaster> GetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName);
            GetCurrentVersionMasterResult result = null;
            try {
                result = await this._client.GetCurrentVersionMasterAsync(
                    request
                );
        ...
        public IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName);
                var future = this._client.UpdateCurrentVersionMasterFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
        ...
        public async Task<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName);
            UpdateCurrentVersionMasterResult result = null;
                result = await this._client.UpdateCurrentVersionMasterAsync(
                    request
                );
        ...
        public IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> Update(
            UpdateCurrentVersionMasterRequest request
        ) {
        ...
        public IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName);
                var future = this._client.UpdateCurrentVersionMasterFromGitHubFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
        ...
        public async Task<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateFromGitHubAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName);
            UpdateCurrentVersionMasterFromGitHubResult result = null;
                result = await this._client.UpdateCurrentVersionMasterFromGitHubAsync(
                    request
                );
        ...
        public IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateFromGitHub(
            UpdateCurrentVersionMasterFromGitHubRequest request
        ) {
    ...
    public partial class CurrentVersionMasterDomain {
        ...
        public IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                    _parentKey,
                    Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain.CreateCacheKey(
                    )
                );
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                        _parentKey,
                        Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain.CreateCacheKey(
                        )
                    );
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                _parentKey,
                Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain.CreateCacheKey(
                )
            );
