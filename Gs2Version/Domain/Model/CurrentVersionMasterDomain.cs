...
namespace Gs2.Gs2Version.Domain.Model
{
    ...
    public partial class CurrentVersionMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> PreUpdateFuture(
            PreUpdateCurrentVersionMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentVersionMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentVersionMasterAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentVersionMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Version.Model.CurrentVersionMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Version.Model.CurrentVersionMaster> Model() => ModelAsync();
        #endif
