...
namespace Gs2.Gs2Version.Domain.Model
{
    ...
    public partial class CurrentVersionMasterDomain {
        ...
        public async Task<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> ExportMasterAsync(
            ...
            Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Version.Model.CurrentVersionMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Version.Model.CurrentVersionMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Version.Model.CurrentVersionMaster> GetAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.GetCurrentVersionMasterAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCurrentVersionMasterAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCurrentVersionMasterFromGitHubAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Version.Model.CurrentVersionMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Version.Model.CurrentVersionMaster value = _cache.Get<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                _parentKey,
                Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain.CreateCacheKey(
                )
            );
            if (value == null) {
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        ...
                        {
                            _cache.Delete<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                            _parentKey,
                            Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain.CreateCacheKey(
                            )
                        );
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Version.Model.CurrentVersionMaster>(
                _parentKey,
                Gs2.Gs2Version.Domain.Model.CurrentVersionMasterDomain.CreateCacheKey(
                )
            );
