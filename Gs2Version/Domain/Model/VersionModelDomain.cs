...
namespace Gs2.Gs2Version.Domain.Model
{
    ...
    public partial class VersionModelDomain {
        ...
        public async Task<Gs2.Gs2Version.Model.VersionModel> Model() {
            ...
            {
        #endif
            Gs2.Gs2Version.Model.VersionModel value = _cache.Get<Gs2.Gs2Version.Model.VersionModel>(
                _parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            {
                                _cache.Delete<Gs2.Gs2Version.Model.VersionModel>(
                                    _parentKey,
                                    Gs2.Gs2Version.Domain.Model.VersionModelDomain.CreateCacheKey(
                                        this.VersionName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Version.Model.VersionModel>(
                    _parentKey,
                    Gs2.Gs2Version.Domain.Model.VersionModelDomain.CreateCacheKey(
                        this.VersionName?.ToString()
                    )
