...
namespace Gs2.Gs2Version.Request
{
	...
	public class UpdateCurrentVersionMasterRequest : Gs2Request<UpdateCurrentVersionMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentVersionMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentVersionMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentVersionMasterRequest)x;
            return this;
        }
    }
}