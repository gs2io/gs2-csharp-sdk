...
namespace Gs2.Gs2Version.Request
{
	...
	public class DescribeAcceptVersionsRequest : Gs2Request<DescribeAcceptVersionsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeAcceptVersionsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeAcceptVersionsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeAcceptVersionsRequest)x;
            return this;
        }
    }
}