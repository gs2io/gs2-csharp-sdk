...
namespace Gs2.Gs2Version.Request
{
	...
	public class DescribeVersionModelMastersRequest : Gs2Request<DescribeVersionModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeVersionModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeVersionModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeVersionModelMastersRequest)x;
            return this;
        }
    }
}