...
namespace Gs2.Gs2Version.Request
{
	...
	public class DescribeVersionModelsRequest : Gs2Request<DescribeVersionModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeVersionModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeVersionModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeVersionModelsRequest)x;
            return this;
        }
    }
}