...
namespace Gs2.Gs2Version.Request
{
	...
	public class GetAcceptVersionRequest : Gs2Request<GetAcceptVersionRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetAcceptVersionRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetAcceptVersionRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetAcceptVersionRequest)x;
            return this;
        }
    }
}