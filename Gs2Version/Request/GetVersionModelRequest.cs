...
namespace Gs2.Gs2Version.Request
{
	...
	public class GetVersionModelRequest : Gs2Request<GetVersionModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetVersionModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetVersionModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetVersionModelRequest)x;
            return this;
        }
    }
}