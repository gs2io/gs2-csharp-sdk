...
namespace Gs2.Gs2Version.Request
{
	...
	public class DeleteAcceptVersionByUserIdRequest : Gs2Request<DeleteAcceptVersionByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteAcceptVersionByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteAcceptVersionByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteAcceptVersionByUserIdRequest)x;
            return this;
        }
    }
}