...
namespace Gs2.Gs2Version.Request
{
	...
	public class DescribeAcceptVersionsByUserIdRequest : Gs2Request<DescribeAcceptVersionsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeAcceptVersionsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeAcceptVersionsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeAcceptVersionsByUserIdRequest)x;
            return this;
        }
    }
}