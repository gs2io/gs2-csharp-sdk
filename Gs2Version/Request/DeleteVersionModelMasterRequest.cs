...
namespace Gs2.Gs2Version.Request
{
	...
	public class DeleteVersionModelMasterRequest : Gs2Request<DeleteVersionModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteVersionModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteVersionModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteVersionModelMasterRequest)x;
            return this;
        }
    }
}