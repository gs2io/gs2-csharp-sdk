...
namespace Gs2.Gs2Version.Request
{
	...
	public class GetCurrentVersionMasterRequest : Gs2Request<GetCurrentVersionMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentVersionMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentVersionMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentVersionMasterRequest)x;
            return this;
        }
    }
}