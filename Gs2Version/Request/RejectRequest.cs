...
#endif
	[System.Serializable]
	public class RejectRequest : Gs2Request<RejectRequest>
	{
        ...
        public RejectRequest WithVersion(Gs2.Gs2Version.Model.Version_ version) {
    	...
    	[Preserve]
#endif
        public static RejectRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
