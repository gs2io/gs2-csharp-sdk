...
#endif
	[System.Serializable]
	public class PreUpdateCurrentVersionMasterResult : IResult
	{
        ...
        public PreUpdateCurrentVersionMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentVersionMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
