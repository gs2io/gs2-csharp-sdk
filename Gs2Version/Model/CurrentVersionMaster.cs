...
namespace Gs2.Gs2Version.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentVersionMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentVersionMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentVersionMaster.", nameof(obj));
            }
            var diff = 0;
