...
namespace Gs2.Gs2Lock.Request
{
	...
	public class GetMutexByUserIdRequest : Gs2Request<GetMutexByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetMutexByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetMutexByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetMutexByUserIdRequest)x;
            return this;
        }
    }
}