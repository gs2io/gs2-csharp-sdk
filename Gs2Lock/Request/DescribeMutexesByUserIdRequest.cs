...
namespace Gs2.Gs2Lock.Request
{
	...
	public class DescribeMutexesByUserIdRequest : Gs2Request<DescribeMutexesByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeMutexesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMutexesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMutexesByUserIdRequest)x;
            return this;
        }
    }
}