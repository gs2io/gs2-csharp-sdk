...
namespace Gs2.Gs2Lock.Request
{
	...
	public class UnlockByUserIdRequest : Gs2Request<UnlockByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static UnlockByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UnlockByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UnlockByUserIdRequest)x;
            return this;
        }
    }
}