...
namespace Gs2.Gs2Lock.Domain.Model
{
    ...
    public partial class UserDomain {
        ...
        public UserDomain(
            ...
            this._userId = userId;
            this._parentKey = Gs2.Gs2Lock.Domain.Model.NamespaceDomain.CreateCacheParentKey(
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Lock.Model.Mutex> Mutexes(
            #else
        ...
        public Gs2.Gs2Lock.Domain.Model.MutexDomain Mutex(
            string propertyId
        ) {
            return new Gs2.Gs2Lock.Domain.Model.MutexDomain(
                this._cache,
