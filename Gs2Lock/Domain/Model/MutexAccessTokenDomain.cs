...
namespace Gs2.Gs2Lock.Domain.Model
{
    ...
    public partial class MutexAccessTokenDomain {
        ...
        ) => UnlockAsync(request).ToGs2Future();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Lock.Model.Mutex> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Lock.Model.Mutex> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Lock.Model.Mutex> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Lock.Model.Mutex> Model() => ModelAsync();
        #endif
