...
namespace Gs2.Gs2Lock.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public async Task<Gs2.Gs2Lock.Domain.Model.NamespaceDomain> GetStatusAsync(
            ...
            Gs2.Gs2Lock.Domain.Model.NamespaceDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Lock.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Lock.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2Lock.Domain.Model.NamespaceDomain> DeleteAsync(
            ...
            try {
                ...
                if (e.errors[0].component == "namespace")
                {
                    ...
                    _cache.Delete<Gs2.Gs2Lock.Model.Namespace>(parentKey, key);
                }
                else
                {
                    throw e;
        ...
        public async Task<Gs2.Gs2Lock.Model.Namespace> Model() {
            ...
            Gs2.Gs2Lock.Model.Namespace value = _cache.Get<Gs2.Gs2Lock.Model.Namespace>(
                parentKey,
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            if (e.errors[0].component == "namespace")
                            {
                                _cache.Delete<Gs2.Gs2Lock.Model.Namespace>(
                                    _parentKey,
                                    Gs2.Gs2Lock.Domain.Model.NamespaceDomain.CreateCacheKey(
                                        this.NamespaceName?.ToString()
                                    )
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Lock.Model.Namespace>(
                    parentKey,
                    Gs2.Gs2Lock.Domain.Model.NamespaceDomain.CreateCacheKey(
                        this.NamespaceName?.ToString()
                    )
