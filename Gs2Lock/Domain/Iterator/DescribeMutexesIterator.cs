...
namespace Gs2.Gs2Lock.Domain.Iterator
{
    ...
    public class DescribeMutexesIterator {
        #else
    public class DescribeMutexesIterator : Gs2Iterator<Gs2.Gs2Lock.Model.Mutex> {
        #endif
    #else
    public class DescribeMutexesIterator : IAsyncEnumerable<Gs2.Gs2Lock.Model.Mutex> {
    #endif
        ...
        private async Task _load() {
        #endif
            string parentKey = Gs2.Gs2Lock.Domain.Model.UserDomain.CreateCacheParentKey(
            ...
            (
                ...
                var future = this._client.DescribeMutexesFuture(
                #else
                var r = await this._client.DescribeMutexesAsync(
                #endif
        ...
        )
        {
            ...
            while(this._hasNext()) {
                ...
                Gs2.Gs2Lock.Model.Mutex ret = this._result[0];
