...
#endif
	[System.Serializable]
	public class UnlockResult : IResult
	{
        public Gs2.Gs2Lock.Model.Mutex Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public UnlockResult WithItem(Gs2.Gs2Lock.Model.Mutex item) {
            this.Item = item;
            return this;
        }

        public UnlockResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static UnlockResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
