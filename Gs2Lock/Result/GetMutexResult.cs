...
#endif
	[System.Serializable]
	public class GetMutexResult : IResult
	{
        public Gs2.Gs2Lock.Model.Mutex Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public GetMutexResult WithItem(Gs2.Gs2Lock.Model.Mutex item) {
            this.Item = item;
            return this;
        }

        public GetMutexResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetMutexResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
