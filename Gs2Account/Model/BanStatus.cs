	...
	public partial class BanStatus : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type BanStatus.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.Compare(Reason, other.Reason);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ReleaseTimestamp, other.ReleaseTimestamp);
            if (diff != 0)
            {
                return diff;
            }
