...
namespace Gs2.Gs2Account.Model
{
	...
	public partial class ScopeValue : IComparable
	{
    	...
    	[Preserve]
#endif
        public static ScopeValue FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type ScopeValue.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (Key.Length > 64) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("scopeValue", "account.scopeValue.key.error.tooLong"),
                    });
                }
            }
            {
                if (Value.Length > 51200) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("scopeValue", "account.scopeValue.value.error.tooLong"),
                    });
                }
            }
        }
