...
namespace Gs2.Gs2Account.Model.Cache
{
    public static partial class AccountExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<AuthenticationResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<AuthenticationResult> self)
            {
            ...
            return new Gs2InlineFuture<AuthenticationResult>(Impl);
        }
#endif
