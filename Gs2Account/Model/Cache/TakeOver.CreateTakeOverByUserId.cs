...
namespace Gs2.Gs2Account.Model.Cache
{
    public static partial class TakeOverExt
    {
        public static void PutCache(
            this CreateTakeOverByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<CreateTakeOverByUserIdResult> InvokeFuture(
            this CreateTakeOverByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<CreateTakeOverByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<CreateTakeOverByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<CreateTakeOverByUserIdResult>(Impl);
        }
#endif
