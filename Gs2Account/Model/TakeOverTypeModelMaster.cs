...
namespace Gs2.Gs2Account.Model
{
	...
	[Preserve]
#endif
	public partial class TakeOverTypeModelMaster : IComparable
	{
        ...
        public TakeOverTypeModelMaster WithType(int? type) {
            this.Type = type;
            return this;
        }
        ...
        public TakeOverTypeModelMaster WithOpenIdConnectSetting(Gs2.Gs2Account.Model.OpenIdConnectSetting openIdConnectSetting) {
    	...
    	[Preserve]
#endif
        public static TakeOverTypeModelMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        {
            var other = obj as TakeOverTypeModelMaster;
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type TakeOverTypeModelMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (TakeOverTypeModelId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.takeOverTypeModelId.error.tooLong"),
                    });
                }
            }
            {
                if (Type < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.type.error.invalid"),
                    });
                }
                if (Type > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
            ...
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.description.error.tooLong"),
                    });
                }
            }
            {
                if (Metadata.Length > 2048) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.metadata.error.tooLong"),
                    });
                }
            }
            {
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("takeOverTypeModelMaster", "account.takeOverTypeModelMaster.revision.error.invalid"),
                    });
                }
