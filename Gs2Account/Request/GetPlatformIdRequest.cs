...
#endif
	[System.Serializable]
	public class GetPlatformIdRequest : Gs2Request<GetPlatformIdRequest>
	{
        ...
        public GetPlatformIdRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static GetPlatformIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
