...
#endif
	[System.Serializable]
	public class UpdateTakeOverTypeModelMasterRequest : Gs2Request<UpdateTakeOverTypeModelMasterRequest>
	{
        ...
        public UpdateTakeOverTypeModelMasterRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
        ...
        public UpdateTakeOverTypeModelMasterRequest WithOpenIdConnectSetting(Gs2.Gs2Account.Model.OpenIdConnectSetting openIdConnectSetting) {
    	...
    	[Preserve]
#endif
        public static UpdateTakeOverTypeModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
