...
namespace Gs2.Gs2Account.Request
{
	...
	public class DescribeTakeOversRequest : Gs2Request<DescribeTakeOversRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeTakeOversRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeTakeOversRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeTakeOversRequest)x;
            return this;
        }
    }
}