...
#endif
	[System.Serializable]
	public class FindPlatformIdRequest : Gs2Request<FindPlatformIdRequest>
	{
        ...
        public FindPlatformIdRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static FindPlatformIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
