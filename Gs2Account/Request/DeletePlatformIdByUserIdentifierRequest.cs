...
#endif
	[System.Serializable]
	public class DeletePlatformIdByUserIdentifierRequest : Gs2Request<DeletePlatformIdByUserIdentifierRequest>
	{
        ...
        public DeletePlatformIdByUserIdentifierRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DeletePlatformIdByUserIdentifierRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
