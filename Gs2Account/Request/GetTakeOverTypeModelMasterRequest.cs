...
#endif
	[System.Serializable]
	public class GetTakeOverTypeModelMasterRequest : Gs2Request<GetTakeOverTypeModelMasterRequest>
	{
        ...
        public GetTakeOverTypeModelMasterRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static GetTakeOverTypeModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
