...
#endif
	[System.Serializable]
	public class DeletePlatformIdRequest : Gs2Request<DeletePlatformIdRequest>
	{
        ...
        public DeletePlatformIdRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DeletePlatformIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
