...
#endif
	[System.Serializable]
	public class GetTakeOverTypeModelRequest : Gs2Request<GetTakeOverTypeModelRequest>
	{
        ...
        public GetTakeOverTypeModelRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static GetTakeOverTypeModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
