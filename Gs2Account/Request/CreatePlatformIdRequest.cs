...
#endif
	[System.Serializable]
	public class CreatePlatformIdRequest : Gs2Request<CreatePlatformIdRequest>
	{
        ...
        public CreatePlatformIdRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static CreatePlatformIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
