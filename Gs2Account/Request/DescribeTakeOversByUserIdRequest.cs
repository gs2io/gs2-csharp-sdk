...
namespace Gs2.Gs2Account.Request
{
	...
	public class DescribeTakeOversByUserIdRequest : Gs2Request<DescribeTakeOversByUserIdRequest>
	{
        ...
        public DescribeTakeOversByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeTakeOversByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeTakeOversByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeTakeOversByUserIdRequest)x;
            return this;
        }
    }
}