...
#endif
	[System.Serializable]
	public class UpdateBannedRequest : Gs2Request<UpdateBannedRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateBannedRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateBannedRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateBannedRequest)x;
            return this;
        }
    }
}