...
namespace Gs2.Gs2Account.Request
{
	...
	public class DeleteDataOwnerByUserIdRequest : Gs2Request<DeleteDataOwnerByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteDataOwnerByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteDataOwnerByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteDataOwnerByUserIdRequest)x;
            return this;
        }
    }
}