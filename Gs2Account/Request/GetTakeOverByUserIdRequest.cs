...
namespace Gs2.Gs2Account.Request
{
	...
	public class GetTakeOverByUserIdRequest : Gs2Request<GetTakeOverByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetTakeOverByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetTakeOverByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetTakeOverByUserIdRequest)x;
            return this;
        }
    }
}