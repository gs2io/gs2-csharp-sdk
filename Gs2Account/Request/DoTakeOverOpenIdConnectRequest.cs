...
#endif
	[System.Serializable]
	public class DoTakeOverOpenIdConnectRequest : Gs2Request<DoTakeOverOpenIdConnectRequest>
	{
        ...
        public DoTakeOverOpenIdConnectRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DoTakeOverOpenIdConnectRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
