...
#endif
	[System.Serializable]
	public class CreateTakeOverOpenIdConnectAndByUserIdRequest : Gs2Request<CreateTakeOverOpenIdConnectAndByUserIdRequest>
	{
        ...
        public CreateTakeOverOpenIdConnectAndByUserIdRequest WithType(int? type) {
            this.Type = type;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static CreateTakeOverOpenIdConnectAndByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
