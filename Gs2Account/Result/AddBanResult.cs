...
#endif
	[System.Serializable]
	public class AddBanResult : IResult
	{
        public Gs2.Gs2Account.Model.Account Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public AddBanResult WithItem(Gs2.Gs2Account.Model.Account item) {
            this.Item = item;
            return this;
        }

        public AddBanResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AddBanResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
