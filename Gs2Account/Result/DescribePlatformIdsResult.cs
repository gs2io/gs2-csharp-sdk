...
#endif
	[System.Serializable]
	public class DescribePlatformIdsResult : IResult
	{
        public Gs2.Gs2Account.Model.PlatformId[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribePlatformIdsResult WithItems(Gs2.Gs2Account.Model.PlatformId[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribePlatformIdsResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribePlatformIdsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
