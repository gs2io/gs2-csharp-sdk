...
#endif
	[System.Serializable]
	public class DescribeTakeOversResult : IResult
	{
        public Gs2.Gs2Account.Model.TakeOver[] Items { set; get; }
        public string NextPageToken { set; get; }

        public DescribeTakeOversResult WithItems(Gs2.Gs2Account.Model.TakeOver[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeTakeOversResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeTakeOversResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Account.Model.TakeOver[]{} : data["items"].Cast<JsonData>().Select(v => {
