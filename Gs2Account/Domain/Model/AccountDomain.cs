...
namespace Gs2.Gs2Account.Domain.Model
{
    ...
    public partial class AccountDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Account.Model.DataOwner> GetDataOwnerAsync(
            #else
        public IFuture<Gs2.Gs2Account.Model.DataOwner> GetDataOwner(
            #endif
        #else
        public async Task<Gs2.Gs2Account.Model.DataOwner> GetDataOwnerAsync(
        #endif
        ...
        public async Task<Gs2.Gs2Account.Domain.Model.DataOwnerDomain> DeleteDataOwnerAsync(
            ...
            #endif
            Gs2.Gs2Account.Domain.Model.DataOwnerDomain domain = new Gs2.Gs2Account.Domain.Model.DataOwnerDomain(
                this._cache,
