...
namespace Gs2.Gs2Account.Domain.Model
{
    ...
    public partial class TakeOverTypeModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Account.Model.TakeOverTypeModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Account.Model.TakeOverTypeModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Account.Model.TakeOverTypeModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Account.Model.TakeOverTypeModelMaster> Model() => ModelAsync();
        #endif
