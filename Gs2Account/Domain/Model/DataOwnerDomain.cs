...
/* diff --- start
                .WithUserId(this.UserId)
                .WithDataOwnerName(model.DataOwnerName);
 diff --- end */
    ...
    public partial class DataOwnerDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Account.Model.DataOwner> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
...
/* diff --- start
        public UniTask<Gs2.Gs2Account.Model.DataOwner> Model() => ModelAsync();
 diff --- end */
/* diff +++ start */
...
/* diff --- start
        public IFuture<Gs2.Gs2Account.Model.DataOwner> Model() => ModelFuture();
 diff --- end */
/* diff +++ start */
...
/* diff +++ end */
        ...
        [Obsolete("The name has been changed to ModelAsync.")]
/* diff --- start
        public Task<Gs2.Gs2Account.Model.DataOwner> Model() => ModelAsync();
 diff --- end */
/* diff +++ start */
...
/* diff +++ end */
        ...
        #if UNITY_2017_1_OR_NEWER
/* diff --- start
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Account.Model.DataOwner> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
 diff --- end */
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Account.Model.DataOwner> callback) => SubscribeWithInitialCallAsync(callback).ToGs2Future(); /* diff +++ */
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Account.Model.DataOwner> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Account.Model.DataOwner> callback)
        #endif
        {
