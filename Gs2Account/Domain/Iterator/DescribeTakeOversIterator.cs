...
namespace Gs2.Gs2Account.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeTakeOversIterator : Gs2Iterator<Gs2.Gs2Account.Model.TakeOver> {
    #else
    public class DescribeTakeOversIterator : IAsyncEnumerable<Gs2.Gs2Account.Model.TakeOver> {
    #endif
        ...
        public DescribeTakeOversIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Account.Model.TakeOver[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Account.Model.TakeOver>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Account.Model.TakeOver>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeTakeOversFuture(
                #else
                var r = await this._client.DescribeTakeOversAsync(
                #endif
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Account.Model.TakeOver>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Account.Model.TakeOver ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Account.Model.TakeOver>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Account.Model.TakeOver> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Account.Model.TakeOver>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
