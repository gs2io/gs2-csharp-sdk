...
#endif
	[System.Serializable]
	public class ExitStateMachineResult : IResult
	{
        public Gs2.Gs2StateMachine.Model.Status Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public ExitStateMachineResult WithItem(Gs2.Gs2StateMachine.Model.Status item) {
            this.Item = item;
            return this;
        }

        public ExitStateMachineResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ExitStateMachineResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
