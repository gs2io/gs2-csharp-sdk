...
namespace Gs2.Gs2StateMachine.Result
{
	...
	public class ReportResult : IResult
	{
        ...
        public ReportResult WithItem(Gs2.Gs2StateMachine.Model.Status item) {
            this.Item = item;
            return this;
        }

        public ReportResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReportResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
