...
#endif
	[System.Serializable]
	public class ReportByUserIdResult : IResult
	{
        public Gs2.Gs2StateMachine.Model.Status Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public ReportByUserIdResult WithItem(Gs2.Gs2StateMachine.Model.Status item) {
            this.Item = item;
            return this;
        }

        public ReportByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReportByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
