...
#endif
	[System.Serializable]
	public class EmitResult : IResult
	{
        public Gs2.Gs2StateMachine.Model.Status Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public EmitResult WithItem(Gs2.Gs2StateMachine.Model.Status item) {
            this.Item = item;
            return this;
        }

        public EmitResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static EmitResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
