...
namespace Gs2.Gs2StateMachine.Model
{
	...
	[Preserve]
#endif
	public partial class ChangeStateEvent : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type ChangeStateEvent.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.Compare(Hash, other.Hash);
            if (diff != 0)
            {
                return diff;
            }
