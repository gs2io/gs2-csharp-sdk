	...
	public partial class Namespace : IComparable
	{
        ...
        public static Namespace FromJson(JsonData data)
        {
            ...
            return new Namespace()
                ...
                .WithLowestStateMachineVersion(!data.Keys.Contains("lowestStateMachineVersion") || data["lowestStateMachineVersion"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableLong(data["lowestStateMachineVersion"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(SupportSpeculativeExecution, other.SupportSpeculativeExecution);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(StartScript, other.StartScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(PassScript, other.PassScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ErrorScript, other.ErrorScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(LowestStateMachineVersion, other.LowestStateMachineVersion);
            if (diff != 0)
            {
                return diff;
            }
