...
namespace Gs2.Gs2StateMachine.Model.Cache
{
    public static partial class StateMachineMasterExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DeleteStateMachineMasterResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DeleteStateMachineMasterResult> self)
            {
            ...
            return new Gs2InlineFuture<DeleteStateMachineMasterResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<DeleteStateMachineMasterResult> InvokeAsync(
#else
        public static async Task<DeleteStateMachineMasterResult> InvokeAsync(
#endif
            this DeleteStateMachineMasterRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<DeleteStateMachineMasterResult>> invokeImpl
#else
            Func<Task<DeleteStateMachineMasterResult>> invokeImpl
#endif
        )
        {
