...
namespace Gs2.Gs2StateMachine.Request
{
	...
	public class ExitStateMachineRequest : Gs2Request<ExitStateMachineRequest>
	{
    	...
    	[Preserve]
#endif
        public static ExitStateMachineRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ExitStateMachineRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ExitStateMachineRequest)x;
            return this;
        }
    }
}