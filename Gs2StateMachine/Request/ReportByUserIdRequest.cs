...
#endif
	[System.Serializable]
	public class ReportByUserIdRequest : Gs2Request<ReportByUserIdRequest>
	{
        ...
        public ReportByUserIdRequest WithEvents(Gs2.Gs2StateMachine.Model.Event[] events) {
            this.Events = events;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static ReportByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ReportByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ReportByUserIdRequest)x;
            return this;
        }
    }
}