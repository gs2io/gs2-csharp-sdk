...
namespace Gs2.Gs2StateMachine.Request
{
	...
	public class DeleteStateMachineMasterRequest : Gs2Request<DeleteStateMachineMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteStateMachineMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteStateMachineMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteStateMachineMasterRequest)x;
            return this;
        }
    }
}