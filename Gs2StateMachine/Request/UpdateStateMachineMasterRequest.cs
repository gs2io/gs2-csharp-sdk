...
namespace Gs2.Gs2StateMachine.Request
{
	...
	public class UpdateStateMachineMasterRequest : Gs2Request<UpdateStateMachineMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateStateMachineMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateStateMachineMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateStateMachineMasterRequest)x;
            return this;
        }
    }
}