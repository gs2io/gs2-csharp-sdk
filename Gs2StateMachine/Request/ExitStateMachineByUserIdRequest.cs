...
#endif
	[System.Serializable]
	public class ExitStateMachineByUserIdRequest : Gs2Request<ExitStateMachineByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static ExitStateMachineByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ExitStateMachineByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ExitStateMachineByUserIdRequest)x;
            return this;
        }
    }
}