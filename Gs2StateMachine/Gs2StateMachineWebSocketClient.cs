...
{
	public class Gs2StateMachineWebSocketClient : AbstractGs2Client
	{
		...
		public Gs2StateMachineWebSocketClient(Gs2WebSocketSession Gs2WebSocketSession) : base(Gs2WebSocketSession)
		{
