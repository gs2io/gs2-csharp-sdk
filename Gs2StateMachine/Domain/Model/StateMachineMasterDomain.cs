...
namespace Gs2.Gs2StateMachine.Domain.Model
{
    ...
    public partial class StateMachineMasterDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2StateMachine.Model.StateMachineMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2StateMachine.Model.StateMachineMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "stateMachineMaster")
                        {
        ...
        private async Task<Gs2.Gs2StateMachine.Model.StateMachineMaster> GetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithVersion(this.Version);
            GetStateMachineMasterResult result = null;
            try {
                result = await this._client.GetStateMachineMasterAsync(
                    request
                );
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2StateMachine.Domain.Model.StateMachineMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2StateMachine.Model.StateMachineMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class StateMachineMasterDomain {
        ...
        public IFuture<Gs2.Gs2StateMachine.Model.StateMachineMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2StateMachine.Model.StateMachineMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2StateMachine.Model.StateMachineMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2StateMachine.Model.StateMachineMaster>(
                        _parentKey,
                        Gs2.Gs2StateMachine.Domain.Model.StateMachineMasterDomain.CreateCacheKey(
                            this.Version?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2StateMachine.Model.StateMachineMaster>(
                _parentKey,
                Gs2.Gs2StateMachine.Domain.Model.StateMachineMasterDomain.CreateCacheKey(
                    this.Version.ToString()
                )
