...
namespace Gs2.Gs2StateMachine.Domain.Model
{
    ...
    public partial class StatusAccessTokenDomain {
        ...
        public string StatusName { get; } = null!;
        ...
        ) => ReportAsync(request).ToGs2Future();
        #endif
        ...
        ) => ExitStateMachineAsync(request).ToGs2Future();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2StateMachine.Model.Status> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2StateMachine.Model.Status> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2StateMachine.Model.Status> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2StateMachine.Model.Status> Model() => ModelAsync();
        #endif
