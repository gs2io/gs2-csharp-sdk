...
namespace Gs2.Gs2Inbox.Model.Cache
{
    public static partial class GlobalMessageMasterExt
    {
        public static void PutCache(
            this DeleteGlobalMessageMasterResult self,
            CacheDatabase cache,
            string userId,
            DeleteGlobalMessageMasterRequest request
        ) {
            (null as GlobalMessageMaster).DeleteCache(
                cache,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DeleteGlobalMessageMasterResult> InvokeFuture(
            this DeleteGlobalMessageMasterRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DeleteGlobalMessageMasterResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DeleteGlobalMessageMasterResult> self)
            {
            ...
            return new Gs2InlineFuture<DeleteGlobalMessageMasterResult>(Impl);
        }
#endif
