...
namespace Gs2.Gs2Inbox.Model
{
	public class ReceiveNotification
	{
        ...
        public ReceiveNotification WithUserId(string userId) {
            this.UserId = userId;
            return this;
        }
        public ReceiveNotification WithMessageName(string messageName) {
    	...
    	[Preserve]
#endif
        public static ReceiveNotification FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
