	...
	public partial class Namespace : IComparable
	{
        ...
        public static Namespace FromJson(JsonData data)
        {
            ...
            return new Namespace()
                ...
                .WithIsAutomaticDeletingEnabled(!data.Keys.Contains("isAutomaticDeletingEnabled") || data["isAutomaticDeletingEnabled"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableBool(data["isAutomaticDeletingEnabled"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(IsAutomaticDeletingEnabled, other.IsAutomaticDeletingEnabled);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(ReceiveMessageScript, other.ReceiveMessageScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ReadMessageScript, other.ReadMessageScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(DeleteMessageScript, other.DeleteMessageScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ReceiveNotification, other.ReceiveNotification);
            if (diff != 0)
            {
                return diff;
            }
