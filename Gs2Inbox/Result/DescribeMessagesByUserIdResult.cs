...
namespace Gs2.Gs2Inbox.Result
{
	...
	public class DescribeMessagesByUserIdResult : IResult
	{
        ...
        public DescribeMessagesByUserIdResult WithItems(Gs2.Gs2Inbox.Model.Message[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeMessagesByUserIdResult FromJson(JsonData data)
        {
            ...
            return new DescribeMessagesByUserIdResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Inbox.Model.Message[]{} : data["items"].Cast<JsonData>().Select(v => {
