...
#endif
	[System.Serializable]
	public class BatchReadMessagesResult : IResult
	{
        ...
        public BatchReadMessagesResult WithItems(Gs2.Gs2Inbox.Model.Message[] items) {
            this.Items = items;
            return this;
        }
        ...
        public BatchReadMessagesResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public BatchReadMessagesResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public BatchReadMessagesResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public BatchReadMessagesResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static BatchReadMessagesResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
