...
#endif
	[System.Serializable]
	public class PreUpdateCurrentMessageMasterResult : IResult
	{
        ...
        public PreUpdateCurrentMessageMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentMessageMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
