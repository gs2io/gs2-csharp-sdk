...
namespace Gs2.Gs2Inbox.Result
{
	...
	public class ReadMessageByUserIdResult : IResult
	{
        ...
        public ReadMessageByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReadMessageByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReadMessageByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReadMessageByUserIdResult WithMetadata(ResultMetadata metadata) {
