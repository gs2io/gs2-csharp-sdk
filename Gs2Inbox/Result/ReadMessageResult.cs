...
#endif
	[System.Serializable]
	public class ReadMessageResult : IResult
	{
        ...
        public ReadMessageResult WithItem(Gs2.Gs2Inbox.Model.Message item) {
            this.Item = item;
            return this;
        }
        ...
        public ReadMessageResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReadMessageResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReadMessageResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReadMessageResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReadMessageResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
