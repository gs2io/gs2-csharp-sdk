...
#endif
	[System.Serializable]
	public class BatchReadMessagesByUserIdResult : IResult
	{
        ...
        public BatchReadMessagesByUserIdResult WithItems(Gs2.Gs2Inbox.Model.Message[] items) {
            this.Items = items;
            return this;
        }
        ...
        public BatchReadMessagesByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public BatchReadMessagesByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public BatchReadMessagesByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public BatchReadMessagesByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static BatchReadMessagesByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
