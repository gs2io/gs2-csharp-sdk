...
namespace Gs2.Gs2Inbox.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Inbox.Model.CurrentMessageMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        if (future.Error.Errors[0].Component != "currentMessageMaster")
                        {
                            self.OnError(future.Error);
                            yield break;
                        }
    ...
    public partial class CurrentMessageMasterDomain {
        ...
        public IFuture<Gs2.Gs2Inbox.Model.CurrentMessageMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Inbox.Model.CurrentMessageMaster> self)
            {
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Inbox.Model.CurrentMessageMaster>(
                        _parentKey,
                        Gs2.Gs2Inbox.Domain.Model.CurrentMessageMasterDomain.CreateCacheKey(
                        )
                    );
        ...
        {
            this._cache.Unsubscribe<Gs2.Gs2Inbox.Model.CurrentMessageMaster>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.CurrentMessageMasterDomain.CreateCacheKey(
                ),
                callbackId
