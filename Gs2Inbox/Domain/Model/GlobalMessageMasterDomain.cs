...
namespace Gs2.Gs2Inbox.Domain.Model
{
    ...
    public partial class GlobalMessageMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Inbox.Model.GlobalMessageMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Inbox.Model.GlobalMessageMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Inbox.Model.GlobalMessageMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Inbox.Model.GlobalMessageMaster> Model() => ModelAsync();
        #endif
