...
namespace Gs2.Gs2Inbox.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "inbox:Gs2.Gs2Inbox.Model.Namespace";
        }
        ...
        public async Task<Gs2.Gs2Inbox.Domain.Model.NamespaceDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Inbox.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.NamespaceDomain.CreateCacheKey(
                    request.NamespaceName != null ? request.NamespaceName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Inbox.Domain.Model.GlobalMessageMasterDomain> CreateGlobalMessageMasterAsync(
            ...
            Gs2.Gs2Inbox.Domain.Model.GlobalMessageMasterDomain domain = new Gs2.Gs2Inbox.Domain.Model.GlobalMessageMasterDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Inbox.Model.GlobalMessage> GlobalMessages(
            #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Inbox.Model.GlobalMessageMaster> GlobalMessageMasters(
            #else
        ...
        public async Task<Gs2.Gs2Inbox.Model.Namespace> Model() {
            ...
            {
        #endif
            Gs2.Gs2Inbox.Model.Namespace value = _cache.Get<Gs2.Gs2Inbox.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.NamespaceDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Inbox.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName?.ToString()
                )
