    ...
    public partial class MessageAccessTokenDomain {
        ...
        private async Task<Gs2.Gs2Inbox.Model.Message> GetAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Inbox.Model.Message> self)
          {
            ...
            request
                ...
                .WithMessageName(this._messageName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        public async Task<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> OpenAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> self)
          {
            ...
            #endif
            _cache.ListCacheClear<Gs2.Gs2Inbox.Model.Message>(
                _parentKey.Replace("Message", "Message")
            );
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> ReadAsync(
            #else
        public IFuture<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> Read(
            #endif
        #else
        public async Task<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> ReadAsync(
        #endif
        ...
        public async Task<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> DeleteAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Inbox.Domain.Model.MessageAccessTokenDomain> self)
          {
            ...
            #endif
            _cache.Delete<Gs2.Gs2Inbox.Model.Message>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.MessageDomain.CreateCacheKey(
                    request.MessageName != null ? request.MessageName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Inbox.Model.Message> Model() {
            ...
            {
        #endif
            Gs2.Gs2Inbox.Model.Message value = _cache.Get<Gs2.Gs2Inbox.Model.Message>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.MessageDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Inbox.Model.Message>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.MessageDomain.CreateCacheKey(
                    this.MessageName?.ToString()
                )
