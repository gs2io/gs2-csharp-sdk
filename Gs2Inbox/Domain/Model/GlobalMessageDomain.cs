...
namespace Gs2.Gs2Inbox.Domain.Model
{
    ...
    public partial class GlobalMessageDomain {
        ...
        private async Task<Gs2.Gs2Inbox.Model.GlobalMessage> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetGlobalMessageAsync(request)
            );
            return result?.Item;
        }
    ...
    public partial class GlobalMessageDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Inbox.Model.GlobalMessage> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Inbox.Model.GlobalMessage>(
                        ...
                        (null as Gs2.Gs2Inbox.Model.GlobalMessage).CacheKey(
                            this.GlobalMessageName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Inbox.Model.GlobalMessage).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.GlobalMessageName,
                    null
                ...
                return await (null as Gs2.Gs2Inbox.Model.GlobalMessage).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.GlobalMessageName,
                    null,
        ...
        public UniTask<Gs2.Gs2Inbox.Model.GlobalMessage> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Inbox.Model.GlobalMessage> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Inbox.Model.GlobalMessage> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Inbox.Model.GlobalMessage).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.GlobalMessageName,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Inbox.Model.GlobalMessage> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Inbox.Model.GlobalMessage> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Inbox.Model.GlobalMessage> callback)
        #endif
        {
