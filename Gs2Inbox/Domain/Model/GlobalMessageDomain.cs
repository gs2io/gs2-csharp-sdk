...
namespace Gs2.Gs2Inbox.Domain.Model
{
    ...
    public partial class GlobalMessageDomain {
        ...
        public async Task<Gs2.Gs2Inbox.Model.GlobalMessage> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Inbox.Model.GlobalMessage>(
                       _parentKey,
            ...
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Inbox.Model.GlobalMessage>(
                _parentKey,
                Gs2.Gs2Inbox.Domain.Model.GlobalMessageDomain.CreateCacheKey(
                    this.GlobalMessageName?.ToString()
                )
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            _cache.Put<Gs2.Gs2Inbox.Model.GlobalMessage>(
                                _parentKey,
                                key,
                                null,
                                UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Inbox.Model.GlobalMessage>(
                    _parentKey,
                    Gs2.Gs2Inbox.Domain.Model.GlobalMessageDomain.CreateCacheKey(
                        this.GlobalMessageName?.ToString()
                    )
