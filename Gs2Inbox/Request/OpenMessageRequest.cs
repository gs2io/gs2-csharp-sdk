...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class OpenMessageRequest : Gs2Request<OpenMessageRequest>
	{
    	...
    	[Preserve]
#endif
        public static OpenMessageRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply OpenMessageRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (OpenMessageRequest)x;
            return this;
        }
    }
}