...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class GetReceivedByUserIdRequest : Gs2Request<GetReceivedByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetReceivedByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetReceivedByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetReceivedByUserIdRequest)x;
            return this;
        }
    }
}