...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class GetGlobalMessageRequest : Gs2Request<GetGlobalMessageRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGlobalMessageRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetGlobalMessageRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetGlobalMessageRequest)x;
            return this;
        }
    }
}