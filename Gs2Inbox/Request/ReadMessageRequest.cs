...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class ReadMessageRequest : Gs2Request<ReadMessageRequest>
	{
    	...
    	[Preserve]
#endif
        public static ReadMessageRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ReadMessageRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ReadMessageRequest)x;
            return this;
        }
    }
}