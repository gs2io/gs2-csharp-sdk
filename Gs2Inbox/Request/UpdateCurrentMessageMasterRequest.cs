...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class UpdateCurrentMessageMasterRequest : Gs2Request<UpdateCurrentMessageMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentMessageMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentMessageMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentMessageMasterRequest)x;
            return this;
        }
    }
}