...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class DescribeGlobalMessagesRequest : Gs2Request<DescribeGlobalMessagesRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeGlobalMessagesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeGlobalMessagesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeGlobalMessagesRequest)x;
            return this;
        }
    }
}