...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class DeleteMessageByStampTaskRequest : Gs2Request<DeleteMessageByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteMessageByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteMessageByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteMessageByStampTaskRequest)x;
            return this;
        }
    }
}