...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class ReceiveGlobalMessageByUserIdRequest : Gs2Request<ReceiveGlobalMessageByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static ReceiveGlobalMessageByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ReceiveGlobalMessageByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ReceiveGlobalMessageByUserIdRequest)x;
            return this;
        }
    }
}