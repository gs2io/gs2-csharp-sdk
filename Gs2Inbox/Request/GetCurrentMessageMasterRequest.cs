...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class GetCurrentMessageMasterRequest : Gs2Request<GetCurrentMessageMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentMessageMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentMessageMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentMessageMasterRequest)x;
            return this;
        }
    }
}