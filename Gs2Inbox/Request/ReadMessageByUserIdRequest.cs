...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class ReadMessageByUserIdRequest : Gs2Request<ReadMessageByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static ReadMessageByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new ReadMessageByUserIdRequest()
                ...
                .WithConfig(!data.Keys.Contains("config") || data["config"] == null ? new Gs2.Gs2Inbox.Model.Config[]{} : data["config"].Cast<JsonData>().Select(v => {
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ReadMessageByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ReadMessageByUserIdRequest)x;
            return this;
        }
    }
}