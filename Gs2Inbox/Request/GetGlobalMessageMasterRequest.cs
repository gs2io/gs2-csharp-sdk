...
namespace Gs2.Gs2Inbox.Request
{
	...
	public class GetGlobalMessageMasterRequest : Gs2Request<GetGlobalMessageMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGlobalMessageMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetGlobalMessageMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetGlobalMessageMasterRequest)x;
            return this;
        }
    }
}