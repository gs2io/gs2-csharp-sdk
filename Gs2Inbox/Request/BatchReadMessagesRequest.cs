...
#endif
	[System.Serializable]
	public class BatchReadMessagesRequest : Gs2Request<BatchReadMessagesRequest>
	{
        ...
        public BatchReadMessagesRequest WithMessageNames(string[] messageNames) {
            this.MessageNames = messageNames;
            return this;
        }
        public BatchReadMessagesRequest WithConfig(Gs2.Gs2Inbox.Model.Config[] config) {
            this.Config = config;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static BatchReadMessagesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
