...
namespace Gs2.Gs2Gateway.Request
{
	...
	public class DescribeWebSocketSessionsRequest : Gs2Request<DescribeWebSocketSessionsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeWebSocketSessionsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeWebSocketSessionsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeWebSocketSessionsRequest)x;
            return this;
        }
    }
}