...
namespace Gs2.Gs2Gateway.Request
{
	...
	public class DisconnectAllRequest : Gs2Request<DisconnectAllRequest>
	{
    	...
    	[Preserve]
#endif
        public static DisconnectAllRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DisconnectAllRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DisconnectAllRequest)x;
            return this;
        }
    }
}