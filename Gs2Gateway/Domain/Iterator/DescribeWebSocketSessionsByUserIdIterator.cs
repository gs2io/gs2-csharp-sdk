...
namespace Gs2.Gs2Gateway.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeWebSocketSessionsByUserIdIterator : Gs2Iterator<Gs2.Gs2Gateway.Model.WebSocketSession> {
    #else
    public class DescribeWebSocketSessionsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Gateway.Model.WebSocketSession> {
    #endif
