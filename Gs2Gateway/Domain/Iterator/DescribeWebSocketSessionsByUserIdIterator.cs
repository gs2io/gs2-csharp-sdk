...
namespace Gs2.Gs2Gateway.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Gateway.Model.WebSocketSession>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Gateway.Model.WebSocketSession>
    #else
        IAsyncEnumerable<Gs2.Gs2Gateway.Model.WebSocketSession>
    #endif
    {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Gateway.Model.WebSocketSession>
            (
                ...
                var request = new Gs2.Gs2Gateway.Request.DescribeWebSocketSessionsByUserIdRequest()
                    .WithContextStack(this._gs2.DefaultContextStack)
                    .WithNamespaceName(this.NamespaceName)
                    .WithUserId(this.UserId)
                    .WithPageToken(this._pageToken)
                    .WithLimit(fetchSize);
                var r = await this._client.DescribeWebSocketSessionsByUserIdAsync(
                    request
                );
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Gateway.Model.WebSocketSession>(
                        (null as Gs2.Gs2Gateway.Model.WebSocketSession).CacheParentKey(
                            NamespaceName,
                            UserId,
                            null
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Gateway.Model.WebSocketSession>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Gateway.Model.WebSocketSession>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Gateway.Model.WebSocketSession> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Gateway.Model.WebSocketSession>(async (writer, token) =>
        #else
