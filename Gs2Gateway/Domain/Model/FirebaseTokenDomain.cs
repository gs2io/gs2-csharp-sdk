...
namespace Gs2.Gs2Gateway.Domain.Model
{
    ...
    public partial class FirebaseTokenDomain {
        ...
        public IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> SetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> self)
            {
                ...
                var future = this._client.SetFirebaseTokenByUserIdFuture(
                    request
                );
                yield return future;
        ...
        public async Task<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> SetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithUserId(this.UserId);
            SetFirebaseTokenByUserIdResult result = null;
                result = await this._client.SetFirebaseTokenByUserIdAsync(
                    request
                );
        ...
        public IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> Set(
            SetFirebaseTokenByUserIdRequest request
        ) {
        ...
        private IFuture<Gs2.Gs2Gateway.Model.FirebaseToken> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Gateway.Model.FirebaseToken> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName)
                    .WithUserId(this.UserId);
                var future = this._client.GetFirebaseTokenByUserIdFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Gateway.Model.FirebaseToken>(
                            _parentKey,
                            key,
                            null,
                            UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        private async Task<Gs2.Gs2Gateway.Model.FirebaseToken> GetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithUserId(this.UserId);
            GetFirebaseTokenByUserIdResult result = null;
            try {
                result = await this._client.GetFirebaseTokenByUserIdAsync(
                    request
                );
        ...
        public IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> DeleteFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName)
                    .WithUserId(this.UserId);
                var future = this._client.DeleteFirebaseTokenByUserIdFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
        ...
        public async Task<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> DeleteAsync(
            ...
            try {
                result = await this._client.DeleteFirebaseTokenByUserIdAsync(
                    request
                );
            } catch (Gs2.Core.Exception.NotFoundException e) {
                var key = Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain.CreateCacheKey(
        ...
        public IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> Delete(
            DeleteFirebaseTokenByUserIdRequest request
        ) {
        ...
        public IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> SendMobileNotificationFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> self)
            {
                request
                    .WithNamespaceName(this.NamespaceName)
                    .WithUserId(this.UserId);
                var future = this._client.SendMobileNotificationByUserIdFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
        ...
        public async Task<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> SendMobileNotificationAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithUserId(this.UserId);
            SendMobileNotificationByUserIdResult result = null;
                result = await this._client.SendMobileNotificationByUserIdAsync(
                    request
                );
        ...
        #if UNITY_2017_1_OR_NEWER
        [Obsolete("The name has been changed to SendMobileNotificationFuture.")]
        public IFuture<Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain> SendMobileNotification(
            SendMobileNotificationByUserIdRequest request
        ) {
            return SendMobileNotificationFuture(request);
        }
        #endif
    ...
    public partial class FirebaseTokenDomain {
        ...
        public IFuture<Gs2.Gs2Gateway.Model.FirebaseToken> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Gateway.Model.FirebaseToken> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Gateway.Model.FirebaseToken>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Gateway.Model.FirebaseToken>(
                        _parentKey,
                        Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain.CreateCacheKey(
                        )
                    );
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Gateway.Model.FirebaseToken>(
                _parentKey,
                Gs2.Gs2Gateway.Domain.Model.FirebaseTokenDomain.CreateCacheKey(
                )
            );
