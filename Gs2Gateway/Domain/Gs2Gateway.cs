...
namespace Gs2.Gs2Gateway.Domain
{
    ...
    public class Gs2Gateway {
        ...
        public async Task<Gs2.Gs2Gateway.Domain.Model.NamespaceDomain> CreateNamespaceAsync(
            ...
            Gs2.Gs2Gateway.Domain.Model.NamespaceDomain domain = new Gs2.Gs2Gateway.Domain.Model.NamespaceDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Gateway.Model.Namespace> Namespaces(
            #else
