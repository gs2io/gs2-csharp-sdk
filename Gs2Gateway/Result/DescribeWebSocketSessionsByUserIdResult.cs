...
#endif
	[System.Serializable]
	public class DescribeWebSocketSessionsByUserIdResult : IResult
	{
        public Gs2.Gs2Gateway.Model.WebSocketSession[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeWebSocketSessionsByUserIdResult WithItems(Gs2.Gs2Gateway.Model.WebSocketSession[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeWebSocketSessionsByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeWebSocketSessionsByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
