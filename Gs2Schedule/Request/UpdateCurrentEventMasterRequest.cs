...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class UpdateCurrentEventMasterRequest : Gs2Request<UpdateCurrentEventMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentEventMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentEventMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentEventMasterRequest)x;
            return this;
        }
    }
}