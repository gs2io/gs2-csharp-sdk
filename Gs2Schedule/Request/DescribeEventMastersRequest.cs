...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class DescribeEventMastersRequest : Gs2Request<DescribeEventMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeEventMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeEventMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeEventMastersRequest)x;
            return this;
        }
    }
}