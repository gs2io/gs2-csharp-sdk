...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class TriggerByStampSheetRequest : Gs2Request<TriggerByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static TriggerByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply TriggerByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (TriggerByStampSheetRequest)x;
            return this;
        }
    }
}