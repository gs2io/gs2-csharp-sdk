...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class DeleteTriggerByStampTaskRequest : Gs2Request<DeleteTriggerByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteTriggerByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteTriggerByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteTriggerByStampTaskRequest)x;
            return this;
        }
    }
}