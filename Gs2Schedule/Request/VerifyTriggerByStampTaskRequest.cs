...
#endif
	[System.Serializable]
	public class VerifyTriggerByStampTaskRequest : Gs2Request<VerifyTriggerByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyTriggerByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
