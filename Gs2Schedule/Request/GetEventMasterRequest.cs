...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class GetEventMasterRequest : Gs2Request<GetEventMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetEventMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetEventMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetEventMasterRequest)x;
            return this;
        }
    }
}