...
namespace Gs2.Gs2Schedule.Request
{
	...
	public class GetTriggerByUserIdRequest : Gs2Request<GetTriggerByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetTriggerByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetTriggerByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetTriggerByUserIdRequest)x;
            return this;
        }
    }
}