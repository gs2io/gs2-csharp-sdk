...
#endif
	[System.Serializable]
	public class VerifyTriggerResult : IResult
	{
        public Gs2.Gs2Schedule.Model.Trigger Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyTriggerResult WithItem(Gs2.Gs2Schedule.Model.Trigger item) {
            this.Item = item;
            return this;
        }

        public VerifyTriggerResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyTriggerResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
