...
#endif
	[System.Serializable]
	public class GetTriggerResult : IResult
	{
        public Gs2.Gs2Schedule.Model.Trigger Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public GetTriggerResult WithItem(Gs2.Gs2Schedule.Model.Trigger item) {
            this.Item = item;
            return this;
        }

        public GetTriggerResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetTriggerResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
