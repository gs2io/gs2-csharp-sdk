...
#endif
	[System.Serializable]
	public class PreUpdateCurrentEventMasterResult : IResult
	{
        ...
        public PreUpdateCurrentEventMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentEventMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
