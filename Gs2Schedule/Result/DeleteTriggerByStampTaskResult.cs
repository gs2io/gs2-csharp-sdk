...
#endif
	[System.Serializable]
	public class DeleteTriggerByStampTaskResult : IResult
	{
        public Gs2.Gs2Schedule.Model.Trigger Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DeleteTriggerByStampTaskResult WithItem(Gs2.Gs2Schedule.Model.Trigger item) {
            this.Item = item;
            return this;
        }
        ...
        public DeleteTriggerByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteTriggerByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
