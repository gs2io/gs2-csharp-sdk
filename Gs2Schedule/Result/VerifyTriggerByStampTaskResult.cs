...
#endif
	[System.Serializable]
	public class VerifyTriggerByStampTaskResult : IResult
	{
        public Gs2.Gs2Schedule.Model.Trigger Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyTriggerByStampTaskResult WithItem(Gs2.Gs2Schedule.Model.Trigger item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyTriggerByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyTriggerByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
