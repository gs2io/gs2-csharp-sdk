...
#endif
	[System.Serializable]
	public class VerifyEventResult : IResult
	{
        ...
        public VerifyEventResult WithItem(Gs2.Gs2Schedule.Model.Event item) {
            this.Item = item;
            return this;
        }

        public VerifyEventResult WithInSchedule(bool? inSchedule) {
        ...
        public VerifyEventResult WithRepeatSchedule(Gs2.Gs2Schedule.Model.RepeatSchedule repeatSchedule) {
            this.RepeatSchedule = repeatSchedule;
            return this;
        }

        public VerifyEventResult WithIsGlobalSchedule(bool? isGlobalSchedule) {
            this.IsGlobalSchedule = isGlobalSchedule;
            return this;
        }

        public VerifyEventResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyEventResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
