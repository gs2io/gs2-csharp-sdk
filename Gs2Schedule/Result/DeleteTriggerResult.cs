...
#endif
	[System.Serializable]
	public class DeleteTriggerResult : IResult
	{
        public Gs2.Gs2Schedule.Model.Trigger Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DeleteTriggerResult WithItem(Gs2.Gs2Schedule.Model.Trigger item) {
            this.Item = item;
            return this;
        }

        public DeleteTriggerResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteTriggerResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
