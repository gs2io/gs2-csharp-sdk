...
namespace Gs2.Gs2Schedule.Domain.Model
{
    ...
    {
        public Gs2.Gs2Schedule.Domain.Model.RepeatScheduleDomain RepeatSchedule(
        ) {
            return new Gs2.Gs2Schedule.Domain.Model.RepeatScheduleDomain(
                this._gs2,
                this.NamespaceName,
                this.UserId,
                this.EventName,
    ...
    public partial class RepeatScheduleDomain {
        ...
        public bool? InSchedule { get; } = null!;

        public RepeatScheduleDomain(
