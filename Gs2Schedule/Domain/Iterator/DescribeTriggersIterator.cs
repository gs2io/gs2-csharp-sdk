    ...
    public class DescribeTriggersIterator : IAsyncEnumerable<Gs2.Gs2Schedule.Model.Trigger> {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Schedule.Request.DescribeTriggersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Schedule.Model.Trigger>(
                        (null as Gs2.Gs2Schedule.Model.Trigger).CacheParentKey(
                            NamespaceName,
                            AccessToken?.UserId
                        )
