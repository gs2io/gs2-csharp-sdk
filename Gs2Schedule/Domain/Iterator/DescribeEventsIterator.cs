...
namespace Gs2.Gs2Schedule.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeEventsIterator : Gs2Iterator<Gs2.Gs2Schedule.Model.Event> {
    #else
    public class DescribeEventsIterator : IAsyncEnumerable<Gs2.Gs2Schedule.Model.Event> {
    #endif
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Schedule.Model.Event>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Schedule.Model.Event>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeEventsFuture(
                #else
                var r = await this._client.DescribeEventsAsync(
                #endif
        ...
        )
        {
            yield return UniTask.ToCoroutine(
                async () => {
                    ...
                    Gs2.Gs2Schedule.Model.Event ret = this._result[0];
