...
namespace Gs2.Gs2Schedule.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentEventMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentEventMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentEventMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentEventMaster", "schedule.currentEventMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentEventMaster", "schedule.currentEventMaster.settings.error.tooLong"),
                    });
                }
            }
        }
