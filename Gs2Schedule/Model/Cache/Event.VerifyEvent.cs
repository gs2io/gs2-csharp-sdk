...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<VerifyEventResult> InvokeFuture(
            this VerifyEventRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<VerifyEventResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<VerifyEventResult> self)
            {
            ...
            return new Gs2InlineFuture<VerifyEventResult>(Impl);
        }
#endif
