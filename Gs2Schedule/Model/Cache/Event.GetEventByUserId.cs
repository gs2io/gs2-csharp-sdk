...
namespace Gs2.Gs2Schedule.Model.Cache
{
    public static partial class EventExt
    {
        public static void PutCache(
            this GetEventByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<GetEventByUserIdResult> InvokeFuture(
            this GetEventByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<GetEventByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<GetEventByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<GetEventByUserIdResult>(Impl);
        }
#endif
