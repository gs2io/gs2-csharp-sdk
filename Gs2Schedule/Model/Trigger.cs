	...
	public partial class Trigger : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Trigger.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(TriggerId, other.TriggerId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(TriggeredAt, other.TriggeredAt);
            if (diff != 0)
            {
                return diff;
            }
