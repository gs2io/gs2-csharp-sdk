...
namespace Gs2.HybridWebSocket
{
    ...
    public class WebSocket : IWebSocket
    {
        ...
        /// </summary>
        protected Gs2.Util.WebSocketSharp.WebSocket ws;
        ...
        public WebSocket(string url)
        {
            ...
            try
            {
                ...
                this.ws = new Gs2.Util.WebSocketSharp.WebSocket(url);
        ...
        public void Connect()
        {
            ...
            // Check state
            if (this.ws.ReadyState == Gs2.Util.WebSocketSharp.WebSocketState.Open || this.ws.ReadyState == Gs2.Util.WebSocketSharp.WebSocketState.Closing)
        ...
        public void Close(WebSocketCloseCode code = WebSocketCloseCode.Normal, string reason = null)
        {
            ...
            // Check state
            if (this.ws.ReadyState == Gs2.Util.WebSocketSharp.WebSocketState.Closing)
                throw new WebSocketInvalidStateException("WebSocket is already closing.");

            if (this.ws.ReadyState == Gs2.Util.WebSocketSharp.WebSocketState.Closed)
        ...
        public WebSocketState GetState()
        {
            ...
            {
                case Gs2.Util.WebSocketSharp.WebSocketState.Connecting:
                    return WebSocketState.Connecting;

                case Gs2.Util.WebSocketSharp.WebSocketState.Open:
                    return WebSocketState.Open;

                case Gs2.Util.WebSocketSharp.WebSocketState.Closing:
                    return WebSocketState.Closing;

                case Gs2.Util.WebSocketSharp.WebSocketState.Closed:
                    return WebSocketState.Closed;
