...
#endif
	[System.Serializable]
	public class DoSeasonMatchmakingResult : IResult
	{
        public Gs2.Gs2Matchmaking.Model.SeasonGathering Item { set; get; }
        public string MatchmakingContextToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DoSeasonMatchmakingResult WithItem(Gs2.Gs2Matchmaking.Model.SeasonGathering item) {
            this.Item = item;
            return this;
        }
        ...
        public DoSeasonMatchmakingResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DoSeasonMatchmakingResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
