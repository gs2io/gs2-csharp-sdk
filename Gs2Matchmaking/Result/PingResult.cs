...
namespace Gs2.Gs2Matchmaking.Result
{
	...
	public class PingResult : IResult
	{
        ...
        public PingResult WithItem(Gs2.Gs2Matchmaking.Model.Gathering item) {
            this.Item = item;
            return this;
        }

        public PingResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PingResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
