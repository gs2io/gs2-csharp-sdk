...
namespace Gs2.Gs2Matchmaking.Result
{
	[Preserve]
	[System.Serializable]
	public class UpdateCurrentRatingModelMasterResult : IResult
	{
        public Gs2.Gs2Matchmaking.Model.CurrentRatingModelMaster Item { set; get; }

        public UpdateCurrentRatingModelMasterResult WithItem(Gs2.Gs2Matchmaking.Model.CurrentRatingModelMaster item) {
            this.Item = item;
            return this;
        }

    	[Preserve]
        public static UpdateCurrentRatingModelMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
