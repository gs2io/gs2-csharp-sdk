...
#endif
	[System.Serializable]
	public class DescribeRatingsByUserIdResult : IResult
	{
        public Gs2.Gs2Matchmaking.Model.Rating[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeRatingsByUserIdResult WithItems(Gs2.Gs2Matchmaking.Model.Rating[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeRatingsByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeRatingsByUserIdResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Matchmaking.Model.Rating[]{} : data["items"].Cast<JsonData>().Select(v => {
