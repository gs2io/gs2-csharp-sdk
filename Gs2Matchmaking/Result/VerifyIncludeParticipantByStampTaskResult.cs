...
#endif
	[System.Serializable]
	public class VerifyIncludeParticipantByStampTaskResult : IResult
	{
        public Gs2.Gs2Matchmaking.Model.SeasonGathering Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyIncludeParticipantByStampTaskResult WithItem(Gs2.Gs2Matchmaking.Model.SeasonGathering item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyIncludeParticipantByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyIncludeParticipantByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
