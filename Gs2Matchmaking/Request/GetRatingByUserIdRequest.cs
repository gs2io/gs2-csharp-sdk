...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class GetRatingByUserIdRequest : Gs2Request<GetRatingByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetRatingByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetRatingByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetRatingByUserIdRequest)x;
            return this;
        }
    }
}