...
#endif
	[System.Serializable]
	public class VerifyIncludeParticipantByUserIdRequest : Gs2Request<VerifyIncludeParticipantByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyIncludeParticipantByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
