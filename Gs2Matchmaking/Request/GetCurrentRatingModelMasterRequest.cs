...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class GetCurrentRatingModelMasterRequest : Gs2Request<GetCurrentRatingModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentRatingModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentRatingModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentRatingModelMasterRequest)x;
            return this;
        }
    }
}