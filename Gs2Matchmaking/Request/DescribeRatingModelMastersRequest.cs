...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class DescribeRatingModelMastersRequest : Gs2Request<DescribeRatingModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRatingModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRatingModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRatingModelMastersRequest)x;
            return this;
        }
    }
}