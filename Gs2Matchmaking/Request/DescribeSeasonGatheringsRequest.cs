...
#endif
	[System.Serializable]
	public class DescribeSeasonGatheringsRequest : Gs2Request<DescribeSeasonGatheringsRequest>
	{
        ...
        public DescribeSeasonGatheringsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSeasonGatheringsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
