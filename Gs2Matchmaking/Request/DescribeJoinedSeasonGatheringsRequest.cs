...
#endif
	[System.Serializable]
	public class DescribeJoinedSeasonGatheringsRequest : Gs2Request<DescribeJoinedSeasonGatheringsRequest>
	{
        ...
        public DescribeJoinedSeasonGatheringsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeJoinedSeasonGatheringsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
