...
#endif
	[System.Serializable]
	public class DescribeJoinedSeasonGatheringsByUserIdRequest : Gs2Request<DescribeJoinedSeasonGatheringsByUserIdRequest>
	{
        ...
        public DescribeJoinedSeasonGatheringsByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeJoinedSeasonGatheringsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
