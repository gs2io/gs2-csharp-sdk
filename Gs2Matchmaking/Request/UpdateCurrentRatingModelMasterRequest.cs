...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class UpdateCurrentRatingModelMasterRequest : Gs2Request<UpdateCurrentRatingModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentRatingModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentRatingModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentRatingModelMasterRequest)x;
            return this;
        }
    }
}