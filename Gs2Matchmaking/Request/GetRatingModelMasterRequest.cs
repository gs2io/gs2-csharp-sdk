...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class GetRatingModelMasterRequest : Gs2Request<GetRatingModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetRatingModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetRatingModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetRatingModelMasterRequest)x;
            return this;
        }
    }
}