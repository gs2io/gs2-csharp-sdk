...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class CancelMatchmakingRequest : Gs2Request<CancelMatchmakingRequest>
	{
    	...
    	[Preserve]
#endif
        public static CancelMatchmakingRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply CancelMatchmakingRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (CancelMatchmakingRequest)x;
            return this;
        }
    }
}