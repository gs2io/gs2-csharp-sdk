	...
	public class VoteMultipleRequest : Gs2Request<VoteMultipleRequest>
	{
        ...
        public static VoteMultipleRequest FromJson(JsonData data)
        {
            ...
            return new VoteMultipleRequest()
                ...
                .WithSignedBallots(!data.Keys.Contains("signedBallots") || data["signedBallots"] == null || !data["signedBallots"].IsArray ? new Gs2.Gs2Matchmaking.Model.SignedBallot[]{} : data["signedBallots"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Matchmaking.Model.SignedBallot.FromJson(v);
                }).ToArray())
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VoteMultipleRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VoteMultipleRequest)x;
            return this;
        }
    }
}