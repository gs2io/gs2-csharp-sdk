...
namespace Gs2.Gs2Matchmaking.Request
{
	...
	public class DescribeRatingsByUserIdRequest : Gs2Request<DescribeRatingsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRatingsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRatingsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRatingsByUserIdRequest)x;
            return this;
        }
    }
}