...
namespace Gs2.Gs2Matchmaking.Model
{
	...
	public partial class CurrentModelMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentModelMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        {
            var other = obj as CurrentModelMaster;
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentModelMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentModelMaster", "matchmaking.currentModelMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentModelMaster", "matchmaking.currentModelMaster.settings.error.tooLong"),
                    });
                }
            }
        }
