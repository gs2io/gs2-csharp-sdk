...
namespace Gs2.Gs2Matchmaking.Model.Cache
{
    public static partial class RatingModelMasterExt
    {
        public static void PutCache(
            this CreateRatingModelMasterResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<CreateRatingModelMasterResult> InvokeFuture(
            this CreateRatingModelMasterRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<CreateRatingModelMasterResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<CreateRatingModelMasterResult> self)
            {
            ...
            return new Gs2InlineFuture<CreateRatingModelMasterResult>(Impl);
        }
#endif
