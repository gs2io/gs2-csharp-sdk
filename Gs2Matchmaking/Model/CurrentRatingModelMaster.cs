...
namespace Gs2.Gs2Matchmaking.Model
{
	...
	public class CurrentRatingModelMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentRatingModelMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentRatingModelMaster", "matchmaking.currentRatingModelMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentRatingModelMaster", "matchmaking.currentRatingModelMaster.settings.error.tooLong"),
                    });
                }
            }
        }
