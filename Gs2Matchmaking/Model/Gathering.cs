...
namespace Gs2.Gs2Matchmaking.Model
{
	...
	[Preserve]
#endif
	public partial class Gathering : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Gathering.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(GatheringId, other.GatheringId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.CompareArray(AttributeRanges, other.AttributeRanges);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.CompareArray(CapacityOfRoles, other.CapacityOfRoles);
            if (diff != 0)
            {
                return diff;
            }
