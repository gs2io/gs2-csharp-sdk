...
namespace Gs2.Gs2Matchmaking.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #else
        public async Task<ulong> SubscribeRatingModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Matchmaking.Model.RatingModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeRatingModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Matchmaking.Model.RatingModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateRatingModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Matchmaking.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Matchmaking.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Matchmaking.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Matchmaking.Model.Namespace> Model() => ModelAsync();
        #endif
