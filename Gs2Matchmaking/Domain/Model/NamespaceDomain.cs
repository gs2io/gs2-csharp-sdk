...
namespace Gs2.Gs2Matchmaking.Domain.Model
{
    ...
    public partial class NamespaceDomain {
            ...
            if (result.Item != null) {
                _cache.Put(
                    ...
                    Gs2.Gs2Matchmaking.Domain.Model.BallotDomain.CreateCacheKey(
                        result.Item?.RatingName?.ToString(),
                        result.Item?.GatheringName?.ToString(),
                        result.Item?.NumberOfPlayer?.ToString(),
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Matchmaking.Model.RatingModel> RatingModels(
            #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Matchmaking.Model.RatingModelMaster> RatingModelMasters(
            #else
