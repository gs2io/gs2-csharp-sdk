...
namespace Gs2.Gs2Matchmaking.Domain.Model
{
    ...
    public partial class RatingModelDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Matchmaking.Model.RatingModel> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Matchmaking.Model.RatingModel>(
                            _parentKey,
                            key,
                            null,
        ...
        private async Task<Gs2.Gs2Matchmaking.Model.RatingModel> GetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithRatingName(this.RatingName);
            GetRatingModelResult result = null;
            try {
                result = await this._client.GetRatingModelAsync(
                    request
                );
    ...
    public partial class RatingModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Matchmaking.Model.RatingModel> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Matchmaking.Model.RatingModel> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Matchmaking.Model.RatingModel>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Matchmaking.Model.RatingModel>(
                        _parentKey,
                        Gs2.Gs2Matchmaking.Domain.Model.RatingModelDomain.CreateCacheKey(
                            this.RatingName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Matchmaking.Model.RatingModel>(
                _parentKey,
                Gs2.Gs2Matchmaking.Domain.Model.RatingModelDomain.CreateCacheKey(
                    this.RatingName.ToString()
                )
