...
namespace Gs2.Gs2Matchmaking.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DoSeasonMatchmakingByUserIdIterator : Gs2Iterator<Gs2.Gs2Matchmaking.Model.SeasonGathering> {
    #else
    public class DoSeasonMatchmakingByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Matchmaking.Model.SeasonGathering> {
    #endif
