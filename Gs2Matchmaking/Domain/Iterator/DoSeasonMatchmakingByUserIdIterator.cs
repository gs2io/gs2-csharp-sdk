...
namespace Gs2.Gs2Matchmaking.Domain.Iterator
{
    ...
    public class DoSeasonMatchmakingByUserIdIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Matchmaking.Model.SeasonGathering>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Matchmaking.Model.SeasonGathering>
    #else
        IAsyncEnumerable<Gs2.Gs2Matchmaking.Model.SeasonGathering>
    #endif
    {
        ...
        public DoSeasonMatchmakingByUserIdIterator(
        ...
        private async Task _load() {
            ...
            var request = new Gs2.Gs2Matchmaking.Request.DoSeasonMatchmakingByUserIdRequest()
                .WithContextStack(this._gs2.DefaultContextStack)
                .WithNamespaceName(this.NamespaceName)
                .WithSeasonName(this.SeasonName)
                .WithUserId(this.UserId)
                .WithMatchmakingContextToken(this._matchmakingContextToken);
            var r = await this._client.DoSeasonMatchmakingByUserIdAsync(
                request
            );
            this._result = new []{
                r.Item
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Matchmaking.Model.SeasonGathering> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Matchmaking.Model.SeasonGathering>(async (writer, token) =>
        #else
