...
namespace Gs2.Gs2Matchmaking.Domain.Iterator
{
    ...
    public class DescribeJoinedSeasonGatheringsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering> {
        ...
        public DescribeJoinedSeasonGatheringsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering>
            (
                ...
                var request = new Gs2.Gs2Matchmaking.Request.DescribeJoinedSeasonGatheringsByUserIdRequest()
                ...
                var future = this._client.DescribeJoinedSeasonGatheringsByUserIdFuture(
                #else
                var r = await this._client.DescribeJoinedSeasonGatheringsByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering>(
                        (null as Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering).CacheParentKey(
                            NamespaceName,
                            UserId,
                            SeasonName,
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
                using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering>(
                        (null as Gs2.Gs2Matchmaking.Model.JoinedSeasonGathering).CacheParentKey(
                            NamespaceName,
                            UserId,
                            SeasonName,
