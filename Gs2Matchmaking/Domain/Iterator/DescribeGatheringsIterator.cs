...
namespace Gs2.Gs2Matchmaking.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeGatheringsIterator : Gs2Iterator<Gs2.Gs2Matchmaking.Model.Gathering> {
    #else
    public class DescribeGatheringsIterator : IAsyncEnumerable<Gs2.Gs2Matchmaking.Model.Gathering> {
    #endif
