...
namespace Gs2.Gs2Matchmaking.Domain.Iterator
{
    ...
    public class DoSeasonMatchmakingIterator :
    #if UNITY_2017_1_OR_NEWER
    ...
    #endif
    {
        ...
        public DoSeasonMatchmakingIterator(
        ...
        private async Task _load() {
            ...
            var request = new Gs2.Gs2Matchmaking.Request.DoSeasonMatchmakingRequest()
            ...
            var r = await this._client.DoSeasonMatchmakingAsync(
                request
            );
            this._result = new []{
                r.Item
