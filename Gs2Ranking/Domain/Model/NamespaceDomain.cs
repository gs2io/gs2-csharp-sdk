...
namespace Gs2.Gs2Ranking.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "ranking:Gs2.Gs2Ranking.Model.Namespace";
        }
        ...
        public async Task<Gs2.Gs2Ranking.Domain.Model.NamespaceDomain> GetStatusAsync(
            ...
            #endif
            Gs2.Gs2Ranking.Domain.Model.NamespaceDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Ranking.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Ranking.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2Ranking.Domain.Model.NamespaceDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Ranking.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheKey(
                    request.NamespaceName != null ? request.NamespaceName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Ranking.Domain.Model.CategoryModelMasterDomain> CreateCategoryModelMasterAsync(
            ...
            Gs2.Gs2Ranking.Domain.Model.CategoryModelMasterDomain domain = new Gs2.Gs2Ranking.Domain.Model.CategoryModelMasterDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Ranking.Model.CategoryModel> CategoryModels(
            #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Ranking.Model.CategoryModelMaster> CategoryModelMasters(
            #else
        ...
        public async Task<Gs2.Gs2Ranking.Model.Namespace> Model() {
            ...
            {
        #endif
            Gs2.Gs2Ranking.Model.Namespace value = _cache.Get<Gs2.Gs2Ranking.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Ranking.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName?.ToString()
                )
