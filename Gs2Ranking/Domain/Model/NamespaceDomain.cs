...
namespace Gs2.Gs2Ranking.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        {
            return this._cache.ListSubscribe<Gs2.Gs2Ranking.Model.CategoryModel>(
        ...
        {
            this._cache.ListUnsubscribe<Gs2.Gs2Ranking.Model.CategoryModel>(
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "CategoryModel"
                ),
        ...
        {
            return this._cache.ListSubscribe<Gs2.Gs2Ranking.Model.CategoryModelMaster>(
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "CategoryModelMaster"
                ),
        ...
        {
            this._cache.ListUnsubscribe<Gs2.Gs2Ranking.Model.CategoryModelMaster>(
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheParentKey(
                    this.NamespaceName,
                    "CategoryModelMaster"
                ),
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        _cache.Put<Gs2.Gs2Ranking.Model.Namespace>(
                            _parentKey,
                            key,
                            null,
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (resultModel != null) {
                    
                    {
                        ...
                        cache.Delete<Gs2.Gs2Ranking.Model.Namespace>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class NamespaceDomain {
        ...
        public IFuture<Gs2.Gs2Ranking.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking.Model.Namespace> self)
            {
                ...
                var (value, find) = _cache.Get<Gs2.Gs2Ranking.Model.Namespace>(
                    parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Ranking.Model.Namespace>(
                        parentKey,
                        Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheKey(
                            this.NamespaceName?.ToString()
                        )
        ...
        {
            this._cache.Unsubscribe<Gs2.Gs2Ranking.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Ranking.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName.ToString()
                ),
