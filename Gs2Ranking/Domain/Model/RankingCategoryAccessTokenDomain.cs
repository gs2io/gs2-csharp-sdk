...
namespace Gs2.Gs2Ranking.Domain.Model
{
    ...
    public partial class RankingCategoryAccessTokenDomain {
        ...
        #endif
/* diff --- start
                            callback.Invoke(await SubscribeUsersAsync(
                            ).ToArrayAsync());
 diff --- end */
                            callback.Invoke(await SubscribeUsersAsync().ToArrayAsync()); /* diff +++ */
                        }
        ...
        #else
        public async Task<ulong> SubscribeSubscribeUsersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking.Model.SubscribeUser[]> callback
        )
        {
...
/* diff --- start
 ...
 diff --- end */
                            callback.Invoke(await RankingsAsync().ToArrayAsync()); /* diff +++ */
                        }
                        catch (System.Exception) {
                            // ignored
                        }
