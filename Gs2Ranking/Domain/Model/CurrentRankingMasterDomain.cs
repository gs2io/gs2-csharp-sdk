...
namespace Gs2.Gs2Ranking.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking.Model.CurrentRankingMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Ranking.Model.CurrentRankingMaster>(
                            _parentKey,
                            key,
                            null,
                            UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "currentRankingMaster")
                        {
                            self.OnError(future.Error);
                            yield break;
                        }
    ...
    public partial class CurrentRankingMasterDomain {
        ...
        public IFuture<Gs2.Gs2Ranking.Model.CurrentRankingMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking.Model.CurrentRankingMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Ranking.Model.CurrentRankingMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Ranking.Model.CurrentRankingMaster>(
                        _parentKey,
                        Gs2.Gs2Ranking.Domain.Model.CurrentRankingMasterDomain.CreateCacheKey(
                        )
                    );
