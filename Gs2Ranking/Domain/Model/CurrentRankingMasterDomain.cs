...
namespace Gs2.Gs2Ranking.Domain.Model
{
    ...
    public partial class CurrentRankingMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking.Domain.Model.CurrentRankingMasterDomain> PreUpdateFuture(
            PreUpdateCurrentRankingMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Ranking.Domain.Model.CurrentRankingMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Ranking.Domain.Model.CurrentRankingMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentRankingMasterRequest request
        ) {
            request = request
    ...
    public partial class CurrentRankingMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking.Model.CurrentRankingMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Ranking.Model.CurrentRankingMaster>(
        ...
        public UniTask<Gs2.Gs2Ranking.Model.CurrentRankingMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Ranking.Model.CurrentRankingMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Ranking.Model.CurrentRankingMaster> Model() => ModelAsync();
        #endif
