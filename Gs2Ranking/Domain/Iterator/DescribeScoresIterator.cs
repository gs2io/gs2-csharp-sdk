...
namespace Gs2.Gs2Ranking.Domain.Iterator
{
    ...
    public class DescribeScoresIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Ranking.Model.Score>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Ranking.Model.Score>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Ranking.Model.Score>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Ranking.Request.DescribeScoresRequest()
                ...
                var future = this._client.DescribeScoresFuture(
                #else
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Ranking.Model.Score>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Ranking.Model.Score>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Ranking.Model.Score> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Ranking.Model.Score> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Ranking.Model.Score>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
