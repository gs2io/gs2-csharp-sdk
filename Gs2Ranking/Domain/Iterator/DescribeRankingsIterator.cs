...
namespace Gs2.Gs2Ranking.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeRankingsIterator : Gs2Iterator<Gs2.Gs2Ranking.Model.Ranking> {
    #else
    public class DescribeRankingsIterator : IAsyncEnumerable<Gs2.Gs2Ranking.Model.Ranking> {
    #endif
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Ranking.Request.DescribeRankingsRequest()
                ...
                var future = this._client.DescribeRankingsFuture(
                #else
                var r = await this._client.DescribeRankingsAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Ranking.Model.Ranking>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Ranking.Model.Ranking>(
                Current,
                error
            ));
        }
