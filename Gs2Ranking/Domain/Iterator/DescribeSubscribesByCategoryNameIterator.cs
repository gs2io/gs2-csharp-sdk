...
namespace Gs2.Gs2Ranking.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Ranking.Model.SubscribeUser>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Ranking.Model.SubscribeUser>
    #else
        IAsyncEnumerable<Gs2.Gs2Ranking.Model.SubscribeUser>
    #endif
    {
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Ranking.Model.SubscribeUser>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Ranking.Model.SubscribeUser>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Ranking.Model.SubscribeUser> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Ranking.Model.SubscribeUser>(async (writer, token) =>
        #else
