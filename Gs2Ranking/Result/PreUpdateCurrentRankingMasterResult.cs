...
#endif
	[System.Serializable]
	public class PreUpdateCurrentRankingMasterResult : IResult
	{
        ...
        public PreUpdateCurrentRankingMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentRankingMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
