	...
	public class DescribeCategoryModelMastersResult : IResult
	{
        ...
        public static DescribeCategoryModelMastersResult FromJson(JsonData data)
        {
            ...
            return new DescribeCategoryModelMastersResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Ranking.Model.CategoryModelMaster[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Ranking.Model.CategoryModelMaster.FromJson(v);
                }).ToArray())
