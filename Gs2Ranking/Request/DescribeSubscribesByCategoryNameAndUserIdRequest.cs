...
namespace Gs2.Gs2Ranking.Request
{
	...
	public class DescribeSubscribesByCategoryNameAndUserIdRequest : Gs2Request<DescribeSubscribesByCategoryNameAndUserIdRequest>
	{
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSubscribesByCategoryNameAndUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSubscribesByCategoryNameAndUserIdRequest)x;
            return this;
        }
    }
}