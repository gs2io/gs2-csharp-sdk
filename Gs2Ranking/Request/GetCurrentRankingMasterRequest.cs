...
namespace Gs2.Gs2Ranking.Request
{
	...
	public class GetCurrentRankingMasterRequest : Gs2Request<GetCurrentRankingMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentRankingMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentRankingMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentRankingMasterRequest)x;
            return this;
        }
    }
}