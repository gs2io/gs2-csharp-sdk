...
namespace Gs2.Gs2Ranking.Request
{
	...
	public class DescribeSubscribesByCategoryNameRequest : Gs2Request<DescribeSubscribesByCategoryNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeSubscribesByCategoryNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSubscribesByCategoryNameRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSubscribesByCategoryNameRequest)x;
            return this;
        }
    }
}