...
namespace Gs2.Gs2Ranking.Request
{
	...
	public class UpdateCurrentRankingMasterRequest : Gs2Request<UpdateCurrentRankingMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentRankingMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentRankingMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentRankingMasterRequest)x;
            return this;
        }
    }
}