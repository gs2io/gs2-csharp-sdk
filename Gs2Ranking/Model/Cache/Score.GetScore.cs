...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<GetScoreResult> InvokeFuture(
            this GetScoreRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<GetScoreResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<GetScoreResult> self)
            {
            ...
            return new Gs2InlineFuture<GetScoreResult>(Impl);
        }
#endif
