...
/* diff +++ end */
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeNearRankingsResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DescribeNearRankingsResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeNearRankingsResult>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<DescribeNearRankingsResult> InvokeAsync(
#else
        public static async Task<DescribeNearRankingsResult> InvokeAsync(
#endif
            this DescribeNearRankingsRequest request,
            CacheDatabase cache,
            string userId,
            ...
            Func<TaskFuture<DescribeNearRankingsResult>> invokeImpl
#else
            Func<Task<DescribeNearRankingsResult>> invokeImpl
#endif
        )
        {
