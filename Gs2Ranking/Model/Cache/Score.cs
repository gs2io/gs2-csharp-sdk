...
namespace Gs2.Gs2Ranking.Model.Cache
{
    public static partial class ScoreExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<Score> FetchFuture(
            this Score self,
            CacheDatabase cache,
            string namespaceName,
            string userId,
            ...
            return new Gs2InlineFuture<Score>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<Score> FetchAsync(
#else
        public static async Task<Score> FetchAsync(
#endif
            this Score self,
            CacheDatabase cache,
            string namespaceName,
        ...
        public static Tuple<Score, bool> GetCache(
            this Score self,
            CacheDatabase cache,
            string namespaceName,
            string userId,
        ...
        /// Gs2Ranking.SetListCached(cache, timeOffset, kind, parentKey) で「リストが揃った印」を立てる。
        /// </summary>
