...
namespace Gs2.Gs2Ranking.Model
{
	...
	[Preserve]
#endif
	public partial class Score : IComparable
	{
        ...
        public static Score FromJson(JsonData data)
        {
            ...
            return new Score()
                ...
                .WithValue(!data.Keys.Contains("score") || data["score"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableLong(data["score"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Score.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(ScoreId, other.ScoreId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(UniqueId, other.UniqueId);
            if (diff != 0)
            {
                return diff;
            }
