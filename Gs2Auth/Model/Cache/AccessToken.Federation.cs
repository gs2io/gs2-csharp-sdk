...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<FederationResult> InvokeFuture(
            this FederationRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<FederationResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<FederationResult> self)
            {
            ...
            return new Gs2InlineFuture<FederationResult>(Impl);
        }
#endif
