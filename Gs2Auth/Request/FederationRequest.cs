...
namespace Gs2.Gs2Auth.Request
{
	...
	public class FederationRequest : Gs2Request<FederationRequest>
	{
        ...
        public FederationRequest WithTimeOffset(int? timeOffset) {
    	...
    	[Preserve]
#endif
        public static FederationRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public void WriteJson(JsonWriter writer)
        {
            ...
            if (OriginalUserId != null) {
                writer.WritePropertyName("originalUserId");
                writer.Write(OriginalUserId.ToString());
            }
            if (UserId != null) {
