...
#endif
	[System.Serializable]
	public class FederationResult : IResult
	{
        ...
        public FederationResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static FederationResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
