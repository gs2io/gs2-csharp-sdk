...
namespace Gs2.Gs2Guild.Result
{
	...
	public class DescribeReceiveRequestsResult : IResult
	{
        ...
        public DescribeReceiveRequestsResult WithItems(Gs2.Gs2Guild.Model.ReceiveMemberRequest[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeReceiveRequestsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
