...
namespace Gs2.Gs2Guild.Result
{
	...
	public class DecreaseMaximumCurrentMaximumMemberCountByStampTaskResult : IResult
	{
        ...
        public DecreaseMaximumCurrentMaximumMemberCountByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DecreaseMaximumCurrentMaximumMemberCountByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
