...
#endif
	[System.Serializable]
	public class VerifyCurrentMaximumMemberCountByStampTaskResult : IResult
	{
        public Gs2.Gs2Guild.Model.Guild Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyCurrentMaximumMemberCountByStampTaskResult WithItem(Gs2.Gs2Guild.Model.Guild item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyCurrentMaximumMemberCountByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyCurrentMaximumMemberCountByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
