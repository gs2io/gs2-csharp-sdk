...
namespace Gs2.Gs2Guild.Result
{
	...
	public class IncreaseMaximumCurrentMaximumMemberCountByGuildNameResult : IResult
	{
        ...
        public IncreaseMaximumCurrentMaximumMemberCountByGuildNameResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IncreaseMaximumCurrentMaximumMemberCountByGuildNameResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
