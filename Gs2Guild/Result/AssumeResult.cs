...
#endif
	[System.Serializable]
	public class AssumeResult : IResult
	{
        ...
        public AssumeResult WithToken(string token) {
            this.Token = token;
            return this;
        }

        public AssumeResult WithUserId(string userId) {
            this.UserId = userId;
            return this;
        }

        public AssumeResult WithExpire(long? expire) {
            this.Expire = expire;
            return this;
        }

        public AssumeResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AssumeResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
