...
namespace Gs2.Gs2Guild.Result
{
	...
	public class SetMaximumCurrentMaximumMemberCountByStampSheetResult : IResult
	{
        ...
        public SetMaximumCurrentMaximumMemberCountByStampSheetResult WithOld(Gs2.Gs2Guild.Model.Guild old) {
            this.Old = old;
            return this;
        }

        public SetMaximumCurrentMaximumMemberCountByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetMaximumCurrentMaximumMemberCountByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
