...
namespace Gs2.Gs2Guild.Result
{
	...
	public class VerifyIncludeMemberByStampTaskResult : IResult
	{
        ...
        public VerifyIncludeMemberByStampTaskResult WithItem(Gs2.Gs2Guild.Model.Guild item) {
            this.Item = item;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static VerifyIncludeMemberByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
