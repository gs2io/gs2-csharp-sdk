...
#endif
	[System.Serializable]
	public class PreUpdateCurrentGuildMasterResult : IResult
	{
        ...
        public PreUpdateCurrentGuildMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentGuildMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
