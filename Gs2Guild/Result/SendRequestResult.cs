...
namespace Gs2.Gs2Guild.Result
{
	...
	public class SendRequestResult : IResult
	{
        ...
        public SendRequestResult WithItem(Gs2.Gs2Guild.Model.Guild item) {
            this.Item = item;
            return this;
        }

        public SendRequestResult WithSendMemberRequest(Gs2.Gs2Guild.Model.SendMemberRequest sendMemberRequest) {
