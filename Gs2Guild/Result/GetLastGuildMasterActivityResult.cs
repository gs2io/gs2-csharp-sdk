...
#endif
	[System.Serializable]
	public class GetLastGuildMasterActivityResult : IResult
	{
        public Gs2.Gs2Guild.Model.LastGuildMasterActivity Item { set; get; }
        public Gs2.Gs2Guild.Model.Guild Guild { set; get; }
        public ResultMetadata Metadata { set; get; }

        public GetLastGuildMasterActivityResult WithItem(Gs2.Gs2Guild.Model.LastGuildMasterActivity item) {
            this.Item = item;
            return this;
        }

        public GetLastGuildMasterActivityResult WithGuild(Gs2.Gs2Guild.Model.Guild guild) {
            this.Guild = guild;
            return this;
        }

        public GetLastGuildMasterActivityResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetLastGuildMasterActivityResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
