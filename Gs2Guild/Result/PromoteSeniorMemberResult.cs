...
#endif
	[System.Serializable]
	public class PromoteSeniorMemberResult : IResult
	{
        public Gs2.Gs2Guild.Model.LastGuildMasterActivity Item { set; get; }
        public Gs2.Gs2Guild.Model.Guild Guild { set; get; }
        public ResultMetadata Metadata { set; get; }

        public PromoteSeniorMemberResult WithItem(Gs2.Gs2Guild.Model.LastGuildMasterActivity item) {
            this.Item = item;
            return this;
        }

        public PromoteSeniorMemberResult WithGuild(Gs2.Gs2Guild.Model.Guild guild) {
            this.Guild = guild;
            return this;
        }

        public PromoteSeniorMemberResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PromoteSeniorMemberResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
