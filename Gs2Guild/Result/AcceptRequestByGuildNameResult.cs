...
#endif
	[System.Serializable]
	public class AcceptRequestByGuildNameResult : IResult
	{
        public Gs2.Gs2Guild.Model.ReceiveMemberRequest Item { set; get; }
        public Gs2.Gs2Guild.Model.Guild Guild { set; get; }
        public ResultMetadata Metadata { set; get; }

        public AcceptRequestByGuildNameResult WithItem(Gs2.Gs2Guild.Model.ReceiveMemberRequest item) {
            this.Item = item;
            return this;
        }

        public AcceptRequestByGuildNameResult WithGuild(Gs2.Gs2Guild.Model.Guild guild) {
            this.Guild = guild;
            return this;
        }

        public AcceptRequestByGuildNameResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AcceptRequestByGuildNameResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
