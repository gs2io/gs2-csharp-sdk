...
namespace Gs2.Gs2Guild.Result
{
	...
	public class WithdrawalByUserIdResult : IResult
	{
        ...
        public WithdrawalByUserIdResult WithGuild(Gs2.Gs2Guild.Model.Guild guild) {
            this.Guild = guild;
            return this;
        }

        public WithdrawalByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static WithdrawalByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
