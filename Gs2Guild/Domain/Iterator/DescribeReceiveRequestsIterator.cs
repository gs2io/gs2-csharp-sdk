...
namespace Gs2.Gs2Guild.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeReceiveRequestsIterator : Gs2Iterator<Gs2.Gs2Guild.Model.ReceiveMemberRequest> {
    #else
    public class DescribeReceiveRequestsIterator : IAsyncEnumerable<Gs2.Gs2Guild.Model.ReceiveMemberRequest> {
    #endif
        ...
        private async Task _load() {
            ...
            (
                ...
                this._result = list
                    .Where(item => this.AccessToken == null || item.TargetGuildName == this.AccessToken.UserId)
                    .ToArray();
                this._pageToken = null;
                this._last = true;
            } else {
