...
namespace Gs2.Gs2Guild.Domain.Iterator
{
    ...
    public class DescribeJoinedGuildsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Guild.Model.JoinedGuild> {
        ...
        public DescribeJoinedGuildsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Guild.Request.DescribeJoinedGuildsByUserIdRequest()
                ...
                var future = this._client.DescribeJoinedGuildsByUserIdFuture(
                #else
                var r = await this._client.DescribeJoinedGuildsByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
