...
namespace Gs2.Gs2Guild.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class SearchGuildsIterator : Gs2Iterator<Gs2.Gs2Guild.Model.Guild> {
    #else
    public class SearchGuildsIterator : IAsyncEnumerable<Gs2.Gs2Guild.Model.Guild> {
    #endif
