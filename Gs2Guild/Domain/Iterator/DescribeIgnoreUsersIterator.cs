...
namespace Gs2.Gs2Guild.Domain.Iterator
{
    ...
    public class DescribeIgnoreUsersIterator :
    #if UNITY_2017_1_OR_NEWER
    ...
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Guild.Request.DescribeIgnoreUsersRequest()
...
/* diff --- start
 ...
 diff --- end */
        ...
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Guild.Model.IgnoreUser>(async (writer, token) =>
        #else
