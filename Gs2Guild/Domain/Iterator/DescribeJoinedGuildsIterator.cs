...
namespace Gs2.Gs2Guild.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeJoinedGuildsIterator : Gs2Iterator<Gs2.Gs2Guild.Model.JoinedGuild> {
    #else
    public class DescribeJoinedGuildsIterator : IAsyncEnumerable<Gs2.Gs2Guild.Model.JoinedGuild> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2Guild.Model.JoinedGuild[] _result;

        public static int? fetchSize;

        public DescribeJoinedGuildsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Guild.Model.JoinedGuild[]{};
        }
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Guild.Model.JoinedGuild>
            (
                ...
                var request = new Gs2.Gs2Guild.Request.DescribeJoinedGuildsRequest()
                ...
                var future = this._client.DescribeJoinedGuildsFuture(
                #else
                var r = await this._client.DescribeJoinedGuildsAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Guild.Model.JoinedGuild>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Guild.Model.JoinedGuild>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Guild.Model.JoinedGuild> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Guild.Model.JoinedGuild>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
