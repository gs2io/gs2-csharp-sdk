...
namespace Gs2.Gs2Guild.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class SearchGuildsByUserIdIterator : Gs2Iterator<Gs2.Gs2Guild.Model.Guild> {
    #else
    public class SearchGuildsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Guild.Model.Guild> {
    #endif
        ...
        public int[] Attributes1 { get; }
        public int[] Attributes2 { get; }
        public int[] Attributes3 { get; }
        public int[] Attributes4 { get; }
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Guild.Request.SearchGuildsByUserIdRequest()
                    ...
                    .WithAttributes3(this.Attributes3)
                    .WithAttributes4(this.Attributes4)
                ...
                var future = this._client.SearchGuildsByUserIdFuture(
                #else
                var r = await this._client.SearchGuildsByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Guild.Model.Guild> GetAsyncEnumerator(
