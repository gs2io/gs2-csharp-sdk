...
namespace Gs2.Gs2Guild.Domain.Model
{
    ...
    public partial class IgnoreUserAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Guild.Model.IgnoreUser> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Guild.Model.IgnoreUser> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Guild.Model.IgnoreUser> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Guild.Model.IgnoreUser> Model() => ModelAsync();
        #endif
