...
namespace Gs2.Gs2Guild.Domain.Model
{
    ...
    public partial class LastGuildMasterActivityDomain {
        ...
        public LastGuildMasterActivityDomain(
    ...
    public partial class LastGuildMasterActivityDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Guild.Domain.Model.LastGuildMasterActivityDomain> PromoteSeniorMemberFuture(
            PromoteSeniorMemberByGuildNameRequest request
        ) {
            IEnumerator Impl(IFuture<Gs2.Gs2Guild.Domain.Model.LastGuildMasterActivityDomain> self)
            {
                request = request
                    .WithContextStack(string.IsNullOrEmpty(request.ContextStack) ? this._gs2.DefaultContextStack : request.ContextStack)
                    .WithNamespaceName(this.NamespaceName)
            ...
            return new Gs2InlineFuture<Gs2.Gs2Guild.Domain.Model.LastGuildMasterActivityDomain>(Impl);
        }
        #endif

        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Guild.Domain.Model.LastGuildMasterActivityDomain> PromoteSeniorMemberAsync(
            #else
        public async Task<Gs2.Gs2Guild.Domain.Model.LastGuildMasterActivityDomain> PromoteSeniorMemberAsync(
            #endif
            PromoteSeniorMemberByGuildNameRequest request
        ) {
            request = request
