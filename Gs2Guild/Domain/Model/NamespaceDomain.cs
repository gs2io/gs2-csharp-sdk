...
namespace Gs2.Gs2Guild.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #else
        public async Task<ulong> SubscribeGuildModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Guild.Model.GuildModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeGuildModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Guild.Model.GuildModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateGuildModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Guild.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Guild.Model.Namespace> callback) => SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif
