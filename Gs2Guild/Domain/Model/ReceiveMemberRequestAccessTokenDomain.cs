...
namespace Gs2.Gs2Guild.Domain.Model
{
    ...
    public partial class ReceiveMemberRequestAccessTokenDomain {
        ...
        public IFuture<Gs2.Gs2Guild.Domain.Model.ReceiveMemberRequestAccessTokenDomain> AcceptFuture(
            ...
            return new Gs2InlineFuture<Gs2.Gs2Guild.Domain.Model.ReceiveMemberRequestAccessTokenDomain>(Impl);
        }
        #endif
        ...
        public IFuture<Gs2.Gs2Guild.Model.ReceiveMemberRequest> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Guild.Model.ReceiveMemberRequest> self)
            {
                ...
                var future = (null as Gs2.Gs2Guild.Model.ReceiveMemberRequest).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.GuildModelName,
                    this.GuildName,
