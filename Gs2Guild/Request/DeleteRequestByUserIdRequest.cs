...
namespace Gs2.Gs2Guild.Request
{
	...
	public class DeleteRequestByUserIdRequest : Gs2Request<DeleteRequestByUserIdRequest>
	{
        ...
        public DeleteRequestByUserIdRequest WithGuildModelName(string guildModelName) {
            this.GuildModelName = guildModelName;
            return this;
        }
        public DeleteRequestByUserIdRequest WithTargetGuildName(string targetGuildName) {
    	...
    	[Preserve]
#endif
        public static DeleteRequestByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
