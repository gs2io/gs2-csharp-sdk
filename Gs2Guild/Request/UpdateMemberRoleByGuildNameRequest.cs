...
#endif
	[System.Serializable]
	public class UpdateMemberRoleByGuildNameRequest : Gs2Request<UpdateMemberRoleByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateMemberRoleByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
