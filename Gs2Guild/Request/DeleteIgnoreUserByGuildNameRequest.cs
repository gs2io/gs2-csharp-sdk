...
#endif
	[System.Serializable]
	public class DeleteIgnoreUserByGuildNameRequest : Gs2Request<DeleteIgnoreUserByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteIgnoreUserByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
