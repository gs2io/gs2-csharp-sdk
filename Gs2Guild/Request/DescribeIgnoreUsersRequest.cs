...
#endif
	[System.Serializable]
	public class DescribeIgnoreUsersRequest : Gs2Request<DescribeIgnoreUsersRequest>
	{
        ...
        public DescribeIgnoreUsersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeIgnoreUsersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
