...
#endif
	[System.Serializable]
	public class PromoteSeniorMemberByGuildNameRequest : Gs2Request<PromoteSeniorMemberByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static PromoteSeniorMemberByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
