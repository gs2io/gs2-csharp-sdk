...
#endif
	[System.Serializable]
	public class GetReceiveRequestByGuildNameRequest : Gs2Request<GetReceiveRequestByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetReceiveRequestByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
