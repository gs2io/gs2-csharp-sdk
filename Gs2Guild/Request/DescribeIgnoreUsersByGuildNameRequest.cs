...
#endif
	[System.Serializable]
	public class DescribeIgnoreUsersByGuildNameRequest : Gs2Request<DescribeIgnoreUsersByGuildNameRequest>
	{
        ...
        public DescribeIgnoreUsersByGuildNameRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeIgnoreUsersByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
