...
#endif
	[System.Serializable]
	public class GetLastGuildMasterActivityByGuildNameRequest : Gs2Request<GetLastGuildMasterActivityByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetLastGuildMasterActivityByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
