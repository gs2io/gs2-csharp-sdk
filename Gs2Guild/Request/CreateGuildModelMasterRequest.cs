...
namespace Gs2.Gs2Guild.Request
{
	...
	public class CreateGuildModelMasterRequest : Gs2Request<CreateGuildModelMasterRequest>
	{
        ...
        public CreateGuildModelMasterRequest WithInactivityPeriodDays(int? inactivityPeriodDays) {
        ...
        public CreateGuildModelMasterRequest WithMaxConcurrentJoinGuilds(int? maxConcurrentJoinGuilds) {
            this.MaxConcurrentJoinGuilds = maxConcurrentJoinGuilds;
            return this;
        }
        public CreateGuildModelMasterRequest WithMaxConcurrentGuildMasterCount(int? maxConcurrentGuildMasterCount) {
