...
#endif
	[System.Serializable]
	public class DeleteMemberByGuildNameRequest : Gs2Request<DeleteMemberByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteMemberByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
