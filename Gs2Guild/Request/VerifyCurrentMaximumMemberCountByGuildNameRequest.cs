...
namespace Gs2.Gs2Guild.Request
{
	...
	public class VerifyCurrentMaximumMemberCountByGuildNameRequest : Gs2Request<VerifyCurrentMaximumMemberCountByGuildNameRequest>
	{
        ...
        public VerifyCurrentMaximumMemberCountByGuildNameRequest WithValue(int? value) {
            this.Value = value;
            return this;
        }
        public VerifyCurrentMaximumMemberCountByGuildNameRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyCurrentMaximumMemberCountByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
