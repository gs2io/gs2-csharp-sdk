...
#endif
	[System.Serializable]
	public class AddIgnoreUserByGuildNameRequest : Gs2Request<AddIgnoreUserByGuildNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static AddIgnoreUserByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
