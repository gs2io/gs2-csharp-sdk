...
#endif
	[System.Serializable]
	public class DescribeReceiveRequestsByGuildNameRequest : Gs2Request<DescribeReceiveRequestsByGuildNameRequest>
	{
        ...
        public DescribeReceiveRequestsByGuildNameRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeReceiveRequestsByGuildNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
