...
#endif
	[System.Serializable]
	public class SetMaximumCurrentMaximumMemberCountByStampSheetRequest : Gs2Request<SetMaximumCurrentMaximumMemberCountByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static SetMaximumCurrentMaximumMemberCountByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
