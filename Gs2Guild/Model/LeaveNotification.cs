...
namespace Gs2.Gs2Guild.Model
{
	public class LeaveNotification
	{
        ...
        public string LeavedUserId { set; get; } = null!;
        public LeaveNotification WithNamespaceName(string namespaceName) {
            this.NamespaceName = namespaceName;
            return this;
        }
        public LeaveNotification WithGuildModelName(string guildModelName) {
            this.GuildModelName = guildModelName;
            return this;
        }
        public LeaveNotification WithGuildName(string guildName) {
            this.GuildName = guildName;
            return this;
        }
        public LeaveNotification WithLeavedUserId(string leavedUserId) {
            this.LeavedUserId = leavedUserId;
            return this;
        }
        ...
        public static LeaveNotification FromJson(JsonData data)
        {
            ...
            return new LeaveNotification()
                ...
                .WithLeavedUserId(!data.Keys.Contains("leavedUserId") || data["leavedUserId"] == null ? null : data["leavedUserId"].ToString());
        }
    }
}
