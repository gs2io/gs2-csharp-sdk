    ...
    public static class StampAction
    {
        public static Gs2Request ToRequest(Gs2.Core.Model.ConsumeAction action) {
            switch (action.Action) {
                case "Gs2Guild:DecreaseMaximumCurrentMaximumMemberCountByGuildName":
                    return DecreaseMaximumCurrentMaximumMemberCountByGuildNameRequest.FromJson(JsonMapper.ToObject(action.Request));
        ...
        public static Gs2Request ToRequest(Gs2.Core.Model.AcquireAction action) {
            switch (action.Action) {
                case "Gs2Guild:IncreaseMaximumCurrentMaximumMemberCountByGuildName":
                    return IncreaseMaximumCurrentMaximumMemberCountByGuildNameRequest.FromJson(JsonMapper.ToObject(action.Request));
                case "Gs2Guild:SetMaximumCurrentMaximumMemberCountByGuildName":
                    return SetMaximumCurrentMaximumMemberCountByGuildNameRequest.FromJson(JsonMapper.ToObject(action.Request));
            }
            throw new ArgumentException($"unknown action {action.Action}");
        }
    }
