...
namespace Gs2.Gs2Guild.Model.Cache
{
    public static partial class ReceiveMemberRequestExt
    {
        public static void PutCache(
            this AcceptRequestByGuildNameResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<AcceptRequestByGuildNameResult> InvokeFuture(
            this AcceptRequestByGuildNameRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<AcceptRequestByGuildNameResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<AcceptRequestByGuildNameResult> self)
            {
            ...
            return new Gs2InlineFuture<AcceptRequestByGuildNameResult>(Impl);
        }
#endif
