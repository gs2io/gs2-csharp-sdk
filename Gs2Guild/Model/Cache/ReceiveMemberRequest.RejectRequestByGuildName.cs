...
namespace Gs2.Gs2Guild.Model.Cache
{
    public static partial class ReceiveMemberRequestExt
    {
        public static void PutCache(
            this RejectRequestByGuildNameResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<RejectRequestByGuildNameResult> InvokeFuture(
            this RejectRequestByGuildNameRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<RejectRequestByGuildNameResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<RejectRequestByGuildNameResult> self)
            {
            ...
            return new Gs2InlineFuture<RejectRequestByGuildNameResult>(Impl);
        }
#endif
