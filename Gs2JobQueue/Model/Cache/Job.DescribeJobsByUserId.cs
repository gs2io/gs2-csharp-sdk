...
namespace Gs2.Gs2JobQueue.Model.Cache
{
    public static partial class JobExt
    {
        public static void PutCache(
            this DescribeJobsByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeJobsByUserIdResult> InvokeFuture(
            this DescribeJobsByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DescribeJobsByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DescribeJobsByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeJobsByUserIdResult>(Impl);
        }
#endif
