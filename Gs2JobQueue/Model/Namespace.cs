...
namespace Gs2.Gs2JobQueue.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2JobQueue.Model.TransactionSetting TransactionSetting { set; get; }
        public Gs2.Gs2JobQueue.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        [Obsolete("This method is deprecated")]
        public Namespace WithTransactionSetting(Gs2.Gs2JobQueue.Model.TransactionSetting transactionSetting) {
            this.TransactionSetting = transactionSetting;
            return this;
        }
        public Namespace WithTransactionSettingV2(Gs2.Gs2JobQueue.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        private static System.Text.RegularExpressions.Regex _regionRegex = new System.Text.RegularExpressions.Regex(
                @"grn:gs2:(?<region>.+):(?<ownerId>.+):queue:(?<namespaceName>.+)",
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(RunNotification, other.RunNotification);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(PushNotification, other.PushNotification);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "jobQueue.namespace.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "jobQueue.namespace.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "jobQueue.namespace.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "jobQueue.namespace.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "jobQueue.namespace.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "jobQueue.namespace.revision.error.invalid"),
                    });
                }
        ...
        public object Clone() {
            return new Namespace {
                ...
                Name = Name,
                Description = Description,
                TransactionSetting = TransactionSetting?.Clone() as Gs2.Gs2JobQueue.Model.TransactionSetting,
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2JobQueue.Model.TransactionSettingV2,
                EnableAutoRun = EnableAutoRun,
                RunNotification = RunNotification?.Clone() as Gs2.Gs2JobQueue.Model.NotificationSetting,
                PushNotification = PushNotification?.Clone() as Gs2.Gs2JobQueue.Model.NotificationSetting,
                LogSetting = LogSetting?.Clone() as Gs2.Gs2JobQueue.Model.LogSetting,
                CreatedAt = CreatedAt,
                UpdatedAt = UpdatedAt,
                Revision = Revision,
            };
