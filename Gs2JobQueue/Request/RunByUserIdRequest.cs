...
namespace Gs2.Gs2JobQueue.Request
{
	...
	public class RunByUserIdRequest : Gs2Request<RunByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static RunByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RunByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RunByUserIdRequest)x;
            return this;
        }
    }
}