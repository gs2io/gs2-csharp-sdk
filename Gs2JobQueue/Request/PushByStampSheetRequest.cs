...
namespace Gs2.Gs2JobQueue.Request
{
	...
	public class PushByStampSheetRequest : Gs2Request<PushByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static PushByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply PushByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (PushByStampSheetRequest)x;
            return this;
        }
    }
}