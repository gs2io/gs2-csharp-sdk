...
namespace Gs2.Gs2JobQueue.Request
{
	...
	public class GetJobByUserIdRequest : Gs2Request<GetJobByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetJobByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetJobByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetJobByUserIdRequest)x;
            return this;
        }
    }
}