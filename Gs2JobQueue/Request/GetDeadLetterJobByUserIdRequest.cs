...
namespace Gs2.Gs2JobQueue.Request
{
	...
	public class GetDeadLetterJobByUserIdRequest : Gs2Request<GetDeadLetterJobByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetDeadLetterJobByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public override string UniqueKey() {
            ...
            key += NamespaceName + ":";
            key += UserId + ":";
            key += DeadLetterJobName + ":";
            return key;
        }

        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetDeadLetterJobByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetDeadLetterJobByUserIdRequest)x;
            return this;
        }
    }
}