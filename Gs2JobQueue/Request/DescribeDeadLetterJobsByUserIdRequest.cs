...
namespace Gs2.Gs2JobQueue.Request
{
	...
	public class DescribeDeadLetterJobsByUserIdRequest : Gs2Request<DescribeDeadLetterJobsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeDeadLetterJobsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeDeadLetterJobsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeDeadLetterJobsByUserIdRequest)x;
            return this;
        }
    }
}