...
namespace Gs2.Gs2JobQueue
{
	public class Gs2JobQueueWebSocketClient : AbstractGs2Client
	{
        ...
        public class GetJobByUserIdTask : Gs2WebSocketSessionTask<Request.GetJobByUserIdRequest, Result.GetJobByUserIdResult>
        {
	        public GetJobByUserIdTask(IGs2Session session, Request.GetJobByUserIdRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.GetJobByUserIdRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
                ...
                if (request.JobName != null)
                {
                    ...
                    jsonWriter.Write(request.JobName.ToString());
                }
                if (request.ContextStack != null)
                {
                    jsonWriter.WritePropertyName("contextStack");
        ...
        public class DeleteJobByUserIdTask : Gs2WebSocketSessionTask<Request.DeleteJobByUserIdRequest, Result.DeleteJobByUserIdResult>
        {
	        public DeleteJobByUserIdTask(IGs2Session session, Request.DeleteJobByUserIdRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.DeleteJobByUserIdRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
