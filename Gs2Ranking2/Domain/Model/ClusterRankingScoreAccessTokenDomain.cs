...
namespace Gs2.Gs2Ranking2.Domain.Model
{
    ...
    public partial class ClusterRankingScoreAccessTokenDomain {
        ...
        public ClusterRankingScoreAccessTokenDomain(
        ...
        private async Task<Gs2.Gs2Ranking2.Model.ClusterRankingScore> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                () => this._client.GetClusterRankingScoreAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingScoreAccessTokenDomain> VerifyFuture(
            VerifyClusterRankingScoreRequest request
        ) => VerifyAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingScoreAccessTokenDomain> VerifyAsync(
        #else
        public async Task<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingScoreAccessTokenDomain> VerifyAsync(
        #endif
            VerifyClusterRankingScoreRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                this.AccessToken?.TimeOffset,
                () => this._client.VerifyClusterRankingScoreAsync(request)
            );
            var domain = this;
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingScore> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Ranking2.Model.ClusterRankingScore> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingScore> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Ranking2.Model.ClusterRankingScore> Model() => ModelAsync();
        #endif
