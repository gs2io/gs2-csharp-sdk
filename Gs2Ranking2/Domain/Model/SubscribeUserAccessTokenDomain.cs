...
namespace Gs2.Gs2Ranking2.Domain.Model
{
    ...
    public partial class SubscribeUserAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> GetSubscribeFuture(
            GetSubscribeRequest request
        ) {
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> self)
            {
                request = request
            ...
            return new Gs2InlineFuture<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain>(Impl);
        }
        #endif

        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> GetSubscribeAsync(
            #else
        public async Task<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> GetSubscribeAsync(
            #endif
            GetSubscribeRequest request
        ) {
            request = request
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> DeleteSubscribeFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    this.UserId,
                    () => this._client.DeleteSubscribeFuture(request)
                );
                yield return future;
                if (future.Error != null) {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> DeleteSubscribeAsync(
            #else
        public async Task<Gs2.Gs2Ranking2.Domain.Model.SubscribeUserAccessTokenDomain> DeleteSubscribeAsync(
            #endif
            DeleteSubscribeRequest request
        ) {
            try {
                ...
                var result = await request.InvokeAsync(
                    _gs2.Cache,
                    this.UserId,
                    () => this._client.DeleteSubscribeAsync(request)
                );
            }
