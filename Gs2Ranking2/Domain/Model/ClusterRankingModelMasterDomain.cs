...
namespace Gs2.Gs2Ranking2.Domain.Model
{
    ...
    public partial class ClusterRankingModelMasterDomain {
        ...
        private IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> self)
            {
                request = request
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.GetClusterRankingModelMasterFuture(request)
                );
                yield return future;
            ...
            return new Gs2InlineFuture<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster>(Impl);
        }
        #endif
        ...
        public IFuture<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingModelMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingModelMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateClusterRankingModelMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingModelMasterDomain> DeleteFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking2.Domain.Model.ClusterRankingModelMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.DeleteClusterRankingModelMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
    ...
    public partial class ClusterRankingModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.RankingName,
                    () => this.GetFuture(
        ...
        public async UniTask<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster> Model()
        {
            return await ModelAsync();
        }
        #endif
