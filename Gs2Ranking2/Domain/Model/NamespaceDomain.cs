...
namespace Gs2.Gs2Ranking2.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #endif
                            callback.Invoke(await GlobalRankingModelsAsync(
                            ).ToArrayAsync());
                        }
        ...
        #else
        public async Task<ulong> SubscribeGlobalRankingModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking2.Model.GlobalRankingModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeGlobalRankingModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking2.Model.GlobalRankingModelMaster[]> callback,
            string namePrefix = null
        )
                ...
                () =>
                {
                    ...
                    async Task Impl() {
                        ...
                        try {
                            ...
                            await UniTask.SwitchToMainThread();
        #endif
                            callback.Invoke(await SubscribeRankingModelsAsync(
                            ).ToArrayAsync());
                        }
                        catch (System.Exception) {
                            // ignored
        ...
        #else
        public async Task<ulong> SubscribeSubscribeRankingModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking2.Model.SubscribeRankingModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeSubscribeRankingModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking2.Model.SubscribeRankingModelMaster[]> callback,
            string namePrefix = null
        )
                ...
                () =>
                {
                    ...
                    async Task Impl() {
                        ...
                        try {
                            ...
                            await UniTask.SwitchToMainThread();
        #endif
                            callback.Invoke(await ClusterRankingModelsAsync(
                            ).ToArrayAsync());
                        }
                        catch (System.Exception) {
                            // ignored
        ...
        #else
        public async Task<ulong> SubscribeClusterRankingModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking2.Model.ClusterRankingModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeClusterRankingModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Ranking2.Model.ClusterRankingModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateGlobalRankingModelMasterAsync(request).ToGs2Future();
        #endif
        ...
        ) => CreateSubscribeRankingModelMasterAsync(request).ToGs2Future();
        #endif
        ...
        ) => CreateClusterRankingModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Ranking2.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Ranking2.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Ranking2.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Ranking2.Model.Namespace> Model() => ModelAsync();
        #endif
