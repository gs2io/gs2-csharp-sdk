...
/* diff +++ start */
        ...
        public static async Task<Func<object>> ExecuteInverseAsync(
            ...
            if (VerifyGlobalRankingScoreByUserIdSpeculativeExecutor.Action() == verifyAction.Action) {
                ...
                return await VerifyGlobalRankingScoreByUserIdSpeculativeExecutor.ExecuteInverseAsync(
                    domain,
                    accessToken,
                    request
                );
            ...
            if (VerifyClusterRankingScoreByUserIdSpeculativeExecutor.Action() == verifyAction.Action) {
                ...
                return await VerifyClusterRankingScoreByUserIdSpeculativeExecutor.ExecuteInverseAsync(
                    domain,
                    accessToken,
                    request
                );
            ...
            if (VerifySubscribeRankingScoreByUserIdSpeculativeExecutor.Action() == verifyAction.Action) {
                ...
                return await VerifySubscribeRankingScoreByUserIdSpeculativeExecutor.ExecuteInverseAsync(
                    domain,
                    accessToken,
                    request
                );
