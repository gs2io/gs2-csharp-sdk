...
{
    public static class VerifyGlobalRankingScoreByUserIdSpeculativeExecutor {
/* diff +++ start */
            ...
            IPreparedSpeculativeVerification
        {
            ...
            private readonly VerifyGlobalRankingScoreByUserIdRequest _request;
            ...
            {
                var (item, found) = ((GlobalRankingScore)null).GetCache(
                    _domain.Cache,
...
/* diff +++ start */
        ...
        private static bool IsUsable(
            GlobalRankingScore item,
            VerifyGlobalRankingScoreByUserIdRequest request,
            string userId,
            string expectedScoreId
        ) {
            return item != null &&
                   item.GlobalRankingScoreId == expectedScoreId &&
                   item.UserId == userId &&
        ...
        public static async Task<Func<object>> ExecuteInverseAsync(
            ...
            var inverse = request == null ? null :
                VerifyGlobalRankingScoreByUserIdRequest.FromJson(request.ToJson());
...
/* diff +++ start */
            ...
            var cached = ((GlobalRankingScore)null).GetCache(
                domain.Cache,
            ...
            var expectedScoreId =
                ...
                $"user:{userId}:global:{prepared.RankingName}:{item.Season}:score";
