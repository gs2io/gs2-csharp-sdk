...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeClusterRankingScoresIterator : Gs2Iterator<Gs2.Gs2Ranking2.Model.ClusterRankingScore> {
    #else
    public class DescribeClusterRankingScoresIterator : IAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingScore> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2Ranking2.Model.ClusterRankingScore[] _result;

        public static int? fetchSize;

        public DescribeClusterRankingScoresIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Ranking2.Model.ClusterRankingScore[]{};
        }
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Ranking2.Model.ClusterRankingScore>
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeClusterRankingScoresRequest()
                ...
                var future = this._client.DescribeClusterRankingScoresFuture(
                #else
                var r = await this._client.DescribeClusterRankingScoresAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Ranking2.Model.ClusterRankingScore>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Ranking2.Model.ClusterRankingScore>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Ranking2.Model.ClusterRankingScore> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Ranking2.Model.ClusterRankingScore>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
