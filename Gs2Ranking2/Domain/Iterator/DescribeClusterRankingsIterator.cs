...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeClusterRankingsIterator : Gs2Iterator<Gs2.Gs2Ranking2.Model.ClusterRankingData> {
    #else
    public class DescribeClusterRankingsIterator : IAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingData> {
    #endif
