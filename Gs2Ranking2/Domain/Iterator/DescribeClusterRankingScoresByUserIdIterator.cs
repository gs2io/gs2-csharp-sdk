...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    public class DescribeClusterRankingScoresByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingScore> {
        ...
        public DescribeClusterRankingScoresByUserIdIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeClusterRankingScoresByUserIdRequest()
                ...
                var future = this._client.DescribeClusterRankingScoresByUserIdFuture(
                #else
                var r = await this._client.DescribeClusterRankingScoresByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
