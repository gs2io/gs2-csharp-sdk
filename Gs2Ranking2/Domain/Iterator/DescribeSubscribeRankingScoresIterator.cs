...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    public class DescribeSubscribeRankingScoresIterator :
    #if UNITY_2017_1_OR_NEWER
    ...
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeSubscribeRankingScoresRequest()
                ...
                var future = this._client.DescribeSubscribeRankingScoresFuture(
                #else
                var r = await this._client.DescribeSubscribeRankingScoresAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
