...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeSubscribeRankingScoresIterator : Gs2Iterator<Gs2.Gs2Ranking2.Model.SubscribeRankingScore> {
    #else
    public class DescribeSubscribeRankingScoresIterator : IAsyncEnumerable<Gs2.Gs2Ranking2.Model.SubscribeRankingScore> {
    #endif
