...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    public class DescribeClusterRankingReceivedRewardsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingReceivedReward> {
        ...
        public DescribeClusterRankingReceivedRewardsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeClusterRankingReceivedRewardsByUserIdRequest()
                ...
                var future = this._client.DescribeClusterRankingReceivedRewardsByUserIdFuture(
                #else
                var r = await this._client.DescribeClusterRankingReceivedRewardsByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
