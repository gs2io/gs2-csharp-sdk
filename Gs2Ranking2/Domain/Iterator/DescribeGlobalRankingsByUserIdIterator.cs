...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    public class DescribeGlobalRankingsByUserIdIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Ranking2.Model.GlobalRankingData>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Ranking2.Model.GlobalRankingData>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Ranking2.Model.GlobalRankingData>
    #endif
    {
        ...
        public DescribeGlobalRankingsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Ranking2.Model.GlobalRankingData>
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeGlobalRankingsByUserIdRequest()
                ...
                var future = this._client.DescribeGlobalRankingsByUserIdFuture(
                #else
                var r = await this._client.DescribeGlobalRankingsByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Ranking2.Model.GlobalRankingData>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Ranking2.Model.GlobalRankingData>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Ranking2.Model.GlobalRankingData> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Ranking2.Model.GlobalRankingData> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Ranking2.Model.GlobalRankingData>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
