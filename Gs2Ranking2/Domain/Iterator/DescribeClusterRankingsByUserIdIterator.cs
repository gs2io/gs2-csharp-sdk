...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeClusterRankingsByUserIdIterator : Gs2Iterator<Gs2.Gs2Ranking2.Model.ClusterRankingData> {
    #else
    public class DescribeClusterRankingsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingData> {
    #endif
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingData> GetAsyncEnumerator(
