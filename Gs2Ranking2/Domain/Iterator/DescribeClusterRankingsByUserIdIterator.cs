...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    public class DescribeClusterRankingsByUserIdIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Ranking2.Model.ClusterRankingData>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingData>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Ranking2.Model.ClusterRankingData>
    #endif
    {
        ...
        public DescribeClusterRankingsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Ranking2.Model.ClusterRankingData>
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeClusterRankingsByUserIdRequest()
                ...
                var future = this._client.DescribeClusterRankingsByUserIdFuture(
                #else
                var r = await this._client.DescribeClusterRankingsByUserIdAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Ranking2.Model.ClusterRankingData>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Ranking2.Model.ClusterRankingData>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Ranking2.Model.ClusterRankingData> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Ranking2.Model.ClusterRankingData> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Ranking2.Model.ClusterRankingData>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
