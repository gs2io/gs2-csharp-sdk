...
namespace Gs2.Gs2Ranking2.Domain.Iterator
{
    ...
    public class DescribeGlobalRankingsIterator :
    #if UNITY_2017_1_OR_NEWER
    ...
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Ranking2.Request.DescribeGlobalRankingsRequest()
                ...
                var future = this._client.DescribeGlobalRankingsFuture(
                #else
                var r = await this._client.DescribeGlobalRankingsAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
