...
namespace Gs2.Gs2Ranking2.Model
{
	...
	[Preserve]
#endif
	public partial class GlobalRankingReceivedReward : IComparable
	{
        public string GlobalRankingReceivedRewardId { set; get; }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type GlobalRankingReceivedReward.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(GlobalRankingReceivedRewardId, other.GlobalRankingReceivedRewardId);
            if (diff != 0)
            {
                return diff;
            }
