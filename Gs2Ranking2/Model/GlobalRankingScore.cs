	...
	public partial class GlobalRankingScore : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type GlobalRankingScore.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(GlobalRankingScoreId, other.GlobalRankingScoreId);
            if (diff != 0)
            {
                return diff;
            }
