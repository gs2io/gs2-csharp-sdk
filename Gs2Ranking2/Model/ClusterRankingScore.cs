...
namespace Gs2.Gs2Ranking2.Model
{
	...
	[Preserve]
#endif
	public partial class ClusterRankingScore : IComparable
	{
        public string ClusterRankingScoreId { set; get; }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type ClusterRankingScore.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(ClusterRankingScoreId, other.ClusterRankingScoreId);
            if (diff != 0)
            {
                return diff;
            }
