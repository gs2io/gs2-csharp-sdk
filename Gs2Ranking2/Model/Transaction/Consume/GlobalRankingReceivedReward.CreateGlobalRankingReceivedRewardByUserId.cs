...
namespace Gs2.Gs2Ranking2.Model.Transaction
{
    public static partial class GlobalRankingReceivedRewardExt
    {
        ...
        public static CreateGlobalRankingReceivedRewardByUserIdRequest Rate(
            ...
            throw new NotSupportedException($"not supported rate action Gs2Ranking2:CreateGlobalRankingReceivedRewardByUserId");
        }
    }

    public static partial class CreateGlobalRankingReceivedRewardByUserIdRequestExt
    {
        public static CreateGlobalRankingReceivedRewardByUserIdRequest Rate(
            this CreateGlobalRankingReceivedRewardByUserIdRequest request,
            BigInteger rate
