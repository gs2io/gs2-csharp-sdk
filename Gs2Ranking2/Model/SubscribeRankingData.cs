...
namespace Gs2.Gs2Ranking2.Model
{
	...
	[Preserve]
#endif
	public partial class SubscribeRankingData : IComparable
	{
        public string SubscribeRankingDataId { set; get; }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type SubscribeRankingData.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(SubscribeRankingDataId, other.SubscribeRankingDataId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(ScorerUserId, other.ScorerUserId);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            ...
            }
            {
                if (InvertUpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("subscribeRankingData", "ranking2.subscribeRankingData.invertUpdatedAt.error.invalid"),
                    });
                }
