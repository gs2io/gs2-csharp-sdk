...
namespace Gs2.Gs2Ranking2.Model.Cache
{
    public static partial class ClusterRankingModelMasterExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<ClusterRankingModelMaster> FetchFuture(
            this ClusterRankingModelMaster self,
            CacheDatabase cache,
            string namespaceName,
            string rankingName,
            ...
            return new Gs2InlineFuture<ClusterRankingModelMaster>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<ClusterRankingModelMaster> FetchAsync(
#else
        public static async Task<ClusterRankingModelMaster> FetchAsync(
#endif
            this ClusterRankingModelMaster self,
            CacheDatabase cache,
            string namespaceName,
...
#else
            Func<Task<ClusterRankingModelMaster>> fetchImpl
#endif
        ) {
            try {
        ...
        public static Tuple<ClusterRankingModelMaster, bool> GetCache(
            this ClusterRankingModelMaster self,
            CacheDatabase cache,
            string namespaceName,
            string rankingName,
