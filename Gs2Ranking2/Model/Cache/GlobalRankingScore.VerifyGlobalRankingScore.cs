...
namespace Gs2.Gs2Ranking2.Model.Cache
{
    public static partial class GlobalRankingScoreExt
    {
        public static void PutCache(
            this VerifyGlobalRankingScoreResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<VerifyGlobalRankingScoreResult> InvokeFuture(
            this VerifyGlobalRankingScoreRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<VerifyGlobalRankingScoreResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<VerifyGlobalRankingScoreResult> self)
            {
            ...
            return new Gs2InlineFuture<VerifyGlobalRankingScoreResult>(Impl);
        }
#endif
