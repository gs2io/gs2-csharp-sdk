...
namespace Gs2.Gs2Ranking2.Model.Cache
{
    public static partial class ClusterRankingReceivedRewardExt
    {
        public static void PutCache(
            this DescribeClusterRankingReceivedRewardsResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeClusterRankingReceivedRewardsResult> InvokeFuture(
            this DescribeClusterRankingReceivedRewardsRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DescribeClusterRankingReceivedRewardsResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DescribeClusterRankingReceivedRewardsResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeClusterRankingReceivedRewardsResult>(Impl);
        }
#endif
