...
namespace Gs2.Gs2Ranking2.Model.Cache
{
    public static partial class SubscribeRankingScoreExt
    {
        public static void PutCache(
            this DescribeSubscribeRankingScoresByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeSubscribeRankingScoresByUserIdResult> InvokeFuture(
            this DescribeSubscribeRankingScoresByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DescribeSubscribeRankingScoresByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DescribeSubscribeRankingScoresByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeSubscribeRankingScoresByUserIdResult>(Impl);
        }
#endif
