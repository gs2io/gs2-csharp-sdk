...
namespace Gs2.Gs2Ranking2.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentRankingMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentRankingMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentRankingMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentRankingMaster", "ranking2.currentRankingMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentRankingMaster", "ranking2.currentRankingMaster.settings.error.tooLong"),
                    });
                }
            }
        }
