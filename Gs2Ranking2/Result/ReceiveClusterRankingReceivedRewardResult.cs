...
#endif
	[System.Serializable]
	public class ReceiveClusterRankingReceivedRewardResult : IResult
	{
        ...
        public ReceiveClusterRankingReceivedRewardResult WithItem(Gs2.Gs2Ranking2.Model.ClusterRankingModel item) {
            this.Item = item;
            return this;
        }

        public ReceiveClusterRankingReceivedRewardResult WithAcquireActions(Gs2.Core.Model.AcquireAction[] acquireActions) {
        ...
        public ReceiveClusterRankingReceivedRewardResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReceiveClusterRankingReceivedRewardResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReceiveClusterRankingReceivedRewardResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReceiveClusterRankingReceivedRewardResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReceiveClusterRankingReceivedRewardResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
