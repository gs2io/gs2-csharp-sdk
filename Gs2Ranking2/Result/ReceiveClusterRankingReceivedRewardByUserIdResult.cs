...
#endif
	[System.Serializable]
	public class ReceiveClusterRankingReceivedRewardByUserIdResult : IResult
	{
        public Gs2.Gs2Ranking2.Model.ClusterRankingModel Item { set; get; }
        ...
        public ReceiveClusterRankingReceivedRewardByUserIdResult WithItem(Gs2.Gs2Ranking2.Model.ClusterRankingModel item) {
            this.Item = item;
            return this;
        }

        public ReceiveClusterRankingReceivedRewardByUserIdResult WithAcquireActions(Gs2.Core.Model.AcquireAction[] acquireActions) {
        ...
        public ReceiveClusterRankingReceivedRewardByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ReceiveClusterRankingReceivedRewardByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ReceiveClusterRankingReceivedRewardByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ReceiveClusterRankingReceivedRewardByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ReceiveClusterRankingReceivedRewardByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new ReceiveClusterRankingReceivedRewardByUserIdResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2Ranking2.Model.ClusterRankingModel.FromJson(data["item"]))
                ...
                .WithAutoRunStampSheet(!data.Keys.Contains("autoRunStampSheet") || data["autoRunStampSheet"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableBool(data["autoRunStampSheet"].ToString()))
