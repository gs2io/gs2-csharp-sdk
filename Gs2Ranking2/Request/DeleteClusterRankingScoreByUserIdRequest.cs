...
#endif
	[System.Serializable]
	public class DeleteClusterRankingScoreByUserIdRequest : Gs2Request<DeleteClusterRankingScoreByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteClusterRankingScoreByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
