...
#endif
	[System.Serializable]
	public class GetGlobalRankingScoreByUserIdRequest : Gs2Request<GetGlobalRankingScoreByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGlobalRankingScoreByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
