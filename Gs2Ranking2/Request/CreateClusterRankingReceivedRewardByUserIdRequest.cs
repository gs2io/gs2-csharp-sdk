...
#endif
	[System.Serializable]
	public class CreateClusterRankingReceivedRewardByUserIdRequest : Gs2Request<CreateClusterRankingReceivedRewardByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static CreateClusterRankingReceivedRewardByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
