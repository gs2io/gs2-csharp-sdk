...
#endif
	[System.Serializable]
	public class DescribeClusterRankingReceivedRewardsByUserIdRequest : Gs2Request<DescribeClusterRankingReceivedRewardsByUserIdRequest>
	{
        ...
        public DescribeClusterRankingReceivedRewardsByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeClusterRankingReceivedRewardsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
