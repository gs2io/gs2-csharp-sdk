...
#endif
	[System.Serializable]
	public class GetGlobalRankingReceivedRewardByUserIdRequest : Gs2Request<GetGlobalRankingReceivedRewardByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGlobalRankingReceivedRewardByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
