...
#endif
	[System.Serializable]
	public class GetSubscribeRankingByUserIdRequest : Gs2Request<GetSubscribeRankingByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSubscribeRankingByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
