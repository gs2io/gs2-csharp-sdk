...
#endif
	[System.Serializable]
	public class DescribeGlobalRankingsRequest : Gs2Request<DescribeGlobalRankingsRequest>
	{
        ...
        public DescribeGlobalRankingsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeGlobalRankingsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
