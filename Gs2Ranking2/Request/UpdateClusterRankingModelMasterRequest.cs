...
#endif
	[System.Serializable]
	public class UpdateClusterRankingModelMasterRequest : Gs2Request<UpdateClusterRankingModelMasterRequest>
	{
        ...
        public UpdateClusterRankingModelMasterRequest WithSum(bool? sum) {
            this.Sum = sum;
            return this;
        }
        public UpdateClusterRankingModelMasterRequest WithScoreTtlDays(int? scoreTtlDays) {
        ...
        public UpdateClusterRankingModelMasterRequest WithRankingRewards(Gs2.Gs2Ranking2.Model.RankingReward[] rankingRewards) {
    	...
    	[Preserve]
#endif
        public static UpdateClusterRankingModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new UpdateClusterRankingModelMasterRequest()
                ...
                .WithRankingRewards(!data.Keys.Contains("rankingRewards") || data["rankingRewards"] == null || !data["rankingRewards"].IsArray ? new Gs2.Gs2Ranking2.Model.RankingReward[]{} : data["rankingRewards"].Cast<JsonData>().Select(v => {
