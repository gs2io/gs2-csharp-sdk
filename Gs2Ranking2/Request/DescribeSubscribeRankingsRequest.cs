...
#endif
	[System.Serializable]
	public class DescribeSubscribeRankingsRequest : Gs2Request<DescribeSubscribeRankingsRequest>
	{
        ...
        public DescribeSubscribeRankingsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSubscribeRankingsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
