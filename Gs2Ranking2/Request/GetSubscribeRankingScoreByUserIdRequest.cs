...
#endif
	[System.Serializable]
	public class GetSubscribeRankingScoreByUserIdRequest : Gs2Request<GetSubscribeRankingScoreByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSubscribeRankingScoreByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
