...
#endif
	[System.Serializable]
	public class ReceiveGlobalRankingReceivedRewardRequest : Gs2Request<ReceiveGlobalRankingReceivedRewardRequest>
	{
        ...
        public ReceiveGlobalRankingReceivedRewardRequest WithConfig(Gs2.Gs2Ranking2.Model.Config[] config) {
            this.Config = config;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static ReceiveGlobalRankingReceivedRewardRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
