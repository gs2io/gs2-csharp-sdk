...
#endif
	[System.Serializable]
	public class GetSubscribeRankingScoreRequest : Gs2Request<GetSubscribeRankingScoreRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSubscribeRankingScoreRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
