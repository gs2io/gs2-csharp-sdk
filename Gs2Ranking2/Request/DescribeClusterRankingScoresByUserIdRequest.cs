...
#endif
	[System.Serializable]
	public class DescribeClusterRankingScoresByUserIdRequest : Gs2Request<DescribeClusterRankingScoresByUserIdRequest>
	{
        ...
        public DescribeClusterRankingScoresByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeClusterRankingScoresByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
