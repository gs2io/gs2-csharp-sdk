...
#endif
	[System.Serializable]
	public class ReceiveClusterRankingReceivedRewardByUserIdRequest : Gs2Request<ReceiveClusterRankingReceivedRewardByUserIdRequest>
	{
        ...
        public ReceiveClusterRankingReceivedRewardByUserIdRequest WithConfig(Gs2.Gs2Ranking2.Model.Config[] config) {
            this.Config = config;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static ReceiveClusterRankingReceivedRewardByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new ReceiveClusterRankingReceivedRewardByUserIdRequest()
                ...
                .WithConfig(!data.Keys.Contains("config") || data["config"] == null || !data["config"].IsArray ? new Gs2.Gs2Ranking2.Model.Config[]{} : data["config"].Cast<JsonData>().Select(v => {
