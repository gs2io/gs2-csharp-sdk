...
#endif
	[System.Serializable]
	public class PutSubscribeRankingScoreRequest : Gs2Request<PutSubscribeRankingScoreRequest>
	{
    	...
    	[Preserve]
#endif
        public static PutSubscribeRankingScoreRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
