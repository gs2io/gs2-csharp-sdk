...
#endif
	[System.Serializable]
	public class DescribeClusterRankingReceivedRewardsRequest : Gs2Request<DescribeClusterRankingReceivedRewardsRequest>
	{
        ...
        public DescribeClusterRankingReceivedRewardsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeClusterRankingReceivedRewardsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
