...
#endif
	[System.Serializable]
	public class DescribeClusterRankingScoresRequest : Gs2Request<DescribeClusterRankingScoresRequest>
	{
        ...
        public DescribeClusterRankingScoresRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeClusterRankingScoresRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
