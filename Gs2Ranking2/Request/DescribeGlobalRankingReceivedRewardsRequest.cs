...
#endif
	[System.Serializable]
	public class DescribeGlobalRankingReceivedRewardsRequest : Gs2Request<DescribeGlobalRankingReceivedRewardsRequest>
	{
        ...
        public DescribeGlobalRankingReceivedRewardsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeGlobalRankingReceivedRewardsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
