...
#endif
	[System.Serializable]
	public class CreateGlobalRankingReceivedRewardByUserIdRequest : Gs2Request<CreateGlobalRankingReceivedRewardByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static CreateGlobalRankingReceivedRewardByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
