...
#endif
	[System.Serializable]
	public class GetGlobalRankingByUserIdRequest : Gs2Request<GetGlobalRankingByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGlobalRankingByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
