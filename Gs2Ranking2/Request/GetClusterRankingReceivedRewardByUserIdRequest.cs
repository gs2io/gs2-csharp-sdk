...
#endif
	[System.Serializable]
	public class GetClusterRankingReceivedRewardByUserIdRequest : Gs2Request<GetClusterRankingReceivedRewardByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetClusterRankingReceivedRewardByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
