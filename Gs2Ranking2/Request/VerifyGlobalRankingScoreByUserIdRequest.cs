...
#endif
	[System.Serializable]
	public class VerifyGlobalRankingScoreByUserIdRequest : Gs2Request<VerifyGlobalRankingScoreByUserIdRequest>
	{
        ...
        public VerifyGlobalRankingScoreByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyGlobalRankingScoreByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
