...
#endif
	[System.Serializable]
	public class GetClusterRankingScoreByUserIdRequest : Gs2Request<GetClusterRankingScoreByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetClusterRankingScoreByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
