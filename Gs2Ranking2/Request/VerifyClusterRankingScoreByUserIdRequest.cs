...
#endif
	[System.Serializable]
	public class VerifyClusterRankingScoreByUserIdRequest : Gs2Request<VerifyClusterRankingScoreByUserIdRequest>
	{
        ...
        public VerifyClusterRankingScoreByUserIdRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyClusterRankingScoreByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
