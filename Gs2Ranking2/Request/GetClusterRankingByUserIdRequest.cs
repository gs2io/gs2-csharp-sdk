...
#endif
	[System.Serializable]
	public class GetClusterRankingByUserIdRequest : Gs2Request<GetClusterRankingByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetClusterRankingByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
