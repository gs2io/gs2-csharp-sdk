...
#endif
	[System.Serializable]
	public class DescribeSubscribeRankingsByUserIdRequest : Gs2Request<DescribeSubscribeRankingsByUserIdRequest>
	{
        ...
        public DescribeSubscribeRankingsByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSubscribeRankingsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
