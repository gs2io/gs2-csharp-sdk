...
#endif
	[System.Serializable]
	public class VerifyGlobalRankingScoreRequest : Gs2Request<VerifyGlobalRankingScoreRequest>
	{
        ...
        public VerifyGlobalRankingScoreRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifyGlobalRankingScoreRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
