...
#endif
	[System.Serializable]
	public class CreateGlobalRankingReceivedRewardRequest : Gs2Request<CreateGlobalRankingReceivedRewardRequest>
	{
    	...
    	[Preserve]
#endif
        public static CreateGlobalRankingReceivedRewardRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
