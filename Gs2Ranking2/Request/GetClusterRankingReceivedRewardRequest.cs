...
#endif
	[System.Serializable]
	public class GetClusterRankingReceivedRewardRequest : Gs2Request<GetClusterRankingReceivedRewardRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetClusterRankingReceivedRewardRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
