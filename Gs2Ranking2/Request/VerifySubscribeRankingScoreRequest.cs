...
#endif
	[System.Serializable]
	public class VerifySubscribeRankingScoreRequest : Gs2Request<VerifySubscribeRankingScoreRequest>
	{
        ...
        public VerifySubscribeRankingScoreRequest WithMultiplyValueSpecifyingQuantity(bool? multiplyValueSpecifyingQuantity) {
    	...
    	[Preserve]
#endif
        public static VerifySubscribeRankingScoreRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
