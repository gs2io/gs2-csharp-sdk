...
#endif
	[System.Serializable]
	public class DescribeClusterRankingsByUserIdRequest : Gs2Request<DescribeClusterRankingsByUserIdRequest>
	{
        ...
        public DescribeClusterRankingsByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeClusterRankingsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
