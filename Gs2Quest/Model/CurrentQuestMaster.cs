...
namespace Gs2.Gs2Quest.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentQuestMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentQuestMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentQuestMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentQuestMaster", "quest.currentQuestMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentQuestMaster", "quest.currentQuestMaster.settings.error.tooLong"),
                    });
                }
            }
        }
