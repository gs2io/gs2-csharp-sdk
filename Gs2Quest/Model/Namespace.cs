...
namespace Gs2.Gs2Quest.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2Quest.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        [Obsolete("This method is deprecated")]
        public Namespace WithTransactionSetting(Gs2.Gs2Quest.Model.TransactionSetting transactionSetting) {
            this.TransactionSetting = transactionSetting;
            return this;
        }
        public Namespace WithTransactionSettingV2(Gs2.Gs2Quest.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        private static System.Text.RegularExpressions.Regex _regionRegex = new System.Text.RegularExpressions.Regex(
                @"grn:gs2:(?<region>.+):(?<ownerId>.+):quest:(?<namespaceName>.+)",
        ...
        public static Namespace FromJson(JsonData data)
        {
            ...
            return new Namespace()
                ...
                .WithTransactionSettingV2(!data.Keys.Contains("transactionSettingV2") || data["transactionSettingV2"] == null ? null : Gs2.Gs2Quest.Model.TransactionSettingV2.FromJson(data["transactionSettingV2"]))
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(StartQuestScript, other.StartQuestScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(CompleteQuestScript, other.CompleteQuestScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(FailedQuestScript, other.FailedQuestScript);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "quest.namespace.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "quest.namespace.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "quest.namespace.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "quest.namespace.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "quest.namespace.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "quest.namespace.revision.error.invalid"),
                    });
                }
        ...
        public object Clone() {
            return new Namespace {
                ...
                Name = Name,
                Description = Description,
                TransactionSetting = TransactionSetting?.Clone() as Gs2.Gs2Quest.Model.TransactionSetting,
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2Quest.Model.TransactionSettingV2,
                StartQuestScript = StartQuestScript?.Clone() as Gs2.Gs2Quest.Model.ScriptSetting,
                CompleteQuestScript = CompleteQuestScript?.Clone() as Gs2.Gs2Quest.Model.ScriptSetting,
                FailedQuestScript = FailedQuestScript?.Clone() as Gs2.Gs2Quest.Model.ScriptSetting,
                LogSetting = LogSetting?.Clone() as Gs2.Gs2Quest.Model.LogSetting,
                CreatedAt = CreatedAt,
                UpdatedAt = UpdatedAt,
