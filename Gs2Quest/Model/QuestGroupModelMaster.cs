...
namespace Gs2.Gs2Quest.Model
{
	...
	[Preserve]
#endif
	public partial class QuestGroupModelMaster : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type QuestGroupModelMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (QuestGroupModelId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.questGroupModelId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.description.error.tooLong"),
                    });
                }
            }
            {
                if (Metadata.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.metadata.error.tooLong"),
                    });
                }
            }
            {
                if (ChallengePeriodEventId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.challengePeriodEventId.error.tooLong"),
                    });
                }
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("questGroupModelMaster", "quest.questGroupModelMaster.revision.error.invalid"),
                    });
                }
