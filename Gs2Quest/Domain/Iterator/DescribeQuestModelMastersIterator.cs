    ...
    public class DescribeQuestModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Quest.Model.QuestModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Quest.Model.QuestModelMaster>
            (
                ...
                var request = new Gs2.Gs2Quest.Request.DescribeQuestModelMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Quest.Model.QuestModelMaster>(
                        (null as Gs2.Gs2Quest.Model.QuestModelMaster).CacheParentKey(
                            NamespaceName,
                            QuestGroupName
                        )
