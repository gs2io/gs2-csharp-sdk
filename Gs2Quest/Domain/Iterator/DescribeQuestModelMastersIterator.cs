...
namespace Gs2.Gs2Quest.Domain.Iterator
{
    ...
    public class DescribeQuestModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Quest.Model.QuestModelMaster> {
        ...
        public DescribeQuestModelMastersIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Quest.Model.QuestModelMaster[]{};
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._cache.TryGetList<Gs2.Gs2Quest.Model.QuestModelMaster>
            (
                    parentKey,
                    out var list
            )) {
                ...
                var future = this._client.DescribeQuestModelMastersFuture(
                #else
                var r = await this._client.DescribeQuestModelMastersAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.SetListCached<Gs2.Gs2Quest.Model.QuestModelMaster>(
                            parentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Quest.Model.QuestModelMaster>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Quest.Model.QuestModelMaster ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Quest.Model.QuestModelMaster>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Quest.Model.QuestModelMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Quest.Model.QuestModelMaster>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
