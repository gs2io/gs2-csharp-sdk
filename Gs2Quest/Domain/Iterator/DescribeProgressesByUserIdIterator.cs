...
namespace Gs2.Gs2Quest.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Quest.Model.Progress>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Quest.Model.Progress>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Quest.Model.Progress>
    #endif
    {
        ...
        public DescribeProgressesByUserIdIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Quest.Model.Progress[]{};
        }
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Quest.Request.DescribeProgressesByUserIdRequest()
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Quest.Model.Progress>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Quest.Model.Progress>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Quest.Model.Progress> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Quest.Model.Progress> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Quest.Model.Progress>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
