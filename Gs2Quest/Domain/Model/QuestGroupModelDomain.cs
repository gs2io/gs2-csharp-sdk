...
namespace Gs2.Gs2Quest.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.QuestGroupModel> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Quest.Model.QuestGroupModel>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "questGroupModel")
                        {
    ...
    public partial class QuestGroupModelDomain {
        ...
        public IFuture<Gs2.Gs2Quest.Model.QuestGroupModel> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.QuestGroupModel> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Quest.Model.QuestGroupModel>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Quest.Model.QuestGroupModel>(
                        _parentKey,
                        Gs2.Gs2Quest.Domain.Model.QuestGroupModelDomain.CreateCacheKey(
                            this.QuestGroupName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Quest.Model.QuestGroupModel>(
                _parentKey,
                Gs2.Gs2Quest.Domain.Model.QuestGroupModelDomain.CreateCacheKey(
                    this.QuestGroupName.ToString()
                )
