...
namespace Gs2.Gs2Quest.Domain.Model
{
    ...
    public partial class NamespaceDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        _cache.Put<Gs2.Gs2Quest.Model.Namespace>(
                            _parentKey,
                            key,
                            null,
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (resultModel != null) {
                    
                    {
                        ...
                        cache.Delete<Gs2.Gs2Quest.Model.Namespace>(parentKey, key);
                    }
                }
                var domain = this;
        ...
        public async UniTask<Gs2.Gs2Quest.Domain.Model.QuestGroupModelMasterDomain> CreateQuestGroupModelMasterAsync(
            ...
            var future = CreateQuestGroupModelMasterFuture(request);
            await future;
            if (future.Error != null) {
                throw future.Error;
            }
    ...
    public partial class NamespaceDomain {
        ...
        public IFuture<Gs2.Gs2Quest.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.Namespace> self)
            {
                ...
                var (value, find) = _cache.Get<Gs2.Gs2Quest.Model.Namespace>(
                    parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Quest.Model.Namespace>(
                        parentKey,
                        Gs2.Gs2Quest.Domain.Model.NamespaceDomain.CreateCacheKey(
                            this.NamespaceName?.ToString()
                        )
