...
namespace Gs2.Gs2Quest.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public async UniTask<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> GetStatusAsync(
            #else
        public IFuture<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> GetStatus(
            #endif
        #else
        public async Task<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> GetStatusAsync(
            ...
            #endif
            Gs2.Gs2Quest.Domain.Model.NamespaceDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Quest.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Quest.Model.Namespace> Get(
            #endif
        #else
        ...
        public async UniTask<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> UpdateAsync(
            #else
        public IFuture<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> Update(
            #endif
        #else
        ...
        public async UniTask<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> DeleteAsync(
            #else
        public IFuture<Gs2.Gs2Quest.Domain.Model.NamespaceDomain> Delete(
            #endif
        #else
        ...
        public async UniTask<Gs2.Gs2Quest.Domain.Model.QuestGroupModelMasterDomain> CreateQuestGroupModelMasterAsync(
            #else
        public IFuture<Gs2.Gs2Quest.Domain.Model.QuestGroupModelMasterDomain> CreateQuestGroupModelMaster(
            #endif
        #else
        public async Task<Gs2.Gs2Quest.Domain.Model.QuestGroupModelMasterDomain> CreateQuestGroupModelMasterAsync(
            ...
            request
                .WithNamespaceName(this._namespaceName);
            #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            var future = this._client.CreateQuestGroupModelMasterFuture(
                request
            );
            yield return future;
            if (future.Error != null)
            ...
            var result = future.Result;
            #else
            var result = await this._client.CreateQuestGroupModelMasterAsync(
                request
            );
            #endif
            ...
            Gs2.Gs2Quest.Domain.Model.QuestGroupModelMasterDomain domain = new Gs2.Gs2Quest.Domain.Model.QuestGroupModelMasterDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Quest.Model.QuestGroupModel> QuestGroupModels(
            #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Quest.Model.QuestGroupModelMaster> QuestGroupModelMasters(
            #else
        ...
        public async Task<Gs2.Gs2Quest.Model.Namespace> Model() {
            ...
            {
        #endif
            Gs2.Gs2Quest.Model.Namespace value = _cache.Get<Gs2.Gs2Quest.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Quest.Domain.Model.NamespaceDomain.CreateCacheKey(
