...
namespace Gs2.Gs2Quest.Domain.Model
{
    ...
    public partial class CompletedQuestListDomain {
    ...
    public partial class CompletedQuestListDomain {
        ...
        private IFuture<Gs2.Gs2Quest.Model.CompletedQuestList> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.CompletedQuestList> self)
            {
                ...
                var future = this._client.GetCompletedQuestListByUserIdFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        _cache.Put<Gs2.Gs2Quest.Model.CompletedQuestList>(
                            _parentKey,
                            key,
                            null,
                ...
                request
                    ...
                    .WithUserId(this.UserId)
                    .WithQuestGroupName(this.QuestGroupName);
                GetCompletedQuestListByUserIdResult result = null;
                try {
                    result = await this._client.GetCompletedQuestListByUserIdAsync(
                        request
                    );
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain> DeleteFuture(
            DeleteCompletedQuestListByUserIdRequest request
        ) {

            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain> self)
            {
                #if UNITY_2017_1_OR_NEWER
                request
                    .WithNamespaceName(this.NamespaceName)
                    .WithUserId(this.UserId)
                    .WithQuestGroupName(this.QuestGroupName);
                var future = this._client.DeleteCompletedQuestListByUserIdFuture(
                    request
                );
                yield return future;
                if (future.Error != null)
            ...
            return new Gs2InlineFuture<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain>(Impl);
        }
        #else
        public async Task<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain> DeleteAsync(
            DeleteCompletedQuestListByUserIdRequest request
        ) {
            #if UNITY_2017_1_OR_NEWER
            request
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain> DeleteAsync(
            DeleteCompletedQuestListByUserIdRequest request
        ) {
        ...
        public IFuture<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain> Delete(
            DeleteCompletedQuestListByUserIdRequest request
        ) {
    ...
    public partial class CompletedQuestListDomain {
        ...
        public IFuture<Gs2.Gs2Quest.Model.CompletedQuestList> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.CompletedQuestList> self)
            {
                var (value, find) = _cache.Get<Gs2.Gs2Quest.Model.CompletedQuestList>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Quest.Model.CompletedQuestList>(
                        _parentKey,
                        Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain.CreateCacheKey(
                            this.QuestGroupName?.ToString()
                        )
        ...
        {
            this._cache.Unsubscribe<Gs2.Gs2Quest.Model.CompletedQuestList>(
                _parentKey,
                Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain.CreateCacheKey(
                    this.QuestGroupName.ToString()
                ),
