...
namespace Gs2.Gs2Quest.Domain.Model
{
    ...
    public partial class CompletedQuestListDomain {
        ...
        private async Task<Gs2.Gs2Quest.Model.CompletedQuestList> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                null,
                () => this._client.GetCompletedQuestListByUserIdAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2Quest.Domain.Model.CompletedQuestListDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    this.UserId,
                    null,
                    () => this._client.DeleteCompletedQuestListByUserIdAsync(request)
                );
            }
    ...
    public partial class CompletedQuestListDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Quest.Model.CompletedQuestList> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Quest.Model.CompletedQuestList> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Quest.Model.CompletedQuestList> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Quest.Model.CompletedQuestList> Model() => ModelAsync();
        #endif
