...
namespace Gs2.Gs2Quest.Domain.Model
{
    ...
    public partial class QuestModelMasterDomain {
        ...
        private async Task<Gs2.Gs2Quest.Model.QuestModelMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetQuestModelMasterAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2Quest.Domain.Model.QuestModelMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateQuestModelMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Quest.Domain.Model.QuestModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    null,
                    null,
                    () => this._client.DeleteQuestModelMasterAsync(request)
                );
            }
    ...
    public partial class QuestModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Quest.Model.QuestModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Quest.Model.QuestModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Quest.Model.QuestModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Quest.Model.QuestModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Quest.Model.QuestModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.QuestGroupName,
                this.QuestName,
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Quest.Model.QuestModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Quest.Model.QuestModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Quest.Model.QuestModelMaster> callback)
        #endif
        {
