        ...
        private IFuture<Gs2.Gs2Quest.Model.CurrentQuestMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.CurrentQuestMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.GetCurrentQuestMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> PreUpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.PreUpdateCurrentQuestMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateCurrentQuestMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> UpdateFromGitHubFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateCurrentQuestMasterFromGitHubFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
    ...
    public partial class CurrentQuestMasterDomain {
        ...
        public IFuture<Gs2.Gs2Quest.Model.CurrentQuestMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Quest.Model.CurrentQuestMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2Quest.Model.CurrentQuestMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    () => this.GetFuture(
