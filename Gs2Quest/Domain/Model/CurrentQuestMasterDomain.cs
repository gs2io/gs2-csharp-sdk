...
namespace Gs2.Gs2Quest.Domain.Model
{
    ...
    public partial class CurrentQuestMasterDomain {
        ...
        private async Task<Gs2.Gs2Quest.Model.CurrentQuestMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetCurrentQuestMasterAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> PreUpdateFuture(
            PreUpdateCurrentQuestMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentQuestMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentQuestMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentQuestMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Quest.Domain.Model.CurrentQuestMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateCurrentQuestMasterFromGitHubAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentQuestMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Quest.Model.CurrentQuestMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Quest.Model.CurrentQuestMaster>(
                        (null as Gs2.Gs2Quest.Model.CurrentQuestMaster).CacheParentKey(
                            this.NamespaceName,
                            null
                        ),
                        (null as Gs2.Gs2Quest.Model.CurrentQuestMaster).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Quest.Model.CurrentQuestMaster).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null
                );
                ...
                return await (null as Gs2.Gs2Quest.Model.CurrentQuestMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetAsync(
        ...
        public UniTask<Gs2.Gs2Quest.Model.CurrentQuestMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Quest.Model.CurrentQuestMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Quest.Model.CurrentQuestMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Quest.Model.CurrentQuestMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
