...
#endif
	[System.Serializable]
	public class PreUpdateCurrentQuestMasterResult : IResult
	{
        ...
        public PreUpdateCurrentQuestMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentQuestMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
