...
namespace Gs2.Gs2Quest.Result
{
	...
	public class CreateProgressByUserIdResult : IResult
	{
        ...
        public CreateProgressByUserIdResult WithItem(Gs2.Gs2Quest.Model.Progress item) {
            this.Item = item;
            return this;
        }

        public CreateProgressByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CreateProgressByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
