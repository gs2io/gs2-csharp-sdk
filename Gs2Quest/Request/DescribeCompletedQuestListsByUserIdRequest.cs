...
namespace Gs2.Gs2Quest.Request
{
	...
	public class DescribeCompletedQuestListsByUserIdRequest : Gs2Request<DescribeCompletedQuestListsByUserIdRequest>
	{
        ...
        public DescribeCompletedQuestListsByUserIdRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeCompletedQuestListsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCompletedQuestListsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCompletedQuestListsByUserIdRequest)x;
            return this;
        }
    }
}