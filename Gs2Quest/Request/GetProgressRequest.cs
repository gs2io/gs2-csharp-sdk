...
namespace Gs2.Gs2Quest.Request
{
	...
	public class GetProgressRequest : Gs2Request<GetProgressRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetProgressRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetProgressRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetProgressRequest)x;
            return this;
        }
    }
}