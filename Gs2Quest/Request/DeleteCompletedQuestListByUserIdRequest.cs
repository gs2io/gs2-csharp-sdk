...
namespace Gs2.Gs2Quest.Request
{
	...
	public class DeleteCompletedQuestListByUserIdRequest : Gs2Request<DeleteCompletedQuestListByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteCompletedQuestListByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteCompletedQuestListByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteCompletedQuestListByUserIdRequest)x;
            return this;
        }
    }
}