...
namespace Gs2.Gs2Quest.Request
{
	...
	public class CreateProgressByStampSheetRequest : Gs2Request<CreateProgressByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static CreateProgressByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply CreateProgressByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (CreateProgressByStampSheetRequest)x;
            return this;
        }
    }
}