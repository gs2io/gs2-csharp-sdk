...
namespace Gs2.Gs2Quest.Request
{
	...
	public class UpdateCurrentQuestMasterRequest : Gs2Request<UpdateCurrentQuestMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentQuestMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentQuestMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentQuestMasterRequest)x;
            return this;
        }
    }
}