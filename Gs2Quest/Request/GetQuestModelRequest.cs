...
namespace Gs2.Gs2Quest.Request
{
	...
	public class GetQuestModelRequest : Gs2Request<GetQuestModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetQuestModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetQuestModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetQuestModelRequest)x;
            return this;
        }
    }
}