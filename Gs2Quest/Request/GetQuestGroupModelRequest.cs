...
namespace Gs2.Gs2Quest.Request
{
	...
	public class GetQuestGroupModelRequest : Gs2Request<GetQuestGroupModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetQuestGroupModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetQuestGroupModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetQuestGroupModelRequest)x;
            return this;
        }
    }
}