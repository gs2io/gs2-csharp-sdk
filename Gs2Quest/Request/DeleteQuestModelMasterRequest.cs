...
namespace Gs2.Gs2Quest.Request
{
	...
	public class DeleteQuestModelMasterRequest : Gs2Request<DeleteQuestModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteQuestModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteQuestModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteQuestModelMasterRequest)x;
            return this;
        }
    }
}