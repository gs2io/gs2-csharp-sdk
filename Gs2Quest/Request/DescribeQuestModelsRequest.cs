...
namespace Gs2.Gs2Quest.Request
{
	...
	public class DescribeQuestModelsRequest : Gs2Request<DescribeQuestModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeQuestModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeQuestModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeQuestModelsRequest)x;
            return this;
        }
    }
}