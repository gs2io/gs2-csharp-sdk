...
namespace Gs2.Gs2Quest.Request
{
	...
	public class DescribeCompletedQuestListsRequest : Gs2Request<DescribeCompletedQuestListsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeCompletedQuestListsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCompletedQuestListsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCompletedQuestListsRequest)x;
            return this;
        }
    }
}