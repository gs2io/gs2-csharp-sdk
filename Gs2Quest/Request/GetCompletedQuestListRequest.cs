...
namespace Gs2.Gs2Quest.Request
{
	...
	public class GetCompletedQuestListRequest : Gs2Request<GetCompletedQuestListRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCompletedQuestListRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCompletedQuestListRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCompletedQuestListRequest)x;
            return this;
        }
    }
}