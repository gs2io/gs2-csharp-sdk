...
namespace Gs2.Gs2Quest.Request
{
	...
	public class GetCompletedQuestListByUserIdRequest : Gs2Request<GetCompletedQuestListByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCompletedQuestListByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCompletedQuestListByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCompletedQuestListByUserIdRequest)x;
            return this;
        }
    }
}