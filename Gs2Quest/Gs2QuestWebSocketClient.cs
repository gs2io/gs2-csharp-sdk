...
namespace Gs2.Gs2Quest
{
	public class Gs2QuestWebSocketClient : AbstractGs2Client
	{
        ...
        public class PreUpdateCurrentQuestMasterTask : Gs2WebSocketSessionTask<Request.PreUpdateCurrentQuestMasterRequest, Result.PreUpdateCurrentQuestMasterResult>
        {
	        public PreUpdateCurrentQuestMasterTask(IGs2Session session, Request.PreUpdateCurrentQuestMasterRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.PreUpdateCurrentQuestMasterRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
		...
		{
			var task = new PreUpdateCurrentQuestMasterTask(
			    Gs2WebSocketSession,
			    request
            );
            yield return task;
            callback.Invoke(new AsyncResult<Result.PreUpdateCurrentQuestMasterResult>(task.Result, task.Error));
        }
    ...
    #if GS2_ENABLE_UNITASK
		public async UniTask<Result.PreUpdateCurrentQuestMasterResult> PreUpdateCurrentQuestMasterAsync(
            Request.PreUpdateCurrentQuestMasterRequest request
        )
		{
		    var task = new PreUpdateCurrentQuestMasterTask(
    ...
    #endif
#else
		public async Task<Result.PreUpdateCurrentQuestMasterResult> PreUpdateCurrentQuestMasterAsync(
            Request.PreUpdateCurrentQuestMasterRequest request
        )
		{
		    var task = new PreUpdateCurrentQuestMasterTask(
