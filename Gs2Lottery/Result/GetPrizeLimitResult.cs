...
namespace Gs2.Gs2Lottery.Result
{
	...
	public class GetPrizeLimitResult : IResult
	{
        ...
        public GetPrizeLimitResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetPrizeLimitResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new GetPrizeLimitResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2Lottery.Model.PrizeLimit.FromJson(data["item"]))
