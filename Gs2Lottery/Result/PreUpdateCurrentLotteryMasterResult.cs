...
#endif
	[System.Serializable]
	public class PreUpdateCurrentLotteryMasterResult : IResult
	{
        ...
        public PreUpdateCurrentLotteryMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentLotteryMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
