...
namespace Gs2.Gs2Lottery.Result
{
	...
	public class DrawByUserIdResult : IResult
	{
        ...
        public DrawByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public DrawByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public DrawByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public DrawByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DrawByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
