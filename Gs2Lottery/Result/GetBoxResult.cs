...
#endif
	[System.Serializable]
	public class GetBoxResult : IResult
	{
        public Gs2.Gs2Lottery.Model.BoxItems Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public GetBoxResult WithItem(Gs2.Gs2Lottery.Model.BoxItems item) {
            this.Item = item;
            return this;
        }

        public GetBoxResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetBoxResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
