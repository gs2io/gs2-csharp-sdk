...
namespace Gs2.Gs2Lottery.Model
{
	...
	[Preserve]
#endif
	public partial class LotteryModelMaster : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type LotteryModelMaster.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(LotteryModelId, other.LotteryModelId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(ChoicePrizeTableScriptId, other.ChoicePrizeTableScriptId);
            if (diff != 0)
            {
                return diff;
            }
