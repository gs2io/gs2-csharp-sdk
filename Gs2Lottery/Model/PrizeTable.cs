...
namespace Gs2.Gs2Lottery.Model
{
	...
	[Preserve]
#endif
	public partial class PrizeTable : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type PrizeTable.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(PrizeTableId, other.PrizeTableId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.CompareArray(Prizes, other.Prizes);
            if (diff != 0)
            {
                return diff;
            }
