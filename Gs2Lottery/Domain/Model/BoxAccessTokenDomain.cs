...
namespace Gs2.Gs2Lottery.Domain.Model
{
    ...
    public partial class BoxAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Lottery.Domain.Model.BoxAccessTokenDomain> ResetAsync(
            #else
        public IFuture<Gs2.Gs2Lottery.Domain.Model.BoxAccessTokenDomain> Reset(
            #endif
        #else
        public async Task<Gs2.Gs2Lottery.Domain.Model.BoxAccessTokenDomain> ResetAsync(
        #endif
            ResetBoxRequest request
        ) {

        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2Lottery.Domain.Model.BoxAccessTokenDomain> self)
            {
        #endif
            request
                .WithNamespaceName(this._namespaceName)
            ...
            Gs2.Gs2Lottery.Domain.Model.BoxAccessTokenDomain domain = this;
        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            ...
            return new Gs2InlineFuture<Gs2.Gs2Lottery.Domain.Model.BoxAccessTokenDomain>(Impl);
        #endif
        }
