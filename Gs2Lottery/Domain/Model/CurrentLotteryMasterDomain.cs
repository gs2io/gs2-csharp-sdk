...
namespace Gs2.Gs2Lottery.Domain.Model
{
    ...
    public partial class CurrentLotteryMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Lottery.Domain.Model.CurrentLotteryMasterDomain> PreUpdateFuture(
            PreUpdateCurrentLotteryMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Lottery.Domain.Model.CurrentLotteryMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Lottery.Domain.Model.CurrentLotteryMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentLotteryMasterRequest request
        ) {
            request = request
    ...
    public partial class CurrentLotteryMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Lottery.Model.CurrentLotteryMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Lottery.Model.CurrentLotteryMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Lottery.Model.CurrentLotteryMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Lottery.Model.CurrentLotteryMaster> Model() => ModelAsync();
        #endif
