...
namespace Gs2.Gs2Lottery.Domain.Model
{
    ...
    public partial class BoxItemDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Lottery.Model.BoxItem> ModelFuture()
        {
            ...
            #endif
        {
            ...
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Lottery.Model.BoxItem>(
                _parentKey,
                Gs2.Gs2Lottery.Domain.Model.BoxItemDomain.CreateCacheKey(
                )).LockAsync())
            {
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Lottery.Model.BoxItem>(
                _parentKey,
                Gs2.Gs2Lottery.Domain.Model.BoxItemDomain.CreateCacheKey(
                )
            );
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Lottery.Model.BoxItem> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Lottery.Model.BoxItem> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Lottery.Model.BoxItem> callback)
            #endif
        {
