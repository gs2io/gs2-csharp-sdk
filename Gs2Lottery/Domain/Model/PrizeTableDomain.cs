...
namespace Gs2.Gs2Lottery.Domain.Model
{
    ...
    public partial class PrizeTableDomain {
        ...
        #else
        public async Task<ulong> SubscribePrizeLimitsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Lottery.Model.PrizeLimit[]> callback
        )
        {
    ...
    public partial class PrizeTableDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Lottery.Model.PrizeTable> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Lottery.Model.PrizeTable> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Lottery.Model.PrizeTable> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Lottery.Model.PrizeTable> Model() => ModelAsync();
        #endif
