...
namespace Gs2.Gs2Lottery.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #endif
                            callback.Invoke(await PrizeTablesAsync(
                            ).ToArrayAsync());
                        }
        ...
        #else
        public async Task<ulong> SubscribePrizeTablesWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Lottery.Model.PrizeTable[]> callback
        )
        {
        ...
        public void InvalidatePrizeTables(
        )
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2Lottery.Model.PrizeTable>(
                (null as Gs2.Gs2Lottery.Model.PrizeTable).CacheParentKey(
                    this.NamespaceName,
                    null
                )
                ...
                () =>
                {
                    ...
                    async Task Impl() {
                        ...
                        try {
                            ...
                            await UniTask.SwitchToMainThread();
        #endif
                            callback.Invoke(await LotteryModelsAsync(
                            ).ToArrayAsync());
                        }
                        catch (System.Exception) {
                            // ignored
        ...
        #else
        public async Task<ulong> SubscribeLotteryModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Lottery.Model.LotteryModel[]> callback
        )
        {
        ...
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2Lottery.Model.LotteryModel>(
                (null as Gs2.Gs2Lottery.Model.LotteryModel).CacheParentKey(
                    this.NamespaceName,
                    null
                )
        ...
        #else
        public async Task<ulong> SubscribePrizeTableMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Lottery.Model.PrizeTableMaster[]> callback,
            string namePrefix = null
        )
        ...
        #else
        public async Task<ulong> SubscribeLotteryModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Lottery.Model.LotteryModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreatePrizeTableMasterAsync(request).ToGs2Future();
        #endif
        ...
        ) => CreateLotteryModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Lottery.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Lottery.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Lottery.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Lottery.Model.Namespace> Model() => ModelAsync();
        #endif
