...
namespace Gs2.Gs2Lottery.Domain.Iterator
{
    ...
    public class DescribePrizeLimitsIterator : IAsyncEnumerable<Gs2.Gs2Lottery.Model.PrizeLimit> {
        ...
        public DescribePrizeLimitsIterator(
            CacheDatabase cache,
            ...
            this._last = false;
            this._result = new Gs2.Gs2Lottery.Model.PrizeLimit[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Lottery.Model.PrizeLimit>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Lottery.Model.PrizeLimit>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribePrizeLimitsFuture(
                #else
                var r = await this._client.DescribePrizeLimitsAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Lottery.Model.PrizeLimit>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Lottery.Model.PrizeLimit>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Lottery.Model.PrizeLimit ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Lottery.Model.PrizeLimit>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Lottery.Model.PrizeLimit> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Lottery.Model.PrizeLimit>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
