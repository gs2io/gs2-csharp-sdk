...
namespace Gs2.Gs2Lottery.Domain.Iterator
{
    ...
    public class DescribeDrawnPrizesIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Lottery.Model.DrawnPrize>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Lottery.Model.DrawnPrize>
    #else
        IAsyncEnumerable<Gs2.Gs2Lottery.Model.DrawnPrize>
    #endif
    {
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Lottery.Model.DrawnPrize> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Lottery.Model.DrawnPrize>(async (writer, token) =>
        #else
