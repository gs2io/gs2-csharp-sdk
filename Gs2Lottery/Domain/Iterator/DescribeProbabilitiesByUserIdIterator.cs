...
namespace Gs2.Gs2Lottery.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeProbabilitiesByUserIdIterator : Gs2Iterator<Gs2.Gs2Lottery.Model.Probability> {
    #else
    public class DescribeProbabilitiesByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Lottery.Model.Probability> {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Lottery.Request.DescribeProbabilitiesByUserIdRequest()
                    .WithContextStack(this._gs2.DefaultContextStack)
                    .WithNamespaceName(this.NamespaceName)
                    .WithLotteryName(this.LotteryName)
                    .WithUserId(this.UserId);
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                var future = this._client.DescribeProbabilitiesByUserIdFuture(
                #else
