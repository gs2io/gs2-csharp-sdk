...
namespace Gs2.Gs2Lottery.Domain.Iterator
{
    ...
    public class DescribeBoxesByUserIdIterator {
        #else
    public class DescribeBoxesByUserIdIterator : Gs2Iterator<Gs2.Gs2Lottery.Model.Box> {
        #endif
    #else
    public class DescribeBoxesByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Lottery.Model.Box> {
    #endif
