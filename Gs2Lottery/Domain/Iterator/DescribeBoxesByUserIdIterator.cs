...
namespace Gs2.Gs2Lottery.Domain.Iterator
{
    ...
    public class DescribeBoxesByUserIdIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Lottery.Model.BoxItems>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Lottery.Model.BoxItems>
    #else
        IAsyncEnumerable<Gs2.Gs2Lottery.Model.BoxItems>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Lottery.Request.DescribeBoxesByUserIdRequest()
                    .WithContextStack(this._gs2.DefaultContextStack)
                    .WithNamespaceName(this.NamespaceName)
                    .WithUserId(this.UserId)
                    .WithPageToken(this._pageToken)
                    .WithLimit(fetchSize);
                var r = await this._client.DescribeBoxesByUserIdAsync(
                    request
                );
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Lottery.Model.BoxItems>(
                        (null as Gs2.Gs2Lottery.Model.BoxItems).CacheParentKey(
                            NamespaceName,
                            UserId,
                            null
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Lottery.Model.BoxItems>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Lottery.Model.BoxItems>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Lottery.Model.BoxItems> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Lottery.Model.BoxItems>(async (writer, token) =>
        #else
