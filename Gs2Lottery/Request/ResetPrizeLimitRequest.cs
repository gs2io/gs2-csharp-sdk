...
#endif
	[System.Serializable]
	public class ResetPrizeLimitRequest : Gs2Request<ResetPrizeLimitRequest>
	{
    	...
    	[Preserve]
#endif
        public static ResetPrizeLimitRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ResetPrizeLimitRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ResetPrizeLimitRequest)x;
            return this;
        }
    }
}