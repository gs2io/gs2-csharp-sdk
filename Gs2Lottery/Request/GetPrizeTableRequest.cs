...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class GetPrizeTableRequest : Gs2Request<GetPrizeTableRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPrizeTableRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPrizeTableRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPrizeTableRequest)x;
            return this;
        }
    }
}