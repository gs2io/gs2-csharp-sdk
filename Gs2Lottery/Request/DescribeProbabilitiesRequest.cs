...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class DescribeProbabilitiesRequest : Gs2Request<DescribeProbabilitiesRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeProbabilitiesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeProbabilitiesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeProbabilitiesRequest)x;
            return this;
        }
    }
}