...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class UpdateCurrentLotteryMasterFromGitHubRequest : Gs2Request<UpdateCurrentLotteryMasterFromGitHubRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentLotteryMasterFromGitHubRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new UpdateCurrentLotteryMasterFromGitHubRequest()
                ...
                .WithCheckoutSetting(!data.Keys.Contains("checkoutSetting") || data["checkoutSetting"] == null ? null : Gs2.Gs2Lottery.Model.GitHubCheckoutSetting.FromJson(data["checkoutSetting"]));
        }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentLotteryMasterFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentLotteryMasterFromGitHubRequest)x;
            return this;
        }
    }
}