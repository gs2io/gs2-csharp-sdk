...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class DrawByStampSheetRequest : Gs2Request<DrawByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static DrawByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DrawByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DrawByStampSheetRequest)x;
            return this;
        }
    }
}