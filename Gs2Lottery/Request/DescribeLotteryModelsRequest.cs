...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class DescribeLotteryModelsRequest : Gs2Request<DescribeLotteryModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeLotteryModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeLotteryModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeLotteryModelsRequest)x;
            return this;
        }
    }
}