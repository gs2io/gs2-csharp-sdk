...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class GetCurrentLotteryMasterRequest : Gs2Request<GetCurrentLotteryMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentLotteryMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentLotteryMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentLotteryMasterRequest)x;
            return this;
        }
    }
}