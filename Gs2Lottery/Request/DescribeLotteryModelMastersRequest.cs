...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class DescribeLotteryModelMastersRequest : Gs2Request<DescribeLotteryModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeLotteryModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeLotteryModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeLotteryModelMastersRequest)x;
            return this;
        }
    }
}