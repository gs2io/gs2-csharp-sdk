...
namespace Gs2.Gs2Lottery.Request
{
	...
	public class GetPrizeLimitRequest : Gs2Request<GetPrizeLimitRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPrizeLimitRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPrizeLimitRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPrizeLimitRequest)x;
            return this;
        }
    }
}