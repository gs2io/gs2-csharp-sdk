...
namespace Gs2.Gs2Mission
{
	public class Gs2MissionWebSocketClient : AbstractGs2Client
	{
        ...
        public class DecreaseCounterByUserIdTask : Gs2WebSocketSessionTask<Request.DecreaseCounterByUserIdRequest, Result.DecreaseCounterByUserIdResult>
        {
	        public DecreaseCounterByUserIdTask(IGs2Session session, Request.DecreaseCounterByUserIdRequest request) : base(session, request)
	        {
	        }

            protected override IGs2SessionRequest CreateRequest(Request.DecreaseCounterByUserIdRequest request)
            {
                var stringBuilder = new StringBuilder();
                var jsonWriter = new JsonWriter(stringBuilder);
