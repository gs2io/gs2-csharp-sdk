    ...
    public static class AcquireActionSpeculativeExecutorIndex
    {
        ...
        public static Gs2Future<Func<object>> ExecuteFuture(
            ...
            IEnumerator Impl(Gs2Future<Func<object>> result) {
                ...
                if (SetCounterByUserIdSpeculativeExecutor.Action() == acquireAction.Action) {
                    var request = SetCounterByUserIdRequest.FromJson(JsonMapper.ToObject(acquireAction.Request));
                    if (rate != 1) {
                        request = request.Rate(rate);
                    }
                    var future = SetCounterByUserIdSpeculativeExecutor.ExecuteFuture(
                        domain,
                        accessToken,
                        request
                    );
        ...
        public static async Task<Func<object>> ExecuteAsync(
            ...
            if (SetCounterByUserIdSpeculativeExecutor.Action() == acquireAction.Action) {
                ...
                return await SetCounterByUserIdSpeculativeExecutor.ExecuteAsync(
                    domain,
                    accessToken,
                    request
                );
