...
{
    public static class RevertReceiveByUserIdSpeculativeExecutor {
        ...
        public static Gs2.Gs2Mission.Model.Complete Transform(
            ...
            item.ReceivedMissionTaskNames = item.ReceivedMissionTaskNames.Where(v => v == request.MissionTaskName).ToArray();
            return item;
        }
