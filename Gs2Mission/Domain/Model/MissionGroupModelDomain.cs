...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class MissionGroupModelDomain {
        ...
        private async UniTask<Gs2.Gs2Mission.Model.MissionGroupModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Mission.Model.MissionGroupModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Mission.Model.MissionGroupModel> GetAsync(
            ...
            #else
            var result = await this._client.GetMissionGroupModelAsync(
                request
            );
            #endif
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Mission.Model.MissionTaskModel> MissionTaskModels(
            #else
