...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class CurrentMissionMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Mission.Domain.Model.CurrentMissionMasterDomain> PreUpdateFuture(
            PreUpdateCurrentMissionMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Mission.Domain.Model.CurrentMissionMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Mission.Domain.Model.CurrentMissionMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentMissionMasterRequest request
        ) {
            request = request
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.PreUpdateCurrentMissionMasterAsync(request)
            );
            var domain = this;
    ...
    public partial class CurrentMissionMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Mission.Model.CurrentMissionMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Mission.Model.CurrentMissionMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Mission.Model.CurrentMissionMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Mission.Model.CurrentMissionMaster> Model() => ModelAsync();
        #endif
