...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class CounterModelDomain {
        ...
        private async UniTask<Gs2.Gs2Mission.Model.CounterModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Mission.Model.CounterModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Mission.Model.CounterModel> GetAsync(
            ...
            #else
            var result = await this._client.GetCounterModelAsync(
                request
            );
            #endif
        ...
        public async UniTask<Gs2.Gs2Mission.Model.CounterModel> Model() {
            #else
        public IFuture<Gs2.Gs2Mission.Model.CounterModel> Model() {
            #endif
        #else
        public async Task<Gs2.Gs2Mission.Model.CounterModel> Model() {
        #endif
        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2Mission.Model.CounterModel> self)
            {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Mission.Model.CounterModel>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Mission.Model.CounterModel>(
                    _parentKey,
                    Gs2.Gs2Mission.Domain.Model.CounterModelDomain.CreateCacheKey(
                        this.CounterName?.ToString()
                    )
