...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class MissionTaskModelDomain {
        ...
        private async UniTask<Gs2.Gs2Mission.Model.MissionTaskModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Mission.Model.MissionTaskModel> Get(
            #endif
        #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Mission.Model.MissionTaskModel> Model() {
            #else
        public IFuture<Gs2.Gs2Mission.Model.MissionTaskModel> Model() {
            #endif
        #else
        public async Task<Gs2.Gs2Mission.Model.MissionTaskModel> Model() {
        #endif
        #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
            IEnumerator Impl(IFuture<Gs2.Gs2Mission.Model.MissionTaskModel> self)
            {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Mission.Model.MissionTaskModel>(
                       _parentKey,
            ...
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Mission.Model.MissionTaskModel>(
                _parentKey,
                Gs2.Gs2Mission.Domain.Model.MissionTaskModelDomain.CreateCacheKey(
                    this.MissionTaskName?.ToString()
                )
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            _cache.Put<Gs2.Gs2Mission.Model.MissionTaskModel>(
                                _parentKey,
                                key,
                                null,
                                UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Mission.Model.MissionTaskModel>(
                    _parentKey,
                    Gs2.Gs2Mission.Domain.Model.MissionTaskModelDomain.CreateCacheKey(
                        this.MissionTaskName?.ToString()
                    )
