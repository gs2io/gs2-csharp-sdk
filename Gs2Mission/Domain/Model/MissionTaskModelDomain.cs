...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class MissionTaskModelDomain {
            ...
            if (result.Item != null) {
                _cache.Put(
                    ...
                    Gs2.Gs2Mission.Domain.Model.MissionTaskModelDomain.CreateCacheKey(
                        request.MissionTaskName != null ? request.MissionTaskName.ToString() : null
                    ),
                    result.Item,
        ...
        public async Task<Gs2.Gs2Mission.Model.MissionTaskModel> Model() {
            ...
            {
        #endif
            Gs2.Gs2Mission.Model.MissionTaskModel value = _cache.Get<Gs2.Gs2Mission.Model.MissionTaskModel>(
                _parentKey,
                Gs2.Gs2Mission.Domain.Model.MissionTaskModelDomain.CreateCacheKey(
