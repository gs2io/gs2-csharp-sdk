...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #else
        public async Task<ulong> SubscribeMissionGroupModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Mission.Model.MissionGroupModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeCounterModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Mission.Model.CounterModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeCounterModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Mission.Model.CounterModelMaster[]> callback,
            string namePrefix = null
        )
        ...
        #else
        public async Task<ulong> SubscribeMissionGroupModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Mission.Model.MissionGroupModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateCounterModelMasterAsync(request).ToGs2Future();
        #endif
        ...
        ) => CreateMissionGroupModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Mission.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Mission.Model.Namespace>(
                        (null as Gs2.Gs2Mission.Model.Namespace).CacheParentKey(
                            null
                        ),
                        (null as Gs2.Gs2Mission.Model.Namespace).CacheKey(
                            this.NamespaceName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Mission.Model.Namespace).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null
                );
                ...
                return await (null as Gs2.Gs2Mission.Model.Namespace).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetAsync(
        ...
        public UniTask<Gs2.Gs2Mission.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Mission.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Mission.Model.Namespace> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Mission.Model.Namespace).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Mission.Model.Namespace> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Mission.Model.Namespace> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Mission.Model.Namespace> callback)
        #endif
        {
