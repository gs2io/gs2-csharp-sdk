...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        private async UniTask<Gs2.Gs2Mission.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Mission.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2Mission.Domain.Model.MissionGroupModelMasterDomain> CreateMissionGroupModelMasterAsync(
            ...
            #else
            var result = await this._client.CreateMissionGroupModelMasterAsync(
                request
            );
            var requestModel = request;
            var resultModel = result;
            ...
            #endif
            Gs2.Gs2Mission.Domain.Model.MissionGroupModelMasterDomain domain = new Gs2.Gs2Mission.Domain.Model.MissionGroupModelMasterDomain(
                this._cache,
        ...
        public async Task<Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain> CreateCounterModelMasterAsync(
            ...
            #else
            var result = await this._client.CreateCounterModelMasterAsync(
                request
            );
            var requestModel = request;
            var resultModel = result;
            ...
            #endif
            Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain domain = new Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain(
                this._cache,
                this._jobQueueDomain,
                this._stampSheetConfiguration,
                this._session,
