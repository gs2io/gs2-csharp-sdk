    ...
    public partial class CounterDomain {
        ...
        public async Task<Gs2.Gs2Mission.Domain.Model.CounterDomain> IncreaseAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Mission.Domain.Model.CounterDomain> self)
          {
            ...
            #endif
            _cache.ListCacheClear<Gs2.Gs2Mission.Model.Complete>(
                _parentKey.Replace("Counter", "Complete")
            );
            ...
            if (result.Item != null) {
                _cache.Put(
                    ...
                    result.Item,
                    result.Item.Values.Select(value => value.NextResetAt).Select(i => i ?? UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes).Min()
                );
            }
        ...
        public async Task<Gs2.Gs2Mission.Model.Counter> Model() {
            ...
            {
        #endif
            Gs2.Gs2Mission.Model.Counter value = _cache.Get<Gs2.Gs2Mission.Model.Counter>(
                _parentKey,
                Gs2.Gs2Mission.Domain.Model.CounterDomain.CreateCacheKey(
