...
namespace Gs2.Gs2Mission.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Mission.Model.CounterModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Mission.Model.CounterModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "counterModelMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Mission.Model.CounterModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class CounterModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2Mission.Model.CounterModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Mission.Model.CounterModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Mission.Model.CounterModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Mission.Model.CounterModelMaster>(
                        _parentKey,
                        Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain.CreateCacheKey(
                            this.CounterName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Mission.Model.CounterModelMaster>(
                _parentKey,
                Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain.CreateCacheKey(
                    this.CounterName.ToString()
                )
