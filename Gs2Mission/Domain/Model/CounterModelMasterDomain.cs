...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class CounterModelMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Mission.Model.CounterModelMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Mission.Model.CounterModelMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Mission.Model.CounterModelMaster> GetAsync(
            ...
            #else
            var result = await this._client.GetCounterModelMasterAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCounterModelMasterAsync(
                request
            );
            #endif
            var requestModel = request;
            ...
            Gs2.Gs2Mission.Domain.Model.CounterModelMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Mission.Model.CounterModelMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Mission.Model.CounterModelMaster>(
                       _parentKey,
