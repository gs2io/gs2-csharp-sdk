...
namespace Gs2.Gs2Mission.Domain.Model
{
    ...
    public partial class MissionTaskModelMasterDomain {
        ...
        private async Task<Gs2.Gs2Mission.Model.MissionTaskModelMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetMissionTaskModelMasterAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2Mission.Domain.Model.MissionTaskModelMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateMissionTaskModelMasterAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Mission.Domain.Model.MissionTaskModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    null,
                    null,
                    () => this._client.DeleteMissionTaskModelMasterAsync(request)
                );
            }
    ...
    public partial class MissionTaskModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Mission.Model.MissionTaskModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Mission.Model.MissionTaskModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Mission.Model.MissionTaskModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Mission.Model.MissionTaskModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Mission.Model.MissionTaskModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.MissionGroupName,
                this.MissionTaskName,
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Mission.Model.MissionTaskModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Mission.Model.MissionTaskModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Mission.Model.MissionTaskModelMaster> callback)
        #endif
        {
