...
namespace Gs2.Gs2Mission.Domain.Iterator
{
    ...
    public class DescribeMissionTaskModelsIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Mission.Model.MissionTaskModel>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Mission.Model.MissionTaskModel>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Mission.Model.MissionTaskModel>
    #endif
    {
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Mission.Model.MissionTaskModel>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Mission.Model.MissionTaskModel>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Mission.Model.MissionTaskModel> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Mission.Model.MissionTaskModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Mission.Model.MissionTaskModel>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
