...
namespace Gs2.Gs2Mission.Domain.Iterator
{
    ...
    public class DescribeCounterModelsIterator : IAsyncEnumerable<Gs2.Gs2Mission.Model.CounterModel> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Mission.Model.CounterModel>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Mission.Model.CounterModel>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeCounterModelsFuture(
                #else
                var r = await this._client.DescribeCounterModelsAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Mission.Model.CounterModel>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Mission.Model.CounterModel>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Mission.Model.CounterModel ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Mission.Model.CounterModel>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Mission.Model.CounterModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Mission.Model.CounterModel>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
