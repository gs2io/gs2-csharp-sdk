    ...
    public class DescribeCounterModelsIterator : IAsyncEnumerable<Gs2.Gs2Mission.Model.CounterModel> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Mission.Model.CounterModel>
            (
                ...
                var request = new Gs2.Gs2Mission.Request.DescribeCounterModelsRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Mission.Model.CounterModel>(
                        (null as Gs2.Gs2Mission.Model.CounterModel).CacheParentKey(
                            NamespaceName
                        )
                    );
