...
#endif
	[System.Serializable]
	public class IncreaseByStampSheetResult : IResult
	{
        public Gs2.Gs2Mission.Model.Counter Item { set; get; }
        public Gs2.Gs2Mission.Model.Complete[] ChangedCompletes { set; get; }
        public ResultMetadata Metadata { set; get; }

        public IncreaseByStampSheetResult WithItem(Gs2.Gs2Mission.Model.Counter item) {
            this.Item = item;
            return this;
        }

        public IncreaseByStampSheetResult WithChangedCompletes(Gs2.Gs2Mission.Model.Complete[] changedCompletes) {
            this.ChangedCompletes = changedCompletes;
            return this;
        }

        public IncreaseByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IncreaseByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
