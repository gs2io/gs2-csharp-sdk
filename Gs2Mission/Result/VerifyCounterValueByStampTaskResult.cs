...
namespace Gs2.Gs2Mission.Result
{
	...
	public class VerifyCounterValueByStampTaskResult : IResult
	{
        ...
        public VerifyCounterValueByStampTaskResult WithItem(Gs2.Gs2Mission.Model.Counter item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyCounterValueByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyCounterValueByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
