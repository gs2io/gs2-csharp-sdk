...
#endif
	[System.Serializable]
	public class ResetByStampTaskResult : IResult
	{
        public Gs2.Gs2Mission.Model.Counter Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public ResetByStampTaskResult WithItem(Gs2.Gs2Mission.Model.Counter item) {
            this.Item = item;
            return this;
        }
        ...
        public ResetByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ResetByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
