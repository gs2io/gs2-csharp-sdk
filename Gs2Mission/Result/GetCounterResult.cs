...
namespace Gs2.Gs2Mission.Result
{
	...
	public class GetCounterResult : IResult
	{
        ...
        public GetCounterResult WithItem(Gs2.Gs2Mission.Model.Counter item) {
            this.Item = item;
            return this;
        }

        public GetCounterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetCounterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
