...
#endif
	[System.Serializable]
	public class PreUpdateCurrentMissionMasterResult : IResult
	{
        ...
        public PreUpdateCurrentMissionMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentMissionMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
