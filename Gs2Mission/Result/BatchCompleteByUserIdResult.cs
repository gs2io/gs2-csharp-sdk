...
#endif
	[System.Serializable]
	public class BatchCompleteByUserIdResult : IResult
	{
        ...
        public BatchCompleteByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public BatchCompleteByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public BatchCompleteByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public BatchCompleteByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static BatchCompleteByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
