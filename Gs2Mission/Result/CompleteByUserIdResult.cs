...
#endif
	[System.Serializable]
	public class CompleteByUserIdResult : IResult
	{
        ...
        public CompleteByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public CompleteByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public CompleteByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public CompleteByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CompleteByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
