...
#endif
	[System.Serializable]
	public class BatchCompleteResult : IResult
	{
        ...
        public BatchCompleteResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public BatchCompleteResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public BatchCompleteResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public BatchCompleteResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static BatchCompleteResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
