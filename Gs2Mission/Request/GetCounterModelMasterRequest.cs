...
namespace Gs2.Gs2Mission.Request
{
	...
	public class GetCounterModelMasterRequest : Gs2Request<GetCounterModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCounterModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCounterModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCounterModelMasterRequest)x;
            return this;
        }
    }
}