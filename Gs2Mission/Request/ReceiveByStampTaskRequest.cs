...
namespace Gs2.Gs2Mission.Request
{
	...
	public class ReceiveByStampTaskRequest : Gs2Request<ReceiveByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static ReceiveByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ReceiveByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ReceiveByStampTaskRequest)x;
            return this;
        }
    }
}