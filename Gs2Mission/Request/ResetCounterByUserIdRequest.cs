...
#endif
	[System.Serializable]
	public class ResetCounterByUserIdRequest : Gs2Request<ResetCounterByUserIdRequest>
	{
        ...
        public ResetCounterByUserIdRequest WithScopes(Gs2.Gs2Mission.Model.ScopedValue[] scopes) {
            this.Scopes = scopes;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static ResetCounterByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
