...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeCompletesByUserIdRequest : Gs2Request<DescribeCompletesByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeCompletesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCompletesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCompletesByUserIdRequest)x;
            return this;
        }
    }
}