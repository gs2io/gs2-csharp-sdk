...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DeleteMissionGroupModelMasterRequest : Gs2Request<DeleteMissionGroupModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteMissionGroupModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteMissionGroupModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteMissionGroupModelMasterRequest)x;
            return this;
        }
    }
}