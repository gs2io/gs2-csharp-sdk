...
namespace Gs2.Gs2Mission.Request
{
	...
	public class GetMissionTaskModelRequest : Gs2Request<GetMissionTaskModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetMissionTaskModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetMissionTaskModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetMissionTaskModelRequest)x;
            return this;
        }
    }
}