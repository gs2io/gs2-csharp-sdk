...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeMissionTaskModelsRequest : Gs2Request<DescribeMissionTaskModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeMissionTaskModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMissionTaskModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMissionTaskModelsRequest)x;
            return this;
        }
    }
}