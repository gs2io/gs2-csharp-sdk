...
namespace Gs2.Gs2Mission.Request
{
	...
	public class GetCompleteByUserIdRequest : Gs2Request<GetCompleteByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCompleteByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCompleteByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCompleteByUserIdRequest)x;
            return this;
        }
    }
}