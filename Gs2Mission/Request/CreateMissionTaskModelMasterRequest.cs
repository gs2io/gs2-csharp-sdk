...
namespace Gs2.Gs2Mission.Request
{
	...
	public class CreateMissionTaskModelMasterRequest : Gs2Request<CreateMissionTaskModelMasterRequest>
	{
        ...
        public CreateMissionTaskModelMasterRequest WithTargetCounter(Gs2.Gs2Mission.Model.TargetCounterModel targetCounter) {
            this.TargetCounter = targetCounter;
            return this;
        }
        public CreateMissionTaskModelMasterRequest WithVerifyCompleteConsumeActions(Gs2.Core.Model.ConsumeAction[] verifyCompleteConsumeActions) {
