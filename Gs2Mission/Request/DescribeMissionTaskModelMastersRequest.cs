...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeMissionTaskModelMastersRequest : Gs2Request<DescribeMissionTaskModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeMissionTaskModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMissionTaskModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMissionTaskModelMastersRequest)x;
            return this;
        }
    }
}