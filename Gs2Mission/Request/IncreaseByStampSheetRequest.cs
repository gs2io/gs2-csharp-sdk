...
namespace Gs2.Gs2Mission.Request
{
	...
	public class IncreaseByStampSheetRequest : Gs2Request<IncreaseByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static IncreaseByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply IncreaseByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (IncreaseByStampSheetRequest)x;
            return this;
        }
    }
}