...
namespace Gs2.Gs2Mission.Request
{
	...
	public class ImportUserDataByUserIdRequest : Gs2Request<ImportUserDataByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static ImportUserDataByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ImportUserDataByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ImportUserDataByUserIdRequest)x;
            return this;
        }
    }
}