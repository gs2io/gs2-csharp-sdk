...
namespace Gs2.Gs2Mission.Request
{
	...
	public class GetCurrentMissionMasterRequest : Gs2Request<GetCurrentMissionMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentMissionMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentMissionMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentMissionMasterRequest)x;
            return this;
        }
    }
}