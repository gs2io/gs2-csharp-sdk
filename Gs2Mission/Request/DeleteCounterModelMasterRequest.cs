...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DeleteCounterModelMasterRequest : Gs2Request<DeleteCounterModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteCounterModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteCounterModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteCounterModelMasterRequest)x;
            return this;
        }
    }
}