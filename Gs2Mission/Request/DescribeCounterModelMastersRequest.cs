...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeCounterModelMastersRequest : Gs2Request<DescribeCounterModelMastersRequest>
	{
        ...
        public DescribeCounterModelMastersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeCounterModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCounterModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCounterModelMastersRequest)x;
            return this;
        }
    }
}