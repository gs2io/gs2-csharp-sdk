...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeMissionGroupModelsRequest : Gs2Request<DescribeMissionGroupModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeMissionGroupModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMissionGroupModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMissionGroupModelsRequest)x;
            return this;
        }
    }
}