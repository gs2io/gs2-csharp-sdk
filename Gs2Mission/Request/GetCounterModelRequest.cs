...
namespace Gs2.Gs2Mission.Request
{
	...
	public class GetCounterModelRequest : Gs2Request<GetCounterModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCounterModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCounterModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCounterModelRequest)x;
            return this;
        }
    }
}