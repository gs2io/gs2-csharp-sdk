...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeCounterModelsRequest : Gs2Request<DescribeCounterModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeCounterModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCounterModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCounterModelsRequest)x;
            return this;
        }
    }
}