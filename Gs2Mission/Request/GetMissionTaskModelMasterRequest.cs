...
namespace Gs2.Gs2Mission.Request
{
	...
	public class GetMissionTaskModelMasterRequest : Gs2Request<GetMissionTaskModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetMissionTaskModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetMissionTaskModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetMissionTaskModelMasterRequest)x;
            return this;
        }
    }
}