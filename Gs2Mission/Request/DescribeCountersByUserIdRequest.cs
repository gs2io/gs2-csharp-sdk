...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeCountersByUserIdRequest : Gs2Request<DescribeCountersByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeCountersByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCountersByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCountersByUserIdRequest)x;
            return this;
        }
    }
}