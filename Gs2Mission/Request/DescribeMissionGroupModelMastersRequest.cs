...
namespace Gs2.Gs2Mission.Request
{
	...
	public class DescribeMissionGroupModelMastersRequest : Gs2Request<DescribeMissionGroupModelMastersRequest>
	{
        ...
        public DescribeMissionGroupModelMastersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeMissionGroupModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeMissionGroupModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeMissionGroupModelMastersRequest)x;
            return this;
        }
    }
}