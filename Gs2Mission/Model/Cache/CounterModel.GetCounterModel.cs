...
namespace Gs2.Gs2Mission.Model.Cache
{
    public static partial class CounterModelExt
    {
        public static void PutCache(
            this GetCounterModelResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<GetCounterModelResult> InvokeFuture(
            this GetCounterModelRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<GetCounterModelResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<GetCounterModelResult> self)
            {
            ...
            return new Gs2InlineFuture<GetCounterModelResult>(Impl);
        }
#endif
