...
namespace Gs2.Gs2Mission.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentMissionMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentMissionMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentMissionMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentMissionMaster", "mission.currentMissionMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentMissionMaster", "mission.currentMissionMaster.settings.error.tooLong"),
                    });
                }
            }
        }
