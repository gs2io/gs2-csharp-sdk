...
namespace Gs2.Gs2Money2.Domain.Model
{
    ...
    public partial class WalletDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Money2.Domain.Model.WalletDomain> DepositFuture(
            DepositByUserIdRequest request
        ) {
            IEnumerator Impl(IFuture<Gs2.Gs2Money2.Domain.Model.WalletDomain> self)
            {
                request = request
                    .WithContextStack(string.IsNullOrEmpty(request.ContextStack) ? this._gs2.DefaultContextStack : request.ContextStack)
                    .WithNamespaceName(this.NamespaceName)
            ...
            return new Gs2InlineFuture<Gs2.Gs2Money2.Domain.Model.WalletDomain>(Impl);
        }
        #endif

        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Money2.Domain.Model.WalletDomain> DepositAsync(
            #else
        public async Task<Gs2.Gs2Money2.Domain.Model.WalletDomain> DepositAsync(
            #endif
            DepositByUserIdRequest request
        ) {
            request = request
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Money2.Domain.Model.WalletDomain> WithdrawFuture(
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Money2.Domain.Model.WalletDomain> WithdrawAsync(
            #else
        public async Task<Gs2.Gs2Money2.Domain.Model.WalletDomain> WithdrawAsync(
            #endif
            WithdrawByUserIdRequest request
        ) {
            request = request
