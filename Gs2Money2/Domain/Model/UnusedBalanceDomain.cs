...
namespace Gs2.Gs2Money2.Domain.Model
{
    ...
    public partial class UnusedBalanceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Money2.Model.UnusedBalance> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Money2.Model.UnusedBalance> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Money2.Model.UnusedBalance> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Money2.Model.UnusedBalance> Model() => ModelAsync();
        #endif
