...
namespace Gs2.Gs2Money2.Domain.Model
{
    ...
    public partial class SubscriptionStatusAccessTokenDomain {
        ...
        public SubscriptionStatusAccessTokenDomain(
        ...
        private IFuture<Gs2.Gs2Money2.Model.SubscriptionStatus> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Money2.Model.SubscriptionStatus> self)
            {
                request = request
                ...
                var future = request.InvokeFuture(
                    ...
                    () => this._client.GetSubscriptionStatusFuture(request)
                );
                yield return future;
            ...
            return new Gs2InlineFuture<Gs2.Gs2Money2.Model.SubscriptionStatus>(Impl);
        }
        #endif
        ...
        private async Task<Gs2.Gs2Money2.Model.SubscriptionStatus> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                this.AccessToken?.TimeOffset,
                () => this._client.GetSubscriptionStatusAsync(request)
            );
            return result?.Item;
        }
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Money2.Model.SubscriptionStatus> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Money2.Model.SubscriptionStatus> self)
            {
                ...
                var future = (null as Gs2.Gs2Money2.Model.SubscriptionStatus).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.UserId,
                    this.ContentName,
        ...
        public async UniTask<Gs2.Gs2Money2.Model.SubscriptionStatus> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Money2.Model.SubscriptionStatus> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Money2.Model.SubscriptionStatus> Model()
        {
            return await ModelAsync();
        }
        #endif
