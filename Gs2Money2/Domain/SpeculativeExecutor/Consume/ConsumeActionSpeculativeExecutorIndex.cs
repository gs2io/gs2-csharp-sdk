    ...
    public static class ConsumeActionSpeculativeExecutorIndex
    {
        ...
        public static Gs2Future<Func<object>> ExecuteFuture(
            ...
            IEnumerator Impl(Gs2Future<Func<object>> result) {
                ...
                if (VerifyReceiptByUserIdSpeculativeExecutor.Action() == consumeAction.Action) {
                    var request = VerifyReceiptByUserIdRequest.FromJson(JsonMapper.ToObject(consumeAction.Request));
                    if (rate != 1) {
                        request = request.Rate(rate);
                    }
                    var future = VerifyReceiptByUserIdSpeculativeExecutor.ExecuteFuture(
                        domain,
                        accessToken,
                        request
                    );
        ...
        public static async Task<Func<object>> ExecuteAsync(
            ...
            if (VerifyReceiptByUserIdSpeculativeExecutor.Action() == consumeAction.Action) {
                ...
                return await VerifyReceiptByUserIdSpeculativeExecutor.ExecuteAsync(
                    domain,
                    accessToken,
                    request
                );
