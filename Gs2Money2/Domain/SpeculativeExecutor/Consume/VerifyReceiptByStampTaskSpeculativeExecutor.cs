...
{
    public static class VerifyReceiptByUserIdSpeculativeExecutor {
...
/* diff --- start
 ...
 diff --- end */
/* diff +++ start */
            // Verification records an event and invokes the configured server
            // script. Those effects cannot be prepared from the local cache.
            return null;
/* diff +++ end */
        }
    }
