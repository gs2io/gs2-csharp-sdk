...
namespace Gs2.Gs2Money2.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeSubscriptionStatusesIterator : Gs2Iterator<Gs2.Gs2Money2.Model.SubscriptionStatus> {
    #else
    public class DescribeSubscriptionStatusesIterator : IAsyncEnumerable<Gs2.Gs2Money2.Model.SubscriptionStatus> {
    #endif
        ...
        public DescribeSubscriptionStatusesIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Money2.Request.DescribeSubscriptionStatusesRequest()
                    .WithContextStack(this._gs2.DefaultContextStack)
                    .WithNamespaceName(this.NamespaceName)
                    .WithAccessToken(this.AccessToken != null ? this.AccessToken.Token : null);
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                var future = this._client.DescribeSubscriptionStatusesFuture(
                #else
                var r = await this._client.DescribeSubscriptionStatusesAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
