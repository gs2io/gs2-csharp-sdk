...
namespace Gs2.Gs2Money2.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeEventsByUserIdIterator : Gs2Iterator<Gs2.Gs2Money2.Model.Event> {
    #else
    public class DescribeEventsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Money2.Model.Event> {
    #endif
        ...
        private bool _last;
        private Gs2.Gs2Money2.Model.Event[] _result;
        ...
        public DescribeEventsByUserIdIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Money2.Model.Event[]{};
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Money2.Model.Event>> callback
        )
        {
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Money2.Model.Event> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Money2.Model.Event> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Money2.Model.Event>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
