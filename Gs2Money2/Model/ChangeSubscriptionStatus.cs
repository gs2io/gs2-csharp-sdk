...
namespace Gs2.Gs2Money2.Model
{
	public class ChangeSubscriptionStatus
	{
        ...
        public ChangeSubscriptionStatus WithNamespaceName(string namespaceName) {
            this.NamespaceName = namespaceName;
            return this;
        }
        public ChangeSubscriptionStatus WithUserId(string userId) {
            this.UserId = userId;
            return this;
        }
        public ChangeSubscriptionStatus WithContentName(string contentName) {
    	...
    	[Preserve]
#endif
        public static ChangeSubscriptionStatus FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
