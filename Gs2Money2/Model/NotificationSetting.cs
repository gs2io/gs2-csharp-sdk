...
namespace Gs2.Gs2Money2.Model
{
	...
	public partial class NotificationSetting : IComparable
	{
        ...
        public Gs2.Gs2Money2.Model.MobileNotificationMessage[] MobileNotificationMessages { set; get; }
        ...
        public NotificationSetting WithMobileNotificationMessages(Gs2.Gs2Money2.Model.MobileNotificationMessage[] mobileNotificationMessages) {
        ...
        public void Validate() {
            {
                if (GatewayNamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("notificationSetting", "money2.notificationSetting.gatewayNamespaceId.error.tooLong"),
                    });
                }
            }
            {
            }
            {
                if (Sound.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("notificationSetting", "money2.notificationSetting.sound.error.tooLong"),
                    });
                }
            }
            {
                if (MobileNotificationMessages.Length > 100) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("notificationSetting", "money2.notificationSetting.mobileNotificationMessages.error.tooMany"),
                    });
                }
            }
            {
                switch (Enable) {
                    ...
                    default:
                        throw new Gs2.Core.Exception.BadRequestException(new [] {
                            new RequestError("notificationSetting", "money2.notificationSetting.enable.error.invalid"),
                        });
                }
            }
        }
        ...
        public object Clone() {
            return new NotificationSetting {
                ...
                EnableTransferMobileNotification = EnableTransferMobileNotification,
                Sound = Sound,
                MobileNotificationMessages = MobileNotificationMessages?.Clone() as Gs2.Gs2Money2.Model.MobileNotificationMessage[],
                Enable = Enable,
            };
        }
    }
