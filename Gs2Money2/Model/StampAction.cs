        ...
        public static Gs2Request ToRequest(Gs2.Core.Model.ConsumeAction action) {
            switch (action.Action) {
                case "Gs2Money2:WithdrawByUserId":
                    return WithdrawByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
                case "Gs2Money2:VerifyReceiptByUserId":
                    return VerifyReceiptByUserIdRequest.FromJson(JsonMapper.ToObject(action.Request));
            }
