...
#endif
	[System.Serializable]
	public class GetStoreSubscriptionContentModelMasterRequest : Gs2Request<GetStoreSubscriptionContentModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetStoreSubscriptionContentModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
