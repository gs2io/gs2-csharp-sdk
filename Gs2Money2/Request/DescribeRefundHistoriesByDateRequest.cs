...
#endif
	[System.Serializable]
	public class DescribeRefundHistoriesByDateRequest : Gs2Request<DescribeRefundHistoriesByDateRequest>
	{
        ...
        public DescribeRefundHistoriesByDateRequest WithYear(int? year) {
            this.Year = year;
            return this;
        }
        public DescribeRefundHistoriesByDateRequest WithMonth(int? month) {
            this.Month = month;
            return this;
        }
        public DescribeRefundHistoriesByDateRequest WithDay(int? day) {
            this.Day = day;
            return this;
        }
        ...
        public DescribeRefundHistoriesByDateRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeRefundHistoriesByDateRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
