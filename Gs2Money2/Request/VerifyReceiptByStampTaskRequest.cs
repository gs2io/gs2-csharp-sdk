...
#endif
	[System.Serializable]
	public class VerifyReceiptByStampTaskRequest : Gs2Request<VerifyReceiptByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyReceiptByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
