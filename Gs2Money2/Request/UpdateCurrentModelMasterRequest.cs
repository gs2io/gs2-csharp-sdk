...
#endif
	[System.Serializable]
	public class UpdateCurrentModelMasterRequest : Gs2Request<UpdateCurrentModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
