...
namespace Gs2.Gs2Money2.Request
{
	...
	public class DepositByUserIdRequest : Gs2Request<DepositByUserIdRequest>
	{
        ...
        public DepositByUserIdRequest WithDepositTransactions(Gs2.Gs2Money2.Model.DepositTransaction[] depositTransactions) {
        ...
        public static DepositByUserIdRequest FromJson(JsonData data)
        {
            ...
            return new DepositByUserIdRequest()
                ...
                .WithDepositTransactions(!data.Keys.Contains("depositTransactions") || data["depositTransactions"] == null || !data["depositTransactions"].IsArray ? new Gs2.Gs2Money2.Model.DepositTransaction[]{} : data["depositTransactions"].Cast<JsonData>().Select(v => {
