...
#endif
	[System.Serializable]
	public class GetSubscriptionStatusByUserIdRequest : Gs2Request<GetSubscriptionStatusByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSubscriptionStatusByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
