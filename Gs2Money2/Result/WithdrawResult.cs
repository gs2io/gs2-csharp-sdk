...
namespace Gs2.Gs2Money2.Result
{
	...
	public class WithdrawResult : IResult
	{
        ...
        public WithdrawResult WithItem(Gs2.Gs2Money2.Model.Wallet item) {
            this.Item = item;
            return this;
        }

        public WithdrawResult WithWithdrawTransactions(Gs2.Gs2Money2.Model.DepositTransaction[] withdrawTransactions) {
