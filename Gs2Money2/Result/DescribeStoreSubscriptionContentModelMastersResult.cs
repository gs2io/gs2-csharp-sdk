...
#endif
	[System.Serializable]
	public class DescribeStoreSubscriptionContentModelMastersResult : IResult
	{
        public Gs2.Gs2Money2.Model.StoreSubscriptionContentModelMaster[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeStoreSubscriptionContentModelMastersResult WithItems(Gs2.Gs2Money2.Model.StoreSubscriptionContentModelMaster[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeStoreSubscriptionContentModelMastersResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeStoreSubscriptionContentModelMastersResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeStoreSubscriptionContentModelMastersResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? null : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Money2.Model.StoreSubscriptionContentModelMaster.FromJson(v);
                }).ToArray())
