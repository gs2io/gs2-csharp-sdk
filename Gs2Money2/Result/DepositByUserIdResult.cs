...
namespace Gs2.Gs2Money2.Result
{
	...
	public class DepositByUserIdResult : IResult
	{
        ...
        public DepositByUserIdResult WithItem(Gs2.Gs2Money2.Model.Wallet item) {
            this.Item = item;
            return this;
        }

        public DepositByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DepositByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
