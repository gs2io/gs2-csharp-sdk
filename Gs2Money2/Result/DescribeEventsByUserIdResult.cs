...
namespace Gs2.Gs2Money2.Result
{
	...
	{
        public Gs2.Gs2Money2.Model.Event[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeEventsByUserIdResult WithItems(Gs2.Gs2Money2.Model.Event[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeEventsByUserIdResult FromJson(JsonData data)
        {
            ...
            return new DescribeEventsByUserIdResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Money2.Model.Event[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Money2.Model.Event.FromJson(v);
                }).ToArray())
