...
#endif
	[System.Serializable]
	public class VerifyReceiptByStampTaskResult : IResult
	{
        public Gs2.Gs2Money2.Model.Event Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyReceiptByStampTaskResult WithItem(Gs2.Gs2Money2.Model.Event item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyReceiptByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyReceiptByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new VerifyReceiptByStampTaskResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2Money2.Model.Event.FromJson(data["item"]))
