...
#endif
	[System.Serializable]
	public class GetWalletResult : IResult
	{
        public Gs2.Gs2Money2.Model.Wallet Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public GetWalletResult WithItem(Gs2.Gs2Money2.Model.Wallet item) {
            this.Item = item;
            return this;
        }

        public GetWalletResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetWalletResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
