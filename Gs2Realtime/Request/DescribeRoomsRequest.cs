...
namespace Gs2.Gs2Realtime.Request
{
	...
	public class DescribeRoomsRequest : Gs2Request<DescribeRoomsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeRoomsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeRoomsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeRoomsRequest)x;
            return this;
        }
    }
}