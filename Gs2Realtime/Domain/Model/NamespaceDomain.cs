...
namespace Gs2.Gs2Realtime.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "realtime:Gs2.Gs2Realtime.Model.Namespace";
        }
        ...
        public async Task<Gs2.Gs2Realtime.Domain.Model.NamespaceDomain> GetStatusAsync(
            ...
            #endif
            Gs2.Gs2Realtime.Domain.Model.NamespaceDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Realtime.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Realtime.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2Realtime.Domain.Model.NamespaceDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Realtime.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Realtime.Domain.Model.NamespaceDomain.CreateCacheKey(
                    request.NamespaceName != null ? request.NamespaceName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Realtime.Domain.Model.RoomDomain> WantRoomAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.WantRoomAsync(
                request
            );
            #endif
            ...
            Gs2.Gs2Realtime.Domain.Model.RoomDomain domain = new Gs2.Gs2Realtime.Domain.Model.RoomDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Realtime.Model.Room> Rooms(
            #else
        ...
        public async Task<Gs2.Gs2Realtime.Model.Namespace> Model() {
            ...
            {
        #endif
            Gs2.Gs2Realtime.Model.Namespace value = _cache.Get<Gs2.Gs2Realtime.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Realtime.Domain.Model.NamespaceDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Realtime.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Realtime.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName?.ToString()
                )
