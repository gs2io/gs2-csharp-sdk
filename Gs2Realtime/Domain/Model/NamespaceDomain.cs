...
namespace Gs2.Gs2Realtime.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public async Task<Gs2.Gs2Realtime.Domain.Model.NamespaceDomain> DeleteAsync(
            ...
            if (future.Error != null)
            {
                if (future.Error is Gs2.Core.Exception.NotFoundException) {
                    ...
                    _cache.Put<Gs2.Gs2Realtime.Model.Namespace>(
                        _parentKey,
                        key,
                        null,
                        UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
        ...
        public async Task<Gs2.Gs2Realtime.Model.Namespace> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Realtime.Model.Namespace>(
                       _parentKey,
            ...
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Realtime.Model.Namespace>(
                parentKey,
                Gs2.Gs2Realtime.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName?.ToString()
                )
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Realtime.Model.Namespace>(
                    parentKey,
                    Gs2.Gs2Realtime.Domain.Model.NamespaceDomain.CreateCacheKey(
                        this.NamespaceName?.ToString()
                    )
