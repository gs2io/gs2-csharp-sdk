...
namespace Gs2.Gs2Guard.Model.Cache
{
    public static partial class NamespaceExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DescribeNamespacesResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<DescribeNamespacesResult> self)
            {
            ...
            return new Gs2InlineFuture<DescribeNamespacesResult>(Impl);
        }
#endif
