...
namespace Gs2.Gs2Guard
{
	public class Gs2GuardRestClient : AbstractGs2Client
	{
#if UNITY_2017_1_OR_NEWER
		private readonly CertificateHandler _certificateHandler;
#endif

		public static string Endpoint = "guard";

        protected Gs2RestSession Gs2RestSession => (Gs2RestSession) Gs2Session;

		public Gs2GuardRestClient(Gs2RestSession Gs2RestSession) : base(Gs2RestSession)
		{

		}

#if UNITY_2017_1_OR_NEWER
		public Gs2GuardRestClient(Gs2RestSession gs2RestSession, CertificateHandler certificateHandler) : base(gs2RestSession)
		{
        ...
        public class CreateNamespaceTask : Gs2RestSessionTask<CreateNamespaceRequest, CreateNamespaceResult>
        {
            ...
            protected override IGs2SessionRequest CreateRequest(CreateNamespaceRequest request)
            {
                ...
                if (request.BlockingPolicy != null)
                {
                    jsonWriter.WritePropertyName("blockingPolicy");
                    request.BlockingPolicy.WriteJson(jsonWriter);
                }
                if (request.ContextStack != null)
                {
