...
namespace Gs2.Gs2Stamina.Model
{
    ...
    )
    {
        ...
        public JsonData ToDict()
        {
            ...
            data["staminaModelId"] = staminaModelId;
            data["name"] = name;
            ...
            data["maxStaminaTable"] = maxStaminaTable.ToDict();
            data["recoverIntervalTable"] = recoverIntervalTable.ToDict();
            data["recoverValueTable"] = recoverValueTable.ToDict();
            return data;
        }
	}
}