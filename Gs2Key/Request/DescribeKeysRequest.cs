...
namespace Gs2.Gs2Key.Request
{
	...
	public class DescribeKeysRequest : Gs2Request<DescribeKeysRequest>
	{
        ...
        public DescribeKeysRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeKeysRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeKeysRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeKeysRequest)x;
            return this;
        }
    }
}