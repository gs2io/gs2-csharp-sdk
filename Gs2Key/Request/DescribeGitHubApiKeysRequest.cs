...
namespace Gs2.Gs2Key.Request
{
	...
	public class DescribeGitHubApiKeysRequest : Gs2Request<DescribeGitHubApiKeysRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeGitHubApiKeysRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeGitHubApiKeysRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeGitHubApiKeysRequest)x;
            return this;
        }
    }
}