...
namespace Gs2.Gs2Key.Request
{
	...
	public class GetGitHubApiKeyRequest : Gs2Request<GetGitHubApiKeyRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGitHubApiKeyRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetGitHubApiKeyRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetGitHubApiKeyRequest)x;
            return this;
        }
    }
}