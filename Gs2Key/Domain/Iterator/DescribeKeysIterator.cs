...
namespace Gs2.Gs2Key.Domain.Iterator
{
    ...
    public class DescribeKeysIterator : IAsyncEnumerable<Gs2.Gs2Key.Model.Key> {
        ...
        private bool _last;
        private Gs2.Gs2Key.Model.Key[] _result;
        ...
        public DescribeKeysIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Key.Model.Key[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Key.Model.Key>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Key.Model.Key>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeKeysFuture(
                #else
                var r = await this._client.DescribeKeysAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Key.Model.Key>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Key.Model.Key>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Key.Model.Key ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Key.Model.Key>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Key.Model.Key> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Key.Model.Key>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
