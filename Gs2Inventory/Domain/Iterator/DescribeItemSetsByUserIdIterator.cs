...
namespace Gs2.Gs2Inventory.Domain.Iterator
{
    ...
    #endif
    {
        ...
        public DescribeItemSetsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Inventory.Request.DescribeItemSetsByUserIdRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Inventory.Model.ItemSet>(
                        (null as Gs2.Gs2Inventory.Model.ItemSet).CacheParentKey(
                            NamespaceName,
                            UserId,
                            InventoryName,
        ...
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Inventory.Model.ItemSet>(async (writer, token) =>
        #else
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Inventory.Model.ItemSet>(
                    (null as Gs2.Gs2Inventory.Model.ItemSet).CacheParentKey(
                        NamespaceName,
                        UserId,
                        InventoryName,
