...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class BigItemAccessTokenDomain {
        ...
        private async Task<Gs2.Gs2Inventory.Model.BigItem> GetAsync(
            ...
            #else
            var result = await this._client.GetBigItemAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Inventory.Domain.Model.BigItemAccessTokenDomain> ConsumeAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.ConsumeBigItemAsync(
                request
            );
            #endif
            var requestModel = request;
            ...
            Gs2.Gs2Inventory.Domain.Model.BigItemAccessTokenDomain domain = this;
