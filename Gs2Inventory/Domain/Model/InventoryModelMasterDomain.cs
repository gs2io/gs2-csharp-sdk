...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class InventoryModelMasterDomain {
        ...
        public async Task<Gs2.Gs2Inventory.Domain.Model.InventoryModelMasterDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Inventory.Model.InventoryModelMaster>(
                _parentKey,
                Gs2.Gs2Inventory.Domain.Model.InventoryModelMasterDomain.CreateCacheKey(
                    request.InventoryName != null ? request.InventoryName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Inventory.Domain.Model.ItemModelMasterDomain> CreateItemModelMasterAsync(
            ...
            Gs2.Gs2Inventory.Domain.Model.ItemModelMasterDomain domain = new Gs2.Gs2Inventory.Domain.Model.ItemModelMasterDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Inventory.Model.ItemModelMaster> ItemModelMasters(
            #else
        ...
        public async Task<Gs2.Gs2Inventory.Model.InventoryModelMaster> Model() {
            ...
            {
        #endif
            Gs2.Gs2Inventory.Model.InventoryModelMaster value = _cache.Get<Gs2.Gs2Inventory.Model.InventoryModelMaster>(
                _parentKey,
                Gs2.Gs2Inventory.Domain.Model.InventoryModelMasterDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Inventory.Model.InventoryModelMaster>(
                _parentKey,
                Gs2.Gs2Inventory.Domain.Model.InventoryModelMasterDomain.CreateCacheKey(
                    this.InventoryName?.ToString()
                )
