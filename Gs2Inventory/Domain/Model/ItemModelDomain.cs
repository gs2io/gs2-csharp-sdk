...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class ItemModelDomain {
        ...
        private IFuture<Gs2.Gs2Inventory.Model.ItemModel> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Inventory.Model.ItemModel> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Inventory.Model.ItemModel>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "itemModel")
                        {
            ...
            return new Gs2InlineFuture<Gs2.Gs2Inventory.Model.ItemModel>(Impl);
        }
        #endif
        ...
        private async Task<Gs2.Gs2Inventory.Model.ItemModel> GetAsync(
            ...
            request
                ...
                .WithInventoryName(this.InventoryName)
                .WithItemName(this.ItemName);
            GetItemModelResult result = null;
            try {
                result = await this._client.GetItemModelAsync(
                    request
                );
    ...
    public partial class ItemModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Inventory.Model.ItemModel> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Inventory.Model.ItemModel> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Inventory.Model.ItemModel>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Inventory.Model.ItemModel>(
                        _parentKey,
                        Gs2.Gs2Inventory.Domain.Model.ItemModelDomain.CreateCacheKey(
                            this.ItemName?.ToString()
                        )
        ...
        public async UniTask<Gs2.Gs2Inventory.Model.ItemModel> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Inventory.Model.ItemModel> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Inventory.Model.ItemModel> Model()
        {
            return await ModelAsync();
        }
        #endif
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Inventory.Model.ItemModel>(
                _parentKey,
                Gs2.Gs2Inventory.Domain.Model.ItemModelDomain.CreateCacheKey(
                    this.ItemName.ToString()
                )
