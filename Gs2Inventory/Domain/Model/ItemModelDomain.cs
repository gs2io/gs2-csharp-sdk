...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class ItemModelDomain {
        ...
        private async UniTask<Gs2.Gs2Inventory.Model.ItemModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Inventory.Model.ItemModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Inventory.Model.ItemModel> GetAsync(
            ...
            #else
            var result = await this._client.GetItemModelAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Inventory.Model.ItemModel> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Inventory.Model.ItemModel>(
                       _parentKey,
