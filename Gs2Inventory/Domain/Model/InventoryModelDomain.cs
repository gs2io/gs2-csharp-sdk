...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class InventoryModelDomain {
        ...
        private async UniTask<Gs2.Gs2Inventory.Model.InventoryModel> GetAsync(
            #else
        private IFuture<Gs2.Gs2Inventory.Model.InventoryModel> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Inventory.Model.InventoryModel> GetAsync(
          ...
          IEnumerator Impl(IFuture<Gs2.Gs2Inventory.Model.InventoryModel> self)
          {
            ...
            #else
            var result = await this._client.GetInventoryModelAsync(
                request
            );
            #endif
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Inventory.Model.ItemModel> ItemModels(
            #else
        ...
        public async Task<Gs2.Gs2Inventory.Model.InventoryModel> Model() {
            ...
            {
        #endif
            Gs2.Gs2Inventory.Model.InventoryModel value = _cache.Get<Gs2.Gs2Inventory.Model.InventoryModel>(
                _parentKey,
                Gs2.Gs2Inventory.Domain.Model.InventoryModelDomain.CreateCacheKey(
