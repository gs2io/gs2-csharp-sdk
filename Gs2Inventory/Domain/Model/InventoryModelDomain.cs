...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class InventoryModelDomain {
        ...
        #endif
                            callback.Invoke(await ItemModelsAsync(
                            ).ToArrayAsync());
                        }
        ...
        #else
        public async Task<ulong> SubscribeItemModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Inventory.Model.ItemModel[]> callback
        )
        {
    ...
    public partial class InventoryModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Inventory.Model.InventoryModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Inventory.Model.InventoryModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Inventory.Model.InventoryModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Inventory.Model.InventoryModel> Model() => ModelAsync();
        #endif
