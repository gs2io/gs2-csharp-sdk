...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class BigItemModelDomain {
        ...
        private async Task<Gs2.Gs2Inventory.Model.BigItemModel> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetBigItemModelAsync(request)
            );
            return result?.Item;
        }
    ...
    public partial class BigItemModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Inventory.Model.BigItemModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Inventory.Model.BigItemModel>(
                        ...
                        (null as Gs2.Gs2Inventory.Model.BigItemModel).CacheKey(
                            this.ItemName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Inventory.Model.BigItemModel).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.InventoryName,
                    this.ItemName,
                ...
                return await (null as Gs2.Gs2Inventory.Model.BigItemModel).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.InventoryName,
                    this.ItemName,
        ...
        public UniTask<Gs2.Gs2Inventory.Model.BigItemModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Inventory.Model.BigItemModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Inventory.Model.BigItemModel> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Inventory.Model.BigItemModel).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.InventoryName,
                this.ItemName,
