...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class SimpleInventoryModelDomain {
        ...
        public ulong SubscribeSimpleItemModels(
            Action<Gs2.Gs2Inventory.Model.SimpleItemModel[]> callback
        )
        {
        ...
        #endif
                            callback.Invoke(await SimpleItemModelsAsync(
                            ).ToArrayAsync());
                        }
        ...
        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeSimpleItemModelsWithInitialCallAsync(
        #else
        public async Task<ulong> SubscribeSimpleItemModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Inventory.Model.SimpleItemModel[]> callback
        )
        {
            var items = await SimpleItemModelsAsync(
            ).ToArrayAsync();
            var callbackId = SubscribeSimpleItemModels(
                callback
            );
        ...
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2Inventory.Model.SimpleItemModel>(
                (null as Gs2.Gs2Inventory.Model.SimpleItemModel).CacheParentKey(
                    this.NamespaceName,
                    this.InventoryName,
                    null
    ...
    public partial class SimpleInventoryModelDomain {
        ...
        private async Task<Gs2.Gs2Inventory.Model.SimpleInventoryModel> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetSimpleInventoryModelAsync(request)
            );
            return result?.Item;
        }
    ...
    public partial class SimpleInventoryModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Inventory.Model.SimpleInventoryModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Inventory.Model.SimpleInventoryModel>(
                        ...
                        (null as Gs2.Gs2Inventory.Model.SimpleInventoryModel).CacheKey(
                            this.InventoryName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Inventory.Model.SimpleInventoryModel).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.InventoryName,
                    null
                ...
                return await (null as Gs2.Gs2Inventory.Model.SimpleInventoryModel).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.InventoryName,
                    null,
        ...
        public UniTask<Gs2.Gs2Inventory.Model.SimpleInventoryModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Inventory.Model.SimpleInventoryModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Inventory.Model.SimpleInventoryModel> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Inventory.Model.SimpleInventoryModel).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.InventoryName,
                null
