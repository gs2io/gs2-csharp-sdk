...
namespace Gs2.Gs2Inventory.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Inventory.Model.BigItemModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Inventory.Model.BigItemModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "bigItemModelMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Inventory.Domain.Model.BigItemModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Inventory.Model.BigItemModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class BigItemModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2Inventory.Model.BigItemModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Inventory.Model.BigItemModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Inventory.Model.BigItemModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Inventory.Model.BigItemModelMaster>(
                        _parentKey,
                        Gs2.Gs2Inventory.Domain.Model.BigItemModelMasterDomain.CreateCacheKey(
                            this.ItemName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Inventory.Model.BigItemModelMaster>(
                _parentKey,
                Gs2.Gs2Inventory.Domain.Model.BigItemModelMasterDomain.CreateCacheKey(
                    this.ItemName.ToString()
                )
