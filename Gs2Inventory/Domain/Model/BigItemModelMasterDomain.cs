...
namespace Gs2.Gs2Inventory.Domain.Model
{
    ...
    public partial class BigItemModelMasterDomain {
        ...
        private async UniTask<Gs2.Gs2Inventory.Model.BigItemModelMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Inventory.Model.BigItemModelMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Inventory.Model.BigItemModelMaster> GetAsync(
            ...
            #else
            var result = await this._client.GetBigItemModelMasterAsync(
                request
            );
            #endif
        ...
        public async Task<Gs2.Gs2Inventory.Domain.Model.BigItemModelMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateBigItemModelMasterAsync(
                request
            );
            #endif
            var requestModel = request;
            ...
            Gs2.Gs2Inventory.Domain.Model.BigItemModelMasterDomain domain = this;
        ...
        public async Task<Gs2.Gs2Inventory.Model.BigItemModelMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Inventory.Model.BigItemModelMaster>(
                       _parentKey,
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Inventory.Model.BigItemModelMaster>(
                    _parentKey,
                    Gs2.Gs2Inventory.Domain.Model.BigItemModelMasterDomain.CreateCacheKey(
                        this.ItemName?.ToString()
                    )
