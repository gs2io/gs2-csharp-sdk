...
#endif
	[System.Serializable]
	public class DeleteReferenceOfResult : IResult
	{
        ...
        public DeleteReferenceOfResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public DeleteReferenceOfResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public DeleteReferenceOfResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public DeleteReferenceOfResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteReferenceOfResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
