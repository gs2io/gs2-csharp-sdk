...
#endif
	[System.Serializable]
	public class GetItemSetByUserIdResult : IResult
	{
        ...
        public GetItemSetByUserIdResult WithItems(Gs2.Gs2Inventory.Model.ItemSet[] items) {
            this.Items = items;
            return this;
        }

        public GetItemSetByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public GetItemSetByUserIdResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public GetItemSetByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetItemSetByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
