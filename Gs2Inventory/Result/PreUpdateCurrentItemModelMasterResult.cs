...
#endif
	[System.Serializable]
	public class PreUpdateCurrentItemModelMasterResult : IResult
	{
        ...
        public PreUpdateCurrentItemModelMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentItemModelMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
