...
#endif
	[System.Serializable]
	public class DescribeBigItemsResult : IResult
	{
        public Gs2.Gs2Inventory.Model.BigItem[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeBigItemsResult WithItems(Gs2.Gs2Inventory.Model.BigItem[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeBigItemsResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeBigItemsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
