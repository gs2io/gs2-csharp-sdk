...
namespace Gs2.Gs2Inventory.Result
{
	...
	public class GetBigItemByUserIdResult : IResult
	{
        ...
        public GetBigItemByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.BigItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public GetBigItemByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetBigItemByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
