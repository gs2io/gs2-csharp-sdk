...
namespace Gs2.Gs2Inventory.Result
{
	...
	public class GetInventoryResult : IResult
	{
        ...
        public GetInventoryResult WithItem(Gs2.Gs2Inventory.Model.Inventory item) {
            this.Item = item;
            return this;
        }

        public GetInventoryResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetInventoryResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
