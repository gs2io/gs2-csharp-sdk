...
#endif
	[System.Serializable]
	public class VerifyReferenceOfResult : IResult
	{
        ...
        public VerifyReferenceOfResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public VerifyReferenceOfResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public VerifyReferenceOfResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public VerifyReferenceOfResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyReferenceOfResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
