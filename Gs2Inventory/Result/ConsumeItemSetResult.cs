...
namespace Gs2.Gs2Inventory.Result
{
	...
	public class ConsumeItemSetResult : IResult
	{
        ...
        public ConsumeItemSetResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public ConsumeItemSetResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public ConsumeItemSetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ConsumeItemSetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
