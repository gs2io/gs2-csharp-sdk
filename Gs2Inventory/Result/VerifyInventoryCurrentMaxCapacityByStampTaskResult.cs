...
#endif
	[System.Serializable]
	public class VerifyInventoryCurrentMaxCapacityByStampTaskResult : IResult
	{
        public Gs2.Gs2Inventory.Model.Inventory Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyInventoryCurrentMaxCapacityByStampTaskResult WithItem(Gs2.Gs2Inventory.Model.Inventory item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyInventoryCurrentMaxCapacityByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyInventoryCurrentMaxCapacityByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
