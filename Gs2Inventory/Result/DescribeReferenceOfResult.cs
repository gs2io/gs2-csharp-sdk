...
#endif
	[System.Serializable]
	public class DescribeReferenceOfResult : IResult
	{
        ...
        public DescribeReferenceOfResult WithItems(string[] items) {
            this.Items = items;
            return this;
        }

        public DescribeReferenceOfResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public DescribeReferenceOfResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public DescribeReferenceOfResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public DescribeReferenceOfResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeReferenceOfResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
