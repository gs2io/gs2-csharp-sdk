...
#endif
	[System.Serializable]
	public class DeleteItemSetByUserIdResult : IResult
	{
        ...
        public DeleteItemSetByUserIdResult WithItems(Gs2.Gs2Inventory.Model.ItemSet[] items) {
            this.Items = items;
            return this;
        }

        public DeleteItemSetByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public DeleteItemSetByUserIdResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public DeleteItemSetByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteItemSetByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
