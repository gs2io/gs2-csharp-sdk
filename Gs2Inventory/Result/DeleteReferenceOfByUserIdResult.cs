...
namespace Gs2.Gs2Inventory.Result
{
	...
	public class DeleteReferenceOfByUserIdResult : IResult
	{
        ...
        public DeleteReferenceOfByUserIdResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public DeleteReferenceOfByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public DeleteReferenceOfByUserIdResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
    	...
    	[Preserve]
#endif
        public static DeleteReferenceOfByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
