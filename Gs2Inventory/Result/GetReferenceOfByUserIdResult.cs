...
#endif
	[System.Serializable]
	public class GetReferenceOfByUserIdResult : IResult
	{
        ...
        public GetReferenceOfByUserIdResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public GetReferenceOfByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public GetReferenceOfByUserIdResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public GetReferenceOfByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetReferenceOfByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
