...
#endif
	[System.Serializable]
	public class VerifySimpleItemByStampTaskResult : IResult
	{
        public Gs2.Gs2Inventory.Model.SimpleItem Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifySimpleItemByStampTaskResult WithItem(Gs2.Gs2Inventory.Model.SimpleItem item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifySimpleItemByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifySimpleItemByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
