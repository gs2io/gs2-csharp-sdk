...
#endif
	[System.Serializable]
	public class DescribeItemSetsByUserIdResult : IResult
	{
        public Gs2.Gs2Inventory.Model.ItemSet[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeItemSetsByUserIdResult WithItems(Gs2.Gs2Inventory.Model.ItemSet[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeItemSetsByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeItemSetsByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
