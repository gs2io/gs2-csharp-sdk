...
#endif
	[System.Serializable]
	public class GetSimpleItemWithSignatureResult : IResult
	{
        ...
        public GetSimpleItemWithSignatureResult WithItem(Gs2.Gs2Inventory.Model.SimpleItem item) {
            this.Item = item;
            return this;
        }

        public GetSimpleItemWithSignatureResult WithSimpleItemModel(Gs2.Gs2Inventory.Model.SimpleItemModel simpleItemModel) {
        ...
        public GetSimpleItemWithSignatureResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetSimpleItemWithSignatureResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
