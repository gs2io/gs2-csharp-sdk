...
namespace Gs2.Gs2Inventory.Result
{
	...
	{
        public Gs2.Gs2Inventory.Model.InventoryModel[] Items { set; get; } = null!;
        ...
        public static DescribeInventoryModelsResult FromJson(JsonData data)
        {
            ...
            return new DescribeInventoryModelsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Inventory.Model.InventoryModel[]{} : data["items"].Cast<JsonData>().Select(v => {
