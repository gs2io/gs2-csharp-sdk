...
#endif
	[System.Serializable]
	public class DescribeItemSetsResult : IResult
	{
        public Gs2.Gs2Inventory.Model.ItemSet[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeItemSetsResult WithItems(Gs2.Gs2Inventory.Model.ItemSet[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeItemSetsResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeItemSetsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
