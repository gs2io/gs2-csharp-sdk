...
namespace Gs2.Gs2Inventory.Result
{
	...
	public class ConsumeItemSetByUserIdResult : IResult
	{
        ...
        public ConsumeItemSetByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public ConsumeItemSetByUserIdResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
    	...
    	[Preserve]
#endif
        public static ConsumeItemSetByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
