...
#endif
	[System.Serializable]
	public class AddReferenceOfByUserIdResult : IResult
	{
        ...
        public AddReferenceOfByUserIdResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public AddReferenceOfByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public AddReferenceOfByUserIdResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public AddReferenceOfByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AddReferenceOfByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
