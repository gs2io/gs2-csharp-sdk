...
#endif
	[System.Serializable]
	public class DescribeSimpleItemsByUserIdResult : IResult
	{
        public Gs2.Gs2Inventory.Model.SimpleItem[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeSimpleItemsByUserIdResult WithItems(Gs2.Gs2Inventory.Model.SimpleItem[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSimpleItemsByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
