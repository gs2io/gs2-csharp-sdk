...
#endif
	[System.Serializable]
	public class VerifyBigItemByStampTaskResult : IResult
	{
        public Gs2.Gs2Inventory.Model.BigItem Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyBigItemByStampTaskResult WithItem(Gs2.Gs2Inventory.Model.BigItem item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyBigItemByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyBigItemByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
