...
#endif
	[System.Serializable]
	public class GetSimpleItemByUserIdResult : IResult
	{
        ...
        public GetSimpleItemByUserIdResult WithItem(Gs2.Gs2Inventory.Model.SimpleItem item) {
            this.Item = item;
            return this;
        }

        public GetSimpleItemByUserIdResult WithItemModel(Gs2.Gs2Inventory.Model.SimpleItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public GetSimpleItemByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetSimpleItemByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
