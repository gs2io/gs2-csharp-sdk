...
#endif
	[System.Serializable]
	public class VerifyItemSetResult : IResult
	{
        public Gs2.Gs2Inventory.Model.ItemSet[] Items { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyItemSetResult WithItems(Gs2.Gs2Inventory.Model.ItemSet[] items) {
            this.Items = items;
            return this;
        }

        public VerifyItemSetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyItemSetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
