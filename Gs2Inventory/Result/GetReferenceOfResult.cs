...
#endif
	[System.Serializable]
	public class GetReferenceOfResult : IResult
	{
        ...
        public GetReferenceOfResult WithItemSet(Gs2.Gs2Inventory.Model.ItemSet itemSet) {
            this.ItemSet = itemSet;
            return this;
        }

        public GetReferenceOfResult WithItemModel(Gs2.Gs2Inventory.Model.ItemModel itemModel) {
            this.ItemModel = itemModel;
            return this;
        }

        public GetReferenceOfResult WithInventory(Gs2.Gs2Inventory.Model.Inventory inventory) {
            this.Inventory = inventory;
            return this;
        }

        public GetReferenceOfResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetReferenceOfResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
