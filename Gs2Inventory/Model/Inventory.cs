	...
	public partial class Inventory : IComparable
	{
        ...
        public static Inventory FromJson(JsonData data)
        {
            ...
            return new Inventory()
                ...
                .WithCurrentInventoryCapacityUsage(!data.Keys.Contains("currentInventoryCapacityUsage") || data["currentInventoryCapacityUsage"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableInt(data["currentInventoryCapacityUsage"].ToString()))
                .WithCurrentInventoryMaxCapacity(!data.Keys.Contains("currentInventoryMaxCapacity") || data["currentInventoryMaxCapacity"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableInt(data["currentInventoryMaxCapacity"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Inventory.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.Compare(CurrentInventoryCapacityUsage, other.CurrentInventoryCapacityUsage);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(CurrentInventoryMaxCapacity, other.CurrentInventoryMaxCapacity);
            if (diff != 0)
            {
                return diff;
            }
