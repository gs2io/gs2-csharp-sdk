...
namespace Gs2.Gs2Inventory.Model.Cache
{
    public static partial class ItemSetExt
    {
        public static void PutCache(
            this VerifyItemSetByStampTaskResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<VerifyItemSetByStampTaskResult> InvokeFuture(
            this VerifyItemSetByStampTaskRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<VerifyItemSetByStampTaskResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<VerifyItemSetByStampTaskResult> self)
            {
            ...
            return new Gs2InlineFuture<VerifyItemSetByStampTaskResult>(Impl);
        }
#endif
