...
namespace Gs2.Gs2Inventory.Model.Cache
{
    public static partial class BigItemExt
    {
        public static void PutCache(
            this VerifyBigItemByStampTaskResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<VerifyBigItemByStampTaskResult> InvokeFuture(
            this VerifyBigItemByStampTaskRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<VerifyBigItemByStampTaskResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<VerifyBigItemByStampTaskResult> self)
            {
            ...
            return new Gs2InlineFuture<VerifyBigItemByStampTaskResult>(Impl);
        }
#endif
