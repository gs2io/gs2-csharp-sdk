...
namespace Gs2.Gs2Inventory.Model.Cache
{
    public static partial class SimpleItemExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<SimpleItem> FetchFuture(
            this SimpleItem self,
            CacheDatabase cache,
            string namespaceName,
            string userId,
            ...
            return new Gs2InlineFuture<SimpleItem>(Impl);
        }
#endif

#if GS2_ENABLE_UNITASK
        public static async UniTask<SimpleItem> FetchAsync(
#else
        public static async Task<SimpleItem> FetchAsync(
#endif
            this SimpleItem self,
            CacheDatabase cache,
            string namespaceName,
        ...
        public static Tuple<SimpleItem, bool> GetCache(
            this SimpleItem self,
            CacheDatabase cache,
            string namespaceName,
            string userId,
        ...
        public static void PutCache(
            ...
            var (value, find) = cache.Get<SimpleItem>(
                self.CacheParentKey(
                    namespaceName,
                    userId,
                    inventoryName,
 ...
 diff --- end */
        ...
        public static string PutUserData(
            ...
            self.PutCache(
                ...
                namespaceName,
                userId,
                SimpleItem.GetInventoryNameFromGrn(self.ItemId),
                self.ItemName,
                timeOffset
            );
