...
namespace Gs2.Gs2Inventory.Model
{
    ...
    )
    {
        ...
        public JsonData ToDict()
        {
            ...
            data["itemSetGroupId"] = itemSetGroupId;
            data["inventoryName"] = inventoryName;
            data["userId"] = userId;
            data["itemName"] = itemName;
            data["sortValue"] = sortValue;
            data["itemSetItemSetIdList"] = new JsonData(itemSetItemSetIdList);
            data["itemSetNameList"] = new JsonData(itemSetNameList);
            data["itemSetCountList"] = new JsonData(itemSetCountList);
            data["itemSetReferenceOfList"] = new JsonData(itemSetReferenceOfList);
            data["itemSetExpiresAtList"] = new JsonData(itemSetExpiresAtList);
            data["itemSetCreatedAtList"] = new JsonData(itemSetCreatedAtList);
            data["itemSetUpdatedAtList"] = new JsonData(itemSetUpdatedAtList);
