...
namespace Gs2.Gs2Inventory.Model
{
	...
	[Preserve]
#endif
	public partial class ConsumeCount : IComparable
	{
    	...
    	[Preserve]
#endif
        public static ConsumeCount FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type ConsumeCount.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (ItemName.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("consumeCount", "inventory.consumeCount.itemName.error.tooLong"),
                    });
                }
            }
            {
                if (Count < 1) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("consumeCount", "inventory.consumeCount.count.error.invalid"),
                    });
                }
