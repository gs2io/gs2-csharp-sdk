...
namespace Gs2.Gs2Inventory.Model
{
	...
	[Preserve]
#endif
	public partial class BigInventoryModel : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type BigInventoryModel.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.CompareArray(BigItemModels, other.BigItemModels);
            if (diff != 0)
            {
                return diff;
            }
