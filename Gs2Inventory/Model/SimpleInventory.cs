...
namespace Gs2.Gs2Inventory.Model
{
	...
	[Preserve]
#endif
	public partial class SimpleInventory : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type SimpleInventory.", nameof(obj));
            }
            var diff = 0;
            ...
            diff = ModelComparer.CompareArray(SimpleItems, other.SimpleItems);
            if (diff != 0)
            {
                return diff;
            }
