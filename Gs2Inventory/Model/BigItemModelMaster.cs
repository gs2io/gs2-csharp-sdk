...
namespace Gs2.Gs2Inventory.Model
{
	...
	[Preserve]
#endif
	public partial class BigItemModelMaster : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type BigItemModelMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (ItemModelId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("bigItemModelMaster", "inventory.bigItemModelMaster.itemModelId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("bigItemModelMaster", "inventory.bigItemModelMaster.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("bigItemModelMaster", "inventory.bigItemModelMaster.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("bigItemModelMaster", "inventory.bigItemModelMaster.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("bigItemModelMaster", "inventory.bigItemModelMaster.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("bigItemModelMaster", "inventory.bigItemModelMaster.revision.error.invalid"),
                    });
                }
