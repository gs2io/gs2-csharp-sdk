...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DescribeItemModelsRequest : Gs2Request<DescribeItemModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeItemModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeItemModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeItemModelsRequest)x;
            return this;
        }
    }
}