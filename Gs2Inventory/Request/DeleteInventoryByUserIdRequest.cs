...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DeleteInventoryByUserIdRequest : Gs2Request<DeleteInventoryByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteInventoryByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteInventoryByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteInventoryByUserIdRequest)x;
            return this;
        }
    }
}