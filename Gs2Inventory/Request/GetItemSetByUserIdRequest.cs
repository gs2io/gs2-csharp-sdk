...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetItemSetByUserIdRequest : Gs2Request<GetItemSetByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetItemSetByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetItemSetByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetItemSetByUserIdRequest)x;
            return this;
        }
    }
}