...
#endif
	[System.Serializable]
	public class GetSimpleItemRequest : Gs2Request<GetSimpleItemRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSimpleItemRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetSimpleItemRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetSimpleItemRequest)x;
            return this;
        }
    }
}