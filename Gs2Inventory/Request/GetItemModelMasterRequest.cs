...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetItemModelMasterRequest : Gs2Request<GetItemModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetItemModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetItemModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetItemModelMasterRequest)x;
            return this;
        }
    }
}