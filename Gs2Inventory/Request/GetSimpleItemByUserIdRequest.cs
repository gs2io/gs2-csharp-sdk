...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetSimpleItemByUserIdRequest : Gs2Request<GetSimpleItemByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSimpleItemByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetSimpleItemByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetSimpleItemByUserIdRequest)x;
            return this;
        }
    }
}