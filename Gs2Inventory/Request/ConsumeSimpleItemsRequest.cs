	...
	public class ConsumeSimpleItemsRequest : Gs2Request<ConsumeSimpleItemsRequest>
	{
        ...
        public static ConsumeSimpleItemsRequest FromJson(JsonData data)
        {
            ...
            return new ConsumeSimpleItemsRequest()
                ...
                .WithConsumeCounts(!data.Keys.Contains("consumeCounts") || data["consumeCounts"] == null ? new Gs2.Gs2Inventory.Model.ConsumeCount[]{} : data["consumeCounts"].Cast<JsonData>().Select(v => {
        ...
        public override JsonData ToJson()
        {
            return new JsonData {
                ...
                ["consumeCounts"] = ConsumeCounts == null ? null : new JsonData(
                        ConsumeCounts.Select(v => {
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ConsumeSimpleItemsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ConsumeSimpleItemsRequest)x;
            return this;
        }
    }
}