...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class VerifyBigItemRequest : Gs2Request<VerifyBigItemRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyBigItemRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyBigItemRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyBigItemRequest)x;
            return this;
        }
    }
}