...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetNamespaceRequest : Gs2Request<GetNamespaceRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetNamespaceRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetNamespaceRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetNamespaceRequest)x;
            return this;
        }
    }
}