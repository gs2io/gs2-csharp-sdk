...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DescribeInventoriesByUserIdRequest : Gs2Request<DescribeInventoriesByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeInventoriesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeInventoriesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeInventoriesByUserIdRequest)x;
            return this;
        }
    }
}