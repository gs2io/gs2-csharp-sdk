...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetInventoryModelRequest : Gs2Request<GetInventoryModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetInventoryModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetInventoryModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetInventoryModelRequest)x;
            return this;
        }
    }
}