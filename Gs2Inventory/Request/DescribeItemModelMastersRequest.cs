...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DescribeItemModelMastersRequest : Gs2Request<DescribeItemModelMastersRequest>
	{
        ...
        public DescribeItemModelMastersRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeItemModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeItemModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeItemModelMastersRequest)x;
            return this;
        }
    }
}