...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class UpdateCurrentItemModelMasterRequest : Gs2Request<UpdateCurrentItemModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentItemModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentItemModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentItemModelMasterRequest)x;
            return this;
        }
    }
}