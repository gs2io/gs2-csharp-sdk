...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class ConsumeSimpleItemsByStampTaskRequest : Gs2Request<ConsumeSimpleItemsByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static ConsumeSimpleItemsByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ConsumeSimpleItemsByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ConsumeSimpleItemsByStampTaskRequest)x;
            return this;
        }
    }
}