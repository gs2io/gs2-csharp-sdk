...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class AcquireSimpleItemsByStampSheetRequest : Gs2Request<AcquireSimpleItemsByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AcquireSimpleItemsByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AcquireSimpleItemsByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AcquireSimpleItemsByStampSheetRequest)x;
            return this;
        }
    }
}