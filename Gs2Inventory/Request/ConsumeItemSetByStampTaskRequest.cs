...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class ConsumeItemSetByStampTaskRequest : Gs2Request<ConsumeItemSetByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static ConsumeItemSetByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ConsumeItemSetByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ConsumeItemSetByStampTaskRequest)x;
            return this;
        }
    }
}