...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class VerifyItemSetByStampTaskRequest : Gs2Request<VerifyItemSetByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyItemSetByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyItemSetByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyItemSetByStampTaskRequest)x;
            return this;
        }
    }
}