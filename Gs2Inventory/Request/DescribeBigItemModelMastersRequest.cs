...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DescribeBigItemModelMastersRequest : Gs2Request<DescribeBigItemModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeBigItemModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeBigItemModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeBigItemModelMastersRequest)x;
            return this;
        }
    }
}