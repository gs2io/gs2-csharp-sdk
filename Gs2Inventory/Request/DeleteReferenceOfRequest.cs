...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DeleteReferenceOfRequest : Gs2Request<DeleteReferenceOfRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteReferenceOfRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteReferenceOfRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteReferenceOfRequest)x;
            return this;
        }
    }
}