...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetItemWithSignatureByUserIdRequest : Gs2Request<GetItemWithSignatureByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetItemWithSignatureByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetItemWithSignatureByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetItemWithSignatureByUserIdRequest)x;
            return this;
        }
    }
}