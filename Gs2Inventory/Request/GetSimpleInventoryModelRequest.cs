...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetSimpleInventoryModelRequest : Gs2Request<GetSimpleInventoryModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSimpleInventoryModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetSimpleInventoryModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetSimpleInventoryModelRequest)x;
            return this;
        }
    }
}