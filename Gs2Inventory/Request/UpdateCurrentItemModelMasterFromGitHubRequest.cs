...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class UpdateCurrentItemModelMasterFromGitHubRequest : Gs2Request<UpdateCurrentItemModelMasterFromGitHubRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentItemModelMasterFromGitHubRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new UpdateCurrentItemModelMasterFromGitHubRequest()
                ...
                .WithCheckoutSetting(!data.Keys.Contains("checkoutSetting") || data["checkoutSetting"] == null ? null : Gs2.Gs2Inventory.Model.GitHubCheckoutSetting.FromJson(data["checkoutSetting"]));
        }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentItemModelMasterFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentItemModelMasterFromGitHubRequest)x;
            return this;
        }
    }
}