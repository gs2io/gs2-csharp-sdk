...
#endif
	[System.Serializable]
	public class DescribeSimpleInventoryModelMastersRequest : Gs2Request<DescribeSimpleInventoryModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeSimpleInventoryModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSimpleInventoryModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSimpleInventoryModelMastersRequest)x;
            return this;
        }
    }
}