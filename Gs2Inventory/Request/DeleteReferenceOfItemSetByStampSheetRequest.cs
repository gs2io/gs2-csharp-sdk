...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class DeleteReferenceOfItemSetByStampSheetRequest : Gs2Request<DeleteReferenceOfItemSetByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteReferenceOfItemSetByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteReferenceOfItemSetByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteReferenceOfItemSetByStampSheetRequest)x;
            return this;
        }
    }
}