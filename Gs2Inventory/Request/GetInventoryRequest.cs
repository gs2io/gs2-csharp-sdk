...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class GetInventoryRequest : Gs2Request<GetInventoryRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetInventoryRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetInventoryRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetInventoryRequest)x;
            return this;
        }
    }
}