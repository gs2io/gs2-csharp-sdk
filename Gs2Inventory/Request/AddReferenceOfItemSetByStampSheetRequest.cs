...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class AddReferenceOfItemSetByStampSheetRequest : Gs2Request<AddReferenceOfItemSetByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AddReferenceOfItemSetByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AddReferenceOfItemSetByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AddReferenceOfItemSetByStampSheetRequest)x;
            return this;
        }
    }
}