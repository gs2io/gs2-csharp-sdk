...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class AcquireBigItemByStampSheetRequest : Gs2Request<AcquireBigItemByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AcquireBigItemByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AcquireBigItemByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AcquireBigItemByStampSheetRequest)x;
            return this;
        }
    }
}