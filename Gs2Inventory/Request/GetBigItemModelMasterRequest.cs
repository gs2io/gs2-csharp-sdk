...
#endif
	[System.Serializable]
	public class GetBigItemModelMasterRequest : Gs2Request<GetBigItemModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetBigItemModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetBigItemModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetBigItemModelMasterRequest)x;
            return this;
        }
    }
}