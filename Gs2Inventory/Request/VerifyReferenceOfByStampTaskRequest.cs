...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class VerifyReferenceOfByStampTaskRequest : Gs2Request<VerifyReferenceOfByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyReferenceOfByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyReferenceOfByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyReferenceOfByStampTaskRequest)x;
            return this;
        }
    }
}