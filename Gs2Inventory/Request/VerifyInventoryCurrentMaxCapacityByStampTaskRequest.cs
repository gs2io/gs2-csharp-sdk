...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class VerifyInventoryCurrentMaxCapacityByStampTaskRequest : Gs2Request<VerifyInventoryCurrentMaxCapacityByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyInventoryCurrentMaxCapacityByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyInventoryCurrentMaxCapacityByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyInventoryCurrentMaxCapacityByStampTaskRequest)x;
            return this;
        }
    }
}