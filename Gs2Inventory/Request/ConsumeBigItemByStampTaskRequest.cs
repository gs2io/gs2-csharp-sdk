...
namespace Gs2.Gs2Inventory.Request
{
	...
	public class ConsumeBigItemByStampTaskRequest : Gs2Request<ConsumeBigItemByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static ConsumeBigItemByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ConsumeBigItemByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ConsumeBigItemByStampTaskRequest)x;
            return this;
        }
    }
}