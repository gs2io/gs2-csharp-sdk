	...
	public partial class Stage : IComparable
	{
        ...
        public static Stage FromJson(JsonData data)
        {
            ...
            return new Stage()
                ...
                .WithSortNumber(!data.Keys.Contains("sortNumber") || data["sortNumber"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableInt(data["sortNumber"].ToString()))
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Stage.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(StageId, other.StageId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(SourceStageName, other.SourceStageName);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(SortNumber, other.SortNumber);
            if (diff != 0)
            {
                return diff;
            }
