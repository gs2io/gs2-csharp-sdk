...
namespace Gs2.Gs2Freeze.Domain.Iterator
{
    ...
    public class DescribeStagesIterator : IAsyncEnumerable<Gs2.Gs2Freeze.Model.Stage> {
        ...
        private bool _last;
        private Gs2.Gs2Freeze.Model.Stage[] _result;

        public static int? fetchSize;

        public DescribeStagesIterator(
            ...
            this._client = client;
            this._last = false;
            this._result = new Gs2.Gs2Freeze.Model.Stage[]{};
        }
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Freeze.Request.DescribeStagesRequest()
                    .WithContextStack(this._gs2.DefaultContextStack);
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                var future = this._client.DescribeStagesFuture(
                #else
                var r = await this._client.DescribeStagesAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Freeze.Model.Stage>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Freeze.Model.Stage>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Freeze.Model.Stage> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Freeze.Model.Stage>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
