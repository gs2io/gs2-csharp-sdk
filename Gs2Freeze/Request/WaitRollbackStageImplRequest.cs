...
#endif
	[System.Serializable]
	public class WaitRollbackStageImplRequest : Gs2Request<WaitRollbackStageImplRequest>
	{
         public string OwnerId { set; get; } = null!;
         public string StageName { set; get; } = null!;
        public WaitRollbackStageImplRequest WithOwnerId(string ownerId) {
            this.OwnerId = ownerId;
            return this;
        }
        public WaitRollbackStageImplRequest WithStageName(string stageName) {
    	...
    	[Preserve]
#endif
        public static WaitRollbackStageImplRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new WaitRollbackStageImplRequest()
