...
#endif
	[System.Serializable]
	public class RollbackStageImplRequest : Gs2Request<RollbackStageImplRequest>
	{
         public string OwnerId { set; get; } = null!;
         public string StageName { set; get; } = null!;
        public RollbackStageImplRequest WithOwnerId(string ownerId) {
            this.OwnerId = ownerId;
            return this;
        }
        public RollbackStageImplRequest WithStageName(string stageName) {
    	...
    	[Preserve]
#endif
        public static RollbackStageImplRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new RollbackStageImplRequest()
