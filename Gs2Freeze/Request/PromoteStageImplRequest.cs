...
#endif
	[System.Serializable]
	public class PromoteStageImplRequest : Gs2Request<PromoteStageImplRequest>
	{
         public string OwnerId { set; get; } = null!;
         public string StageName { set; get; } = null!;
        public PromoteStageImplRequest WithOwnerId(string ownerId) {
            this.OwnerId = ownerId;
            return this;
        }
        public PromoteStageImplRequest WithStageName(string stageName) {
    	...
    	[Preserve]
#endif
        public static PromoteStageImplRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new PromoteStageImplRequest()
