...
namespace Gs2.Gs2Freeze.Result
{
	...
	{
        public Gs2.Gs2Freeze.Model.Output[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeOutputsResult WithItems(Gs2.Gs2Freeze.Model.Output[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeOutputsResult FromJson(JsonData data)
        {
            ...
            return new DescribeOutputsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? null : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Freeze.Model.Output.FromJson(v);
                }).ToArray())
