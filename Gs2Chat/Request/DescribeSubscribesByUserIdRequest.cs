...
namespace Gs2.Gs2Chat.Request
{
	...
	public class DescribeSubscribesByUserIdRequest : Gs2Request<DescribeSubscribesByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeSubscribesByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSubscribesByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSubscribesByUserIdRequest)x;
            return this;
        }
    }
}