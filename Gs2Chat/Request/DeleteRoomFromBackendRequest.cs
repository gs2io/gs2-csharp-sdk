...
namespace Gs2.Gs2Chat.Request
{
	...
	public class DeleteRoomFromBackendRequest : Gs2Request<DeleteRoomFromBackendRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteRoomFromBackendRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteRoomFromBackendRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteRoomFromBackendRequest)x;
            return this;
        }
    }
}