...
namespace Gs2.Gs2Chat.Request
{
	...
	public class DescribeSubscribesByRoomNameRequest : Gs2Request<DescribeSubscribesByRoomNameRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeSubscribesByRoomNameRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSubscribesByRoomNameRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSubscribesByRoomNameRequest)x;
            return this;
        }
    }
}