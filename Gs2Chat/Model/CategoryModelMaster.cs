...
namespace Gs2.Gs2Chat.Model
{
	...
	[Preserve]
#endif
	public partial class CategoryModelMaster : IComparable
	{
        ...
        public CategoryModelMaster WithCategory(int? category) {
        ...
        public void Validate() {
            {
                if (CategoryModelId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("categoryModelMaster", "chat.categoryModelMaster.categoryModelId.error.tooLong"),
                    });
                }
            }
            {
                if (Category < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("categoryModelMaster", "chat.categoryModelMaster.category.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("categoryModelMaster", "chat.categoryModelMaster.description.error.tooLong"),
                    });
                }
            }
            {
                switch (RejectAccessTokenPost) {
                    ...
                    default:
                        throw new Gs2.Core.Exception.BadRequestException(new [] {
                            new RequestError("categoryModelMaster", "chat.categoryModelMaster.rejectAccessTokenPost.error.invalid"),
                        });
                }
            }
            {
                if (CreatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("categoryModelMaster", "chat.categoryModelMaster.createdAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("categoryModelMaster", "chat.categoryModelMaster.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("categoryModelMaster", "chat.categoryModelMaster.revision.error.invalid"),
                    });
                }
