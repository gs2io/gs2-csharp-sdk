...
#endif
	[System.Serializable]
	public class PreUpdateCurrentModelMasterResult : IResult
	{
        ...
        public PreUpdateCurrentModelMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentModelMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
