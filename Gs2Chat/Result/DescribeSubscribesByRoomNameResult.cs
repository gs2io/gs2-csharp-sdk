...
#endif
	[System.Serializable]
	public class DescribeSubscribesByRoomNameResult : IResult
	{
        public Gs2.Gs2Chat.Model.Subscribe[] Items { set; get; }
        public string NextPageToken { set; get; }

        public DescribeSubscribesByRoomNameResult WithItems(Gs2.Gs2Chat.Model.Subscribe[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeSubscribesByRoomNameResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeSubscribesByRoomNameResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Chat.Model.Subscribe[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Chat.Model.Subscribe.FromJson(v);
                }).ToArray())
