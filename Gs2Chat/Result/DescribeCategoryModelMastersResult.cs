...
namespace Gs2.Gs2Chat.Result
{
	...
	{
        public Gs2.Gs2Chat.Model.CategoryModelMaster[] Items { set; get; }
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeCategoryModelMastersResult WithItems(Gs2.Gs2Chat.Model.CategoryModelMaster[] items) {
            this.Items = items;
            return this;
        }
        ...
        public DescribeCategoryModelMastersResult WithMetadata(ResultMetadata metadata) {
        ...
        public static DescribeCategoryModelMastersResult FromJson(JsonData data)
        {
            ...
            return new DescribeCategoryModelMastersResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? null : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Chat.Model.CategoryModelMaster.FromJson(v);
                }).ToArray())
