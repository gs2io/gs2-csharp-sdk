...
namespace Gs2.Gs2Chat.Result
{
	...
	public class GetMessageResult : IResult
	{
        ...
        public GetMessageResult WithItem(Gs2.Gs2Chat.Model.Message item) {
            this.Item = item;
            return this;
        }

        public GetMessageResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static GetMessageResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
