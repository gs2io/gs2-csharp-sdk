...
namespace Gs2.Gs2Chat.Result
{
	...
	public class DeleteMessageResult : IResult
	{
        ...
        public DeleteMessageResult WithItem(Gs2.Gs2Chat.Model.Message item) {
            this.Item = item;
            return this;
        }

        public DeleteMessageResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteMessageResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
