...
namespace Gs2.Gs2Chat.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeRoomsIterator : Gs2Iterator<Gs2.Gs2Chat.Model.Room> {
    #else
    public class DescribeRoomsIterator : IAsyncEnumerable<Gs2.Gs2Chat.Model.Room> {
        ...
        public DescribeRoomsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Chat.Model.Room[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Chat.Model.Room>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Chat.Model.Room>
                (
                        parentKey
                )
                    .ToArray();
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Chat.Model.Room>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Chat.Model.Room ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Chat.Model.Room>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Chat.Model.Room> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Chat.Model.Room> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Chat.Model.Room>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
