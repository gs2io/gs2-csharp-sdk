...
namespace Gs2.Gs2Chat.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Chat.Model.Room>
        #if GS2_ENABLE_UNITASK
        , IUniTaskAsyncEnumerable<Gs2.Gs2Chat.Model.Room>
        #endif
    #else
        IAsyncEnumerable<Gs2.Gs2Chat.Model.Room>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Chat.Request.DescribeRoomsRequest()
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Chat.Model.Room> GetAsyncEnumerator(
