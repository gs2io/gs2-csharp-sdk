...
namespace Gs2.Gs2Chat.Domain.Model
{
    ...
    public partial class MessageDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Chat.Domain.Model.MessageDomain> DeleteFuture(
            DeleteMessageRequest request
        ) => DeleteAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Chat.Domain.Model.MessageDomain> DeleteAsync(
        #else
        public async Task<Gs2.Gs2Chat.Domain.Model.MessageDomain> DeleteAsync(
        #endif
            DeleteMessageRequest request
        ) {
            try {
    ...
    public partial class MessageDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Chat.Model.Message> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Chat.Model.Message> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Chat.Model.Message> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Chat.Model.Message> Model() => ModelAsync();
        #endif
