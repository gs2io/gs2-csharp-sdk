...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<SubGradeResult> InvokeFuture(
            this SubGradeRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<SubGradeResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<SubGradeResult> self)
            {
            ...
            return new Gs2InlineFuture<SubGradeResult>(Impl);
        }
#endif
