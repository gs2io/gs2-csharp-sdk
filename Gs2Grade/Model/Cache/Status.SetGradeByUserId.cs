...
namespace Gs2.Gs2Grade.Model.Cache
{
    public static partial class StatusExt
    {
        public static void PutCache(
            this SetGradeByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<SetGradeByUserIdResult> InvokeFuture(
            this SetGradeByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<SetGradeByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<SetGradeByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<SetGradeByUserIdResult>(Impl);
        }
#endif
