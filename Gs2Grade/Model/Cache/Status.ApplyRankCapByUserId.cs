...
namespace Gs2.Gs2Grade.Model.Cache
{
    public static partial class StatusExt
    {
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<ApplyRankCapByUserIdResult> InvokeFuture(
        ...
        {
            IEnumerator Impl(IFuture<ApplyRankCapByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<ApplyRankCapByUserIdResult>(Impl);
        }
#endif
