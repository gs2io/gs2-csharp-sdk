...
namespace Gs2.Gs2Grade.Model.Transaction
{
    public static partial class StatusExt
    {
        ...
        public static Status SpeculativeExecution(
            ...
            UnityEngine.Debug.LogWarning("Speculative execution not supported on this action: Gs2Grade:MultiplyAcquireActionsByUserId");
#else
            System.Console.WriteLine("Speculative execution not supported on this action: Gs2Grade:MultiplyAcquireActionsByUserId");
#endif
        ...
        public static MultiplyAcquireActionsByUserIdRequest Rate(
            ...
            throw new NotSupportedException($"not supported rate action Gs2Grade:MultiplyAcquireActionsByUserId");
        }
    }
