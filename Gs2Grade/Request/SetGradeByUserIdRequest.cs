...
#endif
	[System.Serializable]
	public class SetGradeByUserIdRequest : Gs2Request<SetGradeByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static SetGradeByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply SetGradeByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (SetGradeByUserIdRequest)x;
            return this;
        }
    }
}