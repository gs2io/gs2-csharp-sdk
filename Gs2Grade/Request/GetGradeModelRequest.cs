...
namespace Gs2.Gs2Grade.Request
{
	...
	public class GetGradeModelRequest : Gs2Request<GetGradeModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetGradeModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetGradeModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetGradeModelRequest)x;
            return this;
        }
    }
}