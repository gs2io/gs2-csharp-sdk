...
namespace Gs2.Gs2Grade.Result
{
	...
	public class ApplyRankCapByStampSheetResult : IResult
	{
        ...
        public ApplyRankCapByStampSheetResult WithExperienceStatus(Gs2.Gs2Experience.Model.Status experienceStatus) {
    	...
    	[Preserve]
#endif
        public static ApplyRankCapByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
