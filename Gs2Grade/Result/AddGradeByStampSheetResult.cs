...
#endif
	[System.Serializable]
	public class AddGradeByStampSheetResult : IResult
	{
        ...
        public AddGradeByStampSheetResult WithItem(Gs2.Gs2Grade.Model.Status item) {
            this.Item = item;
            return this;
        }

        public AddGradeByStampSheetResult WithExperienceNamespaceName(string experienceNamespaceName) {
            this.ExperienceNamespaceName = experienceNamespaceName;
            return this;
        }

        public AddGradeByStampSheetResult WithExperienceStatus(Gs2.Gs2Experience.Model.Status experienceStatus) {
            this.ExperienceStatus = experienceStatus;
            return this;
        }

        public AddGradeByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AddGradeByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
