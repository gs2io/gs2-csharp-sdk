...
#endif
	[System.Serializable]
	public class VerifyGradeResult : IResult
	{
        public Gs2.Gs2Grade.Model.Status Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyGradeResult WithItem(Gs2.Gs2Grade.Model.Status item) {
            this.Item = item;
            return this;
        }

        public VerifyGradeResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyGradeResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
