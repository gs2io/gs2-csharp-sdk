...
#endif
	[System.Serializable]
	public class ApplyRankCapResult : IResult
	{
        ...
        public ApplyRankCapResult WithItem(Gs2.Gs2Grade.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public ApplyRankCapResult WithExperienceStatus(Gs2.Gs2Experience.Model.Status experienceStatus) {
            this.ExperienceStatus = experienceStatus;
            return this;
        }

        public ApplyRankCapResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ApplyRankCapResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
