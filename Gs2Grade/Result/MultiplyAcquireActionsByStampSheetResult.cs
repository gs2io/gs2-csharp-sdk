...
namespace Gs2.Gs2Grade.Result
{
	...
	public class MultiplyAcquireActionsByStampSheetResult : IResult
	{
        ...
        public MultiplyAcquireActionsByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public MultiplyAcquireActionsByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public MultiplyAcquireActionsByStampSheetResult WithMetadata(ResultMetadata metadata) {
