...
#endif
	[System.Serializable]
	public class SubGradeResult : IResult
	{
        ...
        public SubGradeResult WithItem(Gs2.Gs2Grade.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public SubGradeResult WithExperienceStatus(Gs2.Gs2Experience.Model.Status experienceStatus) {
            this.ExperienceStatus = experienceStatus;
            return this;
        }

        public SubGradeResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SubGradeResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
