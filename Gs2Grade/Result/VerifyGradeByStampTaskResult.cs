...
namespace Gs2.Gs2Grade.Result
{
	...
	public class VerifyGradeByStampTaskResult : IResult
	{
        ...
        public VerifyGradeByStampTaskResult WithItem(Gs2.Gs2Grade.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyGradeByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyGradeByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
