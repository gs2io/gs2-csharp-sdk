...
namespace Gs2.Gs2Grade.Result
{
	...
	public class DescribeStatusesResult : IResult
	{
        ...
        public DescribeStatusesResult WithItems(Gs2.Gs2Grade.Model.Status[] items) {
            this.Items = items;
            return this;
        }
        ...
        public static DescribeStatusesResult FromJson(JsonData data)
        {
            ...
            return new DescribeStatusesResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Grade.Model.Status[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Grade.Model.Status.FromJson(v);
                }).ToArray())
