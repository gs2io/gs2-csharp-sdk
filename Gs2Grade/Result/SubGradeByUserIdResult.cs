...
#endif
	[System.Serializable]
	public class SubGradeByUserIdResult : IResult
	{
        ...
        public SubGradeByUserIdResult WithItem(Gs2.Gs2Grade.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public SubGradeByUserIdResult WithExperienceStatus(Gs2.Gs2Experience.Model.Status experienceStatus) {
            this.ExperienceStatus = experienceStatus;
            return this;
        }

        public SubGradeByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SubGradeByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
