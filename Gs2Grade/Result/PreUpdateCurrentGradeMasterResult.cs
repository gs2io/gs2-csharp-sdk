...
#endif
	[System.Serializable]
	public class PreUpdateCurrentGradeMasterResult : IResult
	{
        ...
        public PreUpdateCurrentGradeMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentGradeMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
