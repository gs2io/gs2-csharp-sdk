...
namespace Gs2.Gs2Grade.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Grade.Model.Status>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Grade.Model.Status>
    #else
        IAsyncEnumerable<Gs2.Gs2Grade.Model.Status>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Grade.Request.DescribeStatusesByUserIdRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Grade.Model.Status>(
                        (null as Gs2.Gs2Grade.Model.Status).CacheParentKey(
                            NamespaceName,
                            UserId,
                            null
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Grade.Model.Status> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Grade.Model.Status>(async (writer, token) =>
        #else
