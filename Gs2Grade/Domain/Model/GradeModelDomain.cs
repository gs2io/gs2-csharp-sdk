...
namespace Gs2.Gs2Grade.Domain.Model
{
    ...
    public partial class GradeModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Grade.Model.GradeModel> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Grade.Model.GradeModel> self)
            {
        ...
        public async UniTask<Gs2.Gs2Grade.Model.GradeModel> Model()
        {
            return await ModelAsync();
        }
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Grade.Model.GradeModel> Model()
        {
            return ModelFuture();
        }
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public async Task<Gs2.Gs2Grade.Model.GradeModel> Model()
        {
            return await ModelAsync();
        }
        #endif
