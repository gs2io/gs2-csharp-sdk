...
namespace Gs2.Gs2Grade.Domain.Model
{
    ...
    public partial class GradeModelDomain {
        ...
        #if GS2_ENABLE_UNITASK
        private async UniTask<Gs2.Gs2Grade.Model.GradeModel> GetAsync(
        #else
        private async Task<Gs2.Gs2Grade.Model.GradeModel> GetAsync(
        #endif
            GetGradeModelRequest request
        ) {
            request = request
    ...
    public partial class GradeModelDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Grade.Model.GradeModel> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Grade.Model.GradeModel> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Grade.Model.GradeModel> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Grade.Model.GradeModel> Model() => ModelAsync();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Grade.Model.GradeModel> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Grade.Model.GradeModel> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Grade.Model.GradeModel> callback)
        #endif
        {
