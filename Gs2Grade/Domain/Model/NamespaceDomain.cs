...
namespace Gs2.Gs2Grade.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #else
        public async Task<ulong> SubscribeGradeModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Grade.Model.GradeModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeGradeModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Grade.Model.GradeModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateGradeModelMasterAsync(request).ToGs2Future();
        #endif
        ...
        public async Task<Gs2.Gs2Grade.Domain.Model.GradeModelMasterDomain> CreateGradeModelMasterAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.CreateGradeModelMasterAsync(request)
            );
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Grade.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Grade.Model.Namespace>(
                        ...
                        (null as Gs2.Gs2Grade.Model.Namespace).CacheKey(
                            this.NamespaceName
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Grade.Model.Namespace).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null
                );
                ...
                return await (null as Gs2.Gs2Grade.Model.Namespace).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetAsync(
        ...
        public UniTask<Gs2.Gs2Grade.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Grade.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Grade.Model.Namespace> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Grade.Model.Namespace).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
