...
namespace Gs2.Gs2Grade.Domain.Model
{
    ...
    public partial class CurrentGradeMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Grade.Model.CurrentGradeMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Grade.Model.CurrentGradeMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Grade.Model.CurrentGradeMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Grade.Model.CurrentGradeMaster> Model() => ModelAsync();
        #endif
