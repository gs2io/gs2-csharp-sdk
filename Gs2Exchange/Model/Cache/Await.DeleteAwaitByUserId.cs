...
namespace Gs2.Gs2Exchange.Model.Cache
{
    public static partial class AwaitExt
    {
        public static void PutCache(
            this DeleteAwaitByUserIdResult self,
            CacheDatabase cache,
            string userId,
...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<DeleteAwaitByUserIdResult> InvokeFuture(
            this DeleteAwaitByUserIdRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<DeleteAwaitByUserIdResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<DeleteAwaitByUserIdResult> self)
            {
            ...
            return new Gs2InlineFuture<DeleteAwaitByUserIdResult>(Impl);
        }
#endif
