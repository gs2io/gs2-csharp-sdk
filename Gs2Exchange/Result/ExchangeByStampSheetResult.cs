...
#endif
	[System.Serializable]
	public class ExchangeByStampSheetResult : IResult
	{
        ...
        public ExchangeByStampSheetResult WithItem(Gs2.Gs2Exchange.Model.RateModel item) {
            this.Item = item;
            return this;
        }
        ...
        public ExchangeByStampSheetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ExchangeByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ExchangeByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ExchangeByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ExchangeByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
