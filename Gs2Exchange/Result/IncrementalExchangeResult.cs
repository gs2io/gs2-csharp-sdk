...
namespace Gs2.Gs2Exchange.Result
{
	...
	public class IncrementalExchangeResult : IResult
	{
        ...
        public IncrementalExchangeResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public IncrementalExchangeResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public IncrementalExchangeResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public IncrementalExchangeResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IncrementalExchangeResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
