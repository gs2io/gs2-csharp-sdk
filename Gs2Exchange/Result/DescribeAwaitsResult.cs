...
#endif
	[System.Serializable]
	public class DescribeAwaitsResult : IResult
	{
        public Gs2.Gs2Exchange.Model.Await[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeAwaitsResult WithItems(Gs2.Gs2Exchange.Model.Await[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeAwaitsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeAwaitsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Exchange.Model.Await[]{} : data["items"].Cast<JsonData>().Select(v => {
