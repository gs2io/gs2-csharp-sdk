...
#endif
	[System.Serializable]
	public class AcquireResult : IResult
	{
        ...
        public AcquireResult WithItem(Gs2.Gs2Exchange.Model.Await item) {
            this.Item = item;
            return this;
        }
        ...
        public AcquireResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public AcquireResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public AcquireResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public AcquireResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AcquireResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
