...
#endif
	[System.Serializable]
	public class AcquireByUserIdResult : IResult
	{
        ...
        public AcquireByUserIdResult WithItem(Gs2.Gs2Exchange.Model.Await item) {
            this.Item = item;
            return this;
        }
        ...
        public AcquireByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public AcquireByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public AcquireByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public AcquireByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AcquireByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
