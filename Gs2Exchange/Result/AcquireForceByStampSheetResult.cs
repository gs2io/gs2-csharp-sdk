...
#endif
	[System.Serializable]
	public class AcquireForceByStampSheetResult : IResult
	{
        ...
        public AcquireForceByStampSheetResult WithItem(Gs2.Gs2Exchange.Model.Await item) {
            this.Item = item;
            return this;
        }
        ...
        public AcquireForceByStampSheetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public AcquireForceByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public AcquireForceByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public AcquireForceByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AcquireForceByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
