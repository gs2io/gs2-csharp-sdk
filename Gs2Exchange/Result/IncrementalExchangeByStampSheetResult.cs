...
#endif
	[System.Serializable]
	public class IncrementalExchangeByStampSheetResult : IResult
	{
        ...
        public IncrementalExchangeByStampSheetResult WithItem(Gs2.Gs2Exchange.Model.IncrementalRateModel item) {
            this.Item = item;
            return this;
        }
        ...
        public IncrementalExchangeByStampSheetResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public IncrementalExchangeByStampSheetResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public IncrementalExchangeByStampSheetResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public IncrementalExchangeByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IncrementalExchangeByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new IncrementalExchangeByStampSheetResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2Exchange.Model.IncrementalRateModel.FromJson(data["item"]))
