...
#endif
	[System.Serializable]
	public class PreUpdateCurrentRateMasterResult : IResult
	{
        ...
        public PreUpdateCurrentRateMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentRateMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
