...
namespace Gs2.Gs2Exchange.Result
{
	...
	public class SkipResult : IResult
	{
        ...
        public SkipResult WithItem(Gs2.Gs2Exchange.Model.Await item) {
            this.Item = item;
            return this;
        }
        ...
        public SkipResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
    	...
    	[Preserve]
#endif
        public static SkipResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
