...
#endif
	[System.Serializable]
	public class ExchangeResult : IResult
	{
        ...
        public ExchangeResult WithItem(Gs2.Gs2Exchange.Model.RateModel item) {
            this.Item = item;
            return this;
        }
        ...
        public ExchangeResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ExchangeResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ExchangeResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ExchangeResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static ExchangeResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
