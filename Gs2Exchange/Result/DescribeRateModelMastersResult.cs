...
namespace Gs2.Gs2Exchange.Result
{
	...
	{
        public Gs2.Gs2Exchange.Model.RateModelMaster[] Items { set; get; } = null!;
        public string NextPageToken { set; get; } = null!;

        public DescribeRateModelMastersResult WithItems(Gs2.Gs2Exchange.Model.RateModelMaster[] items) {
            this.Items = items;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeRateModelMastersResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DescribeRateModelMastersResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Exchange.Model.RateModelMaster[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Exchange.Model.RateModelMaster.FromJson(v);
                }).ToArray())
