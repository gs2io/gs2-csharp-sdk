...
#endif
	[System.Serializable]
	public class IncrementalExchangeByUserIdResult : IResult
	{
        ...
        public IncrementalExchangeByUserIdResult WithItem(Gs2.Gs2Exchange.Model.IncrementalRateModel item) {
            this.Item = item;
            return this;
        }
        ...
        public IncrementalExchangeByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public IncrementalExchangeByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public IncrementalExchangeByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public IncrementalExchangeByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static IncrementalExchangeByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
