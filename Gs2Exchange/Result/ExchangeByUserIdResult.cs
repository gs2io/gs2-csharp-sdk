...
namespace Gs2.Gs2Exchange.Result
{
	...
	public class ExchangeByUserIdResult : IResult
	{
        ...
        public ExchangeByUserIdResult WithAutoRunStampSheet(bool? autoRunStampSheet) {
            this.AutoRunStampSheet = autoRunStampSheet;
            return this;
        }

        public ExchangeByUserIdResult WithAtomicCommit(bool? atomicCommit) {
        ...
        public ExchangeByUserIdResult WithTransactionResult(Gs2.Core.Model.TransactionResult transactionResult) {
            this.TransactionResult = transactionResult;
            return this;
        }

        public ExchangeByUserIdResult WithMetadata(ResultMetadata metadata) {
