...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class DescribeAwaitsRequest : Gs2Request<DescribeAwaitsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeAwaitsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeAwaitsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeAwaitsRequest)x;
            return this;
        }
    }
}