...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class CreateAwaitByStampSheetRequest : Gs2Request<CreateAwaitByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static CreateAwaitByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply CreateAwaitByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (CreateAwaitByStampSheetRequest)x;
            return this;
        }
    }
}