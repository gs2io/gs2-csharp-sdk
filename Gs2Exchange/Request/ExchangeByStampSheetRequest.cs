...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class ExchangeByStampSheetRequest : Gs2Request<ExchangeByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static ExchangeByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply ExchangeByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (ExchangeByStampSheetRequest)x;
            return this;
        }
    }
}