...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class DeleteAwaitByStampTaskRequest : Gs2Request<DeleteAwaitByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteAwaitByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteAwaitByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteAwaitByStampTaskRequest)x;
            return this;
        }
    }
}