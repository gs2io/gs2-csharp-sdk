...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class DescribeIncrementalRateModelsRequest : Gs2Request<DescribeIncrementalRateModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeIncrementalRateModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeIncrementalRateModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeIncrementalRateModelsRequest)x;
            return this;
        }
    }
}