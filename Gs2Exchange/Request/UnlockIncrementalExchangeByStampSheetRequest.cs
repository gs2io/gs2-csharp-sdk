...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class UnlockIncrementalExchangeByStampSheetRequest : Gs2Request<UnlockIncrementalExchangeByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static UnlockIncrementalExchangeByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UnlockIncrementalExchangeByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UnlockIncrementalExchangeByStampSheetRequest)x;
            return this;
        }
    }
}