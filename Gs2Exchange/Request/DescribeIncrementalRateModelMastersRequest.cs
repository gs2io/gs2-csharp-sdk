...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class DescribeIncrementalRateModelMastersRequest : Gs2Request<DescribeIncrementalRateModelMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeIncrementalRateModelMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeIncrementalRateModelMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeIncrementalRateModelMastersRequest)x;
            return this;
        }
    }
}