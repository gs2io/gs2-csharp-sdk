...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class GetCurrentRateMasterRequest : Gs2Request<GetCurrentRateMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetCurrentRateMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetCurrentRateMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetCurrentRateMasterRequest)x;
            return this;
        }
    }
}