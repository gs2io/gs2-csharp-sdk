...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class GetRateModelMasterRequest : Gs2Request<GetRateModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetRateModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetRateModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetRateModelMasterRequest)x;
            return this;
        }
    }
}