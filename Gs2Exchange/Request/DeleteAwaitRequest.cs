...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class DeleteAwaitRequest : Gs2Request<DeleteAwaitRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteAwaitRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteAwaitRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteAwaitRequest)x;
            return this;
        }
    }
}