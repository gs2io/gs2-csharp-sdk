...
namespace Gs2.Gs2Exchange.Request
{
	...
	public class DescribeAwaitsByUserIdRequest : Gs2Request<DescribeAwaitsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeAwaitsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeAwaitsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeAwaitsByUserIdRequest)x;
            return this;
        }
    }
}