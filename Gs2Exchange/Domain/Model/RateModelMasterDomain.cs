...
namespace Gs2.Gs2Exchange.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Exchange.Model.RateModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Exchange.Model.RateModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "rateModelMaster")
                        {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Exchange.Domain.Model.RateModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Exchange.Model.RateModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class RateModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2Exchange.Model.RateModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Exchange.Model.RateModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Exchange.Model.RateModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Exchange.Model.RateModelMaster>(
                        _parentKey,
                        Gs2.Gs2Exchange.Domain.Model.RateModelMasterDomain.CreateCacheKey(
                            this.RateName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Exchange.Model.RateModelMaster>(
                _parentKey,
                Gs2.Gs2Exchange.Domain.Model.RateModelMasterDomain.CreateCacheKey(
                    this.RateName.ToString()
                )
