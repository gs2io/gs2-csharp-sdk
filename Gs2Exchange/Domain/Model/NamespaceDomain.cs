...
namespace Gs2.Gs2Exchange.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        public NamespaceDomain(
            ...
            this._parentKey = "exchange:Gs2.Gs2Exchange.Model.Namespace";
        }
        ...
        public async Task<Gs2.Gs2Exchange.Domain.Model.NamespaceDomain> GetStatusAsync(
            ...
            #endif
            Gs2.Gs2Exchange.Domain.Model.NamespaceDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Exchange.Model.Namespace> GetAsync(
            #else
        private IFuture<Gs2.Gs2Exchange.Model.Namespace> Get(
            #endif
        #else
        ...
        public async Task<Gs2.Gs2Exchange.Domain.Model.NamespaceDomain> DeleteAsync(
            ...
            #endif
            _cache.Delete<Gs2.Gs2Exchange.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Exchange.Domain.Model.NamespaceDomain.CreateCacheKey(
                    request.NamespaceName != null ? request.NamespaceName.ToString() : null
                )
        ...
        public async Task<Gs2.Gs2Exchange.Domain.Model.RateModelMasterDomain> CreateRateModelMasterAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.CreateRateModelMasterAsync(
                request
            );
            #endif
            ...
            Gs2.Gs2Exchange.Domain.Model.RateModelMasterDomain domain = new Gs2.Gs2Exchange.Domain.Model.RateModelMasterDomain(
                this._cache,
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Exchange.Model.RateModelMaster> RateModelMasters(
            #else
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Exchange.Model.RateModel> RateModels(
            #else
        ...
        public async Task<Gs2.Gs2Exchange.Model.Namespace> Model() {
            ...
            {
        #endif
            Gs2.Gs2Exchange.Model.Namespace value = _cache.Get<Gs2.Gs2Exchange.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Exchange.Domain.Model.NamespaceDomain.CreateCacheKey(
        ...
        #endif
                value = _cache.Get<Gs2.Gs2Exchange.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Exchange.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName?.ToString()
                )
