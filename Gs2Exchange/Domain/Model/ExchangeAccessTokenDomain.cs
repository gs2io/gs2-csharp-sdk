...
namespace Gs2.Gs2Exchange.Domain.Model
{
    ...
    public partial class ExchangeAccessTokenDomain {
        ...
        public IFuture<Gs2.Core.Domain.TransactionAccessTokenDomain> ExchangeFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Core.Domain.TransactionAccessTokenDomain> self)
            {
                ...
                if (speculativeExecute) {
                    var speculativeExecuteFuture = Transaction.SpeculativeExecutor.ExchangeSpeculativeExecutor.ExecuteFuture(
                        this._gs2,
                        AccessToken,
                        request
                    );
        ...
        public async Task<Gs2.Core.Domain.TransactionAccessTokenDomain> ExchangeAsync(
            ...
            if (speculativeExecute) {
                var commit = await Transaction.SpeculativeExecutor.ExchangeSpeculativeExecutor.ExecuteAsync(
                    this._gs2,
                    AccessToken,
                    request
                );
        ...
        public IFuture<Gs2.Core.Domain.TransactionAccessTokenDomain> IncrementalFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Core.Domain.TransactionAccessTokenDomain> self)
            {
                ...
                if (speculativeExecute) {
                    var speculativeExecuteFuture = Transaction.SpeculativeExecutor.IncrementalExchangeSpeculativeExecutor.ExecuteFuture(
                        this._gs2,
                        AccessToken,
                        request
                    );
        ...
        public async Task<Gs2.Core.Domain.TransactionAccessTokenDomain> IncrementalAsync(
            ...
            if (speculativeExecute) {
                var commit = await Transaction.SpeculativeExecutor.IncrementalExchangeSpeculativeExecutor.ExecuteAsync(
                    this._gs2,
                    AccessToken,
                    request
                );
