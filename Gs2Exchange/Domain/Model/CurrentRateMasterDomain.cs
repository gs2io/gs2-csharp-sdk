...
namespace Gs2.Gs2Exchange.Domain.Model
{
    ...
    public partial class CurrentRateMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Exchange.Domain.Model.CurrentRateMasterDomain> PreUpdateFuture(
            PreUpdateCurrentRateMasterRequest request
        ) => PreUpdateAsync(request).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<Gs2.Gs2Exchange.Domain.Model.CurrentRateMasterDomain> PreUpdateAsync(
        #else
        public async Task<Gs2.Gs2Exchange.Domain.Model.CurrentRateMasterDomain> PreUpdateAsync(
        #endif
            PreUpdateCurrentRateMasterRequest request
        ) {
            request = request
    ...
    public partial class CurrentRateMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Exchange.Model.CurrentRateMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Exchange.Model.CurrentRateMaster>(
                        (null as Gs2.Gs2Exchange.Model.CurrentRateMaster).CacheParentKey(
                            this.NamespaceName,
                            null
                        ),
                        (null as Gs2.Gs2Exchange.Model.CurrentRateMaster).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Exchange.Model.CurrentRateMaster).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null
                );
                ...
                return await (null as Gs2.Gs2Exchange.Model.CurrentRateMaster).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    null,
                    () => this.GetAsync(
        ...
        public UniTask<Gs2.Gs2Exchange.Model.CurrentRateMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Exchange.Model.CurrentRateMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Exchange.Model.CurrentRateMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Exchange.Model.CurrentRateMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                null
            );
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Exchange.Model.CurrentRateMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Exchange.Model.CurrentRateMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Exchange.Model.CurrentRateMaster> callback)
        #endif
        {
