...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    public class DescribeAwaitsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Exchange.Model.Await> {
        ...
        public DescribeAwaitsByUserIdIterator(
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Exchange.Request.DescribeAwaitsByUserIdRequest()
                ...
                var future = this._client.DescribeAwaitsByUserIdFuture(
                #else
