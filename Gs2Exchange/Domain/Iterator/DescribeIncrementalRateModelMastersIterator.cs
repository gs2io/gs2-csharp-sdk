...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    public class DescribeIncrementalRateModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster> {
        ...
        private bool _last;
        private Gs2.Gs2Exchange.Model.IncrementalRateModelMaster[] _result;

        public static int? fetchSize;

        public DescribeIncrementalRateModelMastersIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Exchange.Model.IncrementalRateModelMaster[]{};
        }
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>
            (
                ...
                var request = new Gs2.Gs2Exchange.Request.DescribeIncrementalRateModelMastersRequest()
                    .WithContextStack(this._gs2.DefaultContextStack)
                    .WithNamespaceName(this.NamespaceName)
                    .WithPageToken(this._pageToken)
                    .WithLimit(fetchSize);
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                var future = this._client.DescribeIncrementalRateModelMastersFuture(
                #else
                var r = await this._client.DescribeIncrementalRateModelMastersAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>(
                        (null as Gs2.Gs2Exchange.Model.IncrementalRateModelMaster).CacheParentKey(
                            NamespaceName,
                            null
                        )
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
                using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>(
                       ...
                       "ListIncrementalRateModelMaster"
                   ).LockAsync()) {
                while(this._hasNext()) {
