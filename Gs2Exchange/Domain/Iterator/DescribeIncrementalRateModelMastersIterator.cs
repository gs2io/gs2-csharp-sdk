...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    public class DescribeIncrementalRateModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._cache.TryGetList<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>
            (
                    parentKey,
                    out var list
            )) {
                ...
                if (this._last) {
                    this._cache.SetListCached<Gs2.Gs2Exchange.Model.IncrementalRateModelMaster>(
                            parentKey
                    );
                }
            }
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Exchange.Model.IncrementalRateModelMaster ret = this._result[0];
