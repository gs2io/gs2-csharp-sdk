...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeAwaitsIterator : Gs2Iterator<Gs2.Gs2Exchange.Model.Await> {
    #else
    public class DescribeAwaitsIterator : IAsyncEnumerable<Gs2.Gs2Exchange.Model.Await> {
    #endif
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Exchange.Request.DescribeAwaitsRequest()
                ...
                var future = this._client.DescribeAwaitsFuture(
                #else
                var r = await this._client.DescribeAwaitsAsync(
                #endif
                    request
                );
                #if UNITY_2017_1_OR_NEWER && !GS2_ENABLE_UNITASK
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Exchange.Model.Await>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Exchange.Model.Await>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Exchange.Model.Await> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Exchange.Model.Await>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
