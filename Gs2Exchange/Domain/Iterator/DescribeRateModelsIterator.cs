...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    public class DescribeRateModelsIterator : IAsyncEnumerable<Gs2.Gs2Exchange.Model.RateModel> {
        ...
        private bool _last;
        private Gs2.Gs2Exchange.Model.RateModel[] _result;
        ...
        public DescribeRateModelsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Exchange.Model.RateModel[]{};
        }
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Exchange.Model.RateModel>
            (
                ...
                var request = new Gs2.Gs2Exchange.Request.DescribeRateModelsRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Exchange.Model.RateModel>(
                        (null as Gs2.Gs2Exchange.Model.RateModel).CacheParentKey(
                            NamespaceName
                        )
                    );
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Exchange.Model.RateModel>> callback
        )
        {
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Exchange.Model.RateModel>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Exchange.Model.RateModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Exchange.Model.RateModel>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
