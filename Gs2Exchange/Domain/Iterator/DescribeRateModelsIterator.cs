...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    public class DescribeRateModelsIterator : IAsyncEnumerable<Gs2.Gs2Exchange.Model.RateModel> {
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Exchange.Model.RateModel>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Exchange.Model.RateModel>
                (
                        parentKey
                )
                    .ToArray();
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Exchange.Model.RateModel>(
                            listParentKey
                    );
                }
            }
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Exchange.Model.RateModel ret = this._result[0];
