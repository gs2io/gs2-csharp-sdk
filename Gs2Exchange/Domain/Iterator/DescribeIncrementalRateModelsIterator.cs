...
namespace Gs2.Gs2Exchange.Domain.Iterator
{
    ...
    public class DescribeIncrementalRateModelsIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Exchange.Model.IncrementalRateModel>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Exchange.Model.IncrementalRateModel>
    #else
        IAsyncEnumerable<Gs2.Gs2Exchange.Model.IncrementalRateModel>
    #endif
    {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Exchange.Model.IncrementalRateModel>
            (
                ...
                var request = new Gs2.Gs2Exchange.Request.DescribeIncrementalRateModelsRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Exchange.Model.IncrementalRateModel>(
                        (null as Gs2.Gs2Exchange.Model.IncrementalRateModel).CacheParentKey(
                            NamespaceName,
                            null
                        )
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Exchange.Model.IncrementalRateModel> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Exchange.Model.IncrementalRateModel>(async (writer, token) =>
        #else
