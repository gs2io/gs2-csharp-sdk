...
{
    public static class IncrementalExchangeByUserIdSpeculativeExecutor {
...
/* diff --- start
 ...
 diff --- end */
/* diff +++ start */
            // The incremental rate depends on server-owned exchange history.
            // Propagate the transaction executor's unsupported fallback.
            return null;
/* diff +++ end */
        }
    }
