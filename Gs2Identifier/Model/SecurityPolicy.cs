	...
	public partial class SecurityPolicy : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type SecurityPolicy.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(SecurityPolicyId, other.SecurityPolicyId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(Policy, other.Policy);
            if (diff != 0)
            {
                return diff;
            }
