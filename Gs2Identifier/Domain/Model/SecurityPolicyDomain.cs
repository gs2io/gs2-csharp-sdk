...
namespace Gs2.Gs2Identifier.Domain.Model
{
    ...
    public partial class SecurityPolicyDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Identifier.Model.SecurityPolicy> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Identifier.Model.SecurityPolicy> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Identifier.Model.SecurityPolicy> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Identifier.Model.SecurityPolicy> Model() => ModelAsync();
        #endif
