...
namespace Gs2.Gs2Identifier.Domain.Iterator
{
    ...
    public class DescribeIdentifiersIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Identifier.Model.Identifier>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Identifier.Model.Identifier>
    #else
        IAsyncEnumerable<Gs2.Gs2Identifier.Model.Identifier>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Identifier.Request.DescribeIdentifiersRequest()
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Identifier.Model.Identifier>> callback
        )
        {
            if (this._result.Length == 0 && !this._last) {
                ...
                if (future.Error != null)
                {
                    Current = null;
                    Error = future.Error;
                    callback.Invoke(new AsyncResult<Gs2.Gs2Identifier.Model.Identifier>(
                        Current,
                        Error
                    ));
                    yield break;
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Identifier.Model.Identifier> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Identifier.Model.Identifier>(async (writer, token) =>
        #else
