...
namespace Gs2.Gs2Identifier.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribePasswordsIterator : Gs2Iterator<Gs2.Gs2Identifier.Model.Password> {
    #else
    public class DescribePasswordsIterator : IAsyncEnumerable<Gs2.Gs2Identifier.Model.Password> {
        ...
        public DescribePasswordsIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Identifier.Model.Password[]{};
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._cache.TryGetList<Gs2.Gs2Identifier.Model.Password>
            (
                    parentKey,
                    out var list
            )) {
                ...
                var future = this._client.DescribePasswordsFuture(
                #else
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Identifier.Model.Password>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Identifier.Model.Password ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Identifier.Model.Password>(
                Current,
                error
            ));
        }
        ...
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerable<Gs2.Gs2Identifier.Model.Password> GetAsyncEnumerator(
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Identifier.Model.Password> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Identifier.Model.Password>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
