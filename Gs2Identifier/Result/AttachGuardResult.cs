...
#endif
	[System.Serializable]
	public class AttachGuardResult : IResult
	{
        public string[] Items { set; get; }
        public ResultMetadata Metadata { set; get; }

        public AttachGuardResult WithItems(string[] items) {
            this.Items = items;
            return this;
        }

        public AttachGuardResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static AttachGuardResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
