...
namespace Gs2.Gs2Identifier.Result
{
	...
	public class LoginByUserResult : IResult
	{
        ...
        public LoginByUserResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static LoginByUserResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new LoginByUserResult()
                .WithItem(!data.Keys.Contains("item") || data["item"] == null ? null : Gs2.Gs2Identifier.Model.ProjectToken.FromJson(data["item"]))
