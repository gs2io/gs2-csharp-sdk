...
namespace Gs2.Gs2Identifier.Result
{
	...
	public class CreateUserResult : IResult
	{
        ...
        public CreateUserResult WithItem(Gs2.Gs2Identifier.Model.User item) {
            this.Item = item;
            return this;
        }

        public CreateUserResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CreateUserResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
