...
namespace Gs2.Gs2Identifier.Result
{
	...
	public class DeleteUserResult : IResult
	{
        ...
        public DeleteUserResult WithItem(Gs2.Gs2Identifier.Model.User item) {
            this.Item = item;
            return this;
        }

        public DeleteUserResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteUserResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
