...
#endif
	[System.Serializable]
	public class DescribeAttachedGuardsResult : IResult
	{
        public string[] Items { set; get; }
        public ResultMetadata Metadata { set; get; }

        public DescribeAttachedGuardsResult WithItems(string[] items) {
            this.Items = items;
            return this;
        }

        public DescribeAttachedGuardsResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeAttachedGuardsResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
