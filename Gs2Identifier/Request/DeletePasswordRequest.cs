...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class DeletePasswordRequest : Gs2Request<DeletePasswordRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeletePasswordRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeletePasswordRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeletePasswordRequest)x;
            return this;
        }
    }
}