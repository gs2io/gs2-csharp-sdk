...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class GetHasSecurityPolicyRequest : Gs2Request<GetHasSecurityPolicyRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetHasSecurityPolicyRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetHasSecurityPolicyRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetHasSecurityPolicyRequest)x;
            return this;
        }
    }
}