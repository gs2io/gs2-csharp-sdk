...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class AttachSecurityPolicyRequest : Gs2Request<AttachSecurityPolicyRequest>
	{
    	...
    	[Preserve]
#endif
        public static AttachSecurityPolicyRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public override string UniqueKey() {
            var key = "";
            key += UserName + ":";
            key += SecurityPolicyId + ":";
            return key;
        }

        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AttachSecurityPolicyRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AttachSecurityPolicyRequest)x;
            return this;
        }
    }
}