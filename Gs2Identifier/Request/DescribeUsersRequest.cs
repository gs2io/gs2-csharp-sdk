...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class DescribeUsersRequest : Gs2Request<DescribeUsersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeUsersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeUsersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeUsersRequest)x;
            return this;
        }
    }
}