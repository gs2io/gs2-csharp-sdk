...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class DeleteIdentifierRequest : Gs2Request<DeleteIdentifierRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteIdentifierRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteIdentifierRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteIdentifierRequest)x;
            return this;
        }
    }
}