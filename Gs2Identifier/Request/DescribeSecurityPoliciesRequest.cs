...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class DescribeSecurityPoliciesRequest : Gs2Request<DescribeSecurityPoliciesRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeSecurityPoliciesRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeSecurityPoliciesRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeSecurityPoliciesRequest)x;
            return this;
        }
    }
}