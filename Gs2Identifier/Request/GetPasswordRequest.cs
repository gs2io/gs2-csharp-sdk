...
namespace Gs2.Gs2Identifier.Request
{
	...
	public class GetPasswordRequest : Gs2Request<GetPasswordRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPasswordRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPasswordRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPasswordRequest)x;
            return this;
        }
    }
}