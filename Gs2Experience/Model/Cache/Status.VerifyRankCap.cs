...
#if UNITY_2017_1_OR_NEWER
        public static IFuture<VerifyRankCapResult> InvokeFuture(
            this VerifyRankCapRequest request,
            CacheDatabase cache,
            string userId,
            Func<IFuture<VerifyRankCapResult>> invokeImpl
        )
        {
            IEnumerator Impl(IFuture<VerifyRankCapResult> self)
            {
            ...
            return new Gs2InlineFuture<VerifyRankCapResult>(Impl);
        }
#endif
