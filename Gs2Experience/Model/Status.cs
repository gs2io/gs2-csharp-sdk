	...
	public partial class Status : IComparable
	{
        ...
        public static Status FromJson(JsonData data)
        {
            ...
            return new Status()
                ...
                .WithNextRankUpExperienceValue(!data.Keys.Contains("nextRankUpExperienceValue") || data["nextRankUpExperienceValue"] == null ? null : Gs2.Core.Util.JsonValue.ToNullableLong(data["nextRankUpExperienceValue"].ToString()))
