...
namespace Gs2.Gs2Experience.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2Experience.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        public Namespace WithTransactionSettingV2(Gs2.Gs2Experience.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        public static Namespace FromJson(JsonData data)
        {
            ...
            return new Namespace()
                ...
                .WithTransactionSettingV2(!data.Keys.Contains("transactionSettingV2") || data["transactionSettingV2"] == null ? null : Gs2.Gs2Experience.Model.TransactionSettingV2.FromJson(data["transactionSettingV2"]))
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(RankCapScriptId, other.RankCapScriptId);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ChangeExperienceScript, other.ChangeExperienceScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ChangeRankScript, other.ChangeRankScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(ChangeRankCapScript, other.ChangeRankCapScript);
            if (diff != 0)
            {
                return diff;
            }
            diff = ModelComparer.Compare(OverflowExperienceScript, other.OverflowExperienceScript);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public object Clone() {
            return new Namespace {
                ...
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2Experience.Model.TransactionSettingV2,
                RankCapScriptId = RankCapScriptId,
