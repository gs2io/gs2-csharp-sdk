...
namespace Gs2.Gs2Experience.Domain.Model
{
    ...
    public partial class ExperienceModelMasterDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Model.ExperienceModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors.Length == 0 || future.Error.Errors[0].Component != "experienceModelMaster")
                        {
        ...
        private async Task<Gs2.Gs2Experience.Model.ExperienceModelMaster> GetAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithExperienceName(this.ExperienceName);
            GetExperienceModelMasterResult result = null;
            try {
                result = await this._client.GetExperienceModelMasterAsync(
                    request
                );
        ...
        public async Task<Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain> UpdateAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName)
                .WithExperienceName(this.ExperienceName);
            UpdateExperienceModelMasterResult result = null;
                result = await this._client.UpdateExperienceModelMasterAsync(
                    request
                );
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Experience.Model.ExperienceModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class ExperienceModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2Experience.Model.ExperienceModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Model.ExperienceModelMaster> self)
            {
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                        _parentKey,
                        Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain.CreateCacheKey(
                            this.ExperienceName?.ToString()
                        )
