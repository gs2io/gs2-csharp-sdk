...
namespace Gs2.Gs2Experience.Domain.Model
{
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Model.ExperienceModelMaster> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        _cache.Put<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                            _parentKey,
                            key,
                            null,
                        ...
                        if (future.Error.Errors[0].Component != "experienceModelMaster")
                        {
                ...
                try {
                    ...
                    if (e.Errors[0].Component != "experienceModelMaster")
                    {
                        throw;
                    }
                }
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain> self)
            {
                ...
                if (resultModel != null) {
                    ...
                    if (resultModel.Item != null) {
                        ...
                        cache.Delete<Gs2.Gs2Experience.Model.ExperienceModelMaster>(parentKey, key);
                    }
                }
                var domain = this;
    ...
    public partial class ExperienceModelMasterDomain {
        ...
        public IFuture<Gs2.Gs2Experience.Model.ExperienceModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Model.ExperienceModelMaster> self)
            {
                var (value, find) = _cache.Get<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                    _parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _cache.Get<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                        _parentKey,
                        Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain.CreateCacheKey(
                            this.ExperienceName?.ToString()
                        )
        ...
        {
            this._cache.Unsubscribe<Gs2.Gs2Experience.Model.ExperienceModelMaster>(
                _parentKey,
                Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain.CreateCacheKey(
                    this.ExperienceName.ToString()
                ),
