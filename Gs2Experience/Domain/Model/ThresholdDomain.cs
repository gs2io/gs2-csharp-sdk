...
namespace Gs2.Gs2Experience.Domain.Model
{
    ...
    public partial class ThresholdDomain {
            ...
            #endif
        {
            ...
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Experience.Model.Threshold>(
                _parentKey,
                Gs2.Gs2Experience.Domain.Model.ThresholdDomain.CreateCacheKey(
                )).LockAsync())
            {
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Experience.Model.Threshold> callback)
        {
        ...
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Experience.Model.Threshold> callback)
            #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Experience.Model.Threshold> callback)
            #endif
        {
