...
namespace Gs2.Gs2Experience.Domain.Model
{
    ...
    public partial class NamespaceDomain {
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (future.Error != null)
                {
                    if (future.Error is Gs2.Core.Exception.NotFoundException) {
                        ...
                        this._gs2.Cache.Put<Gs2.Gs2Experience.Model.Namespace>(
                            _parentKey,
                            key,
                            null,
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Domain.Model.NamespaceDomain> self)
            {
                ...
                if (resultModel != null) {
                    
                    {
                        ...
                        _gs2.Cache.Delete<Gs2.Gs2Experience.Model.Namespace>(parentKey, key);
                    }
                }
                var domain = this;
        ...
        public async Task<Gs2.Gs2Experience.Domain.Model.ThresholdMasterDomain> CreateThresholdMasterAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName);
            CreateThresholdMasterResult result = null;
                result = await this._client.CreateThresholdMasterAsync(
                    request
                );
        ...
        #if UNITY_2017_1_OR_NEWER
        [Obsolete("The name has been changed to CreateThresholdMasterFuture.")]
        public IFuture<Gs2.Gs2Experience.Domain.Model.ThresholdMasterDomain> CreateThresholdMaster(
            CreateThresholdMasterRequest request
        ) {
            return CreateThresholdMasterFuture(request);
        }
        #endif
        ...
        public async Task<Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain> CreateExperienceModelMasterAsync(
            ...
            request
                .WithNamespaceName(this.NamespaceName);
            CreateExperienceModelMasterResult result = null;
                result = await this._client.CreateExperienceModelMasterAsync(
                    request
                );
        ...
        #if UNITY_2017_1_OR_NEWER
        [Obsolete("The name has been changed to CreateExperienceModelMasterFuture.")]
        public IFuture<Gs2.Gs2Experience.Domain.Model.ExperienceModelMasterDomain> CreateExperienceModelMaster(
            CreateExperienceModelMasterRequest request
        ) {
            return CreateExperienceModelMasterFuture(request);
        }
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Experience.Model.Namespace> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Experience.Model.Namespace> self)
            {
                var parentKey = string.Join(
                ...
                var (value, find) = _gs2.Cache.Get<Gs2.Gs2Experience.Model.Namespace>(
                    parentKey,
                ...
                if (!find) {
                    ...
                    (value, _) = _gs2.Cache.Get<Gs2.Gs2Experience.Model.Namespace>(
                        parentKey,
                        Gs2.Gs2Experience.Domain.Model.NamespaceDomain.CreateCacheKey(
                            this.NamespaceName?.ToString()
                        )
        ...
        {
            this._gs2.Cache.Delete<Gs2.Gs2Experience.Model.Namespace>(
                _parentKey,
                Gs2.Gs2Experience.Domain.Model.NamespaceDomain.CreateCacheKey(
                    this.NamespaceName.ToString()
                )
