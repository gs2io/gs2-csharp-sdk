...
{
    public static class VerifyRankCapByUserIdSpeculativeExecutor {
...
/* diff +++ start */
            ...
            IPreparedSpeculativeVerification
        {
            ...
            private readonly VerifyRankCapByUserIdRequest _request;
...
/* diff +++ start */
        ...
        public static async Task<Func<object>> ExecuteInverseAsync(
            ...
            var inverse = request == null ? null :
                VerifyRankCapByUserIdRequest.FromJson(request.ToJson());
        ...
        public static Gs2.Gs2Experience.Model.Status Transform(
            ...
            if (!item.IsExecutable(request)) {
                throw new BadRequestException(new [] {
                    new RequestError("rankCapValue", "invalid"),
                });
            }
            return item;
/* diff +++ end */
