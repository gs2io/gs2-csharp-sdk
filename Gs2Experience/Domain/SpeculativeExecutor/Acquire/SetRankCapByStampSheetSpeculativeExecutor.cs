...
{
    public static class SetRankCapByUserIdSpeculativeExecutor {
...
/* diff --- start
 ...
 diff --- end */
/* diff +++ start */
            var preparedRequest = SetRankCapByUserIdRequest.FromJson(
                request?.ToJson()
            );
...
/* diff +++ start */
            return await StatusSpeculativeExecutor.PrepareAsync(
                ...
                item => StatusSpeculativeExecutor.WithRankCap(
                    item,
