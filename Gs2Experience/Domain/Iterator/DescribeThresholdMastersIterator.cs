...
namespace Gs2.Gs2Experience.Domain.Iterator
{
    ...
    public class DescribeThresholdMastersIterator : IAsyncEnumerable<Gs2.Gs2Experience.Model.ThresholdMaster> {
        ...
        private bool _last;
        private Gs2.Gs2Experience.Model.ThresholdMaster[] _result;
        ...
        public DescribeThresholdMastersIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Experience.Model.ThresholdMaster[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Experience.Model.ThresholdMaster>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Experience.Model.ThresholdMaster>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeThresholdMastersFuture(
                #else
                var r = await this._client.DescribeThresholdMastersAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Experience.Model.ThresholdMaster>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Experience.Model.ThresholdMaster>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Experience.Model.ThresholdMaster ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Experience.Model.ThresholdMaster>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Experience.Model.ThresholdMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Experience.Model.ThresholdMaster>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
