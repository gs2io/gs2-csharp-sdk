    ...
    public class DescribeThresholdMastersIterator : IAsyncEnumerable<Gs2.Gs2Experience.Model.ThresholdMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Experience.Model.ThresholdMaster>
            (
                ...
                var request = new Gs2.Gs2Experience.Request.DescribeThresholdMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Experience.Model.ThresholdMaster>(
                        (null as Gs2.Gs2Experience.Model.ThresholdMaster).CacheParentKey(
                            NamespaceName
                        )
                    );
