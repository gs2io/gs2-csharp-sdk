...
namespace Gs2.Gs2Experience.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Experience.Model.Status>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Experience.Model.Status>
    #else
        IAsyncEnumerable<Gs2.Gs2Experience.Model.Status>
    #endif
    {
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Experience.Request.DescribeStatusesByUserIdRequest()
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Experience.Model.Status> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Experience.Model.Status>(async (writer, token) =>
        #else
