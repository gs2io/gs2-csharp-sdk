...
namespace Gs2.Gs2Experience.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeStatusesIterator : Gs2Iterator<Gs2.Gs2Experience.Model.Status> {
    #else
    public class DescribeStatusesIterator : IAsyncEnumerable<Gs2.Gs2Experience.Model.Status> {
    #endif
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Experience.Model.Status>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Experience.Model.Status>
                (
                        parentKey
                )
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Experience.Model.Status>(
                            listParentKey
                    );
                }
            }
