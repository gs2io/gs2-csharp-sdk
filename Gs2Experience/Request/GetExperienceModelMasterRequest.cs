...
namespace Gs2.Gs2Experience.Request
{
	...
	public class GetExperienceModelMasterRequest : Gs2Request<GetExperienceModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetExperienceModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetExperienceModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetExperienceModelMasterRequest)x;
            return this;
        }
    }
}