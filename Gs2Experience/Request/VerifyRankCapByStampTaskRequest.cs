...
namespace Gs2.Gs2Experience.Request
{
	...
	public class VerifyRankCapByStampTaskRequest : Gs2Request<VerifyRankCapByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyRankCapByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyRankCapByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyRankCapByStampTaskRequest)x;
            return this;
        }
    }
}