...
namespace Gs2.Gs2Experience.Request
{
	...
	public class SetRankCapByStampSheetRequest : Gs2Request<SetRankCapByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static SetRankCapByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply SetRankCapByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (SetRankCapByStampSheetRequest)x;
            return this;
        }
    }
}