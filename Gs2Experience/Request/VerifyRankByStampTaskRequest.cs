...
#endif
	[System.Serializable]
	public class VerifyRankByStampTaskRequest : Gs2Request<VerifyRankByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyRankByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyRankByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyRankByStampTaskRequest)x;
            return this;
        }
    }
}