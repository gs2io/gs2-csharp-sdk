...
namespace Gs2.Gs2Experience.Request
{
	...
	public class GetThresholdMasterRequest : Gs2Request<GetThresholdMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetThresholdMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetThresholdMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetThresholdMasterRequest)x;
            return this;
        }
    }
}