...
namespace Gs2.Gs2Experience.Request
{
	...
	public class UpdateCurrentExperienceMasterRequest : Gs2Request<UpdateCurrentExperienceMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentExperienceMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentExperienceMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentExperienceMasterRequest)x;
            return this;
        }
    }
}