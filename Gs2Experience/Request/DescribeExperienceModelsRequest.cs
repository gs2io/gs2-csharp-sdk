...
namespace Gs2.Gs2Experience.Request
{
	...
	public class DescribeExperienceModelsRequest : Gs2Request<DescribeExperienceModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeExperienceModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeExperienceModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeExperienceModelsRequest)x;
            return this;
        }
    }
}