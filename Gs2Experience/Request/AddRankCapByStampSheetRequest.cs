...
namespace Gs2.Gs2Experience.Request
{
	...
	public class AddRankCapByStampSheetRequest : Gs2Request<AddRankCapByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static AddRankCapByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AddRankCapByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AddRankCapByStampSheetRequest)x;
            return this;
        }
    }
}