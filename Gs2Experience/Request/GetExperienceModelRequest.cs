...
namespace Gs2.Gs2Experience.Request
{
	...
	public class GetExperienceModelRequest : Gs2Request<GetExperienceModelRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetExperienceModelRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetExperienceModelRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetExperienceModelRequest)x;
            return this;
        }
    }
}