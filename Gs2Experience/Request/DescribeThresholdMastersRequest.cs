...
namespace Gs2.Gs2Experience.Request
{
	...
	public class DescribeThresholdMastersRequest : Gs2Request<DescribeThresholdMastersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeThresholdMastersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeThresholdMastersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeThresholdMastersRequest)x;
            return this;
        }
    }
}