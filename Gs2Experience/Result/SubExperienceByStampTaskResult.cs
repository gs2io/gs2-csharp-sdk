...
#endif
	[System.Serializable]
	public class SubExperienceByStampTaskResult : IResult
	{
        public Gs2.Gs2Experience.Model.Status Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public SubExperienceByStampTaskResult WithItem(Gs2.Gs2Experience.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public SubExperienceByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SubExperienceByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
