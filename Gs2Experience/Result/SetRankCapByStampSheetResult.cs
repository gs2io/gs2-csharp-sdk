...
namespace Gs2.Gs2Experience.Result
{
	...
	public class SetRankCapByStampSheetResult : IResult
	{
        ...
        public SetRankCapByStampSheetResult WithOld(Gs2.Gs2Experience.Model.Status old) {
            this.Old = old;
            return this;
        }

        public SetRankCapByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static SetRankCapByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
