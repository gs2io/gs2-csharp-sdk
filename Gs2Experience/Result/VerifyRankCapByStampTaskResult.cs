...
namespace Gs2.Gs2Experience.Result
{
	...
	public class VerifyRankCapByStampTaskResult : IResult
	{
        ...
        public VerifyRankCapByStampTaskResult WithItem(Gs2.Gs2Experience.Model.Status item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyRankCapByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyRankCapByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
