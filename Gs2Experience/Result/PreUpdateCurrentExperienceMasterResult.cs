...
#endif
	[System.Serializable]
	public class PreUpdateCurrentExperienceMasterResult : IResult
	{
        ...
        public PreUpdateCurrentExperienceMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentExperienceMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
