...
namespace Gs2.Gs2Limit.Request
{
	...
	public class DeleteLimitModelMasterRequest : Gs2Request<DeleteLimitModelMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteLimitModelMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteLimitModelMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteLimitModelMasterRequest)x;
            return this;
        }
    }
}