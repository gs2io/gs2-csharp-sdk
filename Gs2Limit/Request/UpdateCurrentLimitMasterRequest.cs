...
namespace Gs2.Gs2Limit.Request
{
	...
	public class UpdateCurrentLimitMasterRequest : Gs2Request<UpdateCurrentLimitMasterRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentLimitMasterRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentLimitMasterRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentLimitMasterRequest)x;
            return this;
        }
    }
}