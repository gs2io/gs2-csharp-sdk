...
namespace Gs2.Gs2Limit.Request
{
	...
	public class DescribeCountersRequest : Gs2Request<DescribeCountersRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeCountersRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeCountersRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeCountersRequest)x;
            return this;
        }
    }
}