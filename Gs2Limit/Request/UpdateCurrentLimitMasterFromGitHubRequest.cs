...
namespace Gs2.Gs2Limit.Request
{
	...
	public class UpdateCurrentLimitMasterFromGitHubRequest : Gs2Request<UpdateCurrentLimitMasterFromGitHubRequest>
	{
    	...
    	[Preserve]
#endif
        public static UpdateCurrentLimitMasterFromGitHubRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new UpdateCurrentLimitMasterFromGitHubRequest()
                ...
                .WithCheckoutSetting(!data.Keys.Contains("checkoutSetting") || data["checkoutSetting"] == null ? null : Gs2.Gs2Limit.Model.GitHubCheckoutSetting.FromJson(data["checkoutSetting"]));
        }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UpdateCurrentLimitMasterFromGitHubRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UpdateCurrentLimitMasterFromGitHubRequest)x;
            return this;
        }
    }
}