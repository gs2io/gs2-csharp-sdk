...
namespace Gs2.Gs2Limit.Request
{
	...
	public class DeleteByStampSheetRequest : Gs2Request<DeleteByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteByStampSheetRequest)x;
            return this;
        }
    }
}