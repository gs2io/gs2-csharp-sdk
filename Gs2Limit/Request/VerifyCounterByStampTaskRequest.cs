...
namespace Gs2.Gs2Limit.Request
{
	...
	public class VerifyCounterByStampTaskRequest : Gs2Request<VerifyCounterByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static VerifyCounterByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply VerifyCounterByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (VerifyCounterByStampTaskRequest)x;
            return this;
        }
    }
}