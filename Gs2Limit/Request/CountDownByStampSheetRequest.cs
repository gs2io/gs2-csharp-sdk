...
#endif
	[System.Serializable]
	public class CountDownByStampSheetRequest : Gs2Request<CountDownByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static CountDownByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply CountDownByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (CountDownByStampSheetRequest)x;
            return this;
        }
    }
}