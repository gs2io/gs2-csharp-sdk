...
namespace Gs2.Gs2Limit.Request
{
	...
	public class DescribeLimitModelsRequest : Gs2Request<DescribeLimitModelsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeLimitModelsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeLimitModelsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeLimitModelsRequest)x;
            return this;
        }
    }
}