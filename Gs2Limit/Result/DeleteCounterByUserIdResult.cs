...
namespace Gs2.Gs2Limit.Result
{
	...
	public class DeleteCounterByUserIdResult : IResult
	{
        ...
        public DeleteCounterByUserIdResult WithItem(Gs2.Gs2Limit.Model.Counter item) {
            this.Item = item;
            return this;
        }

        public DeleteCounterByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DeleteCounterByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
