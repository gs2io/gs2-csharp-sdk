...
#endif
	[System.Serializable]
	public class VerifyCounterResult : IResult
	{
        public Gs2.Gs2Limit.Model.Counter Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyCounterResult WithItem(Gs2.Gs2Limit.Model.Counter item) {
            this.Item = item;
            return this;
        }

        public VerifyCounterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyCounterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
