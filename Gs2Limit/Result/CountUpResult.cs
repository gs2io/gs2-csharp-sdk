...
#endif
	[System.Serializable]
	public class CountUpResult : IResult
	{
        public Gs2.Gs2Limit.Model.Counter Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public CountUpResult WithItem(Gs2.Gs2Limit.Model.Counter item) {
            this.Item = item;
            return this;
        }

        public CountUpResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static CountUpResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
