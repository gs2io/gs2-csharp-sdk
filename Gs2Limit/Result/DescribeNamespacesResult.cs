...
namespace Gs2.Gs2Limit.Result
{
	...
	{
        public Gs2.Gs2Limit.Model.Namespace[] Items { set; get; }
        ...
        public static DescribeNamespacesResult FromJson(JsonData data)
        {
            ...
            return new DescribeNamespacesResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Limit.Model.Namespace[]{} : data["items"].Cast<JsonData>().Select(v => {
