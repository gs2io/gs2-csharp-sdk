...
#endif
	[System.Serializable]
	public class PreUpdateCurrentLimitMasterResult : IResult
	{
        ...
        public PreUpdateCurrentLimitMasterResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static PreUpdateCurrentLimitMasterResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
