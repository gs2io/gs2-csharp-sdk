...
#endif
	[System.Serializable]
	public class VerifyCounterByStampTaskResult : IResult
	{
        public Gs2.Gs2Limit.Model.Counter Item { set; get; }
        public string NewContextStack { set; get; }
        public ResultMetadata Metadata { set; get; }

        public VerifyCounterByStampTaskResult WithItem(Gs2.Gs2Limit.Model.Counter item) {
            this.Item = item;
            return this;
        }
        ...
        public VerifyCounterByStampTaskResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static VerifyCounterByStampTaskResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
