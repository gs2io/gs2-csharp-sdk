...
namespace Gs2.Gs2Limit.Domain.Model
{
        ...
        private IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> GetFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.GetLimitModelMasterFuture(request)
                );
                yield return future;
        ...
        public IFuture<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> UpdateFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.UpdateLimitModelMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
                    self.OnError(future.Error);
        ...
        public IFuture<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> DeleteFuture(
            ...
            IEnumerator Impl(IFuture<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> self)
            {
                ...
                var future = request.InvokeFuture(
                    _gs2.Cache,
                    null,
                    () => this._client.DeleteLimitModelMasterFuture(request)
                );
                yield return future;
                if (future.Error != null) {
    ...
    public partial class LimitModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> ModelFuture()
        {
            IEnumerator Impl(IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> self)
            {
                ...
                var future = (null as Gs2.Gs2Limit.Model.LimitModelMaster).FetchFuture(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.LimitName,
                    () => this.GetFuture(
