...
namespace Gs2.Gs2Limit.Domain.Model
{
    ...
    public partial class LimitModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        private IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> GetFuture(
        ...
        private async Task<Gs2.Gs2Limit.Model.LimitModelMaster> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.GetLimitModelMasterAsync(request)
            );
            return result?.Item;
        }

        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> UpdateFuture(
        ...
        public async Task<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                null,
                null,
                () => this._client.UpdateLimitModelMasterAsync(request)
            );
            var domain = this;
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> DeleteFuture(
        ...
        public async Task<Gs2.Gs2Limit.Domain.Model.LimitModelMasterDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    null,
                    null,
                    () => this._client.DeleteLimitModelMasterAsync(request)
                );
            }
    ...
    public partial class LimitModelMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Limit.Model.LimitModelMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Limit.Model.LimitModelMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Limit.Model.LimitModelMaster> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Limit.Model.LimitModelMaster).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.LimitName,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Limit.Model.LimitModelMaster> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Limit.Model.LimitModelMaster> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Limit.Model.LimitModelMaster> callback)
        #endif
        {
