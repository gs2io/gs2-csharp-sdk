...
namespace Gs2.Gs2Limit.Domain.Model
{
    ...
    public partial class NamespaceDomain {
        ...
        #else
        public async Task<ulong> SubscribeLimitModelsWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Limit.Model.LimitModel[]> callback
        )
        {
        ...
        #else
        public async Task<ulong> SubscribeLimitModelMastersWithInitialCallAsync(
        #endif
            Action<Gs2.Gs2Limit.Model.LimitModelMaster[]> callback,
            string namePrefix = null
        )
    ...
    public partial class NamespaceDomain {
        ...
        ) => CreateLimitModelMasterAsync(request).ToGs2Future();
        #endif
    ...
    public partial class NamespaceDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Limit.Model.Namespace> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Limit.Model.Namespace> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Limit.Model.Namespace> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Limit.Model.Namespace> Model() => ModelAsync();
        #endif
