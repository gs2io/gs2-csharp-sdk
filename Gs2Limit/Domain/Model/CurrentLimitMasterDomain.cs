...
namespace Gs2.Gs2Limit.Domain.Model
{
    ...
    public partial class CurrentLimitMasterDomain {
        ...
        public async Task<Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain> ExportMasterAsync(
            ...
            Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain domain = this;
        ...
        private async UniTask<Gs2.Gs2Limit.Model.CurrentLimitMaster> GetAsync(
            #else
        private IFuture<Gs2.Gs2Limit.Model.CurrentLimitMaster> Get(
            #endif
        #else
        private async Task<Gs2.Gs2Limit.Model.CurrentLimitMaster> GetAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.GetCurrentLimitMasterAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain> UpdateAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCurrentLimitMasterAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain> UpdateFromGitHubAsync(
            ...
            var result = future.Result;
            #else
            var result = await this._client.UpdateCurrentLimitMasterFromGitHubAsync(
                request
            );
            #endif
            var requestModel = request;
        ...
        public async Task<Gs2.Gs2Limit.Model.CurrentLimitMaster> Model() {
            ...
            using (await this._cache.GetLockObject<Gs2.Gs2Limit.Model.CurrentLimitMaster>(
                       _parentKey,
                       Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain.CreateCacheKey(
                        )).LockAsync())
            {
        # endif
            var (value, find) = _cache.Get<Gs2.Gs2Limit.Model.CurrentLimitMaster>(
                _parentKey,
                Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain.CreateCacheKey(
                )
            );
                ...
                try {
                    ...
                    if (future.Error != null)
                    {
                        if (future.Error is Gs2.Core.Exception.NotFoundException e)
                        {
                            ...
                            _cache.Put<Gs2.Gs2Limit.Model.CurrentLimitMaster>(
                                _parentKey,
                                key,
                                null,
                                UnixTime.ToUnixTime(DateTime.Now) + 1000 * 60 * Gs2.Core.Domain.Gs2.DefaultCacheMinutes
                            ...
                            if (e.errors[0].component != "currentLimitMaster")
                            {
                                self.OnError(future.Error);
                            }
                        }
        ...
        #endif
                (value, find) = _cache.Get<Gs2.Gs2Limit.Model.CurrentLimitMaster>(
                    _parentKey,
                    Gs2.Gs2Limit.Domain.Model.CurrentLimitMasterDomain.CreateCacheKey(
                    )
                );
