...
namespace Gs2.Gs2Limit.Domain.Model
{
    ...
    public partial class CurrentLimitMasterDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Limit.Model.CurrentLimitMaster> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Limit.Model.CurrentLimitMaster> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Limit.Model.CurrentLimitMaster> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Limit.Model.CurrentLimitMaster> Model() => ModelAsync();
        #endif
