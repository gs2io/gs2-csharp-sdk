...
namespace Gs2.Gs2Limit.Domain.Iterator
{
    ...
    public class DescribeLimitModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Limit.Model.LimitModelMaster> {
        ...
        private bool _last;
        private Gs2.Gs2Limit.Model.LimitModelMaster[] _result;
        ...
        public DescribeLimitModelMastersIterator(
            ...
            this._last = false;
            this._result = new Gs2.Gs2Limit.Model.LimitModelMaster[]{};
        ...
        private async Task _load() {
            ...
            if (this._cache.IsListCached<Gs2.Gs2Limit.Model.LimitModelMaster>
            (
                    listParentKey
            )) {
                this._result = this._cache.List<Gs2.Gs2Limit.Model.LimitModelMaster>
                (
                        parentKey
                )
                    .ToArray();
                ...
                var future = this._client.DescribeLimitModelMastersFuture(
                #else
                var r = await this._client.DescribeLimitModelMastersAsync(
                #endif
                ...
                if (this._last) {
                    this._cache.ListCached<Gs2.Gs2Limit.Model.LimitModelMaster>(
                            listParentKey
                    );
                }
            }
        ...
        protected override System.Collections.IEnumerator Next(
            Action<AsyncResult<Gs2.Gs2Limit.Model.LimitModelMaster>> callback
        )
        {
            ...
            yield return UniTask.ToCoroutine(
                async () => {
                    try {
                        ...
                        Gs2.Gs2Limit.Model.LimitModelMaster ret = this._result[0];
            ...
            callback.Invoke(new AsyncResult<Gs2.Gs2Limit.Model.LimitModelMaster>(
                Current,
                error
            ));
        }
        ...
        protected override IEnumerator Next(
            ...
            #endif
        #else
        public async IAsyncEnumerator<Gs2.Gs2Limit.Model.LimitModelMaster> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        #endif
        )
        {
        #if UNITY_2017_1_OR_NEWER
            #if GS2_ENABLE_UNITASK
            return UniTaskAsyncEnumerable.Create<Gs2.Gs2Limit.Model.LimitModelMaster>(async (writer, token) =>
            {
            #endif
        #endif
        #if !UNITY_2017_1_OR_NEWER || GS2_ENABLE_UNITASK
