    ...
    public class DescribeLimitModelMastersIterator : IAsyncEnumerable<Gs2.Gs2Limit.Model.LimitModelMaster> {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Limit.Model.LimitModelMaster>
            (
                ...
                var request = new Gs2.Gs2Limit.Request.DescribeLimitModelMastersRequest()
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Limit.Model.LimitModelMaster>(
                        (null as Gs2.Gs2Limit.Model.LimitModelMaster).CacheParentKey(
                            NamespaceName,
                            null
                        )
