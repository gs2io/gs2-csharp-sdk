...
namespace Gs2.Gs2Limit.Domain
{
    ...
    public class Gs2Limit {
        ...
        {
            return this._gs2.Cache.ListSubscribe<Gs2.Gs2Limit.Model.Namespace>(
        ...
        {
            this._gs2.Cache.ListUnsubscribe<Gs2.Gs2Limit.Model.Namespace>(
                (null as Gs2.Gs2Limit.Model.Namespace).CacheParentKey(
                ),
                callbackId
            );
        ...
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2Limit.Model.Namespace>(
                (null as Gs2.Gs2Limit.Model.Namespace).CacheParentKey(
                )
            );
        }
