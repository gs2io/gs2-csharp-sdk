...
namespace Gs2.Gs2Limit.Model
{
	...
	[Preserve]
#endif
	public partial class CurrentLimitMaster : IComparable
	{
    	...
    	[Preserve]
#endif
        public static CurrentLimitMaster FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type CurrentLimitMaster.", nameof(obj));
            }
            var diff = 0;
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentLimitMaster", "limit.currentLimitMaster.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Settings.Length > 5242880) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("currentLimitMaster", "limit.currentLimitMaster.settings.error.tooLong"),
                    });
                }
            }
        }
