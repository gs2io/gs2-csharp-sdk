...
namespace Gs2.Gs2Limit.Model
{
	...
	public partial class Namespace : IComparable
	{
        ...
        public Gs2.Gs2Limit.Model.TransactionSettingV2 TransactionSettingV2 { set; get; }
        ...
        public Namespace WithTransactionSettingV2(Gs2.Gs2Limit.Model.TransactionSettingV2 transactionSettingV2) {
        ...
        private static System.Text.RegularExpressions.Regex _regionRegex = new System.Text.RegularExpressions.Regex(
                @"grn:gs2:(?<region>.+):(?<ownerId>.+):limit:(?<namespaceName>.+)",
        ...
        public static Namespace FromJson(JsonData data)
        {
            ...
            return new Namespace()
                ...
                .WithTransactionSettingV2(!data.Keys.Contains("transactionSettingV2") || data["transactionSettingV2"] == null ? null : Gs2.Gs2Limit.Model.TransactionSettingV2.FromJson(data["transactionSettingV2"]))
        ...
        public int CompareTo(object obj)
        {
            ...
            diff = ModelComparer.Compare(CountUpScript, other.CountUpScript);
            if (diff != 0)
            {
                return diff;
            }
        ...
        public void Validate() {
            {
                if (NamespaceId.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "limit.namespace.namespaceId.error.tooLong"),
                    });
                }
            }
            {
                if (Name.Length > 128) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "limit.namespace.name.error.tooLong"),
                    });
                }
            }
            {
                if (Description.Length > 1024) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "limit.namespace.description.error.tooLong"),
                    });
                }
            }
            {
            ...
            }
            {
                if (UpdatedAt < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "limit.namespace.updatedAt.error.invalid"),
                    });
                }
            ...
            }
            {
                if (Revision < 0) {
                    throw new Gs2.Core.Exception.BadRequestException(new [] {
                        new RequestError("namespace", "limit.namespace.revision.error.invalid"),
                    });
                }
        ...
        public object Clone() {
            return new Namespace {
                ...
                TransactionSettingV2 = TransactionSettingV2?.Clone() as Gs2.Gs2Limit.Model.TransactionSettingV2,
