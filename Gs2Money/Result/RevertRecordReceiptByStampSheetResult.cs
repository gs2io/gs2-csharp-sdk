...
namespace Gs2.Gs2Money.Result
{
	...
	public class RevertRecordReceiptByStampSheetResult : IResult
	{
        ...
        public RevertRecordReceiptByStampSheetResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RevertRecordReceiptByStampSheetResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
