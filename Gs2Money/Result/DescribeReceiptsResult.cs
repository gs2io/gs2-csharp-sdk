	...
	public class DescribeReceiptsResult : IResult
	{
        ...
        public static DescribeReceiptsResult FromJson(JsonData data)
        {
            ...
            return new DescribeReceiptsResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Money.Model.Receipt[]{} : data["items"].Cast<JsonData>().Select(v => {
                    return Gs2.Gs2Money.Model.Receipt.FromJson(v);
                }).ToArray())
