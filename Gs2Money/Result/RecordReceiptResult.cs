...
#endif
	[System.Serializable]
	public class RecordReceiptResult : IResult
	{
        public Gs2.Gs2Money.Model.Receipt Item { set; get; }
        public ResultMetadata Metadata { set; get; }

        public RecordReceiptResult WithItem(Gs2.Gs2Money.Model.Receipt item) {
            this.Item = item;
            return this;
        }

        public RecordReceiptResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static RecordReceiptResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
