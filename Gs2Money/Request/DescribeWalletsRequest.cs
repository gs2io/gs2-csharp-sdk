...
namespace Gs2.Gs2Money.Request
{
	...
	public class DescribeWalletsRequest : Gs2Request<DescribeWalletsRequest>
	{
        ...
        public DescribeWalletsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeWalletsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeWalletsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeWalletsRequest)x;
            return this;
        }
    }
}