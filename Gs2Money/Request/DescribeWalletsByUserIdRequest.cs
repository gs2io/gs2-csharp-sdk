...
namespace Gs2.Gs2Money.Request
{
	...
	public class DescribeWalletsByUserIdRequest : Gs2Request<DescribeWalletsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeWalletsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeWalletsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeWalletsByUserIdRequest)x;
            return this;
        }
    }
}