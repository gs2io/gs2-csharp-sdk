...
namespace Gs2.Gs2Money.Request
{
	...
	public class WithdrawByStampTaskRequest : Gs2Request<WithdrawByStampTaskRequest>
	{
    	...
    	[Preserve]
#endif
        public static WithdrawByStampTaskRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply WithdrawByStampTaskRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (WithdrawByStampTaskRequest)x;
            return this;
        }
    }
}