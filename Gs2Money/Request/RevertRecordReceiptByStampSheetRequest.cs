...
namespace Gs2.Gs2Money.Request
{
	...
	public class RevertRecordReceiptByStampSheetRequest : Gs2Request<RevertRecordReceiptByStampSheetRequest>
	{
    	...
    	[Preserve]
#endif
        public static RevertRecordReceiptByStampSheetRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply RevertRecordReceiptByStampSheetRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (RevertRecordReceiptByStampSheetRequest)x;
            return this;
        }
    }
}