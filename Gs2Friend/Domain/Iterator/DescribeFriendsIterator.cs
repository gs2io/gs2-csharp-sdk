...
namespace Gs2.Gs2Friend.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeFriendsIterator : Gs2Iterator<Gs2.Gs2Friend.Model.FriendUser> {
    #else
    public class DescribeFriendsIterator : IAsyncEnumerable<Gs2.Gs2Friend.Model.FriendUser> {
    #endif
