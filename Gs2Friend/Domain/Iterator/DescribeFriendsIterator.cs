...
namespace Gs2.Gs2Friend.Domain.Iterator
{
    ...
    public class DescribeFriendsIterator :
    #if UNITY_2017_1_OR_NEWER
        Gs2Iterator<Gs2.Gs2Friend.Model.FriendUser>,
    #endif
    #if GS2_ENABLE_UNITASK
        IUniTaskAsyncEnumerable<Gs2.Gs2Friend.Model.FriendUser>
    #else
        IAsyncEnumerable<Gs2.Gs2Friend.Model.FriendUser>
    #endif
    {
        ...
        private async Task _load() {
            ...
            if (!isCacheChecked && this._gs2.Cache.TryGetList
                    <Gs2.Gs2Friend.Model.FriendUser>
            (
                ...
                var request = new Gs2.Gs2Friend.Request.DescribeFriendsRequest()
                    ...
                    .WithLimit(fetchSize);
                var r = await this._client.DescribeFriendsAsync(
                    request
                );
                ...
                if (this._last) {
                    this._gs2.Cache.SetListCached<Gs2.Gs2Friend.Model.FriendUser>(
                        (null as Gs2.Gs2Friend.Model.FriendUser).CacheParentKey(
                            NamespaceName,
                            AccessToken?.UserId,
                            WithProfile ?? default,
        ...
        #if GS2_ENABLE_UNITASK
        public IUniTaskAsyncEnumerator<Gs2.Gs2Friend.Model.FriendUser> GetAsyncEnumerator(
            CancellationToken cancellationToken = new CancellationToken()
        ) => UniTaskAsyncEnumerable.Create<Gs2.Gs2Friend.Model.FriendUser>(async (writer, token) =>
        #else
