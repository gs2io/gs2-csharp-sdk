...
namespace Gs2.Gs2Friend.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeSendRequestsIterator : Gs2Iterator<Gs2.Gs2Friend.Model.SendFriendRequest> {
    #else
    public class DescribeSendRequestsIterator : IAsyncEnumerable<Gs2.Gs2Friend.Model.SendFriendRequest> {
    #endif
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Friend.Request.DescribeSendRequestsRequest()
