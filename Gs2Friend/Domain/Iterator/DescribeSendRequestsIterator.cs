...
namespace Gs2.Gs2Friend.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeSendRequestsIterator : Gs2Iterator<Gs2.Gs2Friend.Model.FriendRequest> {
    #else
    public class DescribeSendRequestsIterator : IAsyncEnumerable<Gs2.Gs2Friend.Model.FriendRequest> {
    #endif
