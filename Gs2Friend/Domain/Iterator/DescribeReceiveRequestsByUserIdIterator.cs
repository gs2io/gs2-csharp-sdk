...
namespace Gs2.Gs2Friend.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeReceiveRequestsByUserIdIterator : Gs2Iterator<Gs2.Gs2Friend.Model.FriendRequest> {
    #else
    public class DescribeReceiveRequestsByUserIdIterator : IAsyncEnumerable<Gs2.Gs2Friend.Model.FriendRequest> {
    #endif
