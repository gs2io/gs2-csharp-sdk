...
namespace Gs2.Gs2Friend.Domain.Iterator
{
    ...
    #if UNITY_2017_1_OR_NEWER
    public class DescribeBlackListIterator : Gs2Iterator<string> {
    #else
    public class DescribeBlackListIterator : IAsyncEnumerable<string> {
    #endif
        ...
        private async Task _load() {
            ...
            (
                ...
                var request = new Gs2.Gs2Friend.Request.DescribeBlackListRequest()
                ...
                var future = this._client.DescribeBlackListFuture(
                #else
