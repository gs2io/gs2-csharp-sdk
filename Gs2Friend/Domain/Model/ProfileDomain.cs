...
namespace Gs2.Gs2Friend.Domain.Model
{
    ...
    public partial class ProfileDomain {
        ...
        private async Task<Gs2.Gs2Friend.Model.Profile> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                null,
                () => this._client.GetProfileByUserIdAsync(request)
            );
            return result?.Item;
        }
        ...
        public async Task<Gs2.Gs2Friend.Domain.Model.ProfileDomain> UpdateAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                null,
                () => this._client.UpdateProfileByUserIdAsync(request)
            );
            var domain = this;
        ...
        public async Task<Gs2.Gs2Friend.Domain.Model.ProfileDomain> DeleteAsync(
            ...
            try {
                ...
                var result = await request.InvokeAsync(
                    ...
                    this.UserId,
                    null,
                    () => this._client.DeleteProfileByUserIdAsync(request)
                );
            }
    ...
    public partial class ProfileDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Friend.Model.Profile> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Friend.Model.Profile>(
                        (null as Gs2.Gs2Friend.Model.Profile).CacheParentKey(
                            this.NamespaceName,
                            this.UserId,
                            null
                        ),
                        (null as Gs2.Gs2Friend.Model.Profile).CacheKey(
                        )
                    ).LockAsync()) {
                var (value, find) = (null as Gs2.Gs2Friend.Model.Profile).GetCache(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.UserId,
                    null
                ...
                return await (null as Gs2.Gs2Friend.Model.Profile).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.UserId,
                    null,
        ...
        public UniTask<Gs2.Gs2Friend.Model.Profile> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Friend.Model.Profile> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Friend.Model.Profile> Model() => ModelAsync();
        #endif


        public void Invalidate()
        {
            (null as Gs2.Gs2Friend.Model.Profile).DeleteCache(
                this._gs2.Cache,
                this.NamespaceName,
                this.UserId,
                null
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Friend.Model.Profile> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Friend.Model.Profile> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Friend.Model.Profile> callback)
        #endif
        {
