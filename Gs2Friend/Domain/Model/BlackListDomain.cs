...
namespace Gs2.Gs2Friend.Domain.Model
{
    ...
    public partial class BlackListDomain {
        ...
        ) => RegisterAsync(request).ToGs2Future();
        #endif
        ...
        public async Task<Gs2.Gs2Friend.Domain.Model.BlackListDomain> RegisterAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                null,
                () => this._client.RegisterBlackListByUserIdAsync(request)
            );
            var domain = this;
        ...
        ) => UnregisterAsync(request).ToGs2Future();
        #endif
        ...
        public async Task<Gs2.Gs2Friend.Domain.Model.BlackListDomain> UnregisterAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                null,
                () => this._client.UnregisterBlackListByUserIdAsync(request)
            );
            var domain = this;
    ...
    public partial class BlackListDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Friend.Model.BlackList> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        public UniTask<Gs2.Gs2Friend.Model.BlackList> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Friend.Model.BlackList> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Friend.Model.BlackList> Model() => ModelAsync();
        #endif
