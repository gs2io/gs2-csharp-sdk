...
namespace Gs2.Gs2Friend.Domain.Model
{
    ...
    public partial class UserAccessTokenDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Friend.Domain.Model.SendFriendRequestAccessTokenDomain> SendRequestFuture(
            ...
            #if UNITY_2017_1_OR_NEWER
        public async UniTask<Gs2.Gs2Friend.Domain.Model.SendFriendRequestAccessTokenDomain> SendRequestAsync(
            #else
        public async Task<Gs2.Gs2Friend.Domain.Model.SendFriendRequestAccessTokenDomain> SendRequestAsync(
            #endif
            SendRequestRequest request
        ) {
            request = request
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Iterator<Gs2.Gs2Friend.Model.ReceiveFriendRequest> ReceiveRequests(
        )
        {
        ...
        {
            return this._gs2.Cache.ListSubscribe<Gs2.Gs2Friend.Model.ReceiveFriendRequest>(
        ...
        {
            this._gs2.Cache.ListUnsubscribe<Gs2.Gs2Friend.Model.ReceiveFriendRequest>(
                (null as Gs2.Gs2Friend.Model.ReceiveFriendRequest).CacheParentKey(
                    this.NamespaceName,
                    this.UserId,
                    this.AccessToken?.TimeOffset
        ...
        {
            this._gs2.Cache.ClearListCache<Gs2.Gs2Friend.Model.ReceiveFriendRequest>(
                (null as Gs2.Gs2Friend.Model.ReceiveFriendRequest).CacheParentKey(
                    this.NamespaceName,
                    this.UserId,
                    this.AccessToken?.TimeOffset
