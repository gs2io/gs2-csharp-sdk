...
namespace Gs2.Gs2Friend.Domain.Model
{
    ...
    public partial class PublicProfileDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        private IFuture<Gs2.Gs2Friend.Model.PublicProfile> GetFuture(
        ...
        private async Task<Gs2.Gs2Friend.Model.PublicProfile> GetAsync(
            ...
            var result = await request.InvokeAsync(
                ...
                this.UserId,
                null,
                () => this._client.GetPublicProfileAsync(request)
            );
            return result?.Item;
        }
    ...
    public partial class PublicProfileDomain {
        ...
        #if UNITY_2017_1_OR_NEWER
        public IFuture<Gs2.Gs2Friend.Model.PublicProfile> ModelFuture() => ModelAsync().ToGs2Future();
        #endif
        ...
        #endif
        {
            using (await this._gs2.Cache.GetLockObject<Gs2.Gs2Friend.Model.PublicProfile>(
                ...
                return await (null as Gs2.Gs2Friend.Model.PublicProfile).FetchAsync(
                    this._gs2.Cache,
                    this.NamespaceName,
                    this.UserId,
                    null,
        ...
        public UniTask<Gs2.Gs2Friend.Model.PublicProfile> Model() => ModelAsync();
            #else
        [Obsolete("The name has been changed to ModelFuture.")]
        public IFuture<Gs2.Gs2Friend.Model.PublicProfile> Model() => ModelFuture();
            #endif
        #else
        [Obsolete("The name has been changed to ModelAsync.")]
        public Task<Gs2.Gs2Friend.Model.PublicProfile> Model() => ModelAsync();
        #endif
        ...
        #if UNITY_2017_1_OR_NEWER
        public Gs2Future<ulong> SubscribeWithInitialCallFuture(Action<Gs2.Gs2Friend.Model.PublicProfile> callback) =>
            SubscribeWithInitialCallAsync(callback).ToGs2Future();
        #endif

        #if GS2_ENABLE_UNITASK
        public async UniTask<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Friend.Model.PublicProfile> callback)
        #else
        public async Task<ulong> SubscribeWithInitialCallAsync(Action<Gs2.Gs2Friend.Model.PublicProfile> callback)
        #endif
        {
