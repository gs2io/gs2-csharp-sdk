...
/* diff --- start
 ...
 diff --- end */
        public DescribeReceiveRequestsResult WithItems(Gs2.Gs2Friend.Model.ReceiveFriendRequest[] items) { /* diff +++ */
            this.Items = items;
            return this;
        }
        ...
        public DescribeReceiveRequestsResult WithMetadata(ResultMetadata metadata) {
