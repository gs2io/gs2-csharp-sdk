...
#endif
	[System.Serializable]
	public class DescribeReceiveRequestsByUserIdResult : IResult
	{
/* diff --- start
        public Gs2.Gs2Friend.Model.FriendRequest[] Items { set; get; }
 diff --- end */
        public Gs2.Gs2Friend.Model.ReceiveFriendRequest[] Items { set; get; } /* diff +++ */
        public string NextPageToken { set; get; }
        public ResultMetadata Metadata { set; get; }

/* diff --- start
        public DescribeReceiveRequestsByUserIdResult WithItems(Gs2.Gs2Friend.Model.FriendRequest[] items) {
 diff --- end */
        public DescribeReceiveRequestsByUserIdResult WithItems(Gs2.Gs2Friend.Model.ReceiveFriendRequest[] items) { /* diff +++ */
            this.Items = items;
            return this;
        }
        ...
        public DescribeReceiveRequestsByUserIdResult WithMetadata(ResultMetadata metadata) {
    	...
    	[Preserve]
#endif
        public static DescribeReceiveRequestsByUserIdResult FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
...
/* diff --- start
 ...
 diff --- end */
                    return Gs2.Gs2Friend.Model.ReceiveFriendRequest.FromJson(v); /* diff +++ */
                }).ToArray())
