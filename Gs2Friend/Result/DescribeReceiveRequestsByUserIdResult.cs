...
namespace Gs2.Gs2Friend.Result
{
	...
	{
        public Gs2.Gs2Friend.Model.FriendRequest[] Items { set; get; } = null!;
        ...
        public static DescribeReceiveRequestsByUserIdResult FromJson(JsonData data)
        {
            ...
            return new DescribeReceiveRequestsByUserIdResult()
                .WithItems(!data.Keys.Contains("items") || data["items"] == null || !data["items"].IsArray ? new Gs2.Gs2Friend.Model.FriendRequest[]{} : data["items"].Cast<JsonData>().Select(v => {
