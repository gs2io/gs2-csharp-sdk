...
/* diff --- start
 ...
 diff --- end */
        public DescribeSendRequestsByUserIdResult WithItems(Gs2.Gs2Friend.Model.SendFriendRequest[] items) { /* diff +++ */
            this.Items = items;
            return this;
        }
        ...
        public DescribeSendRequestsByUserIdResult WithMetadata(ResultMetadata metadata) {
