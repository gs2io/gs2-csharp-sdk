...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DescribeFollowsByUserIdRequest : Gs2Request<DescribeFollowsByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeFollowsByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeFollowsByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeFollowsByUserIdRequest)x;
            return this;
        }
    }
}