...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DeleteFriendRequest : Gs2Request<DeleteFriendRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteFriendRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteFriendRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteFriendRequest)x;
            return this;
        }
    }
}