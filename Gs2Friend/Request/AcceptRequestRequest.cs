...
namespace Gs2.Gs2Friend.Request
{
	...
	public class AcceptRequestRequest : Gs2Request<AcceptRequestRequest>
	{
    	...
    	[Preserve]
#endif
        public static AcceptRequestRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AcceptRequestRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AcceptRequestRequest)x;
            return this;
        }
    }
}