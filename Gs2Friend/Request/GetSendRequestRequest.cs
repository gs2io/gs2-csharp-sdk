...
namespace Gs2.Gs2Friend.Request
{
	...
	public class GetSendRequestRequest : Gs2Request<GetSendRequestRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetSendRequestRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetSendRequestRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetSendRequestRequest)x;
            return this;
        }
    }
}