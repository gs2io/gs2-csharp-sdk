...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DeleteFriendByUserIdRequest : Gs2Request<DeleteFriendByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DeleteFriendByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DeleteFriendByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DeleteFriendByUserIdRequest)x;
            return this;
        }
    }
}