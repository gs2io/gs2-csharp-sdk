...
namespace Gs2.Gs2Friend.Request
{
	...
	public class UnregisterBlackListRequest : Gs2Request<UnregisterBlackListRequest>
	{
    	...
    	[Preserve]
#endif
        public static UnregisterBlackListRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UnregisterBlackListRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UnregisterBlackListRequest)x;
            return this;
        }
    }
}