...
namespace Gs2.Gs2Friend.Request
{
	...
	public class FollowByUserIdRequest : Gs2Request<FollowByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static FollowByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply FollowByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (FollowByUserIdRequest)x;
            return this;
        }
    }
}