...
namespace Gs2.Gs2Friend.Request
{
	...
	public class UnregisterBlackListByUserIdRequest : Gs2Request<UnregisterBlackListByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static UnregisterBlackListByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply UnregisterBlackListByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (UnregisterBlackListByUserIdRequest)x;
            return this;
        }
    }
}