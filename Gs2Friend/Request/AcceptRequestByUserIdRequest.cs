...
namespace Gs2.Gs2Friend.Request
{
	...
	public class AcceptRequestByUserIdRequest : Gs2Request<AcceptRequestByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static AcceptRequestByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply AcceptRequestByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (AcceptRequestByUserIdRequest)x;
            return this;
        }
    }
}