...
namespace Gs2.Gs2Friend.Request
{
	...
	public class GetPublicProfileRequest : Gs2Request<GetPublicProfileRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetPublicProfileRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetPublicProfileRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetPublicProfileRequest)x;
            return this;
        }
    }
}