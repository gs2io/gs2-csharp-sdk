...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DescribeFollowsRequest : Gs2Request<DescribeFollowsRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeFollowsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeFollowsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeFollowsRequest)x;
            return this;
        }
    }
}