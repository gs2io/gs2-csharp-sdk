...
namespace Gs2.Gs2Friend.Request
{
	...
	public class GetFriendByUserIdRequest : Gs2Request<GetFriendByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetFriendByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetFriendByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetFriendByUserIdRequest)x;
            return this;
        }
    }
}