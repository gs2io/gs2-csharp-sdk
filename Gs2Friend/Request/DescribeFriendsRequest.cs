...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DescribeFriendsRequest : Gs2Request<DescribeFriendsRequest>
	{
        ...
        public DescribeFriendsRequest WithLimit(int? limit) {
            this.Limit = limit;
            return this;
        }
    	...
    	[Preserve]
#endif
        public static DescribeFriendsRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeFriendsRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeFriendsRequest)x;
            return this;
        }
    }
}