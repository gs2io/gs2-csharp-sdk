...
namespace Gs2.Gs2Friend.Request
{
	...
	public class GetReceiveRequestRequest : Gs2Request<GetReceiveRequestRequest>
	{
    	...
    	[Preserve]
#endif
        public static GetReceiveRequestRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply GetReceiveRequestRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (GetReceiveRequestRequest)x;
            return this;
        }
    }
}