...
namespace Gs2.Gs2Friend.Request
{
	...
	public class DescribeBlackListByUserIdRequest : Gs2Request<DescribeBlackListByUserIdRequest>
	{
    	...
    	[Preserve]
#endif
        public static DescribeBlackListByUserIdRequest FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
        ...
        protected override Gs2Request DoMultiple(int x) {
            if (x != 1) {
                throw new ArithmeticException("Unsupported multiply DescribeBlackListByUserIdRequest");
            }
            return this;
        }

        protected override Gs2Request DoAdd(Gs2Request x) {
            var y = (DescribeBlackListByUserIdRequest)x;
            return this;
        }
    }
}