	...
	public partial class Profile : IComparable
	{
        ...
        public int CompareTo(object obj)
        {
            ...
            if (ReferenceEquals(other, null))
            {
                ...
                throw new ArgumentException("Object must be of type Profile.", nameof(obj));
            }
            var diff = 0;
            diff = ModelComparer.Compare(ProfileId, other.ProfileId);
            if (diff != 0)
            {
                return diff;
            }
            ...
            diff = ModelComparer.Compare(FriendProfile, other.FriendProfile);
            if (diff != 0)
            {
                return diff;
            }
