...
namespace Gs2.Gs2Friend.Model
{
	public class CancelRequestNotification
	{
        ...
        public CancelRequestNotification WithNamespaceName(string namespaceName) {
            this.NamespaceName = namespaceName;
            return this;
        }
        public CancelRequestNotification WithUserId(string userId) {
            this.UserId = userId;
            return this;
        }
        public CancelRequestNotification WithFromUserId(string fromUserId) {
    	...
    	[Preserve]
#endif
        public static CancelRequestNotification FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
