...
namespace Gs2.Gs2Friend.Model
{
	public class DeleteFriendNotification
	{
        ...
        public DeleteFriendNotification WithNamespaceName(string namespaceName) {
            this.NamespaceName = namespaceName;
            return this;
        }
        public DeleteFriendNotification WithUserId(string userId) {
            this.UserId = userId;
            return this;
        }
        public DeleteFriendNotification WithFromUserId(string fromUserId) {
    	...
    	[Preserve]
#endif
        public static DeleteFriendNotification FromJson(JsonData data)
        {
            if (data == null) {
                return null;
            }
            return new DeleteFriendNotification()
